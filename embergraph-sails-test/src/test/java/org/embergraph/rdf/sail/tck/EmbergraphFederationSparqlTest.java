...
public class EmbergraphFederationSparqlTest extends SPARQLQueryTest {
    ...
    public static Test suite(final boolean hideDatasetTests) throws Exception {
        ...
        if(hideDatasetTests)
            suite1 = EmbergraphSparqlTest.filterOutTests(suite1,"dataset");
    ...
    public static TestSuite fullSuite() throws Exception {
        ...
        final SPARQLQueryTest.Factory factory = new SPARQLQueryTest.Factory() {
            ...
            public SPARQLQueryTest createSPARQLQueryTest(String URI,
                ...
                return new EmbergraphFederationSparqlTest(URI, name, query,
    ...
    public EmbergraphFederationSparqlTest(String URI, String name, String query,
    ...
    protected Repository newRepository ()
        throws Exception
    {
        return new DatasetRepository ( new EmbergraphSailRepository( _sail = new EmbergraphSail( newTripleStore () ) ) ) ;
    }
...
//    }
	...
	protected EmbergraphSailRepositoryConnection getQueryConnection(Repository dataRep)
		...
		final EmbergraphSailRepositoryConnection con = new EmbergraphSailRepositoryConnection(new EmbergraphSailRepository(
