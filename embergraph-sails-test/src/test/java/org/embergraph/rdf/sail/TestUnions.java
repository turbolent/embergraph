...
public class TestUnions extends QuadsTestCase {
  ...
  public void testUnions() throws Exception {
    ...
    try {
      ...
      /**/
      cxn.add(a, DC10_TITLE, new LiteralImpl("A"));
      cxn.add(a, DC10_CREATOR, new LiteralImpl("A"));
      cxn.add(b, DC11_TITLE, new LiteralImpl("B"));
      cxn.add(b, DC11_CREATOR, new LiteralImpl("B"));
      cxn.add(c, DC10_TITLE, new LiteralImpl("C"));
      cxn.add(c, DC11_CREATOR, new LiteralImpl("C"));
      /**/
  ...
  public void testSesameFilters() throws Exception {
    ...
    try {
      ...
      /**/
      cxn.add(jack, RDF.TYPE, person);
      cxn.add(jill, RDF.TYPE, person);
      cxn.add(jack, age, new LiteralImpl("40", integer));
      cxn.add(jill, age, new LiteralImpl("30", integer));
      /**/
