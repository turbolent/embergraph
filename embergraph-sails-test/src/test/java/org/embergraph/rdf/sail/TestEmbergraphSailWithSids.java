 ...
 */
public class TestEmbergraphSailWithSids extends AbstractEmbergraphSailTestCase {

    /**
     * 
     */
    public TestEmbergraphSailWithSids() {
    }

    public TestEmbergraphSailWithSids(String name) {
        super(name);
    }
    
    public static Test suite() {
        
        final TestEmbergraphSailWithSids delegate = new TestEmbergraphSailWithSids(); // !!!! THIS CLASS !!!!
