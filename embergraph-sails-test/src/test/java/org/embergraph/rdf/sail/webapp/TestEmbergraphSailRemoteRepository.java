...
/**
 * Proxied test suite for {@link EmbergraphSailRemoteRepository} and
 * {@link EmbergraphSailRemoteRepositoryConnection}.
 * <p>
 ...
 *           embedded tests? (EmbergraphSparqlTest). This would mean having a test
 ...
 *           run against the {@link EmbergraphSailRemoteRepository}.
 * 
 ...
 */
public class TestEmbergraphSailRemoteRepository<S extends IIndexManager> extends
...
//            );
      ...
      return ProxySuiteHelper.suiteWhenStandalone(TestEmbergraphSailRemoteRepository.ReadWriteTx.class,
//            "test.*", TestMode.quads
...
//                requestPath,
   ...
   static public class ReadWriteTx<S extends IIndexManager> extends
       TestEmbergraphSailRemoteRepository<S> {
...
if(true) return; // FIXME (***) TX TEST DISABLED
         ...
         {
            final EmbergraphSailRemoteRepositoryConnection cxn2 = repo
                  .getConnection();
            try {
               assertTrue(cxn2 != cxn);
               // cxn2.begin();
