...
public class TestGetRequestTimeout extends TestCase2 {
  ...
  public void testGetRequestTimeout() {
    ...
    final HttpServletRequest req =
        new MockRequest(httpHeaderEmbergraphMaxQueryMillis, maxQuryTimeMillis, timeout);
  ...
  private class MockRequest implements HttpServletRequest {
    ...
    private MockRequest(
        String httpHeaderEmbergraphMaxQueryMillis, String maxQuryTimeMillis, String timeout) {
    ...
    public String getParameter(String name) {
      if (name.equals(EmbergraphRDFContext.TIMEOUT)) return timeout;
      else if (name.equals(EmbergraphRDFContext.MAX_QUERY_TIME_MILLIS)) return maxQuryTimeMillis;
      return null;
    }
