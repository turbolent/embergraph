 ...
 *
 * <p>Also {@link #xtestServiceSyntaxError()} shows some bug some where in that we take legal SPARQL
 * and make it illegal before the service call ....
 *
 * <p>Some of the other tests show how to use a subselect as a workaround.
 *
...
public class TestService794 extends AbstractProtocolTest {
  ...
  private void abstactAskService(final String... args) throws IOException {
    ...
    serviceRequest(
        "update",
        "PREFIX eg: <http://example.com/a#> INSERT { eg:a eg:p \"rs123\" ; eg:q 123, 100 } WHERE {}");
