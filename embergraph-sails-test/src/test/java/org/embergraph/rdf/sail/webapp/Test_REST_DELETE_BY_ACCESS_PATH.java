 ...
 *     <p>FIXME (***) Add tests for quads mode that target #1177
 */
public class Test_REST_DELETE_BY_ACCESS_PATH<S extends IIndexManager>
  ...
  public static Test suite() {
    ...
    return ProxySuiteHelper.suiteWhenStandalone(
        Test_REST_DELETE_BY_ACCESS_PATH.class, "test.*", TestMode.quads
        //                , TestMode.sids
        //                , TestMode.triples
        );
  }
