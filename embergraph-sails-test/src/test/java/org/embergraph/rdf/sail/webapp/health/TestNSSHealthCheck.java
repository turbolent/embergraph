 ...
 */
package org.embergraph.rdf.sail.webapp.health;
...
public class TestNSSHealthCheck extends TestCase2 {
  ...
  protected Server newFixture() throws Exception {
    ...
    final Server fixture = NanoSparqlServer.newInstance(0 /* port */, m_indexManager, initParams);
  ...
  static HealthCheckTestSuite createTestSuite(final String name, final String requestURI) {

    final HealthCheckTestSuite suite = new HealthCheckTestSuite(name, requestURI);
