    ...
    try {
       ...
       */
      {
        ...
        try {
          ...
          dataLoader.loadData(
              "/org/embergraph/rdf/sail/provenance01.ttlx",
              "" /* baseURL */,
      ...
      if (log.isInfoEnabled()) {
        ...
        try {
          ...
          final EmbergraphStatementIterator itr =
              conn.getTripleStore().getStatements(null, null, null);
          final String rdfXml;
          try {
            ...
            while (itr.hasNext()) {
              ...
              final EmbergraphStatementImpl stmt = (EmbergraphStatementImpl) itr.next();
      ...
      try {
        ...
        final TupleQuery tq =
            new EmbergraphSailRepository(sail)
