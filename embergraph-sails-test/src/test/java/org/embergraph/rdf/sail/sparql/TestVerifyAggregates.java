 ...
 * SPARQL parser from the database.
 *
...
public class TestVerifyAggregates extends TestCase2 {
  ...
  public void test_simpleAggregate() {
    ...
    final IValueExpressionNode totalPriceExprNode =
        new FunctionNode(FunctionRegistry.SUM, null, lprice);
  ...
  public void test_aggregateExpr_04() {
    ...
    final IValueExpressionNode mathExpr =
        FunctionNode.add(o, new ConstantNode(new XSDNumericIV(1)));
  ...
  public void test_simpleHavingClause() {
    ...
    having.addExpr(FunctionNode.GT(x, new ConstantNode(new XSDNumericIV(10))));
  ...
  public void test_complexHavingClause() {
    ...
    final FunctionNode xExpr = new FunctionNode(FunctionRegistry.SUM, null, y);
    ...
    final HavingNode having = new HavingNode();
    having.addExpr(FunctionNode.GT(xExpr, new ConstantNode(new XSDNumericIV(10))));
  ...
  public void test_nestedAggregates() {
    ...
    final IValueExpressionNode zExpr =
        new FunctionNode(
            FunctionRegistry.SUM,
            null,
            FunctionNode.add(x, new FunctionNode(FunctionRegistry.MIN, null, y)));
  ...
  public void test_with_constant() {
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    final ConstantNode xExpr = new ConstantNode(new XSDNumericIV(12));
  ...
  public void test_correctRejection() {
    ...
    try {
      new VerifyAggregates(new ProjectionNode() /* select */, groupBy, having);
      fail("Expecting: " + IllegalArgumentException.class);
    } catch (final IllegalArgumentException ex) {
      if (log.isInfoEnabled()) log.info("Ignoring expected exception: " + ex, ex);
    }
