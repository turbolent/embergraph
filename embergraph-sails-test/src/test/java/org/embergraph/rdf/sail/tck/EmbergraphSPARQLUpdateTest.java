...
public class EmbergraphSPARQLUpdateTest extends SPARQLUpdateTest {
    ...
    static private final Logger logger = Logger
            .getLogger(EmbergraphSPARQLUpdateTest.class);
...
//				+ "} LIMIT 10";
		...
		// run update once.
        final EmbergraphSailUpdate update = (EmbergraphSailUpdate) con.prepareUpdate(QueryLanguage.SPARQL, s);
        update.execute();
...
//        debugPrintSolutions("SELECT * WHERE { GRAPH ?g { ?s ?p ?o } }");
    ...
    public void testUnicodeCleanAndRegex() throws Exception {
        ...
        final EmbergraphSailUpdate update = (EmbergraphSailUpdate)
