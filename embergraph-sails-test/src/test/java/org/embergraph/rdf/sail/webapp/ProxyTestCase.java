 ...
 * for your implementation. This class provides an implementation neutral way to add new tests, not
 * a means for testing specific generic object model Java API implementations.
 *
 ...
 */
public abstract class ProxyTestCase<S extends IIndexManager> extends AbstractIndexManagerTestCase<S>
  ...
  public AbstractIndexManagerTestCase<S> getOurDelegate() {
    ...
    throw new IllegalStateException(
        "The delegate MUST extend "
            + AbstractIndexManagerTestCase.class.getName()
            + ", not "
