...
public class TestUpdateExprBuilder extends AbstractEmbergraphExprBuilderTestCase {
  ...
  public void test_load_graph() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
      ...
      op.setSourceGraph(
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/data"))));
    }
  ...
  public void test_load_silent_graph_into_graph()
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
      ...
      op.setTargetGraph(
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/graph1"))));
    }
  ...
  public void test_load_graphs() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    }
    {
      ...
      op.setSourceGraph(
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/data1"))));
    }
    {
      final LoadGraph op = new LoadGraph();
      ...
      op.setSourceGraph(
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/data2"))));
    }
  ...
  public void test_copy_graph_to_graph()
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
      ...
      op.setTargetGraph(
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/graph2"))));
    }
  ...
  public void test_insert_data() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
      ...
      final EmbergraphURI dcCreator =
          valueFactory.createURI("http://purl.org/dc/elements/1.1/creator");
   ...
   * </pre>
   *
   * Note: Since WITH is not given, the context position is <code>null</code> and the {@link Scope}
   * is {@link Scope#DEFAULT_CONTEXTS} for any {@link StatementPatternNode} which is outside of a
   * GRAPH group. Within a GRAPH group, the context is, of course, the constant IRI or variable
   * specified by the GRAPH group and the {@link Scope} is {@link Scope#NAMED_CONTEXTS}.
   *
  ...
  public void test_delete_insert_00()
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
...

      {
        ...
        deleteClause.addChild(
            new StatementPatternNode(
                new VarNode("person"),
                new ConstantNode(givenName),
...

      {
        ...
        whereClause.addChild(
            new StatementPatternNode(
                ...
                new ConstantNode(givenName),
                new ConstantNode(label1),
                null, // new ConstantNode(addresses),
                Scope.DEFAULT_CONTEXTS));

        // The GRAPH group.
        whereClause.addChild(
            new JoinGroupNode(
                new ConstantNode(addresses),
                new StatementPatternNode(
                    new VarNode("person"),
                    new ConstantNode(givenName),
                    new ConstantNode(label1),
   ...
   * </pre>
   *
   * Note: The context position on the {@link StatementPatternNode} outside of the GRAPH group is
   * bound to the constant specified by the WITH clause. <code>WITH uri</code> is a syntactic sugar
   * for <code>GRAPH uri {...}</code>, so the {@link StatementPatternNode} is also marked as {@link
   * Scope#NAMED_CONTEXTS}.
   */
  @SuppressWarnings("rawtypes")
   ...
   * </pre>
   *
   * Note: WITH is not used, so there is no implicit GRAPH wrapping the INSERT clause, DELETE
   * clause, and WHERE clause. Therefore, the context will be <code>null</code> for the statement
   * patterns in the DELETE clause and INSERT clause and outside of the GRAPH clause in the WHERE
   * clause.
   */
  @SuppressWarnings("rawtypes")
   ...
   * clause.
   *
   * <p>Note: For this test, the GRAPH group is also using a variable.
   */
  @SuppressWarnings("rawtypes")
   ...
   * </pre>
   *
   * Since WITH is used, the DELETE, INSERT, and WHERE clause is each wrapped by an implicit <code>
   * GRAPH uri</code>.
   *
   * <p>Note: For this test, the GRAPH group is also using a variable. However, that variable will
   * be constrained by the WITH clause to a constant.
   */
  @SuppressWarnings("rawtypes")
   ...
   * </pre>
   *
   * Note: Since WITH is given, there is an implicit GRAPH wrapping the INSERT, DELETE, and WHERE
   * clauses.
   *
   * @see StatementPatternNode
   */
  ...
  public void test_delete_insert_20()
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
...

      {
        ...
        deleteClause.addChild(
            new StatementPatternNode(new VarNode("book"), new VarNode("p"), new VarNode("v")));
...

      {
        ...
        whereClause.addChild(
            new StatementPatternNode(
                new VarNode("book"), new ConstantNode(dcDate), new VarNode("date")));
  ...
  public void test_delete_where_01() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    @SuppressWarnings("rawtypes")
    final IV foafName = makeIV(valueFactory.createURI("http://xmlns.com/foaf/0.1/name"));
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
...

      {
        ...
        whereClause.addChild(
            new StatementPatternNode(
                new VarNode("x"), new ConstantNode(foafName), new VarNode("y")));
  ...
  public void test_delete_where_02() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    final UpdateRoot expected = new UpdateRoot();
    {
...

      {
        ...
        graphClause.addChild(
            new StatementPatternNode(
                new VarNode("x"),
                new ConstantNode(foafName),
                new VarNode("y"),
                new VarNode("g"),
                Scope.NAMED_CONTEXTS));
   ...
   * is because the blank nodes in the DELETE clause are distinct for each solution plugged into
   * that template. Thus they can not match anything in the database.
   *
   ...
   * </pre>
   *
   * Note: This is the same operations, but the first one has the data set while the second one does
   * not.
   */
  @SuppressWarnings("rawtypes")
