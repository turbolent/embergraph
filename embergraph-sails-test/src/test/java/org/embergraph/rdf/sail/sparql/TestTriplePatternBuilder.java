...
import org.embergraph.rdf.vocab.decls.DCElementsVocabularyDecl;
 ...
 */
public class TestTriplePatternBuilder extends AbstractEmbergraphExprBuilderTestCase {
  ...
  public void test_triple_pattern_const_var_var()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      final ConstantNode s =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/s")));
      ...
      final JoinGroupNode whereClause = new JoinGroupNode();
      whereClause.addChild(new StatementPatternNode(s, p, o, null /* c */, Scope.DEFAULT_CONTEXTS));
      expected.setWhereClause(whereClause);
    }
  ...
  public void test_triple_pattern_var_const_var()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final ConstantNode p =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/p")));
  ...
  public void test_triple_pattern_var_var_const()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final ConstantNode o =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/o")));
  ...
  public void test_predicate_list_where_predicate_is_constant()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      final ConstantNode foo =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/foo")));

      final ConstantNode bar =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/bar")));
      ...
      whereClause.addChild(
          new StatementPatternNode(
              new VarNode("s"), foo, new VarNode("o"), null /* c */, Scope.DEFAULT_CONTEXTS));

      whereClause.addChild(
          new StatementPatternNode(
              new VarNode("s"), bar, new VarNode("o2"), null /* c */, Scope.DEFAULT_CONTEXTS));
    }
  ...
  public void test_object_list_where_objects_are_constants()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final ConstantNode goo =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org/goo")));
      ...
      whereClause.addChild(
          new StatementPatternNode(
              new VarNode("s"), new VarNode("p"), foo, null /* c */, Scope.DEFAULT_CONTEXTS));

      whereClause.addChild(
          new StatementPatternNode(
              new VarNode("s"), new VarNode("p"), bar, null /* c */, Scope.DEFAULT_CONTEXTS));

      whereClause.addChild(
          new StatementPatternNode(
              new VarNode("s"), new VarNode("p"), goo, null /* c */, Scope.DEFAULT_CONTEXTS));
    }
   ...
   * </pre>
   *
   * Note that <code>[]</code> is a blank node and is represented as an anonymous variable.
   *
   * <p>Note: blank nodes are translated into anonymous variables in the parse tree before the
  ...
  public void test_bnode_bracket_syntax_01()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode p =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/p")));

        final ConstantNode v = new ConstantNode(makeIV(valueFactory.createLiteral("v")));

        final VarNode s = new VarNode("-anon-1");
        s.setAnonymous(true);

        whereClause.addChild(
            new StatementPatternNode(s, p, v, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
   ...
   * </pre>
   *
   * Note: blank nodes are translated into anonymous variables in the parse tree before the
   * embergraph AST model is generated.
   */
  ...
  public void test_bnode_bracket_syntax_03()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode q =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/q")));

        final ConstantNode v = new ConstantNode(makeIV(valueFactory.createLiteral("v")));

        final ConstantNode w = new ConstantNode(makeIV(valueFactory.createLiteral("w")));
        ...
        whereClause.addChild(
            new StatementPatternNode(s, q, w, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
  ...
  public void test_bnode_bracket_syntax_04()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode x =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/x")));
        ...
        whereClause.addChild(
            new StatementPatternNode(bnode, p, v, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(x, q, bnode, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
  ...
  public void test_bnode_bracket_syntax_05()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode foaf_name =
            new ConstantNode(makeIV(valueFactory.createURI(FOAFVocabularyDecl.name.stringValue())));

        final ConstantNode foaf_mbox =
            new ConstantNode(makeIV(valueFactory.createURI(FOAFVocabularyDecl.mbox.stringValue())));

        final ConstantNode mailto =
            new ConstantNode(makeIV(valueFactory.createURI("mailto:alice@example.org")));
        ...
        whereClause.addChild(
            new StatementPatternNode(
                bnode, foaf_name, new VarNode("name"), null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(
                bnode, foaf_mbox, mailto, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
  ...
  public void test_rdf_collections_01()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode rdfFirst =
            new ConstantNode(makeIV(valueFactory.createURI(RDF.FIRST.stringValue())));
        final ConstantNode rdfRest =
            new ConstantNode(makeIV(valueFactory.createURI(RDF.REST.stringValue())));
        final ConstantNode rdfNil =
            new ConstantNode(makeIV(valueFactory.createURI(RDF.NIL.stringValue())));

        final ConstantNode ONE =
            new ConstantNode(makeIV(valueFactory.createLiteral("1", XSD.INTEGER)));
        final ConstantNode THREE =
            new ConstantNode(makeIV(valueFactory.createLiteral("3", XSD.INTEGER)));
        final ConstantNode FOUR =
            new ConstantNode(makeIV(valueFactory.createLiteral("4", XSD.INTEGER)));
        final ConstantNode p =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/ns#p")));
        final ConstantNode w = new ConstantNode(makeIV(valueFactory.createLiteral("w")));
        ...
        whereClause.addChild(
            new StatementPatternNode(b0, rdfFirst, ONE, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b0, rdfRest, b1, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b1, rdfFirst, x, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b1, rdfRest, b2, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b2, rdfFirst, THREE, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b2, rdfRest, b3, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b3, rdfFirst, FOUR, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b3, rdfRest, rdfNil, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b0, p, w, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
  ...
  public void test_rdf_collections_02()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode ONE =
            new ConstantNode(makeIV(valueFactory.createLiteral("1", XSD.INTEGER)));
        final ConstantNode TWO =
            new ConstantNode(makeIV(valueFactory.createLiteral("2", XSD.INTEGER)));
        final ConstantNode p =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/ns#p")));
        final ConstantNode q =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/ns#q")));
        ...
        whereClause.addChild(
            new StatementPatternNode(b2, p, q, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b1, rdfFirst, b2, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b1, rdfRest, b3, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b4, rdfFirst, TWO, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b4, rdfRest, rdfNil, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b3, rdfFirst, b4, null /* c */, Scope.DEFAULT_CONTEXTS));
        whereClause.addChild(
            new StatementPatternNode(b3, rdfRest, rdfNil, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
  ...
  public void test_rdf_collections_03()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode x =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/ns#x")));
        ...
        //                *                Var (name=-anon-1, anonymous)
        //                *                Var (name=-const-2,
        // value=http://www.w3.org/1999/02/22-rdf-syntax-ns#first, anonymous)
        //                *                Var (name=-const-1,
        // value="1"^^<http://www.w3.org/2001/XMLSchema#integer>, anonymous)
        //                *             StatementPattern
        //                *                Var (name=-anon-1, anonymous)
        //                *                Var (name=-const-4,
        // value=http://www.w3.org/1999/02/22-rdf-syntax-ns#rest, anonymous)
        //                *                Var (name=-const-3,
        // value=http://www.w3.org/1999/02/22-rdf-syntax-ns#nil, anonymous)
        //                *          StatementPattern
        //                *             Var (name=-const-5, value=http://example.org/ns#x,
        // anonymous)
        //                *             Var (name=p)
        //                *             Var (name=-anon-1, anonymous)
        whereClause.addChild(
        ...
        whereClause.addChild(
            new StatementPatternNode(b0, rdfRest, rdfNil, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(x, p, b0, null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
  ...
  public void test_rdf_collections_04()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        // value=http://www.w3.org/1999/02/22-rdf-syntax-ns#nil, anonymous)
        //                *          StatementPattern
        //                *             Var (name=-const-4, value=http://example.org/ns#x,
        // anonymous)
        //                *             Var (name=p)
        //                *             Var (name=-anon-1, anonymous)

        whereClause.addChild(
            new StatementPatternNode(b0, rdfFirst, v, null /* c */, Scope.DEFAULT_CONTEXTS));
  ...
  public void test_rdf_collections_05()
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        // value=http://www.w3.org/1999/02/22-rdf-syntax-ns#nil, anonymous)
        //                *          StatementPattern
        //                *             Var (name=-const-6, value=http://example.org/ns#x,
        // anonymous)
        //                *             Var (name=p)
        //                *             Var (name=-anon-1, anonymous)
        ...
        whereClause.addChild(
            new StatementPatternNode(b1, rdfFirst, w, null /* c */, Scope.DEFAULT_CONTEXTS));

        whereClause.addChild(
            new StatementPatternNode(b1, rdfRest, rdfNil, null /* c */, Scope.DEFAULT_CONTEXTS));
   ...
   * </pre>
   *
   * Note: There is a trailing <code>/</code> on the BASE URI declaration for this example.
   *
  ...
  public void test_base_01() throws MalformedQueryException, TokenMgrError {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ConstantNode book1 =
            new ConstantNode(makeIV(valueFactory.createURI("http://example.org/book/book1")));

        final ConstantNode dc_title =
            new ConstantNode(
                makeIV(valueFactory.createURI(DCElementsVocabularyDecl.title.stringValue())));

        whereClause.addChild(
            new StatementPatternNode(
                book1, dc_title, new VarNode("title"), null /* c */, Scope.DEFAULT_CONTEXTS));
      }
    }
   ...
   *
   * <p>[1] http://www.openrdf.org/issues/browse/SES-838
   */
   ...
   * </pre>
   *
   * Note: There is a trailing <code>#</code> on the BASE URI declaration for this example. Per
   * RFC3986, the fragment must be stripped from the base URI before it is used for resolution.
   *
   * <p>Note: This also uses the alternative <code>$title</code> syntax, but <code>$title</code> and
   * <code>?title</code> are the same variable.
   */
   ...
   * </pre>
   *
   * Note: There is a trailing <code>#abc</code> on the BASE URI declaration for this example. Per
   * RFC3986, the fragment must be stripped from the base URI before it is used for resolution.
   *
   * <p>Note: This also uses the alternative <code>$title</code> syntax, but <code>$title</code> and
   * <code>?title</code> are the same variable.
   ...
   * </pre>
   *
   * Note: There is nothing trailing on the BASE URI declaration for this example.
   *
   * <p>Note: This also uses the alternative <code>$title</code> syntax, but <code>$title</code> and
   * <code>?title</code> are the same variable.
   */
