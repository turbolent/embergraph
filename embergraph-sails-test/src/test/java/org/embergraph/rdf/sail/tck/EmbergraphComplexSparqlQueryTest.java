 ...
 * @version $Id$
 */
public class EmbergraphComplexSparqlQueryTest extends ComplexSPARQLQueryTest {

  private static final Logger logger = Logger.getLogger(EmbergraphComplexSparqlQueryTest.class);
  ...
  private static boolean runKnownBadTests = EmbergraphStatics.runKnownBadTests;

  @Override
  @Test
  public void testNullContext1() throws Exception {
    if (runKnownBadTests) super.testNullContext1();
  }

  @Override
  @Test
  public void testDescribeA() throws Exception {
    if (runKnownBadTests) super.testDescribeA();
  }

  @Override
  @Test
  public void testDescribeAWhere() throws Exception {
    if (runKnownBadTests) super.testDescribeAWhere();
  }

  @Override
  @Test
  public void testDescribeB() throws Exception {
    if (runKnownBadTests) super.testDescribeB();
  }

  @Override
  @Test
  public void testDescribeD() throws Exception {
    if (runKnownBadTests) super.testDescribeD();
  }

  @Override
  @Test
  public void testDescribeF() throws Exception {
    if (runKnownBadTests) super.testDescribeF();
  }

  @Override
  @Test
  public void testSameTermRepeatInOptional() throws Exception {
    if (runKnownBadTests) super.testSameTermRepeatInOptional();
  }

  @Override
  @Test
  public void testSES1898LeftJoinSemantics1() throws Exception {
    if (runKnownBadTests) super.testSES1898LeftJoinSemantics1();
  }

  @Override
  @Test
  public void testInComparison1() throws Exception {
    if (runKnownBadTests) super.testInComparison1();
  }

  @Override
  @Test
  public void testInComparison2() throws Exception {
    if (runKnownBadTests) super.testInComparison2();
  }

  @Override
  @Test
  public void testInComparison3() throws Exception {
    if (runKnownBadTests) super.testInComparison3();
  }

  @Override
  @Test
  public void testSameTermRepeatInUnionAndOptional() throws Exception {
    if (runKnownBadTests) super.testSameTermRepeatInUnionAndOptional();
  }

  @Override
  @Test
  public void testSES1991RANDEvaluation() throws Exception {
    if (runKnownBadTests) super.testSES1991RANDEvaluation();
  }
