...
public class StressTest_ClosedByInterrupt_RW extends TestCase {
  ...
  public void test() throws RepositoryException, InterruptedException {
    ...
    props.setProperty(
        "org.embergraph.rdf.rules.InferenceEngine.forwardChainOwlSameAsClosure", "false");
    props.setProperty(
        "org.embergraph.rdf.rules.InferenceEngine.forwardChainOwlSameAsProperties", "false");
    props.setProperty("org.embergraph.rdf.rules.InferenceEngine.forwardChainOwlInverseOf", "false");
    props.setProperty(
        "org.embergraph.rdf.rules.InferenceEngine.forwardChainOwlEquivalentClass", "false");
    props.setProperty(
    ...
    props.setProperty(
        "org.embergraph.service.IEmbergraphClient.collectPlatformStatistics", "false");
      ...
      while (stopRequested == false) {
        ...
        try {
          ...
          for (int invocation = 0; invocation < NUM_SELECTS; ++invocation) {
            ...
            final String sparql = "SELECT ?s WHERE { ?s ?p ?o } LIMIT " + NUM_STATEMENTS_PER_SELECT;
