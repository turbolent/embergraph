 ...
 */
public class EmbergraphSPARQLUpdateConformanceTest extends
...
//          "http://www.w3.org/2009/sparql/docs/tests/data-sparql11/delete-where/manifest#dawg-delete-where-05"
     ...
     *             that testURI.
     */
    static EmbergraphSPARQLUpdateConformanceTest getSingleTest(final TestSuite suite,
...
//            log.warn(aTest.toString());
            if (aTest instanceof TestSuite) {
                final EmbergraphSPARQLUpdateConformanceTest test = getSingleTest((TestSuite) aTest,
                        testURI);
                if (test != null)
                    return test;
            }
            if (aTest instanceof EmbergraphSPARQLUpdateConformanceTest) {
                final EmbergraphSPARQLUpdateConformanceTest test = (EmbergraphSPARQLUpdateConformanceTest) aTest;
    ...
    public EmbergraphSPARQLUpdateConformanceTest(String testURI, String name,
    ...
    public static Test suite() throws Exception {
        ...
        TestSuite suite1 = SPARQL11ManifestTest.suite(new Factory() {
            ...
            public EmbergraphSPARQLUpdateConformanceTest createSPARQLUpdateConformanceTest(
                ...
                return new EmbergraphSPARQLUpdateConformanceTest(testURI, name,
...
//        }
    ...
    protected void runTest()
        throws Exception
    {
        EmbergraphSailRepositoryConnection con = (EmbergraphSailRepositoryConnection) dataRep.getConnection();
        EmbergraphSailRepositoryConnection erCon = (EmbergraphSailRepositoryConnection) expectedResultRepo.getConnection();
        try {
...
//                message.append("\n=========================================\n");
            ...
            final EmbergraphSailUpdate query = (EmbergraphSailUpdate)
