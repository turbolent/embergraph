 ...
 */
public class TestSubqueryPatterns extends AbstractEmbergraphExprBuilderTestCase {
  ...
  public void test_subSubSelect() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    final SubqueryRoot subSelect2;
    {
      ...
      final ConstantNode const1 =
          new ConstantNode(makeIV(valueFactory.createURI("http://www.embergraph.org")));

      final ConstantNode const2 =
          new ConstantNode(makeIV(valueFactory.createLiteral("12", XSD.INTEGER)));
      ...
      // subSelect1
      {
        ...
        whereClause.addChild(
            new StatementPatternNode(s, p, o, null /* c */, Scope.DEFAULT_CONTEXTS));
  ...
  public void test_exists() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      final ConstantNode rdfType =
          new ConstantNode(makeIV(valueFactory.createURI(RDF.TYPE.stringValue())));

      final ConstantNode foafPerson =
          new ConstantNode(makeIV(valueFactory.createURI(FOAF.PERSON.stringValue())));

      final ConstantNode foafName =
          new ConstantNode(makeIV(valueFactory.createURI(FOAF.NAME.stringValue())));
      ...
      whereClause.addChild(
          new StatementPatternNode(
              person, rdfType, foafPerson, null /* c */, Scope.DEFAULT_CONTEXTS));

      final JoinGroupNode existsPattern = new JoinGroupNode();
      existsPattern.addChild(
          new StatementPatternNode(person, foafName, name, null /* c */, Scope.DEFAULT_CONTEXTS));
  ...
  public void test_namedSubquery() throws MalformedQueryException, TokenMgrError, ParseException {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final TermNode subPropertyOf =
          new ConstantNode(makeIV(valueFactory.createURI(RDFS.SUBPROPERTYOF.stringValue())));
      ...
      expected.setNamedSubqueries(namedSubqueries);
      {
        final NamedSubqueryRoot namedSubqueryRoot =
            new NamedSubqueryRoot(QueryType.SELECT, namedSet);
      ...
      whereClause.addChild(
          new StatementPatternNode(p, x, p2, null /* c */, Scope.DEFAULT_CONTEXTS));
      //            whereClause.addChild(new StatementPatternNode(p, subPropertyOf, p2,
      //                    null/* c */, Scope.DEFAULT_CONTEXTS));
      final NamedSubqueryInclude includeNode = new NamedSubqueryInclude(namedSet);
