...
import org.embergraph.rdf.sail.tck.EmbergraphEmbeddedFederationSparqlTest;
 ...
 */
public class TestEmbergraphSailEmbeddedFederationWithQuads extends AbstractEmbergraphSailTestCase {

  /** */
  public TestEmbergraphSailEmbeddedFederationWithQuads() {}

  public TestEmbergraphSailEmbeddedFederationWithQuads(String name) {
    super(name);
  }

  /** Namespace used for the KB and the directory in which any data is written for the test. */
  private static final String NAMESPACE = "TestEmbergraphSailEmbeddedFederationWithQuads";

  public static Test suite() {

    final TestEmbergraphSailEmbeddedFederationWithQuads delegate =
        new TestEmbergraphSailEmbeddedFederationWithQuads(); // !!!! THIS CLASS !!!!
    ...
    final ProxyTestSuite suite =
        new ProxyTestSuite(delegate, "SAIL with Quads (embedded federation)");
    ...
    // The Sesame TCK, including the SPARQL test suite.
    {
       ...
       * different.
       */
      //            tckSuite.addTestSuite(EmbergraphStoreTest.LTSWithPipelineJoins.class);
      //
      //            tckSuite.addTestSuite(EmbergraphConnectionTest.LTSWithPipelineJoins.class);
      ...
      try {
        ...
        tckSuite.addTest(EmbergraphEmbeddedFederationSparqlTest.suite());
  ...
  protected EmbergraphSail getSail(final Properties properties) {
    ...
    return new EmbergraphSail(openTripleStore(NAMESPACE, properties));
  }
  ...
  private AbstractTripleStore openTripleStore(final String namespace, final Properties properties) {

    // locate the resource declaration (aka "open").
    AbstractTripleStore tripleStore =
        (AbstractTripleStore) fed.getResourceLocator().locate(namespace, ITx.UNISOLATED);
