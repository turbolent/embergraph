...
/**
 * Test suite for the {@link EmbergraphSail} with quads enabled running against an
 ...
 */
public class TestEmbergraphSailEmbeddedFederationWithQuads extends
    AbstractEmbergraphSailTestCase {
    ...
    public static Test suite() {
        ...
        final TestEmbergraphSailEmbeddedFederationWithQuads delegate = new TestEmbergraphSailEmbeddedFederationWithQuads(); // !!!! THIS CLASS !!!!
...
//        final Properties properties = sail.getProperties();
    ...
    @Override
    protected void tearDown(final ProxyEmbergraphSailTestCase testCase)
            throws Exception {
