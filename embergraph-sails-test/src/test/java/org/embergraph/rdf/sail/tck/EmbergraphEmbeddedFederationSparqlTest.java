...
public class EmbergraphEmbeddedFederationSparqlTest extends EmbergraphSparqlTest {
    ...
    private static final Logger log = Logger
            .getLogger(EmbergraphEmbeddedFederationSparqlTest.class);

    public EmbergraphEmbeddedFederationSparqlTest(String testURI, String name,
...
//        suite1 = filterOutTests(suite1, "property-paths");
         ...
         */
        suite1 = EmbergraphSparqlTest.filterOutTests(
                suite1,
                "bsbm"
                );
    ...
    public static TestSuite suiteEmbeddedFederation() throws Exception {
        ...
        final SPARQLQueryTest.Factory factory = new SPARQLQueryTest.Factory() {
            ...
            public SPARQLQueryTest createSPARQLQueryTest(String testURI,
                ...
                return new EmbergraphEmbeddedFederationSparqlTest(testURI, name, queryFileURL,
