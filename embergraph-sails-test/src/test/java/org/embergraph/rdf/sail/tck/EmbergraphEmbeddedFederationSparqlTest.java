 ...
 */
public class EmbergraphEmbeddedFederationSparqlTest extends EmbergraphSparqlTest {

  private static final Logger log = Logger.getLogger(EmbergraphEmbeddedFederationSparqlTest.class);

  public EmbergraphEmbeddedFederationSparqlTest(
      String testURI,
      String name,
      String queryFileURL,
    ...
    final SPARQLQueryTest.Factory factory =
        new SPARQLQueryTest.Factory() {
          ...
          public SPARQLQueryTest createSPARQLQueryTest(
            ...
            return new EmbergraphEmbeddedFederationSparqlTest(
  ...
  protected Repository newRepository() throws RepositoryException {
    ...
    sail = new EmbergraphSail(openTripleStore(NAMESPACE, properties));
