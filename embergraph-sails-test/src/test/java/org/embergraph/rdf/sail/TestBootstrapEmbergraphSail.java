...
public class TestBootstrapEmbergraphSail extends TestCase2 {
	 ...
	 * the unisolated connection at a time from the {@link EmbergraphSail} via a
	...
	/**
	 * Unit test verifies that a thread may not obtain more than one instance of
	 * the unisolated connection at a time from the {@link EmbergraphSail} using
...
//			final Condition haveSecondConnection = lock.newCondition();
	 ...
	 * {@link EmbergraphSail} instances for the same {@link AbstractTripleStore} on
