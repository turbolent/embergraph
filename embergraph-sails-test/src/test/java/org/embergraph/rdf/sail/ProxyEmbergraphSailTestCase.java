 ...
 * {@link AbstractEmbergraphSailTestCase} and is used to extend the set of tests
 ...
 * {@link AbstractEmbergraphSailTestCase} instead and implement its abstract
...
//	protected final transient static Logger log = Logger.getLogger(ProxyEmbergraphSailTestCase.class);
	
    public ProxyEmbergraphSailTestCase() {}
    public ProxyEmbergraphSailTestCase(String name){super(name);}
    ...
    public AbstractEmbergraphSailTestCase getOurDelegate() {
        ...
        throw new IllegalStateException("The delegate MUST extend "
                + AbstractEmbergraphSailTestCase.class.getName() + ", not "
