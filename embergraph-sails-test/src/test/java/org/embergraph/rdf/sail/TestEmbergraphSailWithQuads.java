...
/**
 * Test suite for the {@link EmbergraphSail} with quads enabled. The provenance
...
public class TestEmbergraphSailWithQuads extends AbstractEmbergraphSailTestCase {
    ...
    public static Test suite() {
        ...
        final TestEmbergraphSailWithQuads delegate = new TestEmbergraphSailWithQuads(); // !!!! THIS CLASS !!!!
