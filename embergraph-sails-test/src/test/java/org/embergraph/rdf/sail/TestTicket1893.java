...
public class TestTicket1893 extends ProxyEmbergraphSailTestCase {
  ...
  private static final String INSERT_SPARQL = "INSERT DATA {" + DATA + "}";
  ...
  public void test_1() throws Exception {
    ...
    final EmbergraphSailRepositoryConnection cxn =
        prepareTest(
            ...
            true /*textIndexDatatypeLiterals*/);
  ...
  public void test_9() throws Exception {
    ...
    final EmbergraphSailRepositoryConnection cxn =
        prepareTest(
            ...
            true /*inlineTextLiterals*/,
            true /*inlineXSDDatatypeLiterals*/,
            false /*textIndexDatatypeLiterals*/);
  ...
  public void test_17() throws Exception {
    ...
    final EmbergraphSailRepositoryConnection cxn =
        prepareTest(namespace, true /*inlineTextLiterals*/, true /*inlineXSDDatatypeLiterals*/);
  ...
  public void test_19() throws Exception {
    ...
    final EmbergraphSailRepositoryConnection cxn =
        prepareTest(namespace, false /*inlineTextLiterals*/, false /*inlineXSDDatatypeLiterals*/);
  ...
  public void test_21() throws Exception {
    ...
    final EmbergraphSailRepositoryConnection cxn =
        prepareTest(namespace, true /*inlineTextLiterals*/, false /*inlineXSDDatatypeLiterals*/);
    ...
    assertFalse(
        values[10]
            .getIV()
            .isInline()); //    	"very long literal which length exceeds max inline text length"
  ...
  public void test_23() throws Exception {
    ...
    final EmbergraphSailRepositoryConnection cxn =
        prepareTest(namespace, false /*inlineTextLiterals*/, true /*inlineXSDDatatypeLiterals*/);
  ...
  private EmbergraphSailRepositoryConnection prepareTest(
  ...
  private EmbergraphSailRepositoryConnection prepareTest(
      ...
      final boolean inlineTextLiterals,
      final boolean inlineXSDDatatypeLiterals,
      final boolean textIndexDatatypeLiterals)
      throws Exception {
...

    {
      ...
      properties.setProperty(
          "org.embergraph.namespace." + namespace + ".lex." + Options.INLINE_TEXT_LITERALS,
          Boolean.toString(inlineTextLiterals));

      if (inlineTextLiterals) {
        properties.setProperty(
            "org.embergraph.namespace." + namespace + ".lex." + Options.MAX_INLINE_TEXT_LENGTH,
            Integer.toString(45));
      }

      properties.setProperty(
          "org.embergraph.namespace." + namespace + ".lex." + Options.INLINE_XSD_DATATYPE_LITERALS,
          Boolean.toString(inlineXSDDatatypeLiterals));

      properties.setProperty(
          "org.embergraph.namespace." + namespace + ".lex." + Options.TEXT_INDEX_DATATYPE_LITERALS,
          Boolean.toString(textIndexDatatypeLiterals));

      properties.setProperty(
          "org.embergraph.namespace." + namespace + ".lex." + Options.STORE_BLANK_NODES,
  ...
  private void loadData(final EmbergraphSailRepositoryConnection cxn)
