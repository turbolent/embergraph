...
public class TestOptionals extends QuadsTestCase {
  ...
  public void testLeftJoins() throws Exception {
    ...
    try {
      ...
      /**/
      cxn.add(book1, DC_TITLE, new LiteralImpl("TITLE 1"));
      cxn.add(book1, price, new LiteralImpl("10", XSD_INTEGER));
      cxn.add(book2, DC_TITLE, new LiteralImpl("TITLE 2"));
      cxn.add(book2, price, new LiteralImpl("20", XSD_INTEGER));
      cxn.add(book3, DC_TITLE, new LiteralImpl("TITLE 3"));
      /**/
      ...
      answer.add(
          createBindingSet(
              ...
              new BindingImpl("price", new LiteralImpl("10", XSD_INTEGER))));
      answer.add(
          createBindingSet(
              new BindingImpl("title", new LiteralImpl("TITLE 2")),
              new BindingImpl("price", new LiteralImpl("20", XSD_INTEGER))));
      answer.add(createBindingSet(new BindingImpl("title", new LiteralImpl("TITLE 3"))));
  ...
  public void testOptional() throws Exception {
    ...
    properties.put(
        "org.embergraph.rdf.store.AbstractTripleStore.vocabularyClass",
        "org.embergraph.rdf.vocab.NoVocabulary");
