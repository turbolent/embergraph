...
public class TestFullTextIndex extends AbstractTripleStoreTestCase {
  ...
  private void assertExpectedHits(
    ...
    assertExpectedHits(store, query, languageCode, .4f /* minCosine */, expected);
  }
  ...
  private void assertExpectedHits(
    ...
    assertExpectedHits(store, query, null, prefixMatch, .4f /* minCosine */, expected);
  }
  ...
  private void assertExpectedHits(
    ...
    assertExpectedHits(store, query, languageCode, false, minCosine, expected);
  }
  ...
  public void test_fullTextIndex01() throws InterruptedException {
    ...
    try {
      ...
      assertExpectedHits(
          ...
          "abc",
          null /* languageCode */,
          new EmbergraphValue[] {f.createLiteral("abc"), f.createLiteral("abc", "en")});
      ...
      assertExpectedHits(
          ...
          "en",
          new EmbergraphValue[] {
            f.createLiteral("gutten tag", "de"), f.createLiteral("tag team", "en")
          });
      ...
      assertExpectedHits(
          ...
          .0f, // minCosine
          new EmbergraphValue[] {
            f.createLiteral("good day", "en"), f.createLiteral("the first day", "en")
          });
      ...
      assertExpectedHits(
          ...
          null /*lang*/,
          .0f, // minCosine
          new EmbergraphValue[] {f.asValue(largeLiteral)});
    ...
    try {
      ...
      final EmbergraphValue[] terms =
          new EmbergraphValue[] {
            ...
            f.createLiteral("slow brown dog", f.asValue(XMLSchema.STRING)),
            f.createLiteral(
                "http://www.embergraph.org/mangy/yellow/cat", f.asValue(XMLSchema.ANYURI)),
            f.createLiteral("10.128.1.2", f.asValue(XSD.IPV4)),
          };

      store.addTerms(terms);

      if (log.isInfoEnabled()) log.info(DumpLexicon.dump(store.getLexiconRelation()));
      ...
      assertExpectedHits(
          ...
          0f, // minCosine,
          new EmbergraphValue[] {
            f.createLiteral("quick brown fox"), f.createLiteral("slow brown dog", XMLSchema.STRING)
          });
  ...
  /**
   * Unit test for indexing fully inline plain, language code, and datatype literals which using a
   * Unicode representation in the {@link IV}.
   */
  public void test_text_index_inline_unicode_literals() {
     ...
     */
    properties.setProperty(AbstractTripleStore.Options.MAX_INLINE_TEXT_LENGTH, "256");
  ...
  public void test_rebuildIndex() {
    ...
    try {
      ...
      EmbergraphValueFactory f = store.getValueFactory();
      ...
      // Ruin full text index
      {
        final String name =
            store.getLexiconRelation().getNamespace()
                + "."
                + EmbergraphValueCentricFullTextIndex.NAME_SEARCH;
      ...
      // verify that full text index is  broken.
      {
        ...
        assertExpectedHits(store, "abc", null /* languageCode */, new EmbergraphValue[] {});
