...
public class TestId2TermTupleSerializer extends TestCase2 {
  ...
  public void test_id2key() {
    ...
    final Id2TermTupleSerializer fixture =
        new Id2TermTupleSerializer(namespace, EmbergraphValueFactoryImpl.getInstance(namespace));
  ...
  public void test_versionedSerialization() {
    ...
    final TestClass v0 =
        new TestClass(
            (short) 0 /* version */, "namespace", EmbergraphValueFactoryImpl.class.getName());

    final TestClass v1 = new TestClass((short) 1 /* version */, "namespace", "valueFactoryClass");

    //        final TestClass v2 = new TestClass((short) 2/* version */, "namespace",
    //                "valueFactoryClass");

    assertEquals(v0, (TestClass) SerializerUtil.deserialize(SerializerUtil.serialize(v0)));

    assertEquals(v1, (TestClass) SerializerUtil.deserialize(SerializerUtil.serialize(v1)));
