...
public class TestTermIdEncoder extends TestCase2 {
  ...
  public void test_encode_decode_1bits_pidMAX_ctrMIN() {
    ...
    doEncodeDecodeTest(
        new TermIdEncoder(1), Integer.MAX_VALUE /* pid */, Integer.MIN_VALUE /* ctr */);
  }
   ...
   */
  private void doEncodeDecodeTest(final TermIdEncoder encoder, final int pid, final int ctr) {
  ...
  private static void fail(final TermIdEncoder encoder, final long v0, final long v1) {
    final String msg =
        encoder
            + "\n"
            + ", expected="
