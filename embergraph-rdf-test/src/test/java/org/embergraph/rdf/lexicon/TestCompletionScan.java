  ...
  public void test_completionScan() {
    ...
    try {
       ...
       */
      {
        ...
        final Iterator<IV> itr = store.getLexiconRelation().prefixScan(new LiteralImpl("minor"));
        ...
        while (itr.hasNext()) {
          ...
          final Literal lit = (Literal) store.getLexiconRelation().getTerm(tid);

          if (log.isInfoEnabled()) log.info("Found: " + lit);
