 ...
 * maintenance are both enabled, then both the SID and the {@link StatementEnum} are stored as the
 * value under the key.
 *
...
public class TestSPOValueCoders extends TestCase2 {
   ...
   * @param SIDs If statement identifiers should be generated.
   * @param inference if {@link StatementEnum}s should be assigned.
   * @return The array.
   */
  protected SPO[] getData(final int n, final boolean SIDs, final boolean inference) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (SIDs && !inference) {
        ...
        if (SIDs && type == StatementEnum.Explicit && r.nextInt(100) < 20) {
  ...
  public void test_FastRDFValueCoder2_001() {
    ...
    doRoundTripTest(
        new SPO[] {new SPO(_0, _0, _0, StatementEnum.Axiom)}, new FastRDFValueCoder2(), false);

    doRoundTripTest(
        new SPO[] {new SPO(_0, _0, _0, StatementEnum.Explicit)}, new FastRDFValueCoder2(), false);

    doRoundTripTest(
        new SPO[] {new SPO(_0, _0, _0, StatementEnum.Inferred)}, new FastRDFValueCoder2(), false);

    doRoundTripTest(
        new SPO[] {
          new SPO(_0, _0, _0, StatementEnum.Axiom), new SPO(_0, _0, _0, StatementEnum.Inferred)
        },
    ...
    doRoundTripTest(
        new SPO[] {
          new SPO(_0, _0, _0, StatementEnum.Explicit), new SPO(_0, _0, _0, StatementEnum.Axiom)
        },
        new FastRDFValueCoder2(),
        false);
  }
  ...
  protected void doRoundTripTests(
      final IRabaCoder rabaCoder, final boolean SIDs, final boolean inference) {
   ...
   * @param rabaCoder The compression provider.
   * @throws IOException
   */
  protected void doRoundTripTest(final SPO[] a, final IRabaCoder rabaCoder, final boolean sids) {
    ...
    final SPOTupleSerializer tupleSer = new SPOTupleSerializer(SPOKeyOrder.SPO, sids);
