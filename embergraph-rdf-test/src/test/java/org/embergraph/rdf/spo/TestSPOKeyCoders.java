 ...
 * data for a remote operation on a data service; and (c) in the nodes and leaves of the indices
 * themselves.
 *
...
public class TestSPOKeyCoders extends TestCase2 {
  ...
  protected void doRoundTripTest(final SPO[] a, final IRabaCoder rabaCoder) {
     ...
     * FIXME This does not exercise the case with SIDs support enabled.
     */
    final SPOTupleSerializer tupleSer = new SPOTupleSerializer(SPOKeyOrder.SPO, false /* sids */);
