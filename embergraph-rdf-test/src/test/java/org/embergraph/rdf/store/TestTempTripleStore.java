...
public class TestTempTripleStore extends AbstractTestCase {
  ...
  public static Test suite() {
    ...
    final ProxyTestSuite suite = new ProxyTestSuite(delegate, "Temporary Triple Store Test Suite");
   ...
   * @return A new store.
   * @exception UnsupportedOperationException The {@link TempTripleStore} can not be re-opened.
   */
  protected AbstractTripleStore reopenStore(AbstractTripleStore store) {

    throw new UnsupportedOperationException(
        TempTripleStore.class.getName() + " can not be re-opened.");
  }
}
