  ...
  public void test_locators() {
    ...
    try {
...

      {
        ...
        foundSPORelation.getContainerNamespace().equals(store.getNamespaces());
      ...
      {
        // the located store can find its relations.
        final LexiconRelation foundLexiconRelation = foundStore.getLexiconRelation();

        assertNotNull(foundLexiconRelation);

        assertNotNull(foundLexiconRelation.getContainerNamespace());

        foundLexiconRelation.getContainerNamespace().equals(store.getNamespace());
