...
public class TestBulkFilter extends AbstractTripleStoreTestCase {
    ...
    try {
      ...
      { // filter out
        ...
        final IChunkedOrderedIterator<ISPO> itr =
            store.bulkFilterStatements(stmts, numStmts, present);

        assertSameSPOsAnyOrder(
            store,
            new SPO[] {
              new SPO(x, a, v, StatementEnum.Explicit), new SPO(x, a, w, StatementEnum.Explicit)
            },
            itr,
            true // ignore axioms
            );
      ...
      { // filter in
        ...
        assertSameSPOsAnyOrder(
            store,
            new SPO[] {
              new SPO(x, a, y, StatementEnum.Explicit), new SPO(x, a, z, StatementEnum.Explicit)
            },
            itr,
            true // ignore axioms
            );
  ...
  public void testCompletion() {
    ...
    try {
      ...
      SPO[] stmts =
          new SPO[] {
            new SPO(x, a, y, StatementEnum.Explicit), new SPO(x, a, z, StatementEnum.Inferred)
          };
      int numStmts = stmts.length;
      ...
      { // filter out and complete
        final IChunkedOrderedIterator<ISPO> itr = store.bulkCompleteStatements(stmts, numStmts);
        ...
        assertSameSPOsAnyOrder(
            ...
            new SPO[] {
              ...
              new SPO(x, a, v, StatementEnum.Inferred),
