...
//            assertFalse(VTE.isLiteral(store.getIV(new BNodeImpl("a12")).getTermId()));
    ...
    public void test_addBadTerm() {
        ...
        properties
                .setProperty(
                        org.embergraph.rdf.store.AbstractTripleStore.Options.REJECT_INVALID_XSD_VALUES,
                        "false");
...
//            store.commit();
    ...
    /**
     * Test of
     * {@link IRawTripleStore#removeStatements(org.embergraph.relation.accesspath.IChunkedOrderedIterator)}
     */
