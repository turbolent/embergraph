...
public class TestLocalTripleStoreWithoutInlining extends AbstractTestCase {
  ...
  public static Test suite() {
    ...
    final TestLocalTripleStoreWithoutInlining delegate =
        new TestLocalTripleStoreWithoutInlining(); // !!!! THIS CLASS !!!!
    ...
    final ProxyTestSuite suite =
        new ProxyTestSuite(
            delegate, "Local Triple Store With Provenance Test Suite Without Inlining");
  ...
  public Properties getProperties() {
    ...
    properties.setProperty(
        org.embergraph.rdf.store.AbstractTripleStore.Options.STATEMENT_IDENTIFIERS, "true");

    // triples only.
    properties.setProperty(org.embergraph.rdf.store.AbstractTripleStore.Options.QUADS, "false");

    // do not inline anything.
    properties.setProperty(
        org.embergraph.rdf.store.AbstractTripleStore.Options.INLINE_XSD_DATATYPE_LITERALS, "false");
