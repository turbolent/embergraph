...
public class TestLocalTripleStoreWithoutStatementIdentifiers extends AbstractTestCase {
  ...
  public static Test suite() {
    ...
    final TestLocalTripleStoreWithoutStatementIdentifiers delegate =
        new TestLocalTripleStoreWithoutStatementIdentifiers(); // !!!! THIS CLASS !!!!
    ...
    final ProxyTestSuite suite =
        new ProxyTestSuite(delegate, "Local Triple Store Without Statement Identifiers");
