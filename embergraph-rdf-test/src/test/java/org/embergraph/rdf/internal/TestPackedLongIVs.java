...
public class TestPackedLongIVs extends TestCase2 {
  ...
  public void testMath() {
    ...
    final NumericIV<EmbergraphLiteral, ?> result10a_int_act =
        MathUtility.literalMath(zero, ten, MathOp.PLUS);
    final NumericIV<EmbergraphLiteral, ?> result10b_int_act =
        MathUtility.literalMath(twenty, ten, MathOp.MINUS);
    final NumericIV<EmbergraphLiteral, ?> result10c_int_act =
        MathUtility.literalMath(ten, one, MathOp.MULTIPLY);
    final NumericIV<EmbergraphLiteral, ?> result10d_dec_act =
        MathUtility.literalMath(ten, one, MathOp.DIVIDE);
    final NumericIV<EmbergraphLiteral, ?> result10e_int_act =
        MathUtility.literalMath(ten, twenty, MathOp.MIN);
    final NumericIV<EmbergraphLiteral, ?> result10f_int_act =
        MathUtility.literalMath(twenty, ten, MathOp.MIN);
    final NumericIV<EmbergraphLiteral, ?> result20a_int_act =
        MathUtility.literalMath(ten, ten, MathOp.PLUS);
    final NumericIV<EmbergraphLiteral, ?> result20b_int_act =
        MathUtility.literalMath(ten, twenty, MathOp.MAX);
    final NumericIV<EmbergraphLiteral, ?> result20c_int_act =
