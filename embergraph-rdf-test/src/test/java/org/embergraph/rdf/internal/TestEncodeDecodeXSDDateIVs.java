...
public class TestEncodeDecodeXSDDateIVs extends AbstractEncodeDecodeKeysTestCase {
  ...
  public void test_encodeDecodeGDay() throws Exception {
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      final EmbergraphValue valRoundTrip = ext.asValue((LiteralExtensionIV) e[i], vf);
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + "\"^^<http://www.w3.org/2001/XMLSchema#gDay>");
    }
  ...
  public void test_encodeDecodeGMonth() throws Exception {
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + "\"^^<http://www.w3.org/2001/XMLSchema#gMonth>");
    }
  ...
  public void test_encodeDecodeGMonthDay() throws Exception {
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + "\"^^<http://www.w3.org/2001/XMLSchema#gMonthDay>");
    }
  ...
  public void test_encodeDecodeGYear() throws Exception {
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + "\"^^<http://www.w3.org/2001/XMLSchema#gYear>");
    }
  ...
  public void test_encodeDecodeGYearMonth() throws Exception {
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + "\"^^<http://www.w3.org/2001/XMLSchema#gYearMonth>");
    }
  ...
  public void test_encodeDecodeDateTime() throws Exception {
    ...
    final String[] expected = {
      "-2015-01-01T10:10:10", "-1000-12-31T00:00:00", "0001-01-01T23:59:59", "9999-12-31T12:12:12"
    };
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + ".000Z\"^^<http://www.w3.org/2001/XMLSchema#dateTime>");
    }
  ...
  public void test_encodeDecodeTime() throws Exception {
    ...
    for (int i = 0; i < e.length; i++) {
      ...
      assertEquals(
          valRoundTrip.toString(),
          "\"" + expected[i] + ".000Z\"^^<http://www.w3.org/2001/XMLSchema#time>");
    }
