...
public class TestInlineURIHandlers extends TestCase2 {
  ...
  public void testPrefixedIntegerURIHandler() {
    ...
    InlinePrefixedIntegerURIHandler handler =
        new InlinePrefixedIntegerURIHandler(nameSpace, fixture);
  ...
  public void testSuffixedIntegerURIHandler() {
    ...
    InlineSuffixedIntegerURIHandler handler =
        new InlineSuffixedIntegerURIHandler(nameSpace, fixture);
  ...
  public void testFixedWidthIntegerURIHandler() {
    ...
    InlineFixedWidthIntegerURIHandler handler =
        new InlineFixedWidthIntegerURIHandler(nameSpace, width);
  ...
  public void testFixedWidthIntegerURIHandlerFail() {
    ...
    assertTrue(
        String.format("%0" + width + "d", intValue).equals(handler.getLocalNameFromDelegate(iv)));
  }
  ...
  public void testPrefixFixedWidthIntegerURIHandler() {
    ...
    InlinePrefixedFixedWidthIntegerURIHandler handler =
        new InlinePrefixedFixedWidthIntegerURIHandler(nameSpace, fixture, width);
  ...
  public void testSuffixFixedWidthIntegerURIHandler() {
    ...
    InlineSuffixedFixedWidthIntegerURIHandler handler =
        new InlineSuffixedFixedWidthIntegerURIHandler(nameSpace, fixture, width);
  ...
  public void testPrefixedSuffixFixedWidthIntegerURIHandler() {
    ...
    InlinePrefixedSuffixedFixedWidthIntegerURIHandler handler =
        new InlinePrefixedSuffixedFixedWidthIntegerURIHandler(nameSpace, pre, fixture, width);
  ...
  public void testPrefixedSuffixIntegerURIHandler() {
    ...
    InlinePrefixedSuffixedIntegerURIHandler handler =
        new InlinePrefixedSuffixedIntegerURIHandler(nameSpace, pre, fixture);
  ...
  public void testSuffixedHexUUIDURIHandler() {
    ...
    InlineSuffixedHexUUIDURIHandler handler =
        new InlineSuffixedHexUUIDURIHandler(nameSpace, suffix);
  ...
  public void testPrefixedSuffixedHexUUIDURIHandler() {
    ...
    InlinePrefixedSuffixedHexUUIDURIHandler handler =
        new InlinePrefixedSuffixedHexUUIDURIHandler(nameSpace, prefix, suffix);
  ...
  public void testPrefixedSuffixedUUIDURIHandler() {
    ...
    InlinePrefixedSuffixedUUIDURIHandler handler =
        new InlinePrefixedSuffixedUUIDURIHandler(nameSpace, prefix, suffix);
