...
public class TestIVBindingSetEncoder extends AbstractBindingSetEncoderTestCase {
  ...
  public void test_schema_change_simple() {
    ...
    final IBindingSet decoded1 =
        decoder.decodeSolution(
            val1a, 0 /* off */, val1a.length /* len */, true /* resolveCachedValues */);
  ...
  public void test_schema_change_complex() {
    ...
    final IBindingSet decoded1 =
        decoder.decodeSolution(
            val1, 0 /* off */, val1.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded2 =
        decoder.decodeSolution(
            val2, 0 /* off */, val2.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded3 =
        decoder.decodeSolution(
            val3, 0 /* off */, val3.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded4 =
        decoder.decodeSolution(
            val4, 0 /* off */, val4.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded5 =
        decoder.decodeSolution(
            val5, 0 /* off */, val5.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded6 =
        decoder.decodeSolution(
            val6, 0 /* off */, val6.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded7 =
        decoder.decodeSolution(
            val7, 0 /* off */, val7.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded8 =
        decoder.decodeSolution(
            val8, 0 /* off */, val8.length /* len */, true /* resolveCachedValues */);
    final IBindingSet decoded9 =
        decoder.decodeSolution(
            val9, 0 /* off */, val9.length /* len */, true /* resolveCachedValues */);
