...
public class AbstractCoordinateTestCase extends TestCase2 {
  ...
  /** @todo msg is ignored. */
  public void assertEquals(String msg, ICoordinate expected, ICoordinate actual) {
   ...
   * @return The value rounded off at the indicated number of digits after the decimal.
   */
