...
public class TestSubstrBOp extends ProxyTestCase {
  ...
  public void test_substr() {
    ...
    try {
      ...
      {
        final IV expected = DummyConstantNode.toDummyIV(vf.createLiteral("pla"));
      ...
      {
        final IV expected = DummyConstantNode.toDummyIV(vf.createLiteral("plain text"));
      ...
      {
        final IV expected = DummyConstantNode.toDummyIV(vf.createLiteral("pl"));
