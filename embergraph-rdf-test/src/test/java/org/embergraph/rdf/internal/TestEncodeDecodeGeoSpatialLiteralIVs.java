...
public class TestEncodeDecodeGeoSpatialLiteralIVs extends AbstractEncodeDecodeKeysTestCase {
  ...
  public void test_encodeDecodeLatLonTimeGeoSpatialLiterals() throws Exception {
    ...
    final GeoSpatialLiteralExtension<EmbergraphValue> ext = getLatLonTimeGSLiteralExtension(vf);
  ...
  public void test_encodeDecodeLatLonGeoSpatialLiterals() throws Exception {
    ...
    final GeoSpatialLiteralExtension<EmbergraphValue> ext = getLatLonGSLiteralExtension(vf);
  ...
  public void test_encodeDecodeGeoSpatialLiteralsWrongFormat() throws Exception {
    ...
    try {
      ...
      final GeoSpatialLiteralExtension<EmbergraphValue> extLatLon = getLatLonGSLiteralExtension(vf);
   ...
   * example test cases for sample code).
   */
  ...
  protected void zIndexOrderingPositiveBase(
     ...
     *
     * <p>This gives us the following literal pairs, encodings, and binary values (where the binary
     * values reflect the visiting order that are subject to be tested in the following (x/y).
     *
     * <p>0#0 -> 00 00 00 (0) 1#0 -> 00 00 01 (1) 2#0 -> 00 01 00 (4) 3#0 -> 00 01 01 (5) 4#0 -> 01
     * 00 00 (16) 5#0 -> 01 00 01 (17) 6#0 -> 01 01 00 (20) 7#0 -> 01 01 01 (21)
     *
     * <p>0#1 -> 00 00 10 (2) 1#1 -> 00 00 11 (3) 2#1 -> 00 01 10 (6) 3#1 -> 00 01 11 (7) 4#1 -> 01
     * 00 10 (18) 5#1 -> 01 00 11 (19) 6#1 -> 01 01 10 (22) 7#1 -> 01 01 11 (23)
     *
     * <p>0#2 -> 00 10 00 (8) 1#2 -> 00 10 01 (9) 2#2 -> 00 11 00 (12) 3#2 -> 00 11 01 (13) 4#2 ->
     * 01 10 00 (24) 5#2 -> 01 10 01 (25) 6#2 -> 01 11 00 (28) 7#2 -> 01 11 01 (29)
     *
     * <p>0#3 -> 00 10 10 (10) 1#3 -> 00 10 11 (11) 2#3 -> 00 11 10 (14) 3#3 -> 00 11 11 (15) 4#3 ->
     * 01 10 10 (26) 5#3 -> 01 10 11 (27) 6#3 -> 01 11 10 (30) 7#3 -> 01 11 11 (31)
     *
     * <p>0#4 -> 10 00 00 (32) 1#4 -> 10 00 01 (33) 2#4 -> 10 01 00 (36) 3#4 -> 10 01 01 (37) 4#4 ->
     * 11 00 00 (48) 5#4 -> 11 00 01 (49) 6#4 -> 11 01 00 (52) 7#4 -> 11 01 01 (53)
     *
     * <p>0#5 -> 10 00 10 (34) 1#5 -> 10 00 11 (35) 2#5 -> 10 01 10 (38) 3#5 -> 10 01 11 (39) 4#5 ->
     * 11 00 10 (50) 5#5 -> 11 00 11 (51) 6#5 -> 11 01 10 (54) 7#5 -> 11 01 11 (55)
     *
     * <p>0#6 -> 10 10 00 (40) 1#6 -> 10 10 01 (41) 2#6 -> 10 11 00 (44) 3#6 -> 10 11 01 (45) 4#6 ->
     * 11 10 00 (56) 5#6 -> 11 10 01 (57) 6#6 -> 11 11 00 (60) 7#6 -> 11 11 01 (61)
     *
     * <p>0#7 -> 10 10 10 (42) 1#7 -> 10 10 11 (43) 2#7 -> 10 11 10 (46) 3#7 -> 10 11 11 (47) 4#7 ->
     * 11 10 10 (58) 5#7 -> 11 10 11 (59) 6#7 -> 11 11 10 (62) 7#7 -> 11 11 11 (63)
     */

    // Generate in syntactical order (as above): 0#0, ..., 0#7, 1#0, ... 7#7:
    final EmbergraphLiteral[] asWritten = getGeospatialLiteralsLatLonInRange(vf, 0, 7, datatype);

    // convert into LiteralExtensionIVs (backed by BigInteger, in this case)
    @SuppressWarnings("rawtypes")
    final LiteralExtensionIV[] asWrittenConverted = new LiteralExtensionIV[asWritten.length];
    ...
    @SuppressWarnings("rawtypes")
    final LiteralExtensionIV[] ordered = new LiteralExtensionIV[asWrittenConverted.length];
  ...
  protected void zIndexOrderingMixedBase(
    ...
    // Generate values
    final EmbergraphLiteral[] asWritten = getGeospatialLiteralsLatLonInRange(vf, -2, 1, datatype);
   ...
   *
   * <p>The basic schema is a three-component datatype string made up from the following three
   * components:
   *
   * <p>sfd.add(new SchemaFieldDescription(Datatype.DOUBLE, 5)); sfd.add(new
   * SchemaFieldDescription(Datatype.DOUBLE, 5));
   *
   * @param vf the value factory used to generate the literals
  ...
  protected final EmbergraphLiteral[] getDummyGeospatialLiteralsLatLon(
    ...
    final EmbergraphLiteral[] dt = new EmbergraphLiteral[baseLatLong.length * baseLatLong.length];
   ...
   * positive and negative values of different orders of magnitude.
   *
   * <p>The basic schema is a two-component datatype string made up from the following three
   * components:
   *
   * <p>sfd.add(new SchemaFieldDescription(Datatype.DOUBLE, 5)); sfd.add(new
   * SchemaFieldDescription(Datatype.DOUBLE, 5)); sfd.add(new SchemaFieldDescription(Datatype.LONG,
   * -1));
   *
   * @param vf the value factory used to generate the literals
   * @return the list of generated literals
  ...
  protected final EmbergraphLiteral[] getDummyGeospatialLiteralsLatLonTime(
    ...
    // we'll create a permutation over all values above
    final EmbergraphLiteral[] dt =
        new EmbergraphLiteral[baseLatLong.length * baseLatLong.length * baseTime.length];
  ...
  protected final EmbergraphLiteral[] getGeospatialLiteralsLatLonInRange(
      final EmbergraphValueFactory vf, final int from, final int to, final URI datatype) {

    final int numComponents = to - from + 1;

    // we'll create a permutation over all values above
    final EmbergraphLiteral[] dt = new EmbergraphLiteral[numComponents * numComponents];
  ...
  /** Get a {@link GeoSpatialLiteralExtension} object processing lat+lon+time schema literals. */
  protected GeoSpatialLiteralExtension<EmbergraphValue> getLatLonTimeGSLiteralExtension(
      final EmbergraphValueFactory vf) {
  ...
  /** Get a {@link GeoSpatialLiteralExtension} object processing lat+lon schema literals. */
  protected GeoSpatialLiteralExtension<EmbergraphValue> getLatLonGSLiteralExtension(
      final EmbergraphValueFactory vf) {
   ...
   * 5 precise doubles).
   */
  protected GeoSpatialLiteralExtension<EmbergraphValue> getSimpleLatLonGSLiteralExtension(
      final EmbergraphValueFactory vf) {
   ...
   * 5 precise doubles).
   */
  protected GeoSpatialLiteralExtension<EmbergraphValue> getSimpleLatLonGSLiteralExtensionWithRange(
   ...
   */
  protected void assertSemanticallyIdentical(final EmbergraphValue x1, final EmbergraphLiteral x2) {
