...
public class TestBlobIV extends TestCase2 {
  ...
  private void doBlobIVTest(final VTE vte, final int hashCode, final int counter) {

    final IKeyBuilder keyBuilder = helper.newKeyBuilder();

    final BlobIV<?> iv = new BlobIV<EmbergraphURI>(vte, hashCode, (short) counter);
    ...
    final byte[] key = helper.makeKey(keyBuilder.reset(), vte, hashCode, counter);
  ...
  public void test_BlobIV_problemValue_01() {
    ...
    //      [TermId(-5764607523034234880U), TermId(-1152921504606846976U), BlobIV(1974963648:16:L),
    // TermId(8070450532247928832U)]
    //        {
