    ...
    try {
       ...
       */
      {
        ...
        final ICloseableIterator<IBindingSet> itr =
            store.match(new Literal[] {new LiteralImpl("bryan")}, new URI[] {RDFS.LABEL}, person);
        ...
        try {
          ...
          while (itr.hasNext()) {
            ...
            if (log.isInfoEnabled()) log.info(actualBindingSet.toString());
            ...
            final Literal lit = (Literal) actualBindingSet.get(Var.var("lit")).get();
      ...
      {
        final ICloseableIterator<IBindingSet> itr =
            store.match(new Literal[] {new LiteralImpl("paul")}, new URI[] {RDFS.LABEL}, person);
