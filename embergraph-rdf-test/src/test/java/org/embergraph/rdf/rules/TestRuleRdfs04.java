...
public class TestRuleRdfs04 extends AbstractRuleTestCase {
  ...
  public void test_rdfs4b() throws Exception {
    ...
    try {
      ...
      final Rule r = new RuleRdfs04b(store.getSPORelation().getNamespace(), store.getVocabulary());
   ...
   *
   * <p>Note: {@link RuleRdfs03} is the other way that literals can be entailed into the subject
   * position.
   *
   * @throws Exception
   */
  public void test_rdfs4b_filterLiterals() throws Exception {
    ...
    try {
      ...
      applyRule(
          store, r, filter /*, false /*justified*/, 0 /* solutionCount */, 0 /* mutationCount*/);
