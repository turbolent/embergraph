...
import org.embergraph.rdf.rules.AbstractRuleFastClosure_3_5_6_7_9.SubPropertyClosureTask;
...
public class TestRuleFastClosure_3_5_6_7_9 extends AbstractRuleTestCase {
  ...
  public void test_getSubProperties() {
    ...
    try {
      ...
      final SubPropertyClosureTask task =
          new SubPropertyClosureTask(view, vocab.getConstant(RDFS.SUBPROPERTYOF));

      Set<IV> subProperties = task.getSubProperties();

      assertTrue(subProperties.contains(store.getIV(rdfsSubPropertyOf)));
   ...
   * out a possible entailment that would simply conclude its own support.
   *
   * <pre>
  ...
  private static class MyRuleFastClosure6 extends AbstractRuleFastClosure_3_5_6_7_9 {
    ...
    public MyRuleFastClosure6(
      ...
      super(
          ...
          rdfsSubPropertyOf,
          propertyId,
          new MyFastClosure_6_RuleTaskFactory(
  ...
  private static class MyFastClosure_6_RuleTaskFactory implements IRuleTaskFactory {
    ...
    public MyFastClosure_6_RuleTaskFactory(
        final String database,
        final String focusStore,
        final IConstant<IV> rdfsSubPropertyOf,
        final IConstant<IV> propertyId,
