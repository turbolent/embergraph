 ...
 * @version $Id$
 */
public class TestGeoSpatialServiceConfigurationCustomDatatype
  ...
  public void testCustomDatatypeRect01LatLonTime() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-custom-rect01-lat-lon-time.srx")
        .runTest();
  }
  ...
  public void testCustomDatatypeRect01LatTimeLon() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-custom-rect01-lat-time-lon.srx")
        .runTest();
  }
  ...
  public void testCustomDatatypeRect01TimeLatLon() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-custom-rect01-time-lat-lon.srx")
        .runTest();
  }
  ...
  public void testCustomDatatypeCircle01LatLonTime() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-custom-grid101010-lat-lon-time.nt",
            "geo-custom-circle01-lat-lon-time.srx")
        .runTest();
  }
  ...
  public void testCustomDatatypeCircle01LatTimeLon() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-custom-grid101010-lat-time-lon.nt",
            "geo-custom-circle01-lat-time-lon.srx")
        .runTest();
  }
  ...
  public void testCustomDatatypeCircle01TimeLatLon() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-custom-grid101010-time-lat-lon.nt",
            "geo-custom-circle01-time-lat-lon.srx")
        .runTest();
  }
   ...
   *
   * <p><http://s0> <http://p> "0#0#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s1>
   * <http://p> "1.1#1.1#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s2> <http://p>
   * "2.22#2.22#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s3> <http://p>
   * "3.333#3.333#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s4> <http://p>
   * "4.4444#4.4444#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s5> <http://p>
   * "5.55555#5.55555#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6> <http://p>
   * "6.666666#6.6666666#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6b> <http://p>
   * "6.66667#6.6666666#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6c> <http://p>
   * "6.66666#6.66667#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6c> <http://p>
   * "6.66667#6.66667#0"^^<http://my.custom.datatype/lat-lon-time> .
   *
   ...
   * "4.4444#4.4444#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s5> <http://p>
   * "5.55555#5.55555#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6> <http://p>
   * "6.666666#6.666666#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6b> <http://p>
   * "6.66667#6.666666#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6c> <http://p>
   * "6.66666#6.66667#0"^^<http://my.custom.datatype/lat-lon-time> . <http://s6d> <http://p>
   * "6.66667#6.66667#0"^^<http://my.custom.datatype/lat-lon-time> .
   *
