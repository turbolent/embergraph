...
public class TestTicket1200_1780 extends AbstractDataDrivenSPARQLTestCase {
   ...
   * <p>{@See BLZG-1780}
   *
   * <p>prefix : <http://www.embergraph.org/> prefix rdf:
   * <http://www.w3.org/1999/02/22-rdf-syntax-ns#> prefix rdfs:
   * <http://www.w3.org/2000/01/rdf-schema#> prefix foaf: <http://xmlns.com/foaf/0.1/> prefix xsd:
   * <http://www.w3.org/2001/XMLSchema#> PREFIX hint: <http://www.embergraph.org/queryHints#>
   *
   * <p>select ?s where { ?s :hasAddress ?address . FILTER(REGEX(?address, '^10.*', 'i')) }
   *
   * @throws Exception
   */
  public void test_ticket_1780a() throws Exception {
    new TestHelper(
            "ticket-1780a", // testURI,
