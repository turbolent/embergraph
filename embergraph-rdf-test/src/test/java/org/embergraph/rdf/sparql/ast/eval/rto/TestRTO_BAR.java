...
public class TestRTO_BAR extends AbstractRTOTestCase {
   ...
   * lower bound, which makes this an interesting test case. The runtime optimizer detects this
   * lower bound and replaces [nout] with the sum of the range count of the as-bound predicates for
   * the join, which leads to an efficient query plan.
   *
   * <pre>
