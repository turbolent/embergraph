...
public class TestGeoSpatialServiceConfiguration extends AbstractDataDrivenSPARQLTestCase {
   ...
   *
   * <p>With the given precision, the query is equivalent to
   *
   * <p>PREFIX geo: <http://www.embergraph.org/rdf/geospatial#> SELECT ?res ?o WHERE { SERVICE
   * geo:search { ?res geo:search "inRectangle" . ?res geo:predicate <http://p> . ?res
   * geo:spatialRectangleSouthWest "1.10#1.1" . ?res geo:spatialRectangleNorthEast "6.666666#7" .
   ...
   * <http://s5> <http://p>
   * "5.55555#5.55555#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> . <http://s6>
   * <http://p> "6.666666#6.666666#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral>
   * . <http://s6b> <http://p>
   ...
   * "6.66667#6.66667#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   *
   * <p>Consequently, only subjects s0 and s6a, s6b, and s6d are *not* contained in the result,
