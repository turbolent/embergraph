...
public class TestASTServiceNodeOptimizer extends AbstractASTEvaluationTestCase {
   ...
   * </pre>
   *
   * The {@link ServiceNode} is lifted out into a {@link NamedSubqueryRoot}, yielding the following
   * AST after the rewrite:
   *
   * <pre>
   * WITH {
   *   QueryType: SELECT
  ...
  public void test_serviceNodeOptimizer_01() {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        whereClause.addChild(new NamedSubqueryInclude(namedSubqueryName));
      ...
      {
        final NamedSubqueryRoot nsr = new NamedSubqueryRoot(QueryType.SELECT, namedSubqueryName);
  ...
  public void test_serviceNodeOptimizer_02() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
...

      {
        ...
        final ServiceNode serviceNode =
            new ServiceNode(new ConstantNode(serviceUriIV), serviceGraphPattern);
