 ...
 * @version $Id$
 */
public class TestASTQueryHintOptimizer extends AbstractASTEvaluationTestCase {
   ...
   * </pre>
   *
   * The complex optional group in this query should have the {@link
   * BufferAnnotations#CHUNK_CAPACITY} overridden.
   */
  public void test_query_hints() {
    ...
    @SuppressWarnings("rawtypes")
    final IV chunkCapacity =
        makeIV(new URIImpl(QueryHints.NAMESPACE + BufferAnnotations.CHUNK_CAPACITY));
    @SuppressWarnings("rawtypes")
    ...
    final String namedSet1 = "_set1";
    {
      ...
      // NamedSubqueryRoot
      {
        final NamedSubqueryRoot nsr = new NamedSubqueryRoot(QueryType.SELECT, namedSet1);
        ...
        whereClause.addChild(
            new StatementPatternNode(
                new VarNode("_var6"),
                new ConstantNode(party),
                new ConstantNode(democrat),
                null /* c */,
                Scope.DEFAULT_CONTEXTS));
      }
      ...
      // Main Query
      {
        ...
        {
          complexOptGroup.addChild(
              new StatementPatternNode(
                  new VarNode("_var10"),
                  new ConstantNode(votedBy),
                  new VarNode("_var3"),
                  null /* c */,
                  Scope.DEFAULT_CONTEXTS));
          ...
          complexOptGroup.addChild(
              new StatementPatternNode(
                  new ConstantNode(scopePrior),
                  new ConstantNode(chunkCapacity),
                  new ConstantNode(chunkCapacityValue),
                  null /* c */,
                  Scope.DEFAULT_CONTEXTS));
        }
    ...
    // Main Query
    {
      ...
      final JoinGroupNode simpleOptGroup =
          new JoinGroupNode(
              true /* optional */,
              new StatementPatternNode(
                  new VarNode("_var3"),
  ...
  /**
   * Test developed around a query which did not make progress through the {@link
  ...
  public void test_query_hints_2() throws Exception {
    ...
    @SuppressWarnings("rawtypes")
    final IV keyOrder =
        makeIV(new URIImpl(QueryHints.NAMESPACE + IPredicate.Annotations.KEY_ORDER));
    @SuppressWarnings("rawtypes")
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      // Main Query
      {
        ...
        whereClause.addChild(
            new StatementPatternNode(
                new ConstantNode(scopeQuery),
                new ConstantNode(optimizer),
                new ConstantNode(none),
                null /* c */,
                Scope.DEFAULT_CONTEXTS));
        ...
        whereClause.addChild(graphGroup);
        {
          ...
          graphGroup.addChild(
              new StatementPatternNode(
                  new ConstantNode(scopePrior),
                  new ConstantNode(keyOrder),
                  new ConstantNode(pcso),
                  new VarNode("g"),
                  Scope.NAMED_CONTEXTS));
        }
      }
  ...
  /**
   * Test verifies that we can enable native DISTINCT, native HASH JOINS, and MERGE JOINs using
   * query hints.
   *
   * <pre>
   * SELECT (COUNT(?_var3) as ?count)
  ...
  public void test_query_hints_4() throws Exception {
    ...
    final IV scopeQuery = makeIV(new URIImpl(QueryHints.NAMESPACE + QueryHintScope.Query));
    @SuppressWarnings("rawtypes")
    final IV nativeDistinct =
        makeIV(new URIImpl(QueryHints.NAMESPACE + QueryHints.NATIVE_DISTINCT_SOLUTIONS));
    @SuppressWarnings("rawtypes")
    final IV nativeHashJoins =
        makeIV(new URIImpl(QueryHints.NAMESPACE + QueryHints.NATIVE_HASH_JOINS));
    @SuppressWarnings("rawtypes")
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      // Main Query
      {
        ...
        whereClause.addChild(
            new StatementPatternNode(
                new ConstantNode(scopeQuery),
                new ConstantNode(nativeDistinct),
                new ConstantNode(t),
                null /* c */,
                Scope.DEFAULT_CONTEXTS));
        ...
        whereClause.addChild(
            new StatementPatternNode(
                new ConstantNode(scopeQuery),
                new ConstantNode(nativeHashJoins),
                new ConstantNode(t),
                null /* c */,
                Scope.DEFAULT_CONTEXTS));
  ...
  /**
   * Test verifies that we can place a query hint on a {@link JoinGroupNode} using {@link
  ...
  public void test_query_hints_5() throws Exception {
    ...
    final IV scopePrior = makeIV(new URIImpl(QueryHints.NAMESPACE + QueryHintScope.Prior));
    @SuppressWarnings("rawtypes")
    final IV runLast = makeIV(new URIImpl(QueryHints.NAMESPACE + QueryHints.RUN_LAST));
    @SuppressWarnings("rawtypes")
    final IV t = makeIV(new LiteralImpl("true"));
  ...
  /**
   * Test verifies that we can place a query hint on a {@link ServiceNode} using {@link
   * QueryHintScope#Prior}.
   *
   * <pre>
   * SELECT ?score
      ...
      // Main Query
      {
        ...
        // Service
        {
          ...
          serviceGroup.addChild(
              new StatementPatternNode(
                  new VarNode("lit"),
                  new ConstantNode(search),
                  new ConstantNode(mike),
                  null,
                  Scope.DEFAULT_CONTEXTS));
          ...
          serviceGroup.addChild(
              new StatementPatternNode(
                  new VarNode("lit"),
                  new ConstantNode(relevance),
                  new VarNode("score"),
                  null,
                  Scope.DEFAULT_CONTEXTS));

          final ServiceNode service = new ServiceNode(new ConstantNode(serviceURI), serviceGroup);
