...
public class TestASTJoinGroupOrderOptimizer extends AbstractOptimizerTestCaseWithUtilityMethods {
    ...
    new Helper() {
      {
        given =
            select(
                ...
                where(
                    stmtPatternWithVar("x1"),
                    joinGroupNode(stmtPatternWithVar("x2"), filterWithVar("x1"))));
        ...
        expected =
            select(
                ...
                where(
                    stmtPatternWithVar("x1"),
                    joinGroupNode(filterWithVar("x1"), stmtPatternWithVar("x2"))));
      }
    }.test();
  }
        ...
        expected =
            select(
                ...
                where(
                    stmtPatternWithVar("x1"),
                    serviceSparql11WithVariable("x1", "x2"),
                    serviceSparql11WithVariable(
                        "x2", "x1", "x3"), /* x2 bound by previous service! */
                    stmtPatternWithVar("x2"),
                    stmtPatternWithVar("x3")));
      }
    }.test();
        ...
        expected =
            select(
                ...
                where(
                    ...
                    stmtPatternWithVar("x3"),
                    stmtPatternWithVar("x4"),
                    serviceSparql11WithConstant(
                        "x1") /* SPARQL 1.1 service is placed as late as possible */));
      }
    }.test();
  }
            ...
            select(
                ...
                where(
                    ...
                    serviceFTSWithVariable(
                        "outRes", "outScore", "outSnippet", "inSearch", "inEndpoint", "inParams")));
        ...
        expected =
            select(
                ...
                where(
                    ...
                    jgnOpt,
                    serviceFTSWithVariable(
                        /* inParams2 can't be bound at a later time */
                        "outRes", "outScore", "outSnippet", "inSearch", "inEndpoint", "inParams2"),
                    stmtPatternWithVar("z")));
      }
    }.testWhileIgnoringExplainHints();
  }
    ...
    new Helper() {
      {
        given =
            select(
                varNode(x),
                where(stmtPatternWithVarsOptional("x1", "y1"), stmtPatternWithVar("x1")));
        ...
        given =
            select(
                ...
                namedSubQuery(
                    ...
                    varNode("y1"),
                    where(
                        statementPatternNode(varNode("y1"), constantNode(a), constantNode(b), 1))),
                where(
                    stmtPatternWithVar("x1"),
                    stmtPatternWithVarOptional("y1"),
                    stmtPatternWithVar("y1"),
        ...
        given =
            select(
                ...
                namedSubQuery(
                    ...
                    varNode("x1"),
                    where(
                        statementPatternNode(varNode("x1"), constantNode(a), constantNode(b), 1))),
                where(
                    stmtPatternWithVar("x1"),
                    stmtPatternWithVarOptional("y1"),
                    stmtPatternWithVar("y1"),
  ...
  public void testTicket1363a() {
    ...
    new Helper() {
      {
        given = select(varNode(x), where(unA, subqueryWithVars("x1", "x2")));

        expected = select(varNode(x), where(unB, subqueryWithVars("x1", "x2")));
      }
    }.test();
  }
    ...
    new Helper() {
      {
        ...
        expected = select(varNode(x), where(subqueryWithVars("x1", "x2"), unB));
      }
    }.test();
  }
