...
public class TestGeoSpatialDefaults extends AbstractDataDrivenSPARQLTestCase {
  ...
  public void testDefaultDatatypeExplicit() throws Exception {
    ...
    new TestHelper("geo-defaults01", "geo-defaults01.rq", "geo-defaults.nt", "geo-defaults0102.srx")
        .runTest();
  }
  ...
  public void testDefaultDatatypeImplicit() throws Exception {
    ...
    new TestHelper("geo-defaults02", "geo-defaults02.rq", "geo-defaults.nt", "geo-defaults0102.srx")
        .runTest();
  }
  ...
  public void testNonGeoSpatialQuery01() throws Exception {
    ...
    new TestHelper("geo-defaults03", "geo-defaults03.rq", "geo-defaults.nt", "geo-defaults03.srx")
        .runTest();
  }
  ...
  public void testNonGeoSpatialQuery02() throws Exception {
    ...
    new TestHelper("geo-defaults04", "geo-defaults04.rq", "geo-defaults.nt", "geo-defaults04.srx")
        .runTest();
  }

  public void testNonDefaultDatatype() throws Exception {

    new TestHelper("geo-defaults05", "geo-defaults05.rq", "geo-defaults.nt", "geo-defaults05.srx")
        .runTest();
  }
