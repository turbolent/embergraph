...
public class TestFastRangeCountOptimizer extends AbstractDataDrivenSPARQLTestCase {
  ...
  public static class TestTriplesModeAPs extends TestDistinctTermScanOptimizer {
    ...
    public void test_fastRangeCount_triples_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "fastRangeCount_triples_01", // testURI,
    ...
    public void test_fastRangeCount_triples_02() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "fastRangeCount_triples_02", // testURI,
  ...
  public static class TestQuadsModeAPs extends TestFastRangeCountOptimizer {
    ...
    public void test_fastRangeCount_quads_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "fastRangeCount_quads_01", // testURI,
    ...
    public void test_fastRangeCount_quads_02() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "fastRangeCount_quads_02", // testURI,
    ...
    public void test_fastRangeCount_quads_03() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "fastRangeCount_quads_03", // testURI,
    ...
    public void test_fastRangeCount_quads_04() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "fastRangeCount_quads_04", // testURI,
     ...
     * </pre>
     *
     * TODO This case CAN be rewritten as the SUM over the range counts of the individual
     * named-graph APs. This COULD be done as an aggregate or as a physical operator. However, that
     * has not been done yet so we MUST NOT rewrite this query.
     */
    public void test_fastRangeCount_quads_05() throws Exception {

      final TestHelper h =
          new TestHelper(
              "fastRangeCount_quads_05", // testURI,
