 ...
 * @version $Id$
 *     <p>TODO Capture everything from {@link AbstractAggregationTestCase} here. This test suite was
 *     sculpted to exercise the {@link GroupByState} and {@link GroupByRewriter} and the differences
...
public class TestAggregationQuery extends AbstractDataDrivenSPARQLTestCase {
  ...
  public void test_count_distinct_emptyResult() throws Exception {
    ...
    new TestHelper(
            "count_distinct_emptyResult", // testURI,
