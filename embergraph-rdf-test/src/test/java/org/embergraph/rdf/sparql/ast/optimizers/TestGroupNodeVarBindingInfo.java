  ...
  public void testConstructionAndUtilities() {
            ...
            new Helper() {
              {
                tmp =
                    unionNode(
                        joinGroupNode(
                            statementPatternNode(varNode("w"), constantNode(c), varNode("z"))),
    ...
    final FilterNode fn =
        (FilterNode)
            new Helper() {
              {
                tmp = filter(FunctionNode.EQ(constantNode(w), varNode("filterVar")));
              }
            }.getTmp();
    ...
    final JoinGroupNode jgn =
        (JoinGroupNode)
            new Helper() {
              {
                tmp = joinGroupNode(spn, spnOpt, unionNode, fn);
              }
            }.getTmp();
    ...
    final GroupNodeVarBindingInfo biSpn = new GroupNodeVarBindingInfo(spn, sa, null);
    ...
    final GroupNodeVarBindingInfo biSpnOpt = new GroupNodeVarBindingInfo(spnOpt, sa, null);
    ...
    final GroupNodeVarBindingInfo biUnionNode = new GroupNodeVarBindingInfo(unionNode, sa, null);
    ...
    final GroupNodeVarBindingInfo biFn = new GroupNodeVarBindingInfo(fn, sa, null);
    ...
    final GroupNodeVarBindingInfo biJgn = new GroupNodeVarBindingInfo(jgn, sa, null);
