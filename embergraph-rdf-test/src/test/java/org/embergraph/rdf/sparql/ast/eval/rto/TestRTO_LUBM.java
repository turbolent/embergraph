...
public class TestRTO_LUBM extends AbstractRTOTestCase {
   ...
   * fastest path to prove that. In practice, this amounts to proving that one of the joins fails to
   * produce any results.
   *
   * <p>Note: For U50 there are 130 solutions and it discovers the join order <code>
   * [3, 5, 6, 4, 1, 2]</code>.
   */
   ...
   * </code>.
   *
   * <p>Note: When random sampling is used, several join plans are possible including:
   *
   * <pre>
   * {4, 2, 3, 5, 0, 1}
   * {3, 0, 5, 4, 1, 2}
   ...
   * </pre>
   *
   * These all appear to be good join plans even though the last one is is definitely better.
   */
