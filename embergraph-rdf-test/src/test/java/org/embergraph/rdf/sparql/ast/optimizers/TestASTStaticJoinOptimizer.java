...
public class TestASTStaticJoinOptimizer extends AbstractOptimizerTestCase {
            ...
            select(
                ...
                where(
                    ...
                    statementPatternNode(
                        varNode(x), constantNode(g), constantNode(g), 1, OPTIONAL)));
        expected =
            select(
                varNode(x),
                where(
  ...
  public void test_simpleReorder01() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(b), new ConstantNode(b), 2l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(a), new ConstantNode(a), 1l));
  ...
  public void test_simpleReorder03() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(e), new ConstantNode(e), 5l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(b), new ConstantNode(b), 2l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(d), new ConstantNode(d), 4l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(a), new ConstantNode(a), 1l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(c), new ConstantNode(c), 3l));
  ...
  public void test_simpleOptional01() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("x"), new ConstantNode(f), new ConstantNode(f), 1l, true));

      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("x"), new ConstantNode(g), new ConstantNode(g), 1l, true));
  ...
  public void test_ServiceNode01() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(b), new ConstantNode(b), 1l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(a), new VarNode("y"), 2l));
  ...
  public void test_ServiceNode02() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(d), new ConstantNode(d), 3l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(c), new ConstantNode(c), 2l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(e), new ConstantNode(e), 4l));

      whereClause.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(a), new VarNode("y"), 1000l));
      ...
      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("y"), new ConstantNode(g), new ConstantNode(g), 1l, true));
  ...
  public void test_nestedOptionals01() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      subgroup.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(f), new ConstantNode(f), 5l));

      subgroup.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(e), new ConstantNode(e), 4l));

      subgroup.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(d), new ConstantNode(d), 10l));
  ...
  public void test_nestedOptionals02() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      subgroup.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(d), new VarNode("y"), 10l));
  ...
  public void test_nestedOptionals03() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      subgroup1.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(a), new ConstantNode(a), 1l));
      ...
      subgroup2.addChild(
          newStatementPatternNode(new VarNode("z"), new ConstantNode(a), new ConstantNode(a), 1l));

      subgroup2.addChild(
          newStatementPatternNode(new VarNode("z"), new ConstantNode(b), new ConstantNode(b), 2l));

      final JoinGroupNode subgroup3 = new JoinGroupNode();

      subgroup3.addChild(
          newStatementPatternNode(new VarNode("y"), new ConstantNode(d), new ConstantNode(d), 1l));

      subgroup3.addChild(
          newStatementPatternNode(new VarNode("x"), new ConstantNode(e), new ConstantNode(e), 10l));
        ...
        given =
            select(
                ...
                namedSubQuery(
                    "_set1",
                    varNode(x),
                    where(statementPatternNode(varNode(x), constantNode(a), constantNode(b), 1))),
                where(
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      final NamedSubqueryRoot namedSubquery = new NamedSubqueryRoot(QueryType.SELECT, "_set1");
      {
        ...
        projection.addProjectionExpression(
            new AssignmentNode(new VarNode("_var1"), new VarNode("_var1")));

        final JoinGroupNode joinGroup1 =
            new JoinGroupNode(
                newStatementPatternNode(
                    new VarNode("_var1"), new ConstantNode(a), new ConstantNode(b), 1l));
      ...
      joinGroup1.addChild(
          newStatementPatternNode(
              new VarNode("_var1"), new ConstantNode(c), new VarNode("_var2"), 1l, true));

      final JoinGroupNode joinGroup2 = new JoinGroupNode(true);

      joinGroup2.addChild(
          newStatementPatternNode(
              new VarNode("_var12"), new ConstantNode(e), new VarNode("_var4"), 10l));
      joinGroup2.addChild(
          newStatementPatternNode(
              new VarNode("_var12"), new ConstantNode(d), new VarNode("_var1"), 100l));
   ...
   * ?product bsbm:producer ?producer . # card=280k ?review bsbm:reviewFor ?product . # card=2.8m
   * ?review rev:reviewer ?reviewer . # card=2.8m ?reviewer bsbm:country
   * <http://downlode.org/rdf/iso-3166/countries#US> . #card=61k ?product a ?productType . #
   * card=10m ?productType a bsbm:ProductType . # card=2011
   *
   * <pre>
   *   select *
   *   JoinGroupNode {
  ...
  public void test_pessimistic() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("productType"),
              new ConstantNode(type),
              new ConstantNode(productType),
              2000l));
      ...
      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("product"),
              new ConstantNode(producer),
              new VarNode("producer"),
              280000l));

      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("producer"), new ConstantNode(country), new ConstantNode(RU), 7000l));

      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("review"),
              new ConstantNode(reviewFor),
              new VarNode("product"),
              2800000l));
      ...
      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("review"),
              new ConstantNode(reviewer),
              new VarNode("reviewer"),
              2800000l));

      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("reviewer"), new ConstantNode(country), new ConstantNode(US), 61000l));
  ...
  public void test_runFirstRunLast_01() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          runFirst(
              newStatementPatternNode(
                  new VarNode("x"), new ConstantNode(a), new ConstantNode(a), 100l)));

      whereClause.addChild(
          runLast(
              newStatementPatternNode(
                  new VarNode("x"), new ConstantNode(e), new ConstantNode(e), 1l)));
            ...
            select(
                ...
                where(
                    ...
                    propertyPathUnionNode(
                        ...
                        joinGroupNode(
                            statementPatternNode(
                                varNode(x), constantNode(f), varNode(z), 615502)))),
                DISTINCT);
  ...
  public void test_runFirstRunLast_02() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          newStatementPatternNode(
              new VarNode("x"), new ConstantNode(e), new ConstantNode(e), 1l, true));
