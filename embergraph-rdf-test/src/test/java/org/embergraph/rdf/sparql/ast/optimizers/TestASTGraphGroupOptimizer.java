 ...
 * @see TestNamedGraphs
 *     <p>FIXME Unit test where the outer graph group has a variable and the inner graph group has a
 *     constant.
 *     <p>FIXME Unit test where the outer graph group has a constant and the inner graph group has a
 *     variable.
 */
public class TestASTGraphGroupOptimizer extends AbstractASTEvaluationTestCase {
  ...
  public void test_graphGroupOptimizer_02() throws MalformedQueryException {
    ...
    final JoinGroupNode expectedClause = new JoinGroupNode();
    {
      ...
      final FilterNode filterNode = new FilterNode(FunctionNode.sameTerm(g, g1));
  ...
  //     * <pre>
  //     *   SELECT VarNode(subj)
  //     *     StatementPatternNode(VarNode(lit), ConstantNode(bd:search), ConstantNode("mike"),
  // VarNode(g), DEFAULT_CONTEXTS)
  //     *     JoinGroupNode [minus] {
  //     *       StatementPatternNode(VarNode(lit), ConstantNode(bd:search), ConstantNode("rdf"),
  // VarNode(g), DEFAULT_CONTEXTS)
  //     *       JoinGroupNode {
  //     *         StatementPatternNode(VarNode(subj), VarNode(p), VarNode(lit), VarNode(g),
  // DEFAULT_CONTEXTS)
  //     *       }
  //     *     }
  //     * </pre>
  ...
  //     *         StatementPatternNode(VarNode(subj), VarNode(p), VarNode(lit), VarNode(c),
  // NAMED_CONTEXTS)
  //     *       }
  //     *     }
  //     * </pre>
  ...
  //     *       StatementPatternNode(VarNode(lit), ConstantNode(bd:search), ConstantNode("rdf"),
  // ConstantNode(http://example.org/foo), NAMED_CONTEXTS)
  //     *       JoinGroupNode [context=http://example.org/foo] {
  //     *         StatementPatternNode(VarNode(subj), VarNode(p), VarNode(lit),
  // ConstantNode(http://example.org/foo), NAMED_CONTEXTS)
  //     *       }
  //     *     }
  //     * </pre>
