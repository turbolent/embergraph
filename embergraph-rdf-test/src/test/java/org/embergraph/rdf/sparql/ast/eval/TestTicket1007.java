 ...
 * joining/filtering the variable - BINDing to values that are in the dictionary vs. BINDing to
...
public class TestTicket1007 extends AbstractDataDrivenSPARQLTestCase {
   ...
   * }
   * }
   * </code> Note: originally this query failed.
   *
   * @throws Exception
   */
  ...
  */
   ...
   * </code>
   *
   * @see <a href="http://trac.bigdata.com/ticket/490#comment:5">here</a> for more details
   */
  public void test_ticket_1007_subquery() throws Exception {
    new TestHelper(
            "ticket-1007-subquery", // testURI,
