...
public class TestTickets extends AbstractDataDrivenSPARQLTestCase {
  ...
  public void test_ticket_1892b() throws Exception {
    ...
    new TestHelper(
            "ticket-1892-subquery03-modified1", // testURI,
  ...
  public void test_ticket_1892c() throws Exception {
    ...
    new TestHelper(
            "ticket-1892-subquery03-modified2", // testURI,
  ...
  public void test_ticket_1892d() throws Exception {
    ...
    new TestHelper(
            "ticket-1892-subquery03-modified3", // testURI,
  ...
  public void test_ticket_1892e() throws Exception {
    ...
    new TestHelper(
            "ticket-1892-auxiliary1", // testURI,
  ...
  public void test_ticket_1892f() throws Exception {
    ...
    new TestHelper(
            "ticket-1892-auxiliary2", // testURI,
  ...
  public void test_ticket_1892h() throws Exception {
    ...
    new TestHelper(
            "ticket-1892-additional2", // testURI,
  ...
  public void test_ticket_1202c() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group03-modified1", // testURI,
  ...
  public void test_ticket_1202d() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group05-modified1", // testURI,
  ...
  public void test_ticket_1202e() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group03-modified2", // testURI,
  ...
  public void test_ticket_1202f() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group03-modified3", // testURI,
  ...
  public void test_ticket_1202g() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group05-modified2", // testURI,
  ...
  public void test_ticket_1202h() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group05-modified3", // testURI,
  ...
  public void test_ticket_1202i() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group03-modified4", // testURI,
  ...
  public void test_ticket_1202j() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group03-modified5", // testURI,
  ...
  public void test_ticket_1202k() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group05-modified4", // testURI,
  ...
  public void test_ticket_1202l() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-group05-modified5", // testURI,
  ...
  public void test_ticket_1202m() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-additional1", // testURI,
  ...
  public void test_ticket_1202n() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-additional2", // testURI,
  ...
  public void test_ticket_1202o() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-additional3", // testURI,
  ...
  public void test_ticket_1202p() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-additional4", // testURI,
  ...
  public void test_ticket_1202q() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-additional5", // testURI,
  ...
  public void test_ticket_1202r() throws Exception {
    ...
    new TestHelper(
            "ticket-1202-additional6", // testURI,
  ...
  */
   ...
   *
   * @throws Exception
   * @see <a href="http://sourceforge.net/apps/trac/bigdata/ticket/384">IndexOutOfBoundsException
   *     during query evaluation </a>
   */
  ...
  public void test_ticket_two_subselects_748() throws Exception {
    ...
    new TestHelper(
            "ticket748-two-subselects", // testURI,
  ...
  public void test_ticket_two_subselects_748a() throws Exception {
    ...
    new TestHelper(
            "ticket748A-two-subselects", // testURI,
  ...
  public void test_ticket_bad_projection_748() throws Exception {
    ...
    new TestHelper(
            "ticket748-bad-projection", // testURI,
   ...
   * </pre>
   *
   * @see <a href="http://sourceforge.net/apps/trac/bigdata/ticket/563">DISTINCT ORDER BY</a>
   */
  public void test_ticket_563() throws Exception {

    new TestHelper(
            "ticket563-DistinctOrderBy", // testURI,
   ...
   *     NotMaterializedException</a>.
   */
  public void test_ticket_blzg_1331a() throws Exception {
    new TestHelper(
            "ticket_blzg_1331a", // testURI,
  ...
  public void test_ticket_1498() throws Exception {
     ...
     * <http://p1>/<http://p2> "A" . ?s rdf:type <http://T> . }
     *
     * <p>the triples pattern ?s rdf:type <http://T> is still at the last position, i.e. the
     * optimizer hint is considered.
     */
