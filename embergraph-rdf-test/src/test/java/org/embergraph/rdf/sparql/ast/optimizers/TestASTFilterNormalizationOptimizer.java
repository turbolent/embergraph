...
public class TestASTFilterNormalizationOptimizer extends AbstractASTEvaluationTestCase {
  ...
  public void testExtractTopLevelConjunctsMethod() {
    ...
    // conjunct 1
    final FunctionNode bound1 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s1"));

    // conjunct 2
    final FunctionNode bound2 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s2"));
    final FunctionNode not1 = FunctionNode.NOT(bound2);

    // conjunct 3
    final FunctionNode bound3 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s3"));
    final FunctionNode bound4 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s4"));
    final FunctionNode bound5 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s5"));
  ...
  /** Test the {@link ASTFilterNormalizationOptimizer#toConjunctiveValueExpression(List)} method. */
  public void testToConjunctiveValueExpressionMethod() {
    ...
    final IValueExpressionNode expected =
        FunctionNode.AND(FunctionNode.AND(FunctionNode.AND(bound1, not1), or1), bound6);

    final IValueExpressionNode actual = StaticAnalysis.toConjunctiveValueExpression(baseConjuncts);
  ...
  public void testFilterDecompositionNoOp() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(new FilterNode(FunctionNode.EQ(new VarNode("s"), new VarNode("o"))));
    }
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.EQ(new VarNode("s"), new VarNode("o")));
  ...
  public void testSimpleConjunctiveFilter() {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(new FilterNode(FunctionNode.EQ(new VarNode("s"), new VarNode("o"))));
      whereClause.addChild(
          new FilterNode(FunctionNode.NE(new VarNode("s"), new ConstantNode(test))));
    }
  ...
  public void testSimpleDisjunctiveFilter() {
          ...
          new FilterNode(
              FunctionNode.NOT(
                  FunctionNode.OR(
                      ...
                      new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("o")))));
      assertFalse(StaticAnalysis.isCNF(filterNode));
      whereClause.addChild(filterNode);

      final StatementPatternNode spn =
          new StatementPatternNode(
              new VarNode("s"), new VarNode("p"), new VarNode("o"), null, Scope.DEFAULT_CONTEXTS);
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(spn);
      whereClause.addChild(new FilterNode(FunctionNode.GE(new VarNode("s"), new VarNode("o"))));
      whereClause.addChild(
          new FilterNode(
              FunctionNode.NOT(new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("o")))));
    }
  ...
  /** Test rewriting of negated leaves, such as !(?x=?y) -> ?x!=?y, !(?a<?b) -> ?a>=?b, etc. in */
  public void testNegationLeafRewriting01() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.NOT(FunctionNode.AND(FunctionNode.AND(comb1, comb2), comb3)));
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.OR(FunctionNode.OR(comb1, comb2), comb3));
      assertTrue(StaticAnalysis.isCNF(filterNode));
  ...
  public void testNegationLeafRewriting02() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.NOT(FunctionNode.AND(comb1, FunctionNode.AND(comb2, comb3))));
      assertFalse(StaticAnalysis.isCNF(filterNode));
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.OR(comb1, FunctionNode.OR(comb2, comb3)));
      assertTrue(StaticAnalysis.isCNF(filterNode));
  ...
  public void testNestedNegationRewriting() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FunctionNode filterBNot1 =
          FunctionNode.NOT(
              new FunctionNode(FunctionRegistry.EQ, null, new VarNode("s"), new VarNode("o")));
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.NOT(FunctionNode.AND(filterANot3, filterBNot4)));
      assertFalse(StaticAnalysis.isCNF(filterNode));
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FunctionNode bound = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("o"));

      final FunctionNode neq =
          new FunctionNode(FunctionRegistry.NE, null, new VarNode("s"), new VarNode("o"));
  ...
  public void testNestedNegationRewritingAndSplit() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FilterNode filterNode =
          new FilterNode(FunctionNode.NOT(FunctionNode.OR(filterANot3, filterBNot4)));
      assertFalse(StaticAnalysis.isCNF(filterNode));
      ...
      final FilterNode filterNode =
          new FilterNode(
              FunctionNode.OR(
                  ...
                  FunctionNode.AND(bound3, FunctionNode.AND(bound4, bound5))));
      assertFalse(StaticAnalysis.isCNF(filterNode));
  ...
  public void testOrAndSwitchWithNegation() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FunctionNode notBound1 =
          FunctionNode.NOT(new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s1")));
      final FunctionNode notBound2 =
          FunctionNode.NOT(new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s2")));
      final FunctionNode notBound3 =
          FunctionNode.NOT(new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s3")));
      final FunctionNode notBound4 =
          FunctionNode.NOT(new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s4")));
      final FunctionNode notBound5 =
          FunctionNode.NOT(new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s5")));
          ...
          new FilterNode(
              FunctionNode.NOT(
                  FunctionNode.AND(
                      ...
                      FunctionNode.OR(notBound3, FunctionNode.OR(notBound4, notBound5)))));
  ...
  public void testOrAndSwitchRecursive() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FunctionNode bound5 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s5"));
      final FunctionNode bound6 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s6"));
      final FunctionNode bound7 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s7"));
      final FunctionNode bound8 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s8"));
      final FunctionNode bound9 = new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s9"));
      final FunctionNode bound10 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s10"));
      final FunctionNode bound11 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s11"));
      final FunctionNode bound12 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s12"));
      final FunctionNode bound13 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s13"));
      final FunctionNode bound14 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s14"));
      final FunctionNode bound15 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s15"));
      final FunctionNode bound16 =
          new FunctionNode(FunctionRegistry.BOUND, null, new VarNode("s16"));
      ...
      final FilterNode filterNode =
          new FilterNode(
              FunctionNode.OR(
                  FunctionNode.AND(
                      FunctionNode.OR(
                          FunctionNode.AND(bound1, bound2), FunctionNode.AND(bound3, bound4)),
                      FunctionNode.OR(
                          FunctionNode.AND(bound5, bound6), FunctionNode.AND(bound7, bound8))),
                  FunctionNode.AND(
                      FunctionNode.OR(
                          FunctionNode.AND(bound9, bound10), FunctionNode.AND(bound11, bound12)),
                      FunctionNode.OR(
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
       ...
       * FunctionNode.OR(bound1,bound4) FunctionNode.OR(bound2,bound3)
       * FunctionNode.OR(bound2,bound4) ), FunctionNode.AND( FunctionNode.OR(bound5,bound7)
       * FunctionNode.OR(bound5,bound8) FunctionNode.OR(bound6,bound7)
       * FunctionNode.OR(bound6,bound8) ) ), FunctionNode.AND( FunctionNode.AND(
       * FunctionNode.OR(bound9,bound11) FunctionNode.OR(bound9,bound12)
       * FunctionNode.OR(bound10,bound11) FunctionNode.OR(bound10,bound12) ), FunctionNode.AND(
       * FunctionNode.OR(bound13,bound15) FunctionNode.OR(bound13,bound16)
       * FunctionNode.OR(bound14,bound15) FunctionNode.OR(bound14,bound16) ) ) )
       *
       * <p>### STEP 2: pushing down the top-level OR, we compute the cross product of the left and
       * right disjuncts (we flatten out the and in the representation below):
       *
       * <p>FunctionNode.AND( FunctionNode.AND( FunctionNode.OR( FunctionNode.OR(bound1,bound3),
       * FunctionNode.OR(bound9,bound11) ), FunctionNode.OR( FunctionNode.OR(bound1,bound3),
       * FunctionNode.OR(bound9,bound12) ), FunctionNode.OR( FunctionNode.OR(bound1,bound3),
       * FunctionNode.OR(bound10,bound11) ), FunctionNode.OR( FunctionNode.OR(bound1,bound3),
       * FunctionNode.OR(bound10,bound12) ),
       *
       * <p>FunctionNode.OR( FunctionNode.OR(bound1,bound4), FunctionNode.OR(bound9,bound11) ),
       * FunctionNode.OR( FunctionNode.OR(bound1,bound4), FunctionNode.OR(bound9,bound12) ),
       * FunctionNode.OR( FunctionNode.OR(bound1,bound4), FunctionNode.OR(bound10,bound11) ),
       * FunctionNode.OR( FunctionNode.OR(bound1,bound4), FunctionNode.OR(bound10,bound12) ),
       *
       * <p>...
       *
      ...
      for (final FunctionNode left : lefts) {
        for (final FunctionNode right : rights) {
          whereClause.addChild(new FilterNode(FunctionNode.OR(left, right)));
        }
      }
    }
  ...
  public void testOrOrAndSwitch() {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
       ...
       *
       * <p>FunctionNode.OR( FunctionNode.AND( FunctionNode.AND( FunctionNode.OR(bound1, bound3),
       * FunctionNode.OR(bound1, bound4) ), FunctionNode.AND( FunctionNode.OR(bound2, bound3),
       * FunctionNode.OR(bound2, bound4) ) ), FunctionNode.AND( FunctionNode.AND(
       * FunctionNode.OR(bound5, bound7), FunctionNode.OR(bound5, bound8) ), FunctionNode.AND(
       * FunctionNode.OR(bound6, bound7), FunctionNode.OR(bound6, bound8) ) ) )
       *
       * <p>### STEP 2: pushes down the uppermost OR expression
       *
       * <p>Considers all OR-leafs in the left top-level AND expression and joins them with OR-leafs
  ...
  public void testRemoveDuplicateFilter() {
    ...
    final QueryRoot expected = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FunctionNode simpleFunctionNode = FunctionNode.NE(new VarNode("s1"), new VarNode("s2"));
   ...
   *
   * <p>FILTER(bound(?o1)) FILTER(bound(?o2)) FILTER(bound(?o3))
   *
   * <p>FILTER(!bound(?o1)) FILTER(!bound(?o2)) FILTER(!bound(?o3)) FILTER(!bound(?o4))
   *
   * <p>// some duplicates (which should be dropped) FILTER(!bound(?o2)) FILTER(!bound(?o3)) }
   *
   * <p>will be rewritten to
   *
   * <p>SELECT ?s WHERE { ?s ?p ?o1 . { ?s ?p ?o2 } OPTIONAL { ?s ?p ?o3 }
   *
   * <p>// ?o1 and ?o2 are definitely bound, so we can't optimize away FILTER(bound(?o3))
   *
   * <p>// ?o4 is the only variable that is definitely not bound FILTER(!bound(?o1))
   * FILTER(!bound(?o2)) FILTER(!bound(?o3)) }
   */
  public void testRemoveUnsatisfiableFilters() {
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      final FunctionNode filterBound1 =
          new FunctionNode(FunctionRegistry.BOUND, null /* scalarValues */, new VarNode("o1"));

      final FunctionNode filterBound2 =
          new FunctionNode(FunctionRegistry.BOUND, null /* scalarValues */, new VarNode("o2"));

      final FunctionNode filterBound3 =
          new FunctionNode(FunctionRegistry.BOUND, null /* scalarValues */, new VarNode("o3"));
      ...
      final FunctionNode filterNotBound4 =
          FunctionNode.NOT(
              new FunctionNode(FunctionRegistry.BOUND, null /* scalarValues */, new VarNode("o4")));
