...
package org.embergraph.rdf.sparql.ast.eval.reif;
 ...
 * </pre>
 *
 * This triple reference pattern associates the bindings on the subject, predicate, and object
 * positions of some triple pattern with the binding on a variable for the triple. Except in the
 * case where ?sid is already bound, the triple pattern itself is processed normally and the
 * bindings are concatenated to form a representation of a triple, which is then bound on ?sid. When
 * ?sid is bound, it is decomposed into its subject, predicate, and object components and those
 * values are bound on the triple pattern.
 *
 * <p>When there are nested triple reference patterns, then they are just unwound into simple triple
 * reference patterns. A variables is created to provide the association between each nested triple
 * reference pattern and role played by that triple reference pattern in the outer triple reference
 * pattern.
 *
 * <p>We can handle this internally by allowing an optional named/positional role for a {@link
 * Predicate} which (when defined) becomes bound to the composition of the (subject, predicate, and
 * object) bindings for the predicate. It might be easiest to handle this if we allowed the [c]
 * position to be optional as well and ignored it when in a triples only mode. The sid/triple
 * binding would always be "in scope" but it would only be interpreted when non-null (either a
...
public class TestReificationDoneRightEval extends AbstractDataDrivenSPARQLTestCase {
  ...
  public void test_reificationDoneRight_00() throws Exception {
    ...
    final EmbergraphValue[] terms =
        new EmbergraphValue[] {
          SAP, bought, sybase, dcSource, dcCreated, newsSybase, createdDate, g1
        };
    ...
    // ground statement.
    final EmbergraphStatement s0 =
        vf.createStatement(SAP, bought, sybase, context, StatementEnum.Explicit);
    ...
    final EmbergraphStatement mds1 =
        vf.createStatement(s1, dcSource, newsSybase, context, StatementEnum.Explicit);

    final EmbergraphStatement mds2 =
        vf.createStatement(s1, dcCreated, createdDate, context, StatementEnum.Explicit);
    ...
    final TestHelper h =
        new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-00", // testURI,
  ...
  public void test_reificationDoneRight_00_loadDataFromFile() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-00-loadFromFile", // testURI,
            TEST_RESOURCE_PREFIX + "rdr-02.rq", // queryFileURL
  ...
  public void test_reificationDoneRight_00a() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-00a", // testURI,
  ...
  public void test_reificationDoneRight_00a_loadFromFile() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-00a-loadFromFile", // testURI,
            TEST_RESOURCE_PREFIX + "rdr-02a.rq", // queryFileURL
            TEST_RESOURCE_PREFIX + "rdr-02.ttlx", // dataFileURL
            TEST_RESOURCE_PREFIX + "rdr-02a.srx" // resultFileURL
            )
  ...
  public void test_reificationDoneRight_01() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-01", // testURI,
  ...
  public void test_reificationDoneRight_01_usingRDRData() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-01-usingRDRData", // testURI,
            TEST_RESOURCE_PREFIX + "rdr-01.rq", // queryFileURL
  ...
  public void test_reificationDoneRight_01a() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-01a", // testURI,
  ...
  public void test_reificationDoneRight_01a_usingRDRData() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-01a-usingRDRData", // testURI,
            TEST_RESOURCE_PREFIX + "rdr-01a.rq", // queryFileURL
            TEST_RESOURCE_PREFIX + "rdr-01.ttlx", // dataFileURL
            TEST_RESOURCE_PREFIX + "rdr-01a.srx" // resultFileURL
            )
  ...
  public void test_reificationDoneRight_02() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-02", // testURI,
            TEST_RESOURCE_PREFIX + "rdr-02.rq", // queryFileURL
  ...
  public void test_reificationDoneRight_02a() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-02a", // testURI,
            TEST_RESOURCE_PREFIX + "rdr-02a.rq", // queryFileURL
  ...
  public void test_reificationDoneRight_03() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-03", // testURI,
  ...
  public void test_reificationDoneRight_03a() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-03a", // testURI,
   ...
   * </pre>
   *
   * @see <a href="http://trac.blazegraph.com/ticket/815">RDR query does too much work</a>
   */
  public void test_reificationDoneRight_04() throws Exception {

    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-04", // testURI,
  ...
  public void test_reificationDoneRight_05a() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-05a", // testURI,
  ...
  public void test_reificationDoneRight_05b() throws Exception {
    ...
    new TestHelper(
            TEST_RESOURCE_PREFIX + "rdr-05b", // testURI,
