...
public class TestASTFlattenUnionsOptimizer extends AbstractASTEvaluationTestCase {
  ...
  public void test_flattenUnions1() {
     ...
     */
    final IV producerIV =
        makeIV(new URIImpl("http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/producer"));

    final IV producer1IV =
        makeIV(
            new URIImpl(
                "http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/instances/dataFromProducer1/Producer1"));

    final IV reviewForIV =
        makeIV(new URIImpl("http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/reviewFor"));

    final IV rating1IV =
        makeIV(new URIImpl("http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/rating1"));
    final IV rating2IV =
        makeIV(new URIImpl("http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/rating2"));
    final IV rating3IV =
        makeIV(new URIImpl("http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/rating3"));
    final IV rating4IV =
        makeIV(new URIImpl("http://www4.wiwiss.fu-berlin.de/bizer/bsbm/v01/vocabulary/rating4"));
    ...
    final QueryRoot given = new QueryRoot(QueryType.SELECT);
    {
      ...
      whereClause.addChild(
          new StatementPatternNode(
              new VarNode("product"),
              new ConstantNode(producerIV),
              new ConstantNode(producer1IV),
              null /* c */,
   ...
   * </pre>
   *
   * This case can not be flatten because the child UnionNode is not the sole child of its parent
   * group node.
   *
   * @throws Exception
   */
