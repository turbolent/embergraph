...
public class TestUnions extends AbstractDataDrivenSPARQLTestCase {
   ...
   * </pre>
   *
   * @see <a href="https://sourceforge.net/apps/trac/bigdata/ticket/504">UNION with Empty Group
   *     Pattern </a>
   */
  ...
  /** @see <a href="http://trac.blazegraph.com/ticket/831">Union with FILTER issue</a> */
