...
public class TestGeoSpatialServiceEvaluation extends AbstractDataDrivenSPARQLTestCase {
  ...
  public void testInRectangleQuery01() throws Exception {
    ...
    new TestHelper(
            "geo-rectangle01", "geo-rectangle01.rq", "geo-grid101010.nt", "geo-rectangle01.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "5#5" . ?res geo:spatialRectangleNorthEast
   * "5#5" . ?res geo:timeStart "1" . ?res geo:timeEnd "10" . } }
   */
  public void testInRectangleQuery02() throws Exception {

    new TestHelper(
            "geo-rectangle02", "geo-rectangle02.rq", "geo-grid101010.nt", "geo-rectangle02.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "-1#9" . ?res geo:spatialRectangleNorthEast
   * "1#12" . ?res geo:timeStart "7" . ?res geo:timeEnd "12" . } }
   */
   ...
   *
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "-90#8.8837" . ?res
   * geo:spatialRectangleNorthEast "1.00#12.2344" . ?res geo:timeStart "7" . ?res geo:timeEnd
   * "100000000000000" . } }
   */
   ...
   *
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "-90E0#.88837E1" . ?res
   * geo:spatialRectangleNorthEast "1.00#179.2344" . ?res geo:timeStart "7" . ?res geo:timeEnd
   * "1000000" . } }
   */
   ...
   * <p>PREFIX geo: <http://www.embergraph.org/rdf/geospatial#>
   *
   * <p>SELECT ?res WHERE { ?res geo:search "inRectangle" . ?res geo:predicate <http://p> . ?res
   * geo:spatialRectangleSouthWest "-90E0#.88837E1" . ?res geo:spatialRectangleNorthEast
   * "1.00#179.2344" . ?res geo:timeStart "7" . ?res geo:timeEnd "1000000" . }
   */
   ...
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "2#2" . ?res geo:spatialRectangleNorthEast
   * "3#6" . ?res geo:timeStart "4" . ?res geo:timeEnd "4" . } ?res ?p ?o . FILTER(?p = <http://p>)
   * }
   */
  public void testInRectangleQuery07() throws Exception {

    new TestHelper(
            "geo-rectangle07", "geo-rectangle07.rq", "geo-grid101010.nt", "geo-rectangle07.srx")
        .runTest();
  }
   ...
   * geo:search { ?res geo:search "inRectangle" . ?res geo:predicate <http://p> . ?res
   * geo:spatialRectangleSouthWest "1.10#1.100000001111" . ?res geo:spatialRectangleNorthEast
   * "6.666666#7" . ?res geo:timeStart "0" . ?res geo:timeEnd "0" . } ?res ?p ?o . }
   *
   * <p>is evaluated over data
   *
   * <p><http://s0> <http://p> "0#0#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral>
   * . <http://s1> <http://p>
   * "1.1#1.1#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> . <http://s2>
   * <http://p> "2.22#2.22#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s3> <http://p>
   * "3.333#3.333#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> . <http://s4>
   * <http://p> "4.4444#4.4444#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s5> <http://p>
   * "5.55555#5.55555#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> . <http://s6>
   * <http://p> "6.666666#6.6666666#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral>
   * . <http://s6b> <http://p>
   * "6.66667#6.6666666#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s6c> <http://p>
   * "6.66666#6.66667#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s6c> <http://p>
   * "6.66667#6.66667#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   *
   * <p>Since the geospatial datatype has precision=5 (in our standard datatype), the query is
   * equivalent to
   *
   * <p>PREFIX geo: <http://www.embergraph.org/rdf/geospatial#> SELECT ?res ?o WHERE { SERVICE
   * geo:search { ?res geo:search "inRectangle" . ?res geo:predicate <http://p> . ?res
   * geo:spatialRectangleSouthWest "1.10#1.1" . ?res geo:spatialRectangleNorthEast "6.66666#7" .
   * ?res geo:timeStart "0" . ?res geo:timeEnd "0" . } ?res ?p ?o . }
   *
   * <p>and the data is equivalent to
   *
   * <p><http://s0> <http://p> "0#0#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral>
   * . <http://s1> <http://p>
   * "1.1#1.1#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> . <http://s2>
   ...
   * <http://s5> <http://p>
   * "5.55555#5.55555#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> . <http://s6>
   * <http://p> "6.66666#6.666666#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s6b> <http://p>
   * "6.66667#6.666666#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s6c> <http://p>
   * "6.66666#6.66667#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   * <http://s6d> <http://p>
   * "6.66667#6.66667#0"^^<http://www.embergraph.org/rdf/geospatial#geoSpatialLiteral> .
   *
   * <p>Consequently, subjects s0, s6b, and s6d are *not* contained in the result, while all others
   * are.
   */
  public void testInRectangleQuery08() throws Exception {

    new TestHelper(
            "geo-rectangle08", "geo-rectangle08.rq", "geo-rectangle08.nt", "geo-rectangle08.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "4#4" . ?res geo:spatialRectangleNorthEast
   * "5#5" . ?res geo:timeStart "1" . ?res geo:timeEnd "10" . } hint:Prior
   * <http://www.embergraph.org/queryHints#maxParallel> "10" . hint:Prior
   * <http://www.embergraph.org/queryHints#org.embergraph.relation.accesspath.BlockingBuffer.chunkOfChunksCapacity>
   * "10" . hint:Prior
   * <http://www.embergraph.org/queryHints#org.embergraph.relation.accesspath.IBuffer.chunkCapacity>
   * "100" . hint:Prior
   * <http://www.embergraph.org/queryHints#org.embergraph.bop.join.PipelineJoin.avgDataPointsPerThread>
   * "10" . }
   *
   * <p>which implies setup of parallel threads for data extraction.
   */
   ...
   *
   * <p>, which extracts the center point 4#4 with three timestamps.
   *
   * @throws Exception
   */
  public void testInCircleQuery01a() throws Exception {

    new TestHelper("geo-circle01a", "geo-circle01a.rq", "geo-grid101010.nt", "geo-circle01.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "105" . #km ?res
   * geo:timeStart "5" . ?res geo:timeEnd "7" . } }
   *
   * <p>, which extracts the center point 4#4 with three timestamps (105km is still too small to
   * match any points of 1 lat/lon distance in the grid)
   *
   * @throws Exception
   */
  public void testInCircleQuery01b() throws Exception {

    new TestHelper("geo-circle01b", "geo-circle01b.rq", "geo-grid101010.nt", "geo-circle01.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "65" . ?res
   * geo:spatialUnit "Miles" . ?res geo:timeStart "5" . ?res geo:timeEnd "7" . } }
   *
   * <p>, which is the same as the circle01b, just using a (roughly) equivalent value specified in
  ...
  public void testInCircleQuery01c() throws Exception {
    ...
    new TestHelper("geo-circle01c", "geo-circle01c.rq", "geo-grid101010.nt", "geo-circle01.srx")
        .runTest();
  }
   ...
   * <p>PREFIX geo: <http://www.embergraph.org/rdf/geospatial#>
   *
   * <p>SELECT * WHERE { ?res geo:search "inCircle" . ?res geo:predicate <http://p> . ?res
   * geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "1" . #km ?res geo:timeStart "5" .
   * ?res geo:timeEnd "7" . }
   *
   * <p>, which is a variante of circle01a just not wrapped into a SERVICE.
   *
   * @throws Exception
   */
  public void testInCircleQuery01d() throws Exception {

    new TestHelper("geo-circle01d", "geo-circle01d.rq", "geo-grid101010.nt", "geo-circle01.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "112" . #km ?res
   * geo:timeStart "5" . ?res geo:timeEnd "5" . } }
   *
   * <p>extends the radius such that the point's neighbors in the east, west, south, and nord are
   * matched now.
   *
   * @throws Exception
   */
  public void testInCircleQuery02() throws Exception {
    ...
    new TestHelper("geo-circle02", "geo-circle02.rq", "geo-grid101010.nt", "geo-circle0203.srx")
        .runTest();
  }
  ...
  public void testInCircleQuery03() throws Exception {
    ...
    new TestHelper("geo-circle03", "geo-circle03.rq", "geo-grid101010.nt", "geo-circle0203.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "190" . #km ?res
   * geo:timeStart "5" . ?res geo:timeEnd "5" . } }
   *
   * <p>extends the radius such that the point's neighbors in the south-east, sout-west, north-east,
   * and north-west are included now as well.
   *
   * @throws Exception
   */
  public void testInCircleQuery04() throws Exception {

    new TestHelper("geo-circle04", "geo-circle04.rq", "geo-grid101010.nt", "geo-circle04.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "240000" . ?res
   * geo:spatialUnit "Meters" . ?res geo:timeStart "5" . ?res geo:timeEnd "5" . } }
   *
   * <p>further extends the range such that the next set of eastern, western, southern, and northern
   * points are matched.
   */
  public void testInCircleQuery05() throws Exception {

    new TestHelper("geo-circle05", "geo-circle05.rq", "geo-grid101010.nt", "geo-circle05.srx")
        .runTest();
  }
   ...
   *
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "1#1" . ?res geo:spatialCircleRadius "240" . ?res
   * geo:timeStart "5" . ?res geo:timeEnd "5" . } }
   *
   * @throws Exception
   */
  public void testInCircleQuery06a() throws Exception {
    ...
    new TestHelper("geo-circle06a", "geo-circle06a.rq", "geo-grid101010.nt", "geo-circle06a.srx")
        .runTest();
  }
  ...
  public void testInCircleQuery06b() throws Exception {
    ...
    new TestHelper("geo-circle06b", "geo-circle06b.rq", "geo-grid101010.nt", "geo-circle06b.srx")
        .runTest();
  }
  ...
  public void testInCircleQuery06c() throws Exception {
    ...
    new TestHelper("geo-circle06c", "geo-circle06c.rq", "geo-grid101010.nt", "geo-circle06c.srx")
        .runTest();
  }
  ...
  public void testInCircleQuery06d() throws Exception {
    ...
    new TestHelper("geo-circle06d", "geo-circle06d.rq", "geo-grid101010.nt", "geo-circle06d.srx")
        .runTest();
  }
   ...
   * <p>SELECT * WHERE { SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialCircleCenter "4#4" . ?res geo:spatialCircleRadius "240000" . ?res
   * geo:spatialUnit "Meters" . ?res geo:timeStart "5" . ?res geo:timeEnd "5" . } hint:Prior
   * <http://www.embergraph.org/queryHints#maxParallel> "5" . hint:Prior
   * <http://www.embergraph.org/queryHints#org.embergraph.relation.accesspath.BlockingBuffer.chunkOfChunksCapacity>
   * "5" . hint:Prior
   * <http://www.embergraph.org/queryHints#org.embergraph.relation.accesspath.IBuffer.chunkCapacity>
   * "10" . hint:Prior
   ...
   * "3" . }
   *
   * <p>, which is the same as circle05 just executed with parallel processing enabled.
   *
   * @throws Exception
   */
   ...
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "2#2" . ?res geo:spatialRectangleNorthEast
   * "3#6" . ?res geo:timeStart "4" . ?res geo:timeEnd "4" . ?res geo:locationValue ?location . } }
   */
  public void testDimensionValueExtracion01() throws Exception {

    new TestHelper(
            "geo-valueextr", "geo-valueextr01.rq", "geo-grid101010.nt", "geo-valueextr01.srx")
        .runTest();
  }
   ...
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "2#2" . ?res geo:spatialRectangleNorthEast
   * "3#6" . ?res geo:timeStart "4" . ?res geo:timeEnd "4" . ?res geo:timeValue ?time . } }
   */
  public void testDimensionValueExtracion02() throws Exception {

    new TestHelper(
            "geo-valueextr", "geo-valueextr02.rq", "geo-grid101010.nt", "geo-valueextr02.srx")
        .runTest();
  }
   ...
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "2#2" . ?res geo:spatialRectangleNorthEast
   * "3#6" . ?res geo:timeStart "4" . ?res geo:timeEnd "4" . ?res geo:locationAndTimeValue
   * ?locationAndTime . } }
   */
  public void testDimensionValueExtracion03() throws Exception {

    new TestHelper(
            "geo-valueextr", "geo-valueextr03.rq", "geo-grid101010.nt", "geo-valueextr03.srx")
        .runTest();
  }
   ...
   * <p>SELECT ?res WHERE { SERVICE geo:search { ?res geo:search "inRectangle" . ?res geo:predicate
   * <http://p> . ?res geo:spatialRectangleSouthWest "2#2" . ?res geo:spatialRectangleNorthEast
   * "3#6" . ?res geo:timeStart "4" . ?res geo:timeEnd "4" . ?res geo:locationValue ?location . ?res
  ...
  public void testDimensionValueExtracion04() throws Exception {
    ...
    new TestHelper(
            "geo-valueextr", "geo-valueextr04.rq", "geo-grid101010.nt", "geo-valueextr04.srx")
        .runTest();
  }
   ...
   * <p>PREFIX geo: <http://www.embergraph.org/rdf/geospatial#>
   *
   * <p>SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate <http://p> . ?res
   ...
   *
   * <p>SERVICE geo:search { ?res geo:search "inCircle" . ?res geo:predicate <http://p> . ?res
   * geo:spatialCircleCenter "27.9932#39.928" . ?res geo:spatialCircleRadius "10000000" . # spans
   * all earth ?res geo:timeStart "0" . ?res geo:timeEnd "0" . }
   */
  ...
  public void testRectangleOutOfBounds01a() throws Exception {
    ...
    try {
      new TestHelper(
              ...
              "geo-small.nt",
              "geo-rectangle-outofbounds1a.srx")
          .runTest();
    } catch (Exception e) {
  ...
  public void testRectangleOutOfBounds01b() throws Exception {
    ...
    try {
      new TestHelper(
              ...
              "geo-small.nt",
              "geo-rectangle-outofbounds1b.srx")
          .runTest();
    } catch (Exception e) {
  ...
  public void testRealWordCircleWithDistance01() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-realworld-cities.nt",
            "geo-realworld-circlewithdistance01.srx")
        .runTest();
  }
  ...
  public void testRealWordCircleWithDistance02() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-realworld-cities.nt",
            "geo-realworld-circlewithdistance02.srx")
        .runTest();
  }
