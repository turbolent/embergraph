...
public class TestGeoSpatialQueryVaryOneDimension extends AbstractDataDrivenSPARQLTestCase {
  ...
  public void testBuiltinLatLonTime01() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-builtin-llt01.srx")
        .runTest();
  }
  ...
  public void testBuiltinLatLonTime02() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-builtin-llt02.srx")
        .runTest();
  }
  ...
  public void testBuiltinLatLonTime03() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-builtin-llt03.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord01() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc01.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord02() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc02.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord03() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc03.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord04() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc04.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord05() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc05.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord06() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc06.srx")
        .runTest();
  }
  ...
  public void testCustomXYZLatLonTimeCoord07() throws Exception {
    ...
    new TestHelper(
            ...
            "geo-vary1dim.nt",
            "geo-vary1dim-custom-xyzlltc07.srx")
        .runTest();
  }
