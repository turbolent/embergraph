 ...
 *     <p>FIXME Write SPARQL layer tests correct rejection tests for DISTINCT ?var that should not
 *     have been rewritten (those that have more than one BPG).
 */
public class TestDistinctTermScanOptimizer extends AbstractDataDrivenSPARQLTestCase {
  ...
  public static class TestTriplesModeAPs extends TestDistinctTermScanOptimizer {
    ...
    public void test_distinctTermScan_triples_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_triples_01", // testURI,
    ...
    public void test_distinctTermScan_triples_02() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_triples_02", // testURI,
    ...
    public void test_distinctTermScan_triples_03() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_triples_03", // testURI,
    ...
    public void test_distinctTermScan_triples_correctRejection_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_triples_correctRejection_01", // testURI,
    ...
    public void test_distinctTermScan_triples_subQuery_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_triples_subQuery_01", // testURI,
      ...
      assertEquals(
          1,
          BOpUtility.toList(h.getASTContainer().getOptimizedAST(), NamedSubqueryInclude.class)
              .size());
    }
  }
   ...
   * it temporarily in the DefaultOptimizerList when developing the test suite in order to validate
   * the correctness of the test suite without the optimizer in play.
   *
   * <p>Note: The quads mode indices are:
   *
   * <pre>
   * SPOC
   * POCS
   ...
   * </pre>
   *
   * FIXME Add explicit tests using FROM and FROM NAMED. The optimizer handles this, but we should
   * have test coverage for it also.
   */
  public static class TestQuadsModeAPs extends TestDistinctTermScanOptimizer {
    ...
    public void test_distinctTermScan_quads_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_quads_01", // testURI,
    ...
    public void test_distinctTermScan_quads_01b() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_quads_01b", // testURI,
    ...
    public void test_distinctTermScan_quads_01c() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_quads_01c", // testURI,
    ...
    public void test_distinctTermScan_quads_02() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_quads_02", // testURI,
    ...
    public void test_distinctTermScan_quads_correctRejection_01() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_quads_correctRejection_01", // testURI,
    ...
    public void test_distinctTermScan_quads_correctRejection_02() throws Exception {
      ...
      final TestHelper h =
          new TestHelper(
              "distinctTermScan_quads_correctRejection_02", // testURI,
