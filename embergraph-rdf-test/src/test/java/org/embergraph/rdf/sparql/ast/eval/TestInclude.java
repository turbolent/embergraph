...
//		five.setValue(vf.createLiteral(5));
         ...
         * 4. A ProjectionOp.
         */
//        org.embergraph.bop.solutions.ProjectionOp[6](JVMSolutionSetHashJoinOp[5])[ org.embergraph.bop.BOp.bopId=6, org.embergraph.bop.BOp.evaluationContext=CONTROLLER, org.embergraph.bop.PipelineOp.sharedState=true, org.embergraph.bop.join.JoinAnnotations.select=[x, y], org.embergraph.bop.engine.QueryEngine.queryId=562dbadb-afcc-4a2c-bf70-2486f1061dc3]
//                org.embergraph.bop.join.JVMSolutionSetHashJoinOp[5](JVMHashIndexOp[4])[ org.embergraph.bop.BOp.bopId=5, org.embergraph.bop.BOp.evaluationContext=CONTROLLER, org.embergraph.bop.PipelineOp.sharedState=true, namedSetRef=NamedSolutionSetRef{queryId=562dbadb-afcc-4a2c-bf70-2486f1061dc3,namedSet=%solutionSet1,joinVars=[x]}, org.embergraph.bop.join.JoinAnnotations.constraints=null, class org.embergraph.bop.join.SolutionSetHashJoinOp.release=false]
//                  org.embergraph.bop.join.JVMHashIndexOp[4](PipelineJoin[3])[ org.embergraph.bop.BOp.bopId=4, org.embergraph.bop.BOp.evaluationContext=CONTROLLER, org.embergraph.bop.PipelineOp.maxParallel=1, org.embergraph.bop.PipelineOp.lastPass=true, org.embergraph.bop.PipelineOp.sharedState=true, org.embergraph.bop.join.JoinAnnotations.joinType=Normal, org.embergraph.bop.join.HashJoinAnnotations.joinVars=[x], org.embergraph.bop.join.JoinAnnotations.select=null, namedSetSourceRef=NamedSolutionSetRef{queryId=562dbadb-afcc-4a2c-bf70-2486f1061dc3,namedSet=%solutionSet1,joinVars=[]}, namedSetRef=NamedSolutionSetRef{queryId=562dbadb-afcc-4a2c-bf70-2486f1061dc3,namedSet=%solutionSet1,joinVars=[x]}]
//                    org.embergraph.bop.join.PipelineJoin[3]()[ org.embergraph.bop.BOp.bopId=3, org.embergraph.bop.join.JoinAnnotations.constraints=null, org.embergraph.bop.BOp.evaluationContext=ANY, org.embergraph.bop.join.AccessPathJoinAnnotations.predicate=SPOPredicate[1]]
