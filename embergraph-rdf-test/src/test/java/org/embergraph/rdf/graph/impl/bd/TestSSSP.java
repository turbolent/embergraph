...
public class TestSSSP extends AbstractEmbergraphGraphTestCase {
   ...
   * linkAttributeType constraint. (We already have a test with just the linkType constraint above).
   *
   * <p>FIXME This is only testing the scatter AP. We also need to test the gather AP.
   */
