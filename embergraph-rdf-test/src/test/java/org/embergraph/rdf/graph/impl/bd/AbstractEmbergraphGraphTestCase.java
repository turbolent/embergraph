...
public class AbstractEmbergraphGraphTestCase extends AbstractGraphTestCase {
  ...
  protected class SmallGraphProblem {
    ...
    private final EmbergraphURI rdfType, foafKnows, foafPerson, mike, bryan, martyn;
    ...
    public SmallGraphProblem() throws Exception {
      ...
      try {
        ...
        foafKnows = (EmbergraphURI) vf.createURI("http://xmlns.com/foaf/0.1/knows");

        foafPerson = (EmbergraphURI) vf.createURI("http://xmlns.com/foaf/0.1/Person");
        ...
        final EmbergraphValue[] terms =
            new EmbergraphValue[] {rdfType, foafKnows, foafPerson, mike, bryan, martyn};
        ...
        for (EmbergraphValue v : terms) {
          if (v.getIV() == null) fail("Did not resolve: " + v);
        }
  ...
  protected class SmallWeightedGraphProblem {
    ...
    /** The data file. */
    private static final String smallWeightedGraph =
        "src/test/resources/graph/data/smallWeightedGraph.ttlx";
    ...
    public SmallWeightedGraphProblem() throws Exception {
      ...
      try {
        ...
        linkWeight = (EmbergraphURI) vf.createURI("http://www.embergraph.org/weight");
        ...
        final EmbergraphValue[] terms =
            new EmbergraphValue[] {foafKnows, linkWeight, v1, v2, v3, v4, v5};
