...
public class TestLoadAndVerify extends AbstractRIOTestCase {
   ...
   *     <pre>
   * java.lang.RuntimeException: java.util.concurrent.ExecutionException: java.lang.IllegalArgumentException: Not our child : child=org.embergraph.btree.Leaf@1f0cf51#1165593256395406
   *     at org.embergraph.rdf.rio.AbstractRIOTestCase.doVerify(AbstractRIOTestCase.java:470)
   *     at org.embergraph.rdf.rio.AbstractRIOTestCase.doLoadAndVerifyTest(AbstractRIOTestCase.java:101)
   *     at org.embergraph.rdf.rio.TestLoadAndVerify.test_loadAndVerify_U1(TestLoadAndVerify.java:115)
   * ...
   * Caused by: java.lang.IllegalArgumentException: Not our child : child=org.embergraph.btree.Leaf@1f0cf51#1165593256395406
   *     at org.embergraph.btree.Node.getIndexOf(Node.java:1826)
   *     at org.embergraph.btree.Node.getRightSibling(Node.java:1734)
   *     at org.embergraph.btree.BTree$LeafCursor.next(BTree.java:2035)
   *     at org.embergraph.btree.AbstractBTreeTupleCursor$AbstractCursorPosition.nextLeaf(AbstractBTreeTupleCursor.java:1508)
   *     at org.embergraph.btree.AbstractBTreeTupleCursor$MutableCursorPosition.nextLeaf(AbstractBTreeTupleCursor.java:2035)
   *     at org.embergraph.btree.AbstractBTreeTupleCursor$AbstractCursorPosition.forwardScan(AbstractBTreeTupleCursor.java:1766)
   *     at org.embergraph.btree.AbstractBTreeTupleCursor.nextTuple(AbstractBTreeTupleCursor.java:783)
   *     at org.embergraph.btree.AbstractBTreeTupleCursor.next(AbstractBTreeTupleCursor.java:809)
   *     at org.embergraph.btree.filter.Advancer$Advancerator.next(Advancer.java:116)
   *     at org.embergraph.btree.filter.Advancer$Advancerator.next(Advancer.java:1)
   *     at cutthecrap.utils.striterators.Striterator.next(Striterator.java:60)
   *     at org.embergraph.btree.filter.FilterConstructor$WrappedTupleIterator.next(FilterConstructor.java:99)
   *     at org.embergraph.btree.ResultSet.&lt;init&gt;(ResultSet.java:978)
   *     at org.embergraph.btree.ChunkedLocalRangeIterator.getResultSet(ChunkedLocalRangeIterator.java:140)
   *     at org.embergraph.btree.UnisolatedReadWriteIndex$ChunkedIterator.getResultSet(UnisolatedReadWriteIndex.java:719)
   *     at org.embergraph.btree.AbstractChunkedTupleIterator.rangeQuery(AbstractChunkedTupleIterator.java:305)
   *     at org.embergraph.btree.AbstractChunkedTupleIterator.hasNext(AbstractChunkedTupleIterator.java:427)
   ...
   *     at org.embergraph.striterator.ChunkedWrappedIterator.hasNext(ChunkedWrappedIterator.java:197)
   *     at org.embergraph.rdf.store.AbstractTripleStore.predicateUsage(AbstractTripleStore.java:2379)
   *     at org.embergraph.rdf.store.AbstractTripleStore.predicateUsage(AbstractTripleStore.java:2345)
   *     at org.embergraph.rdf.rio.AbstractRIOTestCase$VerifyTask.verify(AbstractRIOTestCase.java:618)
   *     at org.embergraph.rdf.rio.AbstractRIOTestCase$VerifyTask.call(AbstractRIOTestCase.java:596)
   *     at org.embergraph.rdf.rio.AbstractRIOTestCase$VerifyTask.call(AbstractRIOTestCase.java:1)
  ...
  public void test_loadAndVerify_little_jsonld() throws Exception {
    ...
    final String resource = "/org/embergraph/rdf/rio/little.jsonld";
