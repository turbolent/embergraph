...
//	private static String NTRIPLES_TEST_FILE = "/testcases/ntriples/test.nt";
	...
	private static final transient Logger log = Logger.getLogger(EmbergraphNTriplesParserTestCase.class);
	...
	public void testNTriplesFileWithSIDS() throws Exception {
		...
		final String fileUrl = EmbergraphNTriplesParser.class.getResource(
				NTRIPLES_TEST_FILE_WITH_SIDS).toExternalForm();

		// Note: This is a local copy.
		InputStream in = EmbergraphNTriplesParser.class
