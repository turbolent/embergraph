...
public class TestNamespaceMultiURIHandler extends InlineURIFactory {
  ...
  public TestNamespaceMultiURIHandler() {
    ...
    InlineNamespaceMultiURIHandler mHandler =
        new InlineNamespaceMultiURIHandler("http://embergraph.org/Data#Position_");

    mHandler.addHandler(
        new InlineSuffixedHexUUIDURIHandler("http://embergraph.org/Data#Position_", "_TaxCost"));

    mHandler.addHandler(
        new InlineSuffixedHexUUIDURIHandler(
            "http://embergraph.org/Data#Position_", "_UnrealizedGain"));

    mHandler.addHandler(
        new InlineSuffixedHexUUIDURIHandler("http://embergraph.org/Data#Position_", "_WashSale"));

    mHandler.addHandler(new InlineHexUUIDURIHandler("http://embergraph.org/Data#Position_"));
