 ...
 * GroupByOp} implementation is made automatically by the tested implementation rather than by test
 * config.
 *
 * <p>All the current tests were initially used as tests for ticket BLZG 1202.
 *
...
public class TestGroupByOp extends AbstractDataDrivenSPARQLTestCase {
  ...
  /** SELECT?s ?w { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?s ?w */
  ...
  /** SELECT?w (COUNT(DISTINCT ?v) AS ?S) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?w */
  ...
  /** SELECT?s ?w (COUNT(DISTINCT ?v) AS ?c) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?s ?w */
  ...
  /** SELECT?s ?w (STR(?w) AS ?wstr) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?s ?w */
  ...
  /** SELECT?w (SAMPLE(?v) AS ?S) (?w AS ?u) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?w */
  ...
  /** SELECT?s ?w (?w AS ?u) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?s ?w */
  ...
  /** SELECT(COUNT(?w) AS ?wcnt) (SAMPLE(?v) AS ?S) { ?s :p ?v . OPTIONAL { ?s :q ?w } } */
  ...
  /** SELECT(COUNT(?w) AS ?wcnt) (COUNT(DISTINCT ?v) AS ?S) { ?s :p ?v . OPTIONAL { ?s :q ?w } } */
  ...
  /** SELECT?w (COUNT(*) AS ?c) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?w */
  ...
  /** SELECT?w (COUNT(DISTINCT *) AS ?c) { ?s :p ?v . OPTIONAL { ?s :q ?w } } GROUP BY ?w */
  ...
  /** SELECT(COUNT(?w) AS ?u) (COUNT(*) AS ?c) { ?s :p ?v . OPTIONAL { ?s :q ?w } } */
  ...
  /** SELECT(COUNT(?w) AS ?u) (COUNT(DISTINCT *) AS ?c) { ?s :p ?v . OPTIONAL { ?s :q ?w } } */
