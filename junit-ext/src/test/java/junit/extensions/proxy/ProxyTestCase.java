...
public class ProxyTestCase extends TestCase implements IProxyTest {
  ...
  public void doSomething() {
    ...
    if (delegate == null) {
      ...
      System.err.println("The delegate was not setup.");
   ...
   * the proxy tests rather than gathering them up and executing them in {@link DelegateTestCase}.
   * This issue can typically be traced back to how you have configured your Maven/ant JUnit task.
   * It is recommended that the JUnit task exclude all classes matching <code> ** / *ProxyTest*
   * </code>
   */
