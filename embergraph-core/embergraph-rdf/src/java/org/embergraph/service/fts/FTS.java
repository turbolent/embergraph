...
public interface FTS {
  ...
  interface Options {
     ...
     * FTS#ENDPOINT} may be used to override the default.
     */
   ...
   * </pre>
   *
   * The value MUST be bound and MUST be a literal, it points to the Solr search string.
   *
   ...
   * to all of them. Default is URI, which converts the field into a URI; if conversion fails, the
   * value is ignored.
   *
   * <p>
   *
   ...
   * </pre>
   *
   * The referenced variable must not be used somewhere else in the scope. It will be bound to an
   * xsd:double typed literal indicating the score for the match.
   *
