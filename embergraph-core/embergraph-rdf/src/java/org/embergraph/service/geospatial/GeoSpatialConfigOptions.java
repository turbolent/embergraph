...
public class GeoSpatialConfigOptions {
  ...
  public interface Options {
    ...
    String GEO_SPATIAL_INCLUDE_BUILTIN_DATATYPES =
        AbstractTripleStore.class.getName() + ".geoSpatialIncludeBuiltinDatatypes";
     ...
     */
    String GEO_SPATIAL_DEFAULT_DATATYPE =
        AbstractTripleStore.class.getName() + ".geoSpatialDefaultDatatype";
     ...
     *
     * <p>See https://wiki.blazegraph.com/wiki/index.php/GeoSpatial#Custom_Geospatial_Datatypes for
     * a documentation of the JSON syntax. The JSON is parsed into instances by using the
