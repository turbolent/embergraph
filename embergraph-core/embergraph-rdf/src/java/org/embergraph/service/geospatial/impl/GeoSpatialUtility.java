...
public class GeoSpatialUtility {
  ...
  public static class PointLatLonTime {
    ...
    public PointLatLonTime(final String s) throws NumberFormatException {
      ...
      spatialPoint = new PointLatLon(Double.valueOf(xyCoord[0]), Double.valueOf(xyCoord[1]));
      timestamp = Long.valueOf(xyCoord[2]);
    }

    /** Construction from data. */
    public PointLatLonTime(final CoordinateDD spatialPoint, final Long timestamp) {

      this(new PointLatLon(spatialPoint), timestamp);
    }

    /** Construction from data. */
    public PointLatLonTime(final PointLatLon spatialPoint, final Long timestamp) {
    ...
    /** Construction from data. */
    public PointLatLonTime(final Double xCoord, final Double yCoord, final Long timestamp) {
    ...
    public static Object[] toComponentString(PointLatLonTime point) {
      ...
      final Object[] components = {
        point.getSpatialPoint().getLat(), point.getSpatialPoint().getLon(), point.getTimestamp()
      };
  ...
  public static class BoundingBoxLatLonTime {
    ...
    public BoundingBoxLatLonTime(
        ...
        final Double distanceLat,
        final Double distanceLon,
