 ...
 * that constitute the reverse properties for o.
 *
 * @see InferenceEngine
...
public class BackchainOwlSameAsPropertiesPOIterator extends BackchainOwlSameAsIterator {
     ...
     */
    {
      ...
      while (samesIt.hasNext()) {
        ...
        while (reversePropsIt.hasNext()) {
          ...
          if (IVUtility.equals(reverseProp.p(), sameAs) && IVUtility.equals(reverseProp.s(), o)) {
            continue;
          }
   ...
   * access path.
   *
   * @param spo the spo being visited by the source iterator or the sameAs{3} iterator
   */
