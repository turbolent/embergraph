 ...
 * owl:sameAs (s and o) are known up front. We can collect up all the sames in the ctor and use
 * links between those sames to infer new links between the original s and o.
 *
 * @see InferenceEngine
...
public class BackchainOwlSameAsPropertiesSPOIterator extends BackchainOwlSameAsIterator {
   ...
   * @param o The object of the triple pattern. Cannot be null.
