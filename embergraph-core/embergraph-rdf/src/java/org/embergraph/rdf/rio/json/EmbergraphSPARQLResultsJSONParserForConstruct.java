 ...
 * @author Peter Ansell
 */
public class EmbergraphSPARQLResultsJSONParserForConstruct extends RDFParserBase
    implements RDFParser, TupleQueryResultHandler {

  private final EmbergraphSPARQLResultsJSONParser parser;

  public EmbergraphSPARQLResultsJSONParserForConstruct() {
    this.parser = new EmbergraphSPARQLResultsJSONParser();
  }

  public EmbergraphSPARQLResultsJSONParserForConstruct(final ValueFactory vf) {
    this.parser = new EmbergraphSPARQLResultsJSONParser(vf);
