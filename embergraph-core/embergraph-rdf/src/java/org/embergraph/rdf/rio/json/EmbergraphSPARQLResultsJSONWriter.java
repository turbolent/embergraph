 ...
 * Format</a>.
 */
public class EmbergraphSPARQLResultsJSONWriter extends SPARQLJSONWriterBase implements TupleQueryResultWriter {
    ...
    protected void writeValue(final Value value) throws IOException,
        ...
        if (value instanceof EmbergraphBNode &&
                ((EmbergraphBNode) value).isStatementIdentifier()) {
