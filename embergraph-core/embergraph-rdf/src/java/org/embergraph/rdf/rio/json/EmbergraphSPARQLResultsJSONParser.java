 ...
 * @author Peter Ansell
 */
public class EmbergraphSPARQLResultsJSONParser extends SPARQLJSONParserBase
  ...
  /** Default constructor. */
  public EmbergraphSPARQLResultsJSONParser() {
    super();
  }
   ...
   */
  public EmbergraphSPARQLResultsJSONParser(ValueFactory valueFactory) {
    super(valueFactory);
  }
  ...
  protected Value parseValue(final String bindingStr, final JsonParser jp)
    ...
    if (type.equals(SID)) {
      ...
      if (s == null) {
        throw new QueryResultParseException(
            "Missing subject for statement: " + bindingStr,
            jp.getCurrentLocation().getLineNr(),
            jp.getCurrentLocation().getColumnNr());
      }
      ...
      if (p == null) {
        throw new QueryResultParseException(
            "Missing predicate for statement: " + bindingStr,
            jp.getCurrentLocation().getLineNr(),
            jp.getCurrentLocation().getColumnNr());
      }
      ...
      if (o == null) {
        throw new QueryResultParseException(
            "Missing object for statement: " + bindingStr,
            jp.getCurrentLocation().getLineNr(),
            jp.getCurrentLocation().getColumnNr());
      }
      ...
      final EmbergraphStatement stmt = valueFactory.createStatement(s, p, o, c);
