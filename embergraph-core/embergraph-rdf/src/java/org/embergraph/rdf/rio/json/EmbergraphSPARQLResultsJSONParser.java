 ...
 * @author Peter Ansell
 */
public class EmbergraphSPARQLResultsJSONParser extends SPARQLJSONParserBase implements TupleQueryResultParser {
    ...
    protected Value parseValue(final String bindingStr, final JsonParser jp) 
        ...
        if (type.equals(SID)) {
            ...
            final EmbergraphValueFactory valueFactory =
                    (EmbergraphValueFactory) super.valueFactory;
