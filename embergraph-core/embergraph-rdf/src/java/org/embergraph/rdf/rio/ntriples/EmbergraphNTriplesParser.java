...
public class EmbergraphNTriplesParser extends RDFParserBase {
	 ...
	 */
	private Map<Statement, EmbergraphBNode> sids = new LinkedHashMap<Statement, EmbergraphBNode>() {
		/**
		 * 
		 */
		...
		protected boolean removeEldestEntry(
				final Map.Entry<Statement, EmbergraphBNode> eldest) {
...
//	private final StringBuilder datatypeUriBuffer = new StringBuilder(40);
	 ...
	 *             if you have not set a {@link EmbergraphValueFactory}.
	 */
		...
		throws IOException, RDFParseException, RDFHandlerException
	{
		...
		if (embedded) {
			// Create statement.
			EmbergraphStatement st = (EmbergraphStatement) createStatement(
