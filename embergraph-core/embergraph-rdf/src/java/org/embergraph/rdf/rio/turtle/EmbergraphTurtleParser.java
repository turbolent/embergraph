            ...
            throws IOException, RDFParseException
    {
        ...
        if (i == '>' && read() == '>') {
            if (valueFactory == null || 
                    valueFactory instanceof EmbergraphValueFactory == false) {
                /*
                ...
                throw new RDFParseException(
                        "You must use a EmbergraphValueFactory to use the RDR syntax");
            }
            ...
            final EmbergraphValueFactory valueFactory = (EmbergraphValueFactory)
                    super.valueFactory;
