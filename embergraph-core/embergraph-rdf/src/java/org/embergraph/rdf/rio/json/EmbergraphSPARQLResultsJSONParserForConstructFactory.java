 ...
 * @author Peter Ansell
 */
public class EmbergraphSPARQLResultsJSONParserForConstructFactory implements RDFParserFactory {
	...
	public RDFParser getParser() {
		...
		return new EmbergraphSPARQLResultsJSONParserForConstruct(EmbergraphValueFactoryImpl.getInstance(namespace));
	}
