...
public class SparqlDynamicErrorException extends W3CQueryLanguageException {
   ...
   */
  protected SparqlDynamicErrorException(final int errorCode, final String uri, final NV[] params) {
  ...
  protected static String toURI(final int errorCode) {
    ...
    return W3CQueryLanguageException.toURI(
        LanguageFamily.SP, ErrorCategory.DY, errorCode, null /* params */);
  }
  ...
  public static class SolutionSetExistsException extends SparqlDynamicErrorException {
    ...
    public SolutionSetExistsException(final String solutionSet) {
      ...
      super(
          0003 /* errorCode */, SPARQL_DYNAMIC_ERROR_0003, new NV[] {new NV("name", solutionSet)});
    }
  }
  ...
  public static class SolutionSetDoesNotExistException extends SparqlDynamicErrorException {
    ...
    public SolutionSetDoesNotExistException(final String solutionSet) {
      ...
      super(
          0004 /* errorCode */, SPARQL_DYNAMIC_ERROR_0004, new NV[] {new NV("name", solutionSet)});
    }
  }
