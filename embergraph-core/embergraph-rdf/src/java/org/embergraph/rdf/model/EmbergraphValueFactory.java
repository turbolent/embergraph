...
public interface EmbergraphValueFactory extends ValueFactory {
     ...
     * be directed to the same index partition. All {@link EmbergraphValue}s are
...
//    EmbergraphBNodeImpl createSID(String id);
     ...
     * will be normalized to this {@link EmbergraphValueFactory} using
     * {@link #asValue(Value)}.
     * 
     * @param s
     *            The subject.
    ...
    /**
     * Converts a {@link Value} into a {@link EmbergraphValue}. If the value is
     * already a {@link EmbergraphValue} and it was allocated by <i>this</i>
     * {@link EmbergraphValueFactoryImpl} then it is returned unchanged. Otherwise a
     * new {@link EmbergraphValue} will be creating using the same data as the
     * given value and the term identifier on the new {@link EmbergraphValue} will
     * be initialized to {@link IRawTripleStore#NULL}.
     * <p>
     * All {@link EmbergraphValue}s created by a {@link EmbergraphValueFactoryImpl}
     * internally store a transient reference to the {@link EmbergraphValueFactoryImpl}.
     * This reference is used to decide if a {@link EmbergraphValue} MIGHT have
     ...
     * {@link EmbergraphValue}s when possible.
     * 
     * @param v
     *            The value.
     * 
     * @return A {@link EmbergraphValue} with the same data. If the value is
     ...
     * reference to this {@link EmbergraphValueFactoryImpl}.  That reference can be
     * used to identify when two {@link EmbergraphValue}s MIGHT be from different
     * lexicons.
     * 
     * @return
     */
