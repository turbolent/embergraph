...
//            return out.toByteArray();
     ...
     * <p>
     * Note: This automatically uses the {@link EmbergraphValueFactoryImpl} to create
     * the {@link EmbergraphValue}s from the de-serialized state so the factory
     * reference is always set on the returned {@link EmbergraphValueImpl}.
     * 
     * @param b
     ...
     * <p>
     * Note: This automatically uses the {@link EmbergraphValueFactoryImpl} to
     * create the {@link EmbergraphValue}s from the de-serialized state so the
     * factory reference is always set on the returned {@link EmbergraphValueImpl}.
     * 
     * @param b
