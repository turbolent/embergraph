 ...
 * 4th position will be a {@link EmbergraphValue} but its term identifier will
 * report <code>false</code> for {@link AbstractTripleStore#isStatement(IV)}.
 * <p>
 * Note: The ctors are intentionally protected. Use the
 * {@link EmbergraphValueFactory} to create instances of this class - it will
...
//    private transient boolean modified = false;
     ...
     */
    public EmbergraphStatementImpl(final EmbergraphResource subject,
            final EmbergraphURI predicate, final EmbergraphValue object,
            final EmbergraphResource context, final StatementEnum type,
    ...
    @Override
    final public EmbergraphResource getSubject() {
    ...
    @Override
    final public EmbergraphURI getPredicate() {
    ...
    @Override
    final public EmbergraphValue getObject() {
    ...
    @Override
    final public EmbergraphResource getContext() {
