 ...
 */
public class EmbergraphLiteralImpl extends EmbergraphValueImpl implements
    EmbergraphLiteral {
     ...
     */
    EmbergraphLiteralImpl(final EmbergraphValueFactory valueFactory,
            final String label, final String language, final EmbergraphURI datatype) {
...
//        this.language = language;
    ...
    @Override
    final public EmbergraphURI getDatatype() {
