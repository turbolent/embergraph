...
/**
 * A blank node. Use {@link EmbergraphValueFactory} to create instances of this
 * class.
 * <p>
 ...
 * @version $Id$
 */
public class EmbergraphBNodeImpl extends EmbergraphResourceImpl implements
    EmbergraphBNode {
...
//				throw new UnificationException("illegal self-referential sid");
    ...
    final public boolean equals(final BNode o) {
		...
		if ((o instanceof EmbergraphValue)
				&& isRealIV() && ((EmbergraphValue)o).isRealIV()
			...
			return getIV().equals(((EmbergraphValue) o).getIV());
				...
				&& isStatementIdentifier() && ((EmbergraphBNode)o).isStatementIdentifier()
				) {
	 ...
	 */
    @Override
	final public void setStatement(final EmbergraphStatement sid) {
		this.statementIdentifier = true;
		this.sid = sid;
	}
	 ...
	 */
    @Override
	final public EmbergraphStatement getStatement() {
		return sid;
	}
