...
/**
 * Places {@link EmbergraphValue}s into an ordering determined by their assigned
 * {@link EmbergraphValue#getIV() term identifiers}.
 * 
...
public class EmbergraphValueIdComparator implements Comparator<EmbergraphValue> {
    ...
    public static final transient Comparator<EmbergraphValue> INSTANCE = new EmbergraphValueIdComparator();
