 ...
 * over time. This version of this class was the default vocabulary for journals created prior to
 * 11/6/2015. -MP
 */
public class DefaultEmbergraphVocabulary extends RDFSVocabulary {

  /** De-serialization ctor. */
  public DefaultEmbergraphVocabulary() {
   ...
   */
  public DefaultEmbergraphVocabulary(final String namespace) {
  ...
  protected void addValues() {
    ...
    addDecl(
        new BaseVocabularyDecl(
            XSD.IPV4, InlineIPv4URIHandler.NAMESPACE, XSD.UUID, InlineUUIDURIHandler.NAMESPACE));
  }
}
