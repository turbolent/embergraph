 ...
 *
 * <p>Note: {@link StatementEnum#Axiom}s are always rejected by this filter so that they will be
...
public class DoNotAddFilter<E extends ISPO> extends SPOFilter<E> {
   ...
   *     rdf:type rdfs:Resource) when the closure of the database is updated.
   */
  public DoNotAddFilter(
      final Vocabulary vocab, final Axioms axioms, boolean forwardChainRdfTypeRdfsResource) {
