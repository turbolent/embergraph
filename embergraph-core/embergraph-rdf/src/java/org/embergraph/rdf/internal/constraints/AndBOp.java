...
public class AndBOp extends XSDBooleanIVValueExpression {
  ...
  public AndBOp(final IValueExpression<? extends IV> x, final IValueExpression<? extends IV> y) {
  ...
  public AndBOp(final BOp[] args, final Map<String, Object> anns) {
    ...
    if (!(args[1] instanceof XSDBooleanIVValueExpression)) throw new IllegalArgumentException();
  }
  ...
  public boolean accept(final IBindingSet bs) {
    ...
    if (left == null || right == null) {
      ...
      if (left != null && !left.booleanValue()) return false;
      if (right != null && !right.booleanValue()) return false;
