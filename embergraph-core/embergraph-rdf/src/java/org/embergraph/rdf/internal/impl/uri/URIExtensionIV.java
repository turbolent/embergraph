 ...
 * @param <V>
 */
public class URIExtensionIV<V extends EmbergraphURI> extends AbstractInlineExtensionIV<V, Object>
    implements URI {
  ...
  public URIExtensionIV(
      final AbstractLiteralIV<EmbergraphLiteral, ?> delegateIV, final IV<?, ?> namespaceIV) {

    super(VTE.URI, true /* extension */, delegateIV.getDTE());

    if (namespaceIV == null) throw new IllegalArgumentException();
  ...
  public boolean needsMaterialization() {
    return delegateIV.needsMaterialization() || namespaceIV.needsMaterialization();
  }
  ...
  public String toString() {
    ...
    else return getValue().stringValue();
  }
  ...
  public String getNamespace() { // See BLZG-1591
    if (this.namespaceIV != null) return namespaceIV.getValue().stringValue();
    return getValue().getNamespace();
  }

  @Override
  public String getLocalName() { // See BLZG-1591
    if (this.delegateIV != null) return delegateIV.getInlineValue().toString();
  ...
  public V asValue(final LexiconRelation lex) {
    ...
    if (v == null) {
      ...
      final String localName =
          lex.getLexiconConfiguration().getInlineURILocalNameFromDelegate(namespace, delegateIV);
