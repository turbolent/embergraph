 ...
 *
 * <p>Note that this inherits from {@link AbstractLiteralIV}, but does not necessarily reflect a
 * literal: the reflected type depends on the inner type. We do not expose this to the outside
 * (i.e., there's no datatype that can be used for constructing these literals), but this is for
 * internal use only. See BLZG-611.
 *
