 ...
 *     <p>TODO Refactor the test suite for this from the SparqlCache test suite.
 */
public class SolutionSetStreamEncoder {
   ...
   * example, appending one stream onto another at a low-level in the store).
   */
  static int CHUNK_HEADER_SIZE =
      Bytes.SIZEOF_INT
          + // version number.
          Bytes.SIZEOF_INT
          + // #of solutions in chunk.
   ...
   * @param src2 The solutions to be encoded.
   */
  public void encode(final DataOutputStream os, final ICloseableIterator<IBindingSet[]> src2)
      throws IOException {
