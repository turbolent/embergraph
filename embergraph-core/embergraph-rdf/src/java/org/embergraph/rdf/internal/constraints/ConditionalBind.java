 ...
 * @author mroycsi
 */
public class ConditionalBind<E extends IV> extends ImmutableBOp
    implements IValueExpression<E>, IBind<E>, IPassesMaterialization {
  ...
  public ConditionalBind(BOp[] args, Map<String, Object> annotations) {
    ...
    if (getProperty(Annotations.PROJECTION) == null) throw new IllegalArgumentException();
  }
