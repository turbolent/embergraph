 ...
 *   <li>UUID ({@link InlineUUIDURIHandler}
 * </ul>
 *
 * You MAY declare additional handlers. This MUST be done before the triple store instance has been
 * created. Once the triple store exists, the translation imposed by the lexicon configuration and
 * the lexicon indices must be stable.
 *
...
public class InlineURIFactory implements IInlineURIFactory {
   ...
   * This provides lookup by prefix and the longest prefix match is now used rather than visiting
   * all registered handlers.
   *
   * <p>This map should be populated in the constructor for this class and the subclasses in order
