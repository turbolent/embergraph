...
public class OrBOp extends XSDBooleanIVValueExpression {
  ...
  public OrBOp(final IValueExpression<? extends IV> x, final IValueExpression<? extends IV> y) {
  ...
  public boolean accept(final IBindingSet bs) {
    ...
    if (left == null || right == null) {
      ...
      if (left != null && left.booleanValue()) return true;
      if (right != null && right.booleanValue()) return true;
