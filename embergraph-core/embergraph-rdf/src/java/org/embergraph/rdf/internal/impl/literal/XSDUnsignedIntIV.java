...
public class XSDUnsignedIntIV<V extends EmbergraphLiteral> extends AbstractLiteralIV<V, Long> {
  ...
  public IV<V, Long> clone(final boolean clearCache) {
    ...
    final XSDUnsignedIntIV<V> tmp = new XSDUnsignedIntIV<>(value);
  ...
  private static final int UNSIGNED_ZERO = 0x80000000;
