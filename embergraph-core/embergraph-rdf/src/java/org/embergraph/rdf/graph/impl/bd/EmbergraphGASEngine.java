 ...
 * {@link EmbergraphGraphAccessor} interface from
...
//    private final IIndexManager indexManager;
     ...
     * 
     * @param sail
     *            The sail (must be a {@link EmbergraphSail}).
     * @param nthreads
     ...
     *            {@link IEmbergraphFederation}. The {@link EmbergraphGASEngine} would
...
//        this.indexManager = indexManager;
    ...
    public <VS, ES, ST> IGASState<VS, ES, ST> newGASState(
        ...
        return new EmbergraphGASState<VS, ES, ST>(this,
                (EmbergraphGraphAccessor) graphAccessor, frontier, gasScheduler,
                gasProgram);
    ...
    static public class EmbergraphGraphAccessor implements IGraphAccessor {
        ...
        public EmbergraphGraphAccessor(final IIndexManager indexManager) {
            ...
            this(indexManager, EmbergraphSail.Options.DEFAULT_NAMESPACE,
