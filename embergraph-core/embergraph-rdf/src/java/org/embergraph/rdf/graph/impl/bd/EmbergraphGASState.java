...
public class EmbergraphGASState<VS, ES, ST> extends GASState<VS, ES, ST> {
    ...
    static private final Logger log = Logger.getLogger(EmbergraphGASState.class);
    ...
    public EmbergraphGASState(final IGASEngine gasEngine,
    ...
    public void traceState() {
        ...
        final Map<IV<?, ?>, EmbergraphValue> m = kb.getLexiconRelation().getTerms(
                tmp);
