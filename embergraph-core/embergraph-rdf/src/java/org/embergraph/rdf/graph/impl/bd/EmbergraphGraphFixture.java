...
public class EmbergraphGraphFixture extends AbstractGraphFixture {
    ...
    public EmbergraphGraphFixture(final Properties properties)
    ...
    public EmbergraphGraphFixture(final AbstractTripleStore kb)
            throws SailException {
    ...
    public static class EmbergraphSailGraphLoader extends SailGraphLoader {
        ...
        public EmbergraphSailGraphLoader(SailConnection cxn) {
            ...
            // Note: Needed for RDR.
            this.valueFactory = ((EmbergraphSailConnection) cxn).getEmbergraphSail()
                    .getValueFactory();
