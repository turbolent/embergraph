...
public class EmbergraphGASRunner<VS, ES, ST> extends GASRunnerBase<VS, ES, ST> {
     ...
     * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
     */
    protected class EmbergraphOptionData extends
         ...
         * {@link EmbergraphGASRunner#loadFiles()}.
         */
...
//                            DataLoader.Options.FLUSH,
        ...
        public void init() throws Exception {
            ...
            if (isTransient) {
                ...
                if (fileStr == null) {
                    ...
                    final File tmpFile = File.createTempFile(
                            EmbergraphGASRunner.class.getSimpleName(),
                            Journal.Options.JNL);
            ...
            namespace = namespaceOverride == null ? properties
                    .getProperty(EmbergraphSail.Options.NAMESPACE,
                            EmbergraphSail.Options.DEFAULT_NAMESPACE) : namespaceOverride;
    ...
    private void loadFiles(final EmbergraphSail sail, final String[] loadSet)
            throws Exception {
        boolean ok = false;
