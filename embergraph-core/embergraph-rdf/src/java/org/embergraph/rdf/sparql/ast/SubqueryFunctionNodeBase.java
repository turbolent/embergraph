 ...
 */
public abstract class SubqueryFunctionNodeBase extends FunctionNode
    implements IGraphPatternContainer {
  ...
  interface Annotations extends FunctionNode.Annotations, IGraphPatternContainer.Annotations {
     ...
     *
     * <p>Note: This annotation gets propagated to the {@link SubqueryRoot} when the FILTER (NOT)
     * EXISTS is turned into an ASK subquery.
     *
