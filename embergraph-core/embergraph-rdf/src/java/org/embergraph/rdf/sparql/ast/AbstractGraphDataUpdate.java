...
public abstract class AbstractGraphDataUpdate extends GraphUpdate {
  ...
  interface Annotations extends GraphUpdate.Annotations {
     ...
     * ticket below (573). This forces us to work with materialized RDF Values. That makes it more
     * difficult to optimize SPARQL UPDATE by not materializing {@link IV}s as {@link
     * EmbergraphValue}s (ticket 522).
     *
     ...
     * @see <a href="https://sourceforge.net/apps/trac/bigdata/ticket/522">SPARQL UPDATE should not
     *     materialize RDF Values</a>
     */
    String DATA = "data";
  }
   ...
   * @param anns
   */
  public AbstractGraphDataUpdate(final BOp[] args, final Map<String, Object> anns) {
  ...
  public final String toString(final int indent) {
    ...
    if (data != null) {
       ...
       * Truncate the description.
           ...
           *
           * @see https://sourceforge.net/apps/trac/bigdata/ticket/613 (SPARQL UPDATE response
           *     inlines large DELETE or INSERT triple graphs)
