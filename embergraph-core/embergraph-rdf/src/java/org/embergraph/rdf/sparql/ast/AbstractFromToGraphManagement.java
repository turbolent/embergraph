...
public abstract class AbstractFromToGraphManagement extends GraphManagement {
   ...
   * @param anns
   */
  public AbstractFromToGraphManagement(final BOp[] args, final Map<String, Object> anns) {
  ...
  public void setSourceGraph(final ConstantNode sourceGraph) {
    ...
    if (sourceGraph == null) throw new IllegalArgumentException();
  ...
  public final String toString(final int indent) {
...

    {
      ...
      sb.append(" source=" + sourceGraph == null ? "default" : sourceGraph);
    }
