...
public abstract class ExplainHint implements IExplainHint {
   ...
   * make sure to include a respective subsection in the Wiki.
   */
  private final String LINK_BASE = "https://wiki.embergraph.org/wiki/index.php/Explain#";
  ...
  /** Constructor */
  public ExplainHint(
      final String explainHintDescription,
      final String explainHintType,
