...
public class ASTBase extends ModifiableBOpBase {
  ...
  public interface Annotations extends ModifiableBOpBase.Annotations {
     ...
     * node.
     *
     * <p>The relationship between SPARQL level query hints, the annotations on the {@link ASTBase}
     * and {@link PipelineOp} nodes is a bit complex, and this {@link Properties} object is a bit
     * complex. Briefly, this {@link Properties} object contains property values which will be
     * applied (copied) onto generated {@link PipelineOp}s while annotations on the {@link ASTBase}
     * nodes are interpreted by {@link IASTOptimizer} s and {@link AST2BOpUtility}. SPARQL level
     * query hints map into one or another of these things, or may directly set attributes on the
     * {@link AST2BOpContext}.
     *
   ...
   * @return The value of the query hint and <code>null</code> if the query hint is not defined.
   */
   ...
   *
   * @param name The name of the query hint.
   * @param defaultValue The default value to use if the query hint is not defined.
   * @return The value of the query hint and <i>defaultValue</i> if the query hint is not defined.
   */
  public String getQueryHint(final String name, final String defaultValue) {
    ...
    if (queryHints == null) return defaultValue;
   ...
   * @param defaultValue The default value to use if the query hint is not defined.
   */
  public boolean getQueryHintAsBoolean(final String name, final String defaultValue) {
   ...
   * @param defaultValue The default value to use if the query hint is not defined.
   */
  public boolean getQueryHintAsBoolean(final String name, final boolean defaultValue) {
   ...
   * @param defaultValue The default value to use if the query hint is not defined.
   */
  public Integer getQueryHintAsInteger(final String name, final Integer defaultValue) {
   ...
   * @param value The property value for the query hint.
   */
