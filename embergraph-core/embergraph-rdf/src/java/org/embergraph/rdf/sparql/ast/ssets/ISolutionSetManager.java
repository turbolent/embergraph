...
public interface ISolutionSetManager {
   ...
   * @return <code>true</code> iff a solution set by that name existed and was cleared.
   */
   ...
   *
   * @param solutionSet The name of the solution set.
   * @param params The configuration parameters (optional).
   * @throws RuntimeException if a solution set exists for that name.
   */
   ...
   * @throws IllegalStateException if no solution set with that name exists.
   */
   ...
   *
   * @param solutionSet The name of the solution set.
   * @return The statistics -or- <code>null</code> if there is no such named solution set.
   */
