 ...
 * @version $Id$
 */
public abstract class ValueExpressionListBaseNode<E extends IValueExpressionNode>
  ...
  //            return false;
  //
  //        final ValueExpressionListBaseNode<? extends IValueExpressionNode> t =
  // (ValueExpressionListBaseNode<?>) o;
  //
