 ...
 *     do not have any common ancestor other than {@link Object}.
...
public interface ServiceCall<E> {
   ...
   * same factory. This should be appropriate because the factory is specific to the service URI.
   * The only exception would be the {@link ServiceRegistry#getDefaultServiceFactory()}. Consider
   * replacing this with a back reference to the {@link ServiceFactory}.
   */
   ...
   *
   * @param bindingSets The binding sets flowing into the service.
   * @return An iterator from which the solutions can be drained. If the iterator is closed, the
   *     service invocation must be cancelled.
   * @throws Exception
   *     <p>TODO RECHUNKING: This should probably return an ICloseableIterator<IBindingSet[]> for
   *     consistent chunking across our access path abstractions. And maybe it could implement
   *     {@link IBindingSetAccessPath}.
   */
