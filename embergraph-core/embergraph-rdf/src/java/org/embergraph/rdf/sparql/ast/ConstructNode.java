...
public class ConstructNode extends AbstractStatementContainer<StatementPatternNode>
  ...
  public interface Annotations extends AbstractStatementContainer.Annotations {
     ...
     * applied.
     *
     * <p>Note: This can be set using either {@link QueryHints#ANALYTIC} or {@link
     ...
     *
     * <p>Note: This can only be set programmatically using {@link
     * ConstructNode#setDistinctQuads(boolean)}
     *
     * <p>Note: When this property is set and mixed quads are detected or suspected then the {@link
     * #NATIVE_DISTINCT} property is ignored.
     *
     * @see <a href="https://sourceforge.net/apps/trac/bigdata/ticket/579">CONSTRUCT should apply
     *     DISTINCT (s,p,o) filter </a>
     */
  ...
  @Override
  public IGroupNode<StatementPatternNode> addChild(final StatementPatternNode child) {

    if (!(child instanceof StatementPatternNode)) throw new UnsupportedOperationException();
  ...
  public boolean isNativeDistinct() {
    ...
    return getProperty(Annotations.NATIVE_DISTINCT, Annotations.DEFAULT_NATIVE_DISTINCT);
  }
  ...
  public boolean isDistinctQuads() {
    ...
    return getProperty(Annotations.DISTINCT_QUADS, Annotations.DEFAULT_DISTINCT_QUADS);
  }
  ...
  public String toString(final int indent) {
    ...
    if (isNativeDistinct()) sb.append(" [nativeDistinct]");
