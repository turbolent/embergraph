...
public class ASTConstructOptimizer implements IASTOptimizer {
  ...
  public QueryNodeWithBindingSet optimize(
    ...
    if (queryRoot.getProjection() == null) {
       ...
       * maintaining a DESCRIBE cache.
       *
       * <p>Note: We do NOT specify REDUCED if a query hint has been used to disable the DISTINCT
       * SPO semantics of the CONSTRUCT.
       *
       * @see <a href="https://jira.blazegraph.com/browse/BLZG-687">DESCRIBE CACHE </a>
       * @see <a href="https://jira.blazegraph.com/browse/BLZG-1341">Query hint to disable DISTINCT
       *     SPO semantics for CONSTRUCT </a>
       */
    ...
    // Add projected variables based on the CONSTRUCT template.
    {
      ...
      final Iterator<IVariable<?>> itr = BOpUtility.getSpannedVariables(constructNode);
