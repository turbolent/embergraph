...
public class SubqueryRoot extends SubqueryBase implements IJoinNode {
  ...
  public interface Annotations
     ...
     * <code>false</code>, the subquery will not be lifted unless other semantics require that it be
     * lifted out regardless.
     *
     ...
     *
     * <p>Note: This annotation is propagated to the {@link SubqueryRoot} when the FILTER (NOT)
     * EXISTS for a {@link SubqueryFunctionNodeBase} is turned into an ASK subquery.
     *
  ...
  public FilterExistsModeEnum getFilterExistsMode() {
    ...
    return getProperty(Annotations.FILTER_EXISTS, Annotations.DEFAULT_FILTER_EXISTS);
  }
