 ...
 * @version $Id: IRemoteSparqlQueryBuilder.java 6071 2012-03-04 18:08:57Z thompsonbry $
 */
public interface IRemoteSparqlQueryBuilder {
   ...
   *
   * @param bindingSets The solutions to flow into the remote SPARQL end point.
   * @return The query.
   */
