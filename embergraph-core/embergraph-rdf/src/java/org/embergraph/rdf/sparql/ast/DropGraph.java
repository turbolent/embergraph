...
public class DropGraph extends AbstractOneGraphManagement {
  ...
  public boolean isAllGraphs() {
    ...
    return getProperty(Annotations.ALL_GRAPHS, Annotations.DEFAULT_ALL_GRAPHS);
  }
  ...
  /** Return <code>true</code> IFF this operation should effect ALL SOLUTION SETS. */
  public boolean isAllSolutionSets() {

    return getProperty(Annotations.ALL_SOLUTION_SETS, Annotations.DEFAULT_ALL_SOLUTION_SETS);
  }
