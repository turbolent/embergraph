...
public class QuadData extends AbstractStatementContainer<IStatementContainer>
   ...
   * construct template.
   *
   * @param template The {@link ConstructNode} for the template.
   * @return The argument.
   *     <p>TODO Maybe we could just flatten this in UpdateExprBuilder?
   */
  public ConstructNode flatten(final ConstructNode template) {
    ...
    while (itr.hasNext()) {
      ...
      final StatementPatternNode sp = (StatementPatternNode) (itr.next().clone());
  ...
  public String toString(final int indent) {
    ...
    for (IStatementContainer v : this) {
      ...
      if (i >= 10) {
         ...
         *
         * @see https://sourceforge.net/apps/trac/bigdata/ticket/613 (SPARQL UPDATE response inlines
         *     large DELETE or INSERT triple graphs)
