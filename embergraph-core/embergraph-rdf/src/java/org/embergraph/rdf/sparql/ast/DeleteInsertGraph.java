...
public class DeleteInsertGraph extends GraphUpdate implements IGraphPatternContainer, IDataSetNode {
  ...
  interface Annotations
      extends GraphUpdate.Annotations,
   ...
   * is specific to the DELETE/INSERT operation to which it is attached (it is not inherited or
   * combined with the data set for later operations in a sequence).
   */
  @Override
  ...
  public void setWhereClause(final GraphPatternGroup<IGroupMemberNode> whereClause) {
