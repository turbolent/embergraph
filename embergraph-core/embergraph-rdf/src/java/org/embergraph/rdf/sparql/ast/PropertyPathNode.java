 ...
 */
public class PropertyPathNode extends GroupMemberNodeBase<PropertyPathNode>
   ...
   */
  public PropertyPathNode(final TermNode s, final PathNode p, final TermNode o) {
   ...
   * marked as {@link Scope#DEFAULT_CONTEXTS} if it is NOT embedded within a GRAPH clause and
   * otherwise as {@link Scope#NAMED_CONTEXTS}.
   *
   ...
   * @param p The property path (required).
   ...
   *     is <code>null</code>.
   */
  public PropertyPathNode(
      final TermNode s, final PathNode p, final TermNode o, final TermNode c, final Scope scope) {
