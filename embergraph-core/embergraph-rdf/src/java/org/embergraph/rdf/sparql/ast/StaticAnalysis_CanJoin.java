 ...
 *
 * <p>Note: This is a port of org.embergraph.bop.joinGraph.PartitionedJoinGroup
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id: StaticAnalysis_CanJoin.java 5378 2011-10-20 20:37:08Z thompsonbry $
 */
public abstract class StaticAnalysis_CanJoin extends StaticAnalysisBase {
   ...
   *
   * <p>Note: Use {@link StaticAnalysis#canJoin(IJoinNode, IJoinNode)} instead to identify joins
   * based on a variable which is directly shared.
   *
   * <p>Note: Any two predicates may join regardless of the presence of shared variables. However,
   * such joins will produce the full cross product of the binding sets selected by each predicate.
   * As such, they should be run last and this method will not return <code>true</code> for such
   ...
   *     </code>.
   */
  public boolean canJoinUsingConstraints(
      final IJoinNode[] path, final IJoinNode vertex, final FilterNode[] constraints) {
     ...
     */
    {
       ...
       * join path.
       */
      final FilterNode[][] constraintRunArray =
      ...
      if (joinGraphConstraints != null) {
        ...
        for (FilterNode c : joinGraphConstraints) {
          ...
          if (attach) {
            ...
            if (log.isDebugEnabled()) {
              log.debug(
                  "Constraint attached at index " + i + " of " + path.length + ", constraint=" + c);
            }
   ...
   *
   * <p>The class hierarchy is a little untidy at this point. This method is defined in the only
   * subclass of this abstract class. Initially it was thought to not be needed here.
   *
