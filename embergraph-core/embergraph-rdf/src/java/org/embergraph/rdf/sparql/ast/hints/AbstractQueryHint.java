...
public abstract class AbstractQueryHint<T> implements IQueryHint<T> {
   ...
   * <i>value</i> will be converted to a String.
   *
   * <p>Note: Unlike annotations, query hints are propagated en-mass from an AST node to the
   * generated pipeline operator.
   *
   * @param name The name of the query hint.
   * @param value The value for the query hint.
   */
  protected final void _setQueryHint(
      final IEvaluationContext ctx,
   ...
   * plan generation. Unlike the query hints, the annotations are not automatically transferred to
   * the generated pipeline operators. Instead, they typically control the behavior of the {@link
   * IASTOptimizer}s.
   *
   * @param op The AST node.
   * @param name The name of the annotation.
   * @param value The value of the annotation.
   */
  protected final void _setAnnotation(
      final IEvaluationContext ctx,
      final QueryHintScope scope,
      final ASTBase op,
      final String name,
