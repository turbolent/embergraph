 ...
 *
 * <p>Note: The embergraph SPARQL parser no longer produces this nested UNION construction. However,
 * it is possible that other SPARQL parsers or hand construction can still produce this nesting
 * pattern, in which case this optimizer will flatten out that pattern.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id: ASTFlattenUnionsOptimizer.java 5314 2011-10-12 12:51:13Z thompsonbry $
 */
  ...
  private static void flattenUnions(final GroupNodeBase<?> op) {
    ...
    if ((op instanceof UnionNode)) {
      ...
      for (int i = 0; i < op.arity(); i++) {
        ...
        if (directChild.arity() == 1 && directChild.get(0) instanceof UnionNode) {
          ...
          for (int j = 0; j < childUnion.arity(); j++) {
            ...
            final JoinGroupNode childToLift = (JoinGroupNode) childUnion.get(j);
