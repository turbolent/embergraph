 ...
 * @version $Id: RemoteSparqlQueryBuilder.java 6071 2012-03-04 18:08:57Z thompsonbry $
 */
public class RemoteSparql11QueryBuilder implements IRemoteSparqlQueryBuilder {
  ...
  public RemoteSparql11QueryBuilder(final ServiceNode serviceNode) {
    ...
    this.util =
        new AST2SPARQLUtil(prefixDecls) {
   ...
   * set.
   *
   * @param bindingSets The solution set.
   ...
   * @throws UnsupportedOperationException If there are correlated variables and there is more than
   *     one source solution (for this case you need to use the SPARQL 1.0 compatible query
   *     generator).
   * @see RemoteSparql10QueryBuilder
   */
  protected static Map<BNode, Set<String>> getCorrelatedVariables(final BindingSet[] bindingSets) {
    Map<BNode, Set<String /* vars */>> bnodes = null;
    for (BindingSet bindingSet : bindingSets) {
