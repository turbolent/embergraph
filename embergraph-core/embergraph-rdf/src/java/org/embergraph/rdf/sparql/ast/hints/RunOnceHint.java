 ...
 * hint must be used with {@link QueryHintScope#SubQuery}.
 *
 ...
 * </pre>
 *
 * <p>Note: This sets the {@link SubqueryRoot.Annotations#RUN_ONCE} AST annotation which is then
 * interpreted by the {@link ASTSparql11SubqueryOptimizer}.
 */
final class RunOnceHint extends AbstractBooleanQueryHint {
  ...
  public void handle(
    ...
    if (op instanceof SubqueryRoot) {
      ...
      _setAnnotation(context, scope, op, SubqueryRoot.Annotations.RUN_ONCE, value);
    }
  }
}
