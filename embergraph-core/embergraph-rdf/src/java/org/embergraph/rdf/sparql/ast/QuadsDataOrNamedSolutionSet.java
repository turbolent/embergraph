 ...
 * @version $Id: QuadsDataOrNamedSolutionSet.java 6196 2012-03-27 20:06:22Z thompsonbry $
 *     <p>TODO Rather than overriding this for two very different things (quads data and the name of
 *     a solution set) it might be better to relayer the AST model or just handle this via
 *     polymorphism in the {@link DeleteInsertGraph} AST node.
 */
public class QuadsDataOrNamedSolutionSet extends QueryNodeBase
    implements INamedSolutionSet, IProjectionDecl {
  ...
  public interface Annotations
    ...
    /** The {@link QuadData} (optional; when present this is modeling QUADS data). */
   ...
   * @param annotations
   */
  public QuadsDataOrNamedSolutionSet(final BOp[] args, final Map<String, Object> annotations) {
  ...
  /** Return <code>true</code> iff this models QUADS data (rather than named solutions) */
  ...
  /*
   * Return <code>true</code> iff this models a reference to some named solutions (rather than QUADS
   * data).
   */
