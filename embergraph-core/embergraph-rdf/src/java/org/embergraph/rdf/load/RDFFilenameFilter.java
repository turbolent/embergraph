 ...
 * so that it will be performed on the machine where this filter is being used.
 */
public class RDFFilenameFilter implements FilenameFilter, Serializable {
  ...
  /*
   * Force the load of the NxParser integration class and its registration of the
   * NQuadsParser#nquads RDFFormat.
   *
  ...
  public boolean accept(final File dir, final String name) {
    ...
    if (name.endsWith(".zip")) {
      ...
      // recognizable as gzip'd RDF.
      return RDFFormat.forFileName(s) != null;
    }
