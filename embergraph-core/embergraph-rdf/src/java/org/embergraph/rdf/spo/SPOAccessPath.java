...
//     * Strengthened return type.
   ...
   * retract justifications having no support once the statements visitable by this access path have
   * been retracted.
   */
  @Override
...
//     * Return a new {@link SPOAccessPath} where the given positions have been bound to the
  ...
  //     * <p>
  //     * Note: The added constraints may mean that a different index provides more efficient
  // traversal. For scale-out, this means that the data may be on
  //     * different index partition.
  //     *
  //     * @param values
