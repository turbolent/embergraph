...
public class StatementWriter implements Callable<Long> {
  ...
  public StatementWriter(
    ...
    this(database, statementStore, copyOnly, itr, nwritten, null /* changeLog */);
  }
  ...
  public StatementWriter(
    ...
    if (nwritten == null) throw new IllegalArgumentException();
  ...
  public Long call() throws Exception {
    ...
    if (changeLog == null) {
      ...
      n = database.addStatements(statementStore, copyOnly, itr, null /* filter */);

    } else {

      n =
          org.embergraph.rdf.changesets.StatementWriter.addStatements(
              database, statementStore, copyOnly, null /* filter */, itr, changeLog);
    }
