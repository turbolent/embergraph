 ...
 * @version $Id: EmbergraphOpenRDFBindingSetsResolverator.java 6151 2012-03-16
...
public class EmbergraphOpenRDFBindingSetsResolverator
    ...
    final private static Logger log = Logger
            .getLogger(EmbergraphOpenRDFBindingSetsResolverator.class);
     ...
     */
    public EmbergraphOpenRDFBindingSetsResolverator(final AbstractTripleStore db,
     ...
     */
    public EmbergraphOpenRDFBindingSetsResolverator start(
...
//        final LexiconRelation r = state.getLexiconRelation();
     ...
     * resolved to their corresponding {@link EmbergraphValue}s.
     * 
     * @param solution
    ...
    static private IBindingSet getBindingSet(final BindingSet bindingSet,
            final Map<Value, EmbergraphValue> map) {
