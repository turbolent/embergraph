...
public class EmbergraphTriplePatternMaterializer
        extends
        AbstractChunkedResolverator<EmbergraphTriplePattern, ISPO, AbstractTripleStore>
        implements ICloseableIterator<ISPO> {
//        implements IChunkedOrderedIterator<ISPO> {

    private final int nthreads;
    
    public EmbergraphTriplePatternMaterializer(final AbstractTripleStore db,
    ...
    private class ResolveTriplePatternTask implements Callable<Long> {
        ...
        public ResolveTriplePatternTask(final EmbergraphTriplePattern stmt,
...
//                    }
                     ...
                     *      Deadlock in EmbergraphTriplePatternMaterializer </a>
                     */
