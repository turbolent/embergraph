...
public class EmbergraphSubjectCentricFullTextIndex extends FullTextIndex implements
    ...
    final private static transient Logger log = Logger
            .getLogger(EmbergraphSubjectCentricFullTextIndex.class);
    ...
    static public EmbergraphSubjectCentricFullTextIndex getInstance(
        ...
        return new EmbergraphSubjectCentricFullTextIndex(indexManager, namespace, timestamp,
                properties);
     ...
     * @param properties
     */
    public EmbergraphSubjectCentricFullTextIndex(final IIndexManager indexManager,
