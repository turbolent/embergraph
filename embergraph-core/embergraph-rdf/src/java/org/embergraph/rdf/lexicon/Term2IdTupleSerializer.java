 ...
 * @version $Id: Term2IdTupleSerializer.java 4818 2011-06-29 20:01:56Z thompsonbry $
 */
public class Term2IdTupleSerializer extends DefaultTupleSerializer {
  ...
  public Term2IdTupleSerializer(final IKeyBuilderFactory keyBuilderFactory) {
    ...
    super(
        ...
        IVUtility.PACK_TIDS
            ? new org.embergraph.btree.raba.codec.SimpleRabaCoder()
            : new org.embergraph.btree.raba.codec.FixedLengthValueRabaCoder(9));
  }
