...
/**
 * Places {@link KVO}s containing {@link EmbergraphValue} references into an
...
public class KVOTermIdComparator implements Comparator<KVO<EmbergraphValue>> {
    ...
    public static final transient Comparator<KVO<EmbergraphValue>> INSTANCE = new KVOTermIdComparator();

    /**
     * Note: defers to natural ordering for {@link IV} objects.
     */
    public int compare(final KVO<EmbergraphValue> term1,
            final KVO<EmbergraphValue> term2) {
