 ...
 * must handle comparisons when the value is not an IV, e.g., using {@link IVComparator}.
 *
 * @author thompsonbry
...
public class MAX extends AggregateBase<IV> implements INeedsMaterialization {
   ...
   *
   * <p>Note: This field is guarded by the monitor on the {@link MAX} instance.
   */
  ...
  /**
   * Note: {@link MAX} only works on pretty much anything and uses the same semantics as {@link
