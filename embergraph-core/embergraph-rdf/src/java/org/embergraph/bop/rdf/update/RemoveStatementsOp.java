...
/*
 * Vectored remove operator for RDF Statements. The solutions flowing through this operator MUST
...
public final class RemoveStatementsOp extends AbstractAddRemoveStatementsOp {
  ...
  public RemoveStatementsOp(final BOp[] args, final Map<String, Object> annotations) {
  ...
  private static class ChunkTask implements Callable<Void> {
    ...
    public ChunkTask(final BOpContext<IBindingSet> context, final RemoveStatementsOp op) {
    ...
    public Void call() {
      ...
      final long nmodified = tripleStore.removeStatements(stmts, stmts.length);
