...
public abstract class AbstractAddRemoveStatementsOp extends PipelineOp {
   ...
   * @param annotations
   */
  public AbstractAddRemoveStatementsOp(final BOp[] args, final Map<String, Object> annotations) {
   ...
   * @param bindsC <code>true</code> if the graph variable should be bound in the statements (SIDs
   *     or QUADs).
   ...
   * @param bindsC if the context position should be bound.
   * @param type The {@link StatementEnum}.
   * @return The {@link ISPO}.
   */
  protected static ISPO getSPO(
      final IBindingSet bset, final boolean bindsC, final StatementEnum type) {
