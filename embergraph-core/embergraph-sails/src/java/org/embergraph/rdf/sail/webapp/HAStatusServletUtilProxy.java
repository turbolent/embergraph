...
public class HAStatusServletUtilProxy {
  ...
  private static final String DEFAULT_PROVIDER =
      "org.embergraph.rdf.sail.webapp.HAStatusServletUtil";

  private static final String WITHOUT_JINI_MSG =
      "Running without the embergraph-jini package.  See BLZG-1370.";
   ...
   * <ol>
   *   <li>QuorumState
   *   <li>Who is the leader, who is a follower.
   *   <li>What is the SPARQL end point for each leader and follower.
   *   <li>Dump of the zookeeper state related to the quorum.
   *   <li>listServices (into pre element).
   * </ol>
   *
   * @throws IOException
   */
