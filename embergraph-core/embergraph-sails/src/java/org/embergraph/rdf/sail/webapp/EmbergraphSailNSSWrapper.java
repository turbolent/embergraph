...
public class EmbergraphSailNSSWrapper {

  private static final transient Logger log = Logger.getLogger(EmbergraphSailNSSWrapper.class);
  ...
  public EmbergraphSailNSSWrapper(final EmbergraphSail sail) {
    this.sail = sail;
  }
  ...
  public void init() throws Exception {
    ...
    m_fixture = NanoSparqlServer.newInstance(0 /* port */, getSail().getIndexManager(), initParams);
    ...
    m_repo =
        new RemoteRepositoryManager(
            m_serviceURL, m_httpClient, getSail().getIndexManager().getExecutorService());
  }
  ...
  public void shutdown() throws Exception {
    ...
    if (log.isDebugEnabled()) log.debug("Stopping", new StackInfoReport("Stopping HTTPClient"));
  ...
  /** The backing {@link EmbergraphSail} instance. */
