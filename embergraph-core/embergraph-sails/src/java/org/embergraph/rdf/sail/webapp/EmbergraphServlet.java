 ...
 * any service action/
 */
abstract public class EmbergraphServlet extends HttpServlet implements IMimeTypes {
     ...
     * {@link EmbergraphRDFContext}.
     */
    static public final transient String ATTRIBUTE_RDF_CONTEXT = EmbergraphRDFContext.class
            .getName();
...
//    /* package */static final transient String ATTRIBUTE_SPARQL_CACHE = SparqlCache.class.getName();
     ...
     */
    static public final String HTTP_HEADER_EMBERGRAPH_READ_ONLY = "X-EMBERGRAPH-READ-ONLY";
...
//		HTTP_FORBIDDEN = HttpServletResponse.SC_FORBIDDEN,
    ...
    static final EmbergraphRDFContext getEmbergraphRDFContext(
            final ServletContext servletContext) {
...
//    private volatile EmbergraphRDFContext m_context;
   ...
   protected <T> FutureTask<T> submitApiTask(final AbstractRestApiTask<T> task)
    ...
    static boolean isWritable(final ServletContext servletContext,
        ...
        if (req.getHeader(HTTP_HEADER_EMBERGRAPH_READ_ONLY) != null || getConfig(servletContext).readOnly) {
