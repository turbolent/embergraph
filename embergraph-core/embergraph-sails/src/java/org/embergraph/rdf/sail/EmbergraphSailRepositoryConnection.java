...
public class EmbergraphSailRepositoryConnection extends SailRepositoryConnection {
	...
	private static transient final Logger log = Logger
			.getLogger(EmbergraphSailRepositoryConnection.class);
    ...
    public EmbergraphSailRepositoryConnection(EmbergraphSailRepository repository,
    ...
    *      {@link EmbergraphSailConnection#hasStatement(Resource, URI, Value, boolean, Resource...)}
...
//      }
    ...
    @Override
    public EmbergraphSailGraphQuery prepareGraphQuery(final QueryLanguage ql,
    ...
    @Override
	public EmbergraphSailTupleQuery prepareTupleQuery(final QueryLanguage ql,
			final String qs, final String baseURI)
			throws MalformedQueryException {
    ...
    @Override
	public EmbergraphSailBooleanQuery prepareBooleanQuery(final QueryLanguage ql,
			final String qs, final String baseURI)
			throws MalformedQueryException {
     ...
     */
    public EmbergraphSailQuery prepareNativeSPARQLQuery(final QueryLanguage ql,
     ...
     */
    public EmbergraphSailUpdate prepareNativeSPARQLUpdate(final QueryLanguage ql,
    ...
    public long commit2() throws RepositoryException {
        ...
        if (isAutoCommit() && 
            !((EmbergraphSailConnection) getSailConnection()).getAllowAutoCommit()) {
...
//            sailConnection.commit();
    ...
    /**
     * Flush the statement buffers. The {@link EmbergraphSailConnection} heavily
     ...
     * The public methods on the {@link EmbergraphSailConnection} all flush the
    ...
    public void removeAllEntailments() throws SailException,
        ...
        try {
            ...
            ((EmbergraphSailConnection) getSailConnection())
