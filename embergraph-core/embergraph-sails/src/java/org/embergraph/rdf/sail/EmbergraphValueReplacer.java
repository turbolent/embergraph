...
public class EmbergraphValueReplacer {
    ...
    private final static Logger log = Logger
            .getLogger(EmbergraphValueReplacer.class);
     ...
     * or in the {@link Dataset} with {@link EmbergraphValue} objects, which have
     ...
     * {@link EmbergraphValue}s. If any value does not exist in the lexicon then
