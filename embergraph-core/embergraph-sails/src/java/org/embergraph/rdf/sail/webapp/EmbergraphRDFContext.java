...
public class EmbergraphRDFContext extends EmbergraphBaseContext {
    ...
    static private final transient Logger log = Logger
            .getLogger(EmbergraphRDFContext.class);
     ...
     * @see #XSL_STYLESHEET
     */
    protected static final String DEFAULT_XSL_STYLESHEET = EmbergraphStatics
    ...
    */
     ...
     */
    static public final String HTTP_HEADER_EMBERGRAPH_MAX_QUERY_MILLIS = "X-EMBERGRAPH-MAX-QUERY-MILLIS";
     ...
     * The {@link #HTTP_HEADER_EMBERGRAPH_MAX_QUERY_MILLIS} and the
    ...
    static class TaskAndFutureTask<T> {
         ...
         */
         ...
         /**
 		 * Convenience method to return org.embergraph.rdf.sail.model.RunningQuery from a EmbergraphRDFContext
 		 * running query. 
 		 * 
    ...
    public EmbergraphRDFContext(final SparqlEndpointConfig config,
...
//        final AtomicLong beginTime = new AtomicLong();
        ...
        /**
         * The parsed query. It will be one of the {@link EmbergraphSailQuery}
         * implementations or {@link EmbergraphSailUpdate}. They all extend
...
//                final String fileExt,
         ...
         * <ul>
         * <li>{@value EmbergraphRDFContext#DEFAULT_GRAPH_URI}</li>
         * <li>{@value EmbergraphRDFContext#NAMED_GRAPH_URI}</li>
         * <li>{@value EmbergraphRDFContext#USING_GRAPH_URI}</li>
         * <li>{@value EmbergraphRDFContext#USING_NAMED_GRAPH_URI}</li>
         * </ul>
        ...
        final AbstractQuery setupQuery(final EmbergraphSailRepositoryConnection cxn) {
            ...
            final UUID queryId2 = setQueryId(((EmbergraphSailQuery) query)
                    .getASTContainer());
         ...
         *            The connection.
         */
        final EmbergraphSailUpdate setupUpdate(
                final EmbergraphSailRepositoryConnection cxn) {

            // Note the begin time for the query.
            final long begin =  System.nanoTime();
            
            final EmbergraphSailUpdate update = new EmbergraphSailUpdate(astContainer,
                    cxn);

            // Figure out the UUID under which the query will execute.
            final UUID queryId2 = setQueryId(((EmbergraphSailUpdate) update)
                    .getASTContainer());
...
//                    .getQueryType();
         ...
         * @throws Exception
         */
        abstract protected void doQuery(EmbergraphSailRepositoryConnection cxn,
...
//                        success = true;
    ...
    private class AskQueryTask extends AbstractQueryTask {
        ...
        public AskQueryTask(final EmbergraphSailRepositoryConnection cxn,
        ...
        @Override
        protected void doQuery(final EmbergraphSailRepositoryConnection cxn,
    ...
    private class TupleQueryTask extends AbstractQueryTask {
        ...
        public TupleQueryTask(final EmbergraphSailRepositoryConnection cxn,
        		final String namespace, final long timestamp,
                final String baseURI, final boolean includeInferred,
                final Map<String, Value> bindings,
                final ASTContainer astContainer,
    ...
    private class GraphQueryTask extends AbstractQueryTask {
        ...
        public GraphQueryTask(final EmbergraphSailRepositoryConnection cxn,
                final String namespace, final long timestamp,
                final String baseURI, final boolean includeInferred,
                final Map<String, Value> bindings,
                final ASTContainer astContainer,
	...
	UpdateTask getUpdateTask(final EmbergraphSailRepositoryConnection cxn,
    ...
    class UpdateTask extends AbstractQueryTask {
        ...
        public UpdateTask(final EmbergraphSailRepositoryConnection cxn,
        		final String namespace, final long timestamp,
...
//    }
	 ...
	 * {@link EmbergraphSailConnection} for what would otherwise amount to dirty
	 * reads. This is especially critical for reads on the global row store
	 * since it can not be protected by the {@link EmbergraphSailConnection} for
   ...
   public void commitTx(final long tx) {
	 ...
	 * {@link EmbergraphBaseContext#HTTP_HEADER_BIGDATA_MAX_QUERY_MILLIS} or
	 * via one of the request parameters 
	 * {@link EmbergraphBaseContext#MAX_QUERY_TIME_MILLIS} or
	 * {@link EmbergraphBaseContext#TIMEOUT}
