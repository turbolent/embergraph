...
public interface IHALoadBalancerPolicy extends IHAPolicyLifeCycle {
   ...
   *
   * @param isLeaderRequest <code>true</code> iff this request must be directed to the leaeder and
   *     <code>false</code> iff this request may be load balanced over the joined services. UPDATEs
   *     MUST be handled by the leader. Read requests can be handled by any service that is joined
   *     with the met quorum.
   * @param servlet The {@link HALoadBalancerServlet}. This is exposed in order to allow the {@link
   *     IHALoadBalancerPolicy} to perform a local forward of the request.
   ...
   * @return The proxyTo Request-URI -or- <code>null</code> if we could not find a service to which
   *     we could proxy this request.
   */
