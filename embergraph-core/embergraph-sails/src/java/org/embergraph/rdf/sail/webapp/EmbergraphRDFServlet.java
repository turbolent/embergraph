 ...
 */
abstract public class EmbergraphRDFServlet extends EmbergraphServlet {
    ...
    static private final transient Logger log = Logger.getLogger(EmbergraphRDFServlet.class);
  ...
  static protected void buildAndCommitBooleanResponse(
    ...
    static public void sendGraph(final HttpServletRequest req,
		...
		final String acceptStr = ConnegUtil.getMimeTypeForQueryParameterQueryRequest(req
				.getParameter(EmbergraphRDFServlet.OUTPUT_FORMAT_QUERY_PARAMETER),
