 ...
 * @version $Id: Embergraph2Sesame2BindingSetIterator.java 5021 2011-08-04
 *          15:44:21Z thompsonbry $
 * @param <E>
 *            The generic type of the thrown exception.
 */
public class Embergraph2Sesame2BindingSetIterator implements
        CloseableIteration<BindingSet, QueryEvaluationException> {

    final protected static Logger log = Logger
            .getLogger(Embergraph2Sesame2BindingSetIterator.class);
     ...
     *            MUST be either (a) {@link EmbergraphValue}s -or- (b) {@link IV}s
     *            having a cached {@link EmbergraphValue}.
     */
     ...
     *      Embergraph2Sesame2BindingSetIterator throws QueryEvaluationException
...
//        }
     ...
     *             if a bound value is not a {@link EmbergraphValue}.
     */
