 ...
 * @version $Id: Embergraph2Sesame2BindingSetIterator.java 5021 2011-08-04 15:44:21Z thompsonbry $
 * @param <E> The generic type of the thrown exception.
 */
public class Embergraph2Sesame2BindingSetIterator
    implements CloseableIteration<BindingSet, QueryEvaluationException> {

  protected static final Logger log = Logger.getLogger(Embergraph2Sesame2BindingSetIterator.class);
   ...
   */
  public Embergraph2Sesame2BindingSetIterator(final ICloseableIterator<IBindingSet> src) {
   ...
   * @param constants Optional constants to be united with the output solutions.
   */
  public Embergraph2Sesame2BindingSetIterator(
      final ICloseableIterator<IBindingSet> src, final BindingSet constants) {
   ...
   *     Embergraph2Sesame2BindingSetIterator throws QueryEvaluationException were it should throw
  ...
  public boolean hasNext() throws QueryEvaluationException {
    ...
    try {
       ...
       * The iterator was concurrently closed. This often means that the connection guarding the
         ...
         * triggered by reading against a commit point that had since been recycled.
         *
         * <p>Note: The logic to fetch the next result was moved into hasNext() in order to avoid
         * doing any work in next(). Thus, if there is any problem resolving the next chunk of
         * solutions, hasNext() will report [false] if the iterator was concurrently closed and
         * otherwise will throw out the exception.
         *
         * @see <a href="https://sourceforge.net/apps/trac/bigdata/ticket/644" >
         *     Embergraph2Sesame2BindingSetIterator can fail to notice asynchronous close() </a>
         */
        return false;
      }
...
//                 * The iterator was concurrently closed. This often means that
    ...
    //                 *      > Embergraph2Sesame2BindingSetIterator can fail to notice
   ...
   * @throws ClassCastException if a bound value is not a {@link EmbergraphValue}.
   */
  ...
  private BindingSet getBindingSet(final IBindingSet src) {
    ...
    while (itr.hasNext()) {
       ...
       * The bound value is an IV. The IV MUST have the EmbergraphValue
        ...
        // Otherwise the bound value must be a EmbergraphValue.
        value = (EmbergraphValue) val;
      }
