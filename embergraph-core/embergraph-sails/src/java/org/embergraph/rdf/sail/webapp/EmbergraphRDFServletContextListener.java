 ...
 */
public class EmbergraphRDFServletContextListener implements
        ServletContextListener {

    private static final transient Logger log = Logger
            .getLogger(EmbergraphRDFServletContextListener.class);
...
//    private SparqlCache sparqlCache;
     ...
     * {@link EmbergraphRDFServletContextListener#INIT_PARAM_OVERRIDES} attributes.
     */
     ...
     * {@link EmbergraphRDFServletContextListener#contextInitialized(javax.servlet.ServletContextEvent)}
     * .
     */
    ...
    public void contextInitialized(final ServletContextEvent e) {
         ...
         */
        {
             ...
             */
            {
                ...
                final Map<String, String> initParamOverrides = (Map<String, String>) context
                        .getAttribute(EmbergraphRDFServletContextListener.INIT_PARAM_OVERRIDES);
      ...
      if (create) {
         ...
         if (indexManager instanceof IEmbergraphFederation) {
            ...
            properties = ((IEmbergraphFederation<?>) indexManager).getClient()
                  .getProperties();
         } else {
...
//        }
    ...
    private IIndexManager openIndexManager(final String propertyFile) {
        ...
        if (new File(propertyFile).exists()) {
            ...
            // Check the classpath.
            propertyFileUrl = EmbergraphRDFServletContextListener.class
    ...
    private static class NanoSparqlServerFederationDelegate<T> extends
        ...
        final private IEmbergraphClient<?> client;
        final private EmbergraphRDFServletContextListener servletContextListener;
        ...
        public NanoSparqlServerFederationDelegate(final IEmbergraphClient<?> client,
