...
public class EmbergraphSailHelper {
     ...
     * @return The SAIL.
     */
    public EmbergraphSail getSail(final IEmbergraphFederation<?> fed,
     ...
     * @return The SAIL.
     */
    public EmbergraphSail getSail(final String filename, final String namespace,
     ...
     *       people to configure a {@link EmbergraphSail} and make that a command
...
//        properties.setProperty(Options.TEXT_INDEX, "false");
     ...
     * backing the {@link EmbergraphSail}.
     * 
     * @param sail
     *            The sail.
     *            
     ...
     * 
     * @param indexManager
     *            Use {@link EmbergraphSail#getDatabase()} and then
     ...
     */
    public Properties setProperties(final EmbergraphSail sail,
