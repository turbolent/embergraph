...
/**
 * Class extends {@link ParsedQuery} for API compliance with {@link QueryParser} but DOES NOT
 ...
 * EmbergraphParsedQuery}. Embergraph uses an entirely different model to represent the parsed
 ...
 * @openrdf
 */
public class EmbergraphParsedQuery extends ParsedQuery {

  private final ASTContainer astContainer;

  /** */
  public EmbergraphParsedQuery(final ASTContainer astContainer) {

    this.astContainer = astContainer;
  }

  /** Unsupported operation. */
  public EmbergraphParsedQuery(TupleExpr tupleExpr) {
    throw new UnsupportedOperationException();
  }

  /** Unsupported operation. */
  public EmbergraphParsedQuery(TupleExpr tupleExpr, Dataset dataset) {
    throw new UnsupportedOperationException();
  }
