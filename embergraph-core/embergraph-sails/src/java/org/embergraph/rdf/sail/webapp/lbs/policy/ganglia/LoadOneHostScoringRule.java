 ...
 * @see <a href="http://en.wikipedia.org/wiki/Load_%28computing%29#Unix-style_load_calculation" >
...
public class LoadOneHostScoringRule implements IHostScoringRule {
  ...
  public double getScore(final IHostMetrics metrics) {
    ...
    /** Note: A fallback value of 1.0 implies that the system is at 100% load. */
