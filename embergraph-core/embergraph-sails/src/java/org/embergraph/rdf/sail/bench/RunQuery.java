...
public class RunQuery {
   ...
   * </pre>
   *
   * to specify the name of the journal file if it is not specified in the propertyFile.
   *
   * @param args (-namespace namespace|-f file) propertyFile
   */
  public static void main(String[] args) {
    try {
      ...
      if (namespace != null) properties.setProperty(EmbergraphSail.Options.NAMESPACE, namespace);
        ...
        try {
          ...
          try {
            ...
            while (result.hasNext()) {
              ...
              if (log.isInfoEnabled()) log.info(bset);
