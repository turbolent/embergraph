 ...
 * containers for indices, including an {@link IRelation} and an {@link IDatabase}, which is
 * essentially a container for {@link IRelation}s.
 *
 * <p>Note: a locator does not proxy for a resource. Either the resource is locally accessible,
 * including the case of a resource distributed across a federation, or it is not since the resource
 * is accessible using the {@link IEmbergraphFederation}'s API. However, you CAN NOT "locate" a
 * <em>local</em> resource on another JVM or machine using this interface.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 * @param <T> The generic [T]ype of the resource.
 */
public interface IResourceLocator<T extends ILocatableResource> {
   ...
   * visible, thus defeating the abort semantics.
   *
   * @param instance The instance whose cached references should be discarded.
   * @param destroyed <code>true</code> iff the resource was destroyed, in which case the
