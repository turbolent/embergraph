 ...
 * @deprecated This is not currently supported. It was implemented, but we did not find improved
 *     performance for it.
 */
public interface IStarJoin<E> extends IPredicate<E> {
   ...
   *
   * @param constraint the star constraint
   */
   ...
   *
   * @return the star constraints iterator
   */
   ...
   *
   * @return the star constraints' variables iterator
   */
  Iterator<IVariable> getConstraintVariables();

  /*
   * A star constraint specifies the shape of the star join. Star constraints will determine whether
  ...
  interface IStarConstraint<E> {
     ...
     *
     * @param bindingSet the binding set from which to pull variable bindings
     * @return the as-bound version of this star constraint
     */
    ...
    /*
     * Adds variable bindings to the supplied binding set based on the as-bound values of the
     * supplied element.
     *
     * @param bs the binding set to modify
     * @param e the element from which to pull variable bindings
     */
