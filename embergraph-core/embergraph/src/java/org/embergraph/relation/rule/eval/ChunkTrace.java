 ...
 * </pre>
 *
 * where <code>n</code> is the evaluation order of the predicate and <code>m</code> is the #of
...
public class ChunkTrace {
   ...
   *
   * <p>Note: This is static so that it will count for all concurrent {@link JoinTask} for some
   * {@link JoinMasterTask}, at least those running in the same JVM.
   */
