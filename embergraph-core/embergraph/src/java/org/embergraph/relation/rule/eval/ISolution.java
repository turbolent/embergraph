 ...
 * behavior of its {@link IJoinNexus#newSolution(IRule, IBindingSet)} implementation.
 *
 * <p>Note: The {@link IBindingSet} is useful both for high-level query and to materialize the
 * justifications for the entailments. The RDF DB uses this for to maintain a justifications index
 * in support of truth maintenance.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 * @param <E> The generic type of elements materialized from the head of the rule.
 */
