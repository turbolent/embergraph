...
public final class ResourceLockService implements IResourceLockService {
  ...
  @Override
  public IResourceLock acquireLock(final String namespace, final long timeout)
      throws InterruptedException, TimeoutException {

    final Lock lock = locks.acquireLock(namespace, timeout, TimeUnit.MILLISECONDS);
  ...
  private static final class ResourceLock implements IResourceLock {
    ...
    /** @param lock The lock (must have been acquired by the caller). */
