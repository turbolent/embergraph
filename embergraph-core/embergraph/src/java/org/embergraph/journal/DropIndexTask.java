 ...
 * However, unisolated writers that execute after the index has been dropped will NOT be able to see
 * the index.
 *
...
public class DropIndexTask extends AbstractTask<Boolean> {
  ...
  public DropIndexTask(final IConcurrencyManager concurrencyManager, final String name) {
   ...
   *     time that this task executed and therefore was dropped. <code>false</code> is returned iff
