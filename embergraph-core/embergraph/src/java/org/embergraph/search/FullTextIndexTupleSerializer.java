 ...
 * @version $Id: FullTextIndexTupleSerializer.java 4702 2011-06-13 16:25:38Z thompsonbry $
 */
public class FullTextIndexTupleSerializer<V extends Comparable<V>>
  ...
  protected ITermDocKey<V> deserialize(final ITuple tuple, final boolean keyOnly) {
    ...
    final int fieldId;
    if (fieldsEnabled) {
      fieldId = KeyBuilder.decodeShort(kbuf.array(), kbuf.limit() - Bytes.SIZEOF_INT);
    } else {
      fieldId = -1;
    }
