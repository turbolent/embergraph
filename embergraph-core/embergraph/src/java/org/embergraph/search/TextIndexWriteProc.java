...
public class TextIndexWriteProc extends AbstractKeyArrayIndexProcedure<Long>
  ...
  public static class IndexWriteProcConstructor
    ...
    public static TextIndexWriteProc.IndexWriteProcConstructor NO_OVERWRITE =
        new IndexWriteProcConstructor(false);
    ...
    @Override
    public TextIndexWriteProc newInstance(
      ...
      return new TextIndexWriteProc(keySer, valSer, fromIndex, toIndex, keys, vals, overwrite);
    }
  }
  ...
  /** @return The #of pre-existing tuples that were updated as an {@link Integer}. */
  @Override
