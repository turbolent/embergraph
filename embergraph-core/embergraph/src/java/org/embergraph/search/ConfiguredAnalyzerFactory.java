 ...
 * stop words are not supported or not required).
 *
 * <p>If there is no entry for the language tag in the map {@link
 * ConfiguredAnalyzerFactory#langTag2AnalyzerPair}, then one is created, by walking down the array
 * {@link ConfiguredAnalyzerFactory#config} of AnalyzerPairs until a matching one is found.
 *
