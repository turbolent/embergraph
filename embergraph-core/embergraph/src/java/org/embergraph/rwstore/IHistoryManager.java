...
public interface IHistoryManager {
   ...
   *
   * <p>Writes the content of currentTxnFreeList to the store.
   *
   * <p>These are the current buffered frees that have yet been saved into a block referenced from
   * the deferredFreeList
   *
   ...
   *
   * <p>Note: It is not safe to clear at the point of the delete request since the data could still
   * be loaded if the data is retained for a period due to a non-zero retention period or session
   * protection.
   *
