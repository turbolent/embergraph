 ...
 * <p>*
 *
 * <p>If you define additional files that are stored within the {@link ResourceManager#getDataDir()}
 * then you SHOULD subclass {@link ResourceFileFilter} to recognize those files and override {@link
 * ResourceManager#newFileFilter()} method to return your {@link ResourceFileFilter} subclass.
 *
...
public class ResourceFileFilter implements FileFilter {
   ...
   * @return <code>true</code> iff the file should be accepted by the filter.
   */
  ...
  public final boolean accept(File f) {
    ...
    if (f.isDirectory()) {
      ...
      if (!fc.startsWith(resourceManager.getDataDir().getPath())) {
        ...
        throw new RuntimeException(
            "File not in data directory: file=" + f + ", dataDir=" + resourceManager.dataDir);
      }
    ...
    if (log.isInfoEnabled()) log.info("Unknown file: " + f);
