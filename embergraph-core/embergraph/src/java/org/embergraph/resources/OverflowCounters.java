...
public class OverflowCounters implements Serializable {
  ...
  public void add(final OverflowCounters c) {
    ...
    synchronousOverflowCounter.addAndGet(c.synchronousOverflowCounter.get());

    synchronousOverflowMillis.addAndGet(c.synchronousOverflowMillis.get());

    asynchronousOverflowStartMillis.addAndGet(c.asynchronousOverflowStartMillis.get());

    asynchronousOverflowCounter.addAndGet(c.asynchronousOverflowCounter.get());

    asynchronousOverflowMillis.addAndGet(c.asynchronousOverflowMillis.get());

    asynchronousOverflowFailedCounter.addAndGet(c.asynchronousOverflowFailedCounter.get());

    asynchronousOverflowTaskFailedCounter.addAndGet(c.asynchronousOverflowTaskFailedCounter.get());

    asynchronousOverflowTaskCancelledCounter.addAndGet(
        c.asynchronousOverflowTaskCancelledCounter.get());

    indexPartitionBuildCounter.addAndGet(c.indexPartitionBuildCounter.get());

    indexPartitionMergeCounter.addAndGet(c.indexPartitionMergeCounter.get());

    indexPartitionSplitCounter.addAndGet(c.indexPartitionSplitCounter.get());

    indexPartitionTailSplitCounter.addAndGet(c.indexPartitionTailSplitCounter.get());
    ...
    indexPartitionReceiveCounter.addAndGet(c.indexPartitionReceiveCounter.get());
  }
  ...
  public CounterSet getCounters() {
    ...
    tmp.addCounter(
        ...
        new Instrument<Long>() {
          public void sample() {
            setValue(asynchronousOverflowTaskCancelledCounter.get());
          }
        });

    {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.BuildCount,
          new Instrument<Long>() {
            public void sample() {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.MergeCount,
          new Instrument<Long>() {
            public void sample() {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.SplitCount,
          new Instrument<Long>() {
            public void sample() {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.TailSplitCount,
          new Instrument<Long>() {
            public void sample() {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.JoinCount,
          new Instrument<Long>() {
            public void sample() {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.MoveCount,
          new Instrument<Long>() {
            public void sample() {
      ...
      tmp2.addCounter(
          IIndexPartitionTaskCounters.ReceiveCount,
          new Instrument<Long>() {
            public void sample() {
