...
public class CSet {
   ...
   * {@link ICounter}.
   *
   * @param cats An ordered set of category values.
   * @param counter A counter from whose {@link ICounterNode#getPath()} the category values were
   *     extracted as capturing groups.
   */
  public CSet(final String[] cats, final ICounter counter) {

    if (cats == null) throw new IllegalArgumentException();
