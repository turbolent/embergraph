...
public class TabDelimitedHistoryTableRenderer extends HistoryTableRenderer {
   ...
   * @param formatter
   */
  public TabDelimitedHistoryTableRenderer(
      HistoryTable tbl, Pattern pattern, ValueFormatter formatter) {
   ...
   * table has the counter path. The seconds header row has just the counter name. The data rows are
   * the samples from each period of the history for each counter.
   */
