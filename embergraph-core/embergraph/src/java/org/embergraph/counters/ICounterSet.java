...
public interface ICounterSet extends ICounterNode {
   ...
   *
   * @param filter An optional regular expression that will be applied to {@link ICounter#getPath()}
   ...
   * @param instrumentFactory Used to create counters on an as needed basis.
   * @param filter An optional filter, when specified only counters matching the filter will be
   *     processed.
   * @throws IOException
   */
