...
public class DefaultInstrumentFactory implements IInstrumentFactory {
  ...
  public static final DefaultInstrumentFactory OVERWRITE_60M =
      new DefaultInstrumentFactory(60 /* slots */, PeriodEnum.Minutes, true /* overwrite */);
   ...
   */
  public DefaultInstrumentFactory(
      final int nslots, final PeriodEnum period, final boolean overwrite) {

    if (nslots <= 0) throw new IllegalArgumentException();
