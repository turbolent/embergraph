...
public interface ITxState extends ITxState0 {
   ...
   * and ABORT requests.
   *
   * <p>Note: This is a transient state. Once the transaction has prepared it will transition to
   * either COMMIT or ABORT and this method will no longer report <code>true</code>.
   *
