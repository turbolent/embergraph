 ...
 * double-precision rank}. The ranks move in the same direction as the {@link #rawScore}s - a higher
 * rank indicates higher utilization. The least utilized service is always rank zero (0). The most
 * utilized service is always in the last rank.
 *
