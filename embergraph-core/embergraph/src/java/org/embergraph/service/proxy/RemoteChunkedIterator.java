 ...
 * @version $Id$
 * @param <E> The generic type of the component elements visited by the source iterator.
 */
public class RemoteChunkedIterator<E> implements IRemoteChunkedIterator<E> {
  ...
  public RemoteChunkedIterator(
    ...
    if (sourceIterator == null) throw new IllegalArgumentException();
    ...
    if (DEBUG) {
      ...
      log.debug("sourceIterator=" + sourceIterator + ", serializer=" + serializer);
    }
  }
