 ...
 *
 * <p>Note: In practice, {@link IAsynchronousIterator}s are declared with an array type. There are
 * two main uses: transferring {@link IBindingSet}[]s between {@link JoinTask}s and transferring
 * {@link ISolution}[]s from the last join dimension back to the client.
 *
...
public interface RemoteAsynchronousIterator<E> extends Remote {
  ...
  boolean hasNext(final long timeout, final TimeUnit unit) throws IOException, InterruptedException;
