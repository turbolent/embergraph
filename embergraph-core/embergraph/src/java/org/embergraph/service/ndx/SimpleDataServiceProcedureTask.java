...
class SimpleDataServiceProcedureTask extends AbstractDataServiceProcedureTask {
   ...
   * @param resultHandler
   */
  public SimpleDataServiceProcedureTask(
    ...
    if (key == null) throw new IllegalArgumentException("name=" + ndx.getName() + ", proc=" + proc);
  ...
  protected void retry() throws Exception {
    ...
    final PartitionLocator locator =
        ndx.getFederation().getMetadataIndex(ndx.getName(), ts).find(key);
