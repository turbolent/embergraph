 ...
 * the byte[] values.
 *
 * <p>When duplicates are eliminated, {@link KVOC}s identified as duplicates are arranged into a
 * linked list.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 * @param <O> The generic type of the object associated with the key-value pair.
 */
public class DefaultDuplicateRemover<O> implements IDuplicateRemover<O> {
   ...
   *
   * @param prior The previous {@link KVO} instance.
   * @param other Another {@link KVO} instance.
