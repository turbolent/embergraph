...
public abstract class AbstractPendingSetMasterStats<L, HS extends AbstractSubtaskStats>
  ...
  protected class PendingSetStatisticsTask extends StatisticsTask {
    ...
    final MovingAverageTask averageMaximumSinkPendingSetSize =
        new MovingAverageTask(
            "averageMaximumSinkPendingSetSize",
  ...
  public CounterSet getCounters() {
    ...
    final PendingSetStatisticsTask statisticsTask =
        ((PendingSetStatisticsTask) this.statisticsTask);
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          public void sample() {
            setValue(statisticsTask.averageMasterPendingSetSize.getMovingAverage());
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          public void sample() {
            setValue(statisticsTask.averageSinkPendingSetSize.getMovingAverage());
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          public void sample() {
            setValue(statisticsTask.averageMaximumSinkPendingSetSize.getMovingAverage());
          }
        });
