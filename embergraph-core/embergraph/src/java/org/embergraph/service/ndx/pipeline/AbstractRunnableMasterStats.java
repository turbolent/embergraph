 ...
 * @version $Id$
 * @todo The sink counters based on a {@link MovingAverageTask} will stop updating once a given sink
 *     is discarded. Since the {@link MovingAverageTask} is no longer run, the counter does not get
 *     a new sample from that task and the counter value thereafter remains the same.
 */
public class AbstractRunnableMasterStats<L, HS extends AbstractSubtaskStats>
  ...
  protected class StatisticsTask implements Runnable {
     ...
     * report ZERO (0).
     */
    private final MovingAverageTask averageMaximumSinkChunkWaitingNanos =
        new MovingAverageTask(
            "averageMaximumSinkChunkWaitingNanos",
            new Callable<Long>() {
              public Long call() {
     ...
     */
    private final MovingAverageTask averageMaximumSinkChunkWritingNanos =
        new MovingAverageTask(
            "averageMaximumChunkWritingNanos",
            new Callable<Long>() {
              public Long call() {
                final AtomicLong max = new AtomicLong(0);
                final SubtaskOp op =
    ...
    /** The moving average #of elements (tuples) per chunk written on an output sink. */
     ...
     */
    private final MovingAverageTask averageSinkQueueSize =
        new MovingAverageTask(
            "averageSinkQueueSize",
            new Callable<Double>() {
              public Double call() {
     ...
     * (0.0).
     */
    private final MovingAverageTask averageSinkQueueSizeStdev =
        new MovingAverageTask(
            "averageSinkQueueSizeStdev",
            new Callable<Double>() {
              public Double call() {
     ...
     */
    private final MovingAverageTask averageMaximumSinkQueueSize =
        new MovingAverageTask(
            "averageMaximumSinkQueueSize",
     ...
     * partition.
     *
     * @todo Change this to be the average #of elements on each sink queue rather than the average
     *     of the total #of elements across all sink queues? Or just rename as "OnAllSinkQueues"?
     */
  ...
  public CounterSet getCounterSet() {
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          public void sample() {
            setValue(statisticsTask.averageElementsOnMasterQueues.getMovingAverage());
          }
        });
     ...
     */
    t.addCounter(
        "averageHandleChunkMillis",
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageHandleChunkNanos.getMovingAverage() * scalingFactor);
          }
        });
     ...
     */
    t.addCounter(
        "averageSplitChunkMillis",
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageSplitChunkNanos.getMovingAverage() * scalingFactor);
          }
        });
     ...
     */
    t.addCounter(
        "averageSinkOfferMillis",
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageSinkOfferNanos.getMovingAverage() * scalingFactor);
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageTransferChunkSize.getMovingAverage());
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          ...
          protected void sample() {
            setValue(
                statisticsTask.averageSinkChunkWaitingNanos.getMovingAverage() * scalingFactor);
          }
        });
     ...
     */
    t.addCounter(
        "averageMaximumMillisPerWait",
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(
                statisticsTask.averageMaximumSinkChunkWaitingNanos.getMovingAverage()
                    * scalingFactor);
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          ...
          protected void sample() {
            setValue(
                statisticsTask.averageSinkChunkWritingNanos.getMovingAverage() * scalingFactor);
          }
        });
     ...
     */
    t.addCounter(
        "averageMaximumMillisPerWrite",
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(
                statisticsTask.averageMaximumSinkChunkWritingNanos.getMovingAverage()
                    * scalingFactor);
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          ...
          protected void sample() {
            ...
            final double consumerRate =
                statisticsTask.averageSinkChunkWritingNanos.getMovingAverage();

            final double producerRate =
                statisticsTask.averageSinkChunkWaitingNanos.getMovingAverage();
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageSinkWriteChunkSize.getMovingAverage());
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageMasterQueueSize.getMovingAverage());
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          protected void sample() {
            setValue(statisticsTask.averageMasterRedirectQueueSize.getMovingAverage());
          }
        });
    ...
    t.addCounter(
        ...
        new Instrument<Double>() {
          @Override
          public void sample() {
            setValue(statisticsTask.averageElementsOnSinkQueues.getMovingAverage());
          }
        });
