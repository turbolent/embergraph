...
public class ScaleOutIndexCounters {
   ...
   *
   * @todo While this reports several averages, most of them are not moving averages but averages
   *     over the life of the client. They should be sampled and converted into moving averages.
   */
  public CounterSet getCounters() {
    ...
    counterSet.makePath("synchronous").attach(synchronousCounters.getCounters());

    // attach the statistics for synchronous RPC (reads and writes).
    counterSet.makePath("asynchronous").attach(asynchronousStats.getCounterSet());
