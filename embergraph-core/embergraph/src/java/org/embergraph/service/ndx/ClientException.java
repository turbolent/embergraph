...
public class ClientException extends RuntimeException {
  ...
  public List<Throwable> getCauses() {
    ...
    if (causes == null) return Collections.EMPTY_LIST;
...
//         *
  ...
  public ClientException(String msg, Throwable cause, List<Throwable> causes) {
    ...
    super(msg + (causes == null ? "" : ", with " + causes.size() + " causes=" + causes), cause);
  ...
  public ClientException(String msg, List<Throwable> causes) {
    ...
    super(msg + (causes == null ? "" : ", with " + causes.size() + " causes=" + causes));
