 ...
 * write. Failure to do this will cause a {@link KVOLatch#dec()} to be "lost" and generally results
 * in non-termination of {@link KVOLatch#await()} since the count for the "lost" latch would never
 * reach zero.
 *
...
public class KVOC<O> extends KVOList<O> {
   ...
   * @param latch The object that maintains the counter.
   */
  public KVOC(final byte[] key, final byte[] val, final O obj, final KVOLatch latch) {
