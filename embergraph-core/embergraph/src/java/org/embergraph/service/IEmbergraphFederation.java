 ...
 */
public interface IEmbergraphFederation<T> extends IIndexManager,
     ...
     * {@link IEmbergraphFederation} and having the specified service name.
     ...
     *         joined with the {@link IEmbergraphFederation} at this time.
     * 
