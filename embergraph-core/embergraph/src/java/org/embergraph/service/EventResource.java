...
public class EventResource implements Serializable {
  ...
  public EventResource(String indexName) {
    ...
    if (indexName == null) throw new IllegalArgumentException();
  ...
  public EventResource(final String indexName, final int partitionId, final File file) {
  ...
  public EventResource(final String indexName, final String partitionId, final String file) {
