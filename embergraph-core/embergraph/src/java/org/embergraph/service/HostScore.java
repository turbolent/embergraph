 ...
 * The ranks move in the same direction as the {@link #rawScore}s - a higher rank indicates higher
 * utilization. The least utilized host is always rank zero (0). The most utilized host is always in
 * the last rank.
 *
