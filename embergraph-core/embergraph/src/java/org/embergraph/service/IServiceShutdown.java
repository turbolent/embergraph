 ...
 * @version $Id$
 * @todo declare on the various "Manager" interfaces, all of which use these method signatures.
 *     Perhaps rename as "IShutdown".
 */
public interface IServiceShutdown {
  ...
  interface Options {
     ...
     *
     * <p>Note: since services will continue to execute tasks that are already running but SHOULD
     * NOT accept queued tasks once shutdown begins, this primarily effects whether or not tasks
     * that are already executing will be allowed to run until completion.
     *
     * <p>Note: You can use {@link #shutdownNow()} to terminate the service immediately.
     *
     * @see #DEFAULT_SHUTDOWN_TIMEOUT
     */
    String SHUTDOWN_TIMEOUT = IServiceShutdown.class.getName() + ".shutdownTimeout";
