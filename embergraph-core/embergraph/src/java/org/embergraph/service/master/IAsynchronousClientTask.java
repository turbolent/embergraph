 ...
 * @version $Id$
 * @param <U> The generic type of the {@link Callable}'s aggregate result.
 * @param <V> The generic type of the resources in the chunk.
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 */
...
//     * This is the main thread for the client. It should setup operations and
   ...
   *
   * @param chunk The chunk of resources to be processed. Each resource is normally a file path,
   *     URL, etc.
   ...
   * work is complete, then the client MAY interrupt the main thread.
   *
   * @throws RemoteException if there is an RMI problem.
   * @throws InterruptedException if the client thread accepting the request is interrupted.
   */
