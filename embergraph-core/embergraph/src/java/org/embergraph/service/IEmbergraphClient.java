 ...
 * <p>
 * An application uses a {@link IEmbergraphClient} to connect to an
 * {@link IEmbergraphFederation}. Once connected, the application uses the
 * {@link IEmbergraphFederation} for operations against a given federation.
 * <p>
 * An application can read and write on multiple federations by creating an
 * {@link IEmbergraphClient} for each federation to which it needs to establish a
 ...
 * by {@link IEmbergraphFederation} to register, drop, or access indices.
 * <p>
...
public interface IEmbergraphClient<T> {
    ...
    interface Options {
         ...
         */
        String CLIENT_THREAD_POOL_SIZE = IEmbergraphClient.class.getName()
                + ".threadPoolSize";
         ...
         * succeed.
         */
        String CLIENT_MAX_STALE_LOCATOR_RETRIES = IEmbergraphClient.class
                .getName()
         ...
         */
        String CLIENT_READ_CONSISTENT = IEmbergraphClient.class.getName()
                + ".readConsistent";
         ...
         */
        String CLIENT_MAX_PARALLEL_TASKS_PER_REQUEST = IEmbergraphClient.class
                .getName()
         ...
         * for a {@link Long}).
         */
        String CLIENT_TASK_TIMEOUT = IEmbergraphClient.class.getName()
                + "taskTimeout";
...
//        String DEFAULT_CLIENT_TASK_TIMEOUT = ""+20*1000L;
         ...
         */
        String CLIENT_RANGE_QUERY_CAPACITY = IEmbergraphClient.class.getName()
         ...
         */
        String CLIENT_BATCH_API_ONLY = IEmbergraphClient.class.getName()
                + ".batchOnly";
         ...
         * {@link IResourceLocator} maintained by the {@link IEmbergraphClient}.
         * The capacity of this cache indirectly controls how many
         * {@link ILocatableResource}s the {@link IEmbergraphClient} will hold
         * open.
         * <p>
         ...
         */
        String CLIENT_LOCATOR_CACHE_CAPACITY = IEmbergraphClient.class.getName()
         ...
         */
        String CLIENT_LOCATOR_CACHE_TIMEOUT = IEmbergraphClient.class.getName()
                + ".locatorCacheTimeout";
         ...
         */
        String CLIENT_INDEX_CACHE_CAPACITY = IEmbergraphClient.class.getName()
                + ".indexCacheCapacity";
         ...
         */
        String CLIENT_INDEX_CACHE_TIMEOUT = IEmbergraphClient.class.getName()
                + ".indexCacheTimeout";
...
//        String DEFAULT_TEMP_STORE_MAXIMUM_EXTENT = "" + (5 * Bytes.gigabyte);
         ...
         */
        String COLLECT_PLATFORM_STATISTICS = IEmbergraphClient.class.getName()
         ...
         */
        String COLLECT_QUEUE_STATISTICS = IEmbergraphClient.class.getName()
         ...
         * network.
         */
        String GANGLIA_LISTEN_GROUP = IEmbergraphClient.class.getName()
                + ".ganglia.listenGroup";
         ...
         * monitoring network.
         */
        String GANGLIA_LISTEN_PORT = IEmbergraphClient.class.getName()
                + ".ganglia.listenPort";
         ...
         * be started.
         */
        String GANGLIA_LISTEN = IEmbergraphClient.class.getName()
                + ".ganglia.listen";
         ...
         * be started.
         */
        String GANGLIA_REPORT = IEmbergraphClient.class.getName()
                + ".ganglia.report";
         ...
         */
        String GANGLIA_SERVERS = IEmbergraphClient.class.getName()
                + ".ganglia.servers";
