...
public class DataInputBuffer extends InputStream implements DataInput, RepositionableStream {
   ...
   *
   * @param buf The source data.
   * @param off The offset of the first byte to be read.
   * @param len The #of bytes available.
   */
  ...
  public void setBuffer(final byte[] buf, final int off, final int len) {
    ...
    if (off + len > buf.length) throw new IllegalArgumentException();
  ...
  public char readChar() throws IOException {
    ...
    if (off + 2 > limit) throw new EOFException();
  ...
  public final void readFully(final byte[] a, final int aoff, final int alen) throws IOException {

    if (this.off + alen > this.limit) throw new EOFException();

    System.arraycopy(
        buf /* src */, this.off /* srcPos */, a /* dest */, aoff /* destPos */, alen /* len */);
  ...
  public final int read(final byte[] a, final int aoff, final int alen) {
    ...
    System.arraycopy(
        buf /* src */, this.off /* srcPos */, a /* dest */, aoff /* destPos */, n /* len */);
  ...
  public final long unpackLong() throws IOException {
    if (off + 1 > limit) throw new EOFException();
    int b = buf[off++];
    int nbytes;
    long l;
    if ((b & 0x80) != 0) {
    ...
    if (off + nbytes - 1 > limit) throw new EOFException();
