...
public interface IDataRecord extends IByteArraySlice {
   ...
   * @param alen The #of bytes in the slice.
   * @return The slice.
   */
   ...
   * @param src The source data.
   * @param srcoff The offset of the 1st byte in the source data to be copied.
   * @param srclen The #of bytes to be copied.
   */
   ...
   *
   * @param srcoff The offset into the slice of the first byte to be copied.
   ...
   *
   * @param srcoff The offset into the slice defined by this buffer of the first byte to be copied.
   * @param dst The array into which the data will be copied.
   * @param dstoff The offset of the first byte in that array onto which the data will be copied.
   * @param dstlen The #of bytes to be copied.
   */
