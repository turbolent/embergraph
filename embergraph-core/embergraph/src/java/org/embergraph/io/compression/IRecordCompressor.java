...
public interface IRecordCompressor {
   ...
   *     will be advanced to the limit as a side effect.
   * @param out The ByteBuffer into which the compressed data is written
   */
   ...
   * @param bin The data. The data from the position to the limit will be compressed. The position
   *     will be advanced to the limit as a side effect.
   * @return The ByteBuffer into which the compressed data is written
   */
   ...
   * @param bin The data. The data from the position to the limit will be compressed. The position
   *     will be advanced to the limit as a side effect.
   * @param os The stream onto which the compressed data are written.
   */
   ...
   * @param off The offset of the first source byte that will be compressed onto the output stream.
   * @param len The #of source bytes that will be compressed onto the output stream.
   * @param os The stream onto which the compressed data are written.
   */
   ...
   * @return A view onto a shared buffer. The data between position() and limit() are the
   *     decompressed data. The contents of this buffer are valid only until the next compression or
   ...
   *
   * @param bin The compressed data.
   * @return A read-only view onto a shared buffer. The data between position() and limit() are the
   *     decompressed data. The contents of this buffer are valid only until the next compression or
   *     decompression request. The position will be zero. The limit will be the #of decompressed
   *     bytes.
   */
