...
public class RecordCompressor implements Externalizable, IRecordCompressor {
  ...
  public void compress(final byte[] bytes, final int off, final int len, final OutputStream os) {
  ...
  public ByteBuffer decompress(final ByteBuffer bin) {
    ...
    final InflaterInputStream iis =
        new InflaterInputStream(new ByteBufferInputStream(bin), _inflater, size);
  ...
  public ByteBuffer decompress(final byte[] bin) {
    ...
    final InflaterInputStream iis =
        new InflaterInputStream(new ByteArrayInputStream(bin), _inflater, size);
   ...
   * approach is suited to single-threaded processes that achieve a suitable buffer size and then
