...
public class UnicodeHelper {
  ...
  public UnicodeHelper(final IUnicodeCompressor uc) {
    ...
    if (uc == null) throw new IllegalArgumentException();
   ...
   * @throws IOException
   */
  public int encode(final String s, final OutputStream out, final ByteArrayBuffer tmp)
      throws IOException {
   ...
   * @throws IOException
   */
  public int decode(final InputStream in, final StringBuilder out) throws IOException {
   ...
   *
   * @param in The input stream.
   * @param tmp The temporary buffer used to decode the data. The buffer will be reset automatically
   *     by this method.
   * @return The decoded data.
   * @throws IOException
   */
  public String decode1(final DataInputBuffer in, final StringBuilder tmp) throws IOException {
