 ...
 */
public class WriteCacheServiceCounters extends WriteCacheCounters
  ...
  public WriteCacheServiceCounters(
      final int nbuffers, final int dirtyListThreshold, final int compactingThreshold) {
        ...
        new Instrument<Double>() {
          ...
          public void sample() {
            final double mbPerSec =
                (((double) bytesWritten)
                    / Bytes.megabyte32
                    / (TimeUnit.NANOSECONDS.toSeconds(elapsedWriteNanos)));
