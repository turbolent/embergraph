...
// * #of times {@link IWriteCache#flush(boolean)} was called.
   ...
   * channel was concurrently closed, so the value here can diverge from the #of accepted records
   * and the #of requested flushes.
   */
  ...
  public CounterSet getCounters() {
    ...
    root.addCounter(
        ...
        new Instrument<Double>() {
          public void sample() {
            final double bytesPerWrite =
                (nchannelWrite == 0 ? 0d : (bytesWritten / (double) nchannelWrite));
