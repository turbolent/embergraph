 ...
 * extent is identified by the global depth of the bucket page.
 *
 * <p>Note: Because the slots are divided logically among the buddy buckets any slot may have a non-
 * <code>null</code> value and the {@link IRaba} methods as implemented by this class DO NOT range
 * check the index against {@link #size()}.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 *     <p>TODO Test suite. This should be pretty much a clone of the test suite for the {@link
 *     MutableKeyBuffer} in this package.
 */
public class MutableValueBuffer implements IRaba {
   ...
   * determine the #of values in a buddy bucket on the page.
   */
  @Override
  ...
  public final void insert(final int index, final byte[] value) {
   ...
   */
  @Override
  public final int add(final byte[] value) {
