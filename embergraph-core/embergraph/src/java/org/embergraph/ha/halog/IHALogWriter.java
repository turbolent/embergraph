...
public interface IHALogWriter {
   ...
   * counter that is on the opening root block).
   *
   * <p>Note: Once the HALog is sealed, the closing root block will have a commitCounter that is
   * equal to <code>getCommitCounter() + 1</code>.
   *
   ...
   * committed by applying its closing root block is NOT removed).
   *
