 ...
 * @version $Id$
 * @param <I> The parameterized generic type of the source iterator.
 * @param <E> The generic type of the elements visited by the source iterator.
 * @param <F> The generic type of the elements after applying this filter. This will differ from
 *     {@link E} iff the filter is transforming the element type.
...
public abstract class ChunkedFilter<I extends IChunkedIterator<E>, E, F>
   ...
   * transforms can change the natural order of the chunk in many, many different ways, e.g., by
   * changing the type of the elements in the chunk.
   */
   ...
   * specified.
   *
   * @see <a href="https://sourceforge.net/apps/trac/bigdata/ticket/517">Java 7 Compatibility </a>
   */
   ...
   * @return The next chunk of elements to be visited by the filtered iterator. If all elements are
   *     filtered then this method should return either an empty chunk or <code>null</code>.
   */
