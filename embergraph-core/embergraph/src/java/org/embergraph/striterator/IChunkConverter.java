 ...
 * @version $Id: SPOConvertingIterator.java,v 1.6 2008/08/25 17:21:01 thompsonbry Exp $
...
public interface IChunkConverter<E, F> {
   ...
   * reports <code>true</code> for the source iterator.
   *
   * <p>Note: Iterators are single-threaded so the implementation of this method does not need to be
   * thread-safe.
   *
