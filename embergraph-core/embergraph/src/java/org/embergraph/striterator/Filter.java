 ...
 * @version $Id$
 * @param <I> The generic type of the iterator.
 * @param <E> The generic type of the elements visited by the iterator.
 */
public abstract class Filter<I extends Iterator<E>, E> implements IFilter<I, E, E> {
   ...
   * @param <E>
   */
  private static class FilteredIterator<I extends Iterator<E>, E> implements IChunkedIterator<E> {
    ...
    public E[] nextChunk() {
       ...
       * Dynamically instantiation an array of the same component type
          ...
          chunk = (E[]) java.lang.reflect.Array.newInstance(t.getClass(), chunkSize);
        }
        ...
        E[] tmp =
            (E[])
                java.lang.reflect.Array.newInstance(
                    //                        chunk[0].getClass(),
                    chunk.getClass().getComponentType(), n);
    ...
    /** The {@link IKeyOrder} iff the source iterator implements {@link IChunkedOrderedIterator}. */
