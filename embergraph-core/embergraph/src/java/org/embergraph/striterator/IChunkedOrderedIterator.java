 ...
 * @version $Id$
 * @param <R> The generic type for the [R]elation elements.
 */
public interface IChunkedOrderedIterator<R> extends IChunkedIterator<R> {
   ...
   * NOT sorted. Otherwise the elements in the next chunk are sorted before they are returned. The
   * size of the chunk is up to the implementation.
   *
   * @param keyOrder The natural order for the elements in the chunk.
