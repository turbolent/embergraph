...
public interface ILeafCursor<L extends Leaf> extends Cloneable {
   ...
   * @throws IllegalArgumentException if the argument is a cursor for a different {@link
   *     AbstractBTree}.
   */
   ...
   *
   * @return The previous leaf -or- <code>null</code> iff there is no previous leaf.
   */
  L prior();
   ...
   *
   * @return The next leaf -or- <code>null</code> iff there is no next leaf.
   */
  L next();
}
