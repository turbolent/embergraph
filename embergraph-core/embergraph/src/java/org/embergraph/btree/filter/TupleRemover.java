 ...
 * #remove(Object)} always return <code>true</code>. Note that you MUST also specify {@link
 * IRangeQuery#CURSOR} if the index is a local B+Tree since traversal with concurrent modification
...
public abstract class TupleRemover<E> extends FilterBase implements ITupleFilter<E> {
  ...
  private static class Removerator<E> implements ITupleIterator<E> {
     ...
     */
    public Removerator(
        final ITupleIterator<E> src, final Object context, final TupleRemover<E> filter) {
