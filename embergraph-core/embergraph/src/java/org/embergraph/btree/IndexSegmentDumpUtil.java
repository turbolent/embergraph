...
public class IndexSegmentDumpUtil {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println(
          "bytes on disk for root: " + store.getByteCount(store.getCheckpoint().addrRoot));

      System.err.println(
          "bytes on disk for first leaf: "
              + store.getByteCount(store.getCheckpoint().addrFirstLeaf));
