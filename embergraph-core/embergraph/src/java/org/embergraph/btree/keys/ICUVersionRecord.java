 ...
 * this persistence capable data record is to note the version of ICU against which embergraph was
 * linked with the associated binary store file was created.
 *
 * <p>Note: This can result in data which apparently becomes "lost", such as this <a
 * href="http://sourceforge.net/apps/trac/bigdata/ticket/193>trac issue</a>. The underlying problem
 * was substituting a newer version of ICU for the one included in the embergraph distribution. Such
 * errors are now caught by detecting a change in the ICU runtime environment.
 *
...
public class ICUVersionRecord implements Externalizable {
  ...
  private void writeVersionInfo(final VersionInfo v, final ObjectOutput out) throws IOException {
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof ICUVersionRecord)) return false;
  ...
  public static void main(String[] args) {
    ...
    if (!b.equals(a)) throw new AssertionError();
  }
}
