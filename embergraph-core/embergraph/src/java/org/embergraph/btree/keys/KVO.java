 ...
 * value.
 *
 * @param <O> The generic type of the unserialized value object.
...
public class KVO<O> implements Comparable<KVO<O>> {
   ...
   * not by value.
   *
   * @param chunk A chunk of {@link KVO} objects.
   * @return The keys.
   */
  public static byte[][] getKeys(final KVO<?>[] chunk) {
   ...
   * @return The values.
   */
  public static byte[][] getVals(final KVO<?>[] chunk) {
   ...
   *
   * @param a The array.
   * @param len The #of elements in the array [0:len-1].
   * @return A dense array.
   */
  public static <T> KVO<T>[] dense(final KVO<T>[] a, final int len) {

    if (a == null) throw new IllegalArgumentException();

    if (len < 0 || len > a.length) throw new IllegalArgumentException();
    ...
    System.arraycopy(a /* src */, 0 /* srcpos */, b /* dst */, 0 /* dstpos */, len);
