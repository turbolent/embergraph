 ...
 * However, the extension principle is of general use and a similar mechanism exists to allow the
 * override when assembling key components for {@link IKeyOrder}.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 * @param <V> The value type of the document identifier.
 */
public interface IKeyBuilderExtension<V> {
   ...
   *
   * @param key The key.
   * @param off The offset of the start of the encoded object.
   ...
   * @return The byte length when encoded into a component of an unsigned byte[] key.
   */
