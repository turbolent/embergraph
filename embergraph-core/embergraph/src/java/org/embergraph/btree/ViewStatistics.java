...
public class ViewStatistics {
   ...
   * all sources in its {@link LocalPartitionMetadata} then statistics about any {@link
   * IndexSegment}s in the view WILL NOT be reported.
   *
   * @param view The view.
   */
  public ViewStatistics(final ILocalBTreeView view) {
    ...
    if (pmd == null) {
      ...
      this.sumSegBytes = isSeg ? (view.getMutableBTree().getStore().size()) : 0;
    } else {
      /*
