 ...
 */
public class BatchPutIfAbsent extends AbstractKeyArrayIndexProcedure<ResultBuffer>
  ...
  public static class BatchPutIfAbsentConstructor
     ...
     * the operation.
     */
    public static final BatchPutIfAbsentConstructor RETURN_NO_VALUES =
        new BatchPutIfAbsentConstructor(false);
    ...
    @Override
    public BatchPutIfAbsent newInstance(
      ...
      return new BatchPutIfAbsent(
          keysCoder, valsCoder, fromIndex, toIndex, keys, vals, returnOldValues);
    }
  }
