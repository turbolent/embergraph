 ...
 */
public class BatchRemove extends AbstractKeyArrayIndexProcedure<Object>
  ...
  public static class BatchRemoveConstructor
     ...
     */
    public static final BatchRemoveConstructor ASSERT_FOUND_RETURN_NO_VALUES =
        new BatchRemoveConstructor(true /* assertFound */, ReturnWhatEnum.BitMask);
    ...
    private BatchRemoveConstructor(final boolean assertFound, final ReturnWhatEnum returnWhat) {
    ...
    @Override
    public BatchRemove newInstance(
      ...
      return new BatchRemove(keySer, valSer, fromIndex, toIndex, keys, assertFound, returnWhat);
    }
  }
   ...
   */
  protected BatchRemove(
      final IRabaCoder keySer,
      final IRabaCoder valSer,
      final int fromIndex,
      final int toIndex,
      final byte[][] keys,
      final boolean assertFound,
   ...
   * @throws AssertionError if {@link #getAssertFound()} is <code>true</code> and a given key was
  ...
  public Object applyOnce(final IIndex ndx, final IRaba keys, final IRaba vals) {
    ...
    final boolean[] modified = returnWhat == ReturnWhatEnum.BitMask ? new boolean[n] : null;
    ...
    while (i < n) {
      ...
      if (assertFound) {
        ...
        if (oldval == null) {
          ...
          throw new AssertionError("No entry: " + BytesUtil.toString(key));
        }
      }
