...
public interface IIndexProcedure<T> extends IReadOnly, Serializable {
   ...
   * order for a distributed procedure to be ACID, the procedure MUST be executed within a fully
   * isolated transaction.
   *
   * @param ndx The index.
   * @return The result, which is entirely defined by the procedure implementation and which MAY be
