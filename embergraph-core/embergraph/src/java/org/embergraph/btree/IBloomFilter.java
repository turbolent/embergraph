 ...
 * #add(byte[])} or {@link #contains(byte[])} reports <code>true</code> then you MUST also test the
 * data into order to determine whether the response is a <em>false positive</em>.
 *
...
public interface IBloomFilter {
   ...
   *
   * @param key The key.
   * @return <code>true</code> iff the filter state was unchanged by the incorporation of this key
   *     into the filter.
   ...
   *
   * @param key The key.
   * @return <code>true</code> if the filter has either that key or some key that is hash equivalent
   *     to that key using the hashing function imposed by the filter; <code>false</code> iff the
