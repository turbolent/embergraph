...
public final class NOPBloomFilter implements IBloomFilter {
   ...
   *
   * <p>Note: The NOP filter returns <code>true</code> because a <code>true</code> return by a bloom
   * filter means that you have to test the data, which is how we achieve NOP semantics. If this
   * method were to return <code>false</code> then it would be claiming that the key was not in the
   * index!!!
   *
