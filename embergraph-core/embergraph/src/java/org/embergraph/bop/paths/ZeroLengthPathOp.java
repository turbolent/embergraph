...
public class ZeroLengthPathOp extends PipelineOp {
  ...
  private static class ZeroLengthPathTask implements Callable<Void> {
    ...
    ZeroLengthPathTask(final ZeroLengthPathOp op, final BOpContext<IBindingSet> context) {

      this.context = context;

      final IVariableOrConstant<?> leftTerm =
          (IVariableOrConstant<?>) op.getProperty(Annotations.LEFT_TERM);
      ...
      final IVariableOrConstant<?> rightTerm =
          (IVariableOrConstant<?>) op.getProperty(Annotations.RIGHT_TERM);
