...
public abstract class CoreBaseBOp implements BOp {
   ...
   * @throws IllegalArgumentException if the arguments are not valid for the operator.
   */
  ...
  /** General contract is a short (non-recursive) representation of the {@link BOp}. */
  @Override
  ...
  @Override
  public final Object getRequiredProperty(final String name) {
  ...
  public final boolean isController() {
    ...
    return getProperty(Annotations.CONTROLLER, Annotations.DEFAULT_CONTROLLER);
  }

  @Override
  public final BOpEvaluationContext getEvaluationContext() {

    return getProperty(Annotations.EVALUATION_CONTEXT, Annotations.DEFAULT_EVALUATION_CONTEXT);
  }
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof BOp)) return false;
   ...
   * equals.
   *
   * <p>Note: This method permits override by subclasses with direct access to the maps to be
   * compared.
   *
   ...
   * same data but different array instances will not compare as equal.
   *
  ...
  protected static final boolean annotationsEqual(
    ...
    while (itr.hasNext()) {
      ...
      if (v1.getClass().isArray()) {
        // Arrays.equals(v1,v2).
        if (!v2.getClass().isArray()) return false;
