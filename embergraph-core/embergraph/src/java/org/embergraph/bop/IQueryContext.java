...
public interface IQueryContext {
   ...
   * context associated with a query will be released when the query terminates, operators which
   * create child {@link IMemoryManager} contexts are responsible for releasing their {@link
   * IMemoryManager} in a timely fashion when the operator has finished its evaluation.
   */
