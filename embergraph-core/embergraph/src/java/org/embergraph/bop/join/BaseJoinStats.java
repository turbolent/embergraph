...
public class BaseJoinStats extends BOpStats {
   ...
   *
   * <p>Note: Some join operators can coalesce duplicate access paths. Such operators may reported
   * fewer access paths here.
   *
   * <p>Note: Hash join operators typically run the access path exactly once (if they are written to
   * use the native heap and their memory budget is exceeded then they may run the access path more
   * than once).
   */
  ...
  protected void toString(final StringBuilder sb) {
    super.toString(sb);
    sb.append(",accessPathDups=").append(accessPathDups.get());
    sb.append(",accessPathCount=").append(accessPathCount.get());
    sb.append(",accessPathRangeCount=").append(accessPathRangeCount.get());
    sb.append(",accessPathChunksIn=").append(accessPathChunksIn.get());
    sb.append(",accessPathUnitsIn=").append(accessPathUnitsIn.get());
  }
}
