...
public interface IDistinctFilter {
   ...
   * @return A new {@link IBindingSet} containing only the distinct as bound values -or- <code>null
   *     </code> if the binding set duplicates a solution which was already accepted.
   */
   ...
   * @param stats Statistics object to be updated.
   * @param sink The sink onto which the DISTINCT solutions will be written.
