...
//         * When <code>true</code> the hash index identified by
   ...
   * @param annotations
   */
  public HTreeSolutionSetHashJoinOp(final BOp[] args, final Map<String, Object> annotations) {
...
//         * Do a hash join of the buffered solutions with the access path.
  ...
  //
  //            final UnsyncLocalOutputBuffer<IBindingSet> unsyncBuffer = new
  // UnsyncLocalOutputBuffer<IBindingSet>(
  ...
  //                    final AbstractUnsynchronizedArrayBuffer<IBindingSet> unsyncBuffer2 = sink2
  // == null ? unsyncBuffer
