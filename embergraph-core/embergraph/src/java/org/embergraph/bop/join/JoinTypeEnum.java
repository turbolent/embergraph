...
public enum JoinTypeEnum {
   ...
   * populating the "join set" and then outputs the join set once all solutions which join have been
   * identified.
   */
  Exists,
  /*
   ...
   *
   * <p>Note: This is also used for "MINUS" since the only difference between "NotExists" and
