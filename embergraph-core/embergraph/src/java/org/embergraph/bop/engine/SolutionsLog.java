...
public class SolutionsLog {
  ...
  /*
   * Logging for this class should be performed when this logger has a detail level of at least
   * INFO.
   */
  ...
  private static final StringBuilder sb = new StringBuilder(Bytes.kilobyte32 * 4);
   ...
   */
  private static String getPredSummary(final BOp bop) {
...
//     *
  ...
  public static synchronized void log(
    ...
    for (IBindingSet bset : a) {
      ...
      if (bset == null) sb.append("NA");
      else sb.append(bset.toString());
