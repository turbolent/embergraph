...
public class LocalChunkMessage implements IChunkMessage<IBindingSet> {
   ...
   *
   * <p>See {@link IChunkAccessor} which has some notes concerning this and related matters. It
   * might be useful to preserve the ability to have a message with multiple chunks, ie., to deal
   * with data on different driect buffers.
   *
