...
public class HaltOpMessage implements Externalizable, IHaltOpMessage {
   ...
   *     and input chunk.
   * @param partitionId The index partition against which the operator was executed.
   * @param serviceId The node which executed the operator.
   * @param cause <code>null</code> unless execution halted abnormally.
   * @param sinkMessagesOut The number of {@link IChunkMessage} which were sent to the operator for
   *     the default sink.
   * @param altSinkMessagesOut The number of {@link IChunkMessage} which were sent to the operator
   *     for the alternative sink.
   * @param taskStats The statistics for the execution of that bop on that shard and service.
   */
  //    * @param sinkId
