 ...
 *
 * <p>{@link ModifiableBOpBase}s should define the following public constructors
 *
 * <dl>
...
public class ModifiableBOpBase extends CoreBaseBOp {
  ...
  /** A mutable list containing the argument values (aka children) and never <code>null</code>. */
   ...
   *
   * <p>The default implementation makes a shallow copy of {@link #args()} and {@link
   * #annotations()} but DOES NOT perform field-by-field copying. Subclasses may simply delegate the
   * constructor to their super class unless they have additional fields which need to be copied.
   *
   ...
   * @param annotations The annotations for the operator (optional). When <code>null</code>, a
   *     mutable map with a default capacity of {@value CoreBaseBOp#DEFAULT_INITIAL_CAPACITY} is
   *     allocated. Do NOT specify an immutable map.
   */
   ...
   * will be invoked if there is change in the state of this {@link BOp}.
   */
