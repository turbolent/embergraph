...
public class VertexSample extends SampleBase {
   ...
   *
   * @param estCard The estimated cardinality.
   * @param limit The cutoff limit used to make that cardinality estimate.
   * @param estimateEnum The type of estimate. For a vertex this should be {@link
   *     EstimateEnum#Exact} iff the sample is the fully materialized access path for that vertex
   *     and otherwise {@link EstimateEnum#Normal}.
