...
public interface IEvaluationPlan {
   ...
   *     the rule. Each tail predicate must be used exactly once. The elements in this array are the
   *     order in which each tail predicate will be evaluated. The index into the array is the index
