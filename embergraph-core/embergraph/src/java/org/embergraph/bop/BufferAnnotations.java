...
public interface BufferAnnotations {
   ...
   * #DEFAULT_CHUNK_OF_CHUNKS_CAPACITY}). Note that partial chunks may be combined into full chunks
   * whose nominal capacity is specified by {@link #CHUNK_CAPACITY}.
   */
   ...
   * IBindingSet}s (default {@value #DEFAULT_CHUNK_CAPACITY}). Partial chunks may be automatically
   * combined into full chunks.
   *
   ...
   * combine with the current chunk before returning the current chunk (default {@value
