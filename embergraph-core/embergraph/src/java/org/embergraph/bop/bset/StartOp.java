 ...
 *
 * <p>Note: {@link StartOp} is generally NOT required in a query plan. It is more of a historical
 * artifact than something that we actually need to have in the query pipeline. It is perfectly
 * possible to have the query pipeline begin with any of the {@link PipelineOp pipeline operators}.
 */
