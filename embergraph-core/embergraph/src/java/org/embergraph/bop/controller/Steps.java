 ...
 * </pre>
 *
 * Will run the subqueries <i>a</i>, <i>b</i>, and <i>c</i> in sequence. Each subquery will be
 * initialized with a single empty {@link IBindingSet}. The output of those subqueries will be
 * routed to the STEPS operator (their parent) unless the subqueries explicitly override this
 * behavior using {@link PipelineOp.Annotations#SINK_REF}.
 *
...
public class Steps extends AbstractSubqueryOp {
   ...
   * @param annotations
   */
  public Steps(final BOp[] args, final Map<String, Object> annotations) {
    ...
    if (getMaxParallelSubqueries() != 1) {
      ...
      throw new IllegalArgumentException(
          Annotations.MAX_PARALLEL_SUBQUERIES + "=" + getMaxParallelSubqueries());
    }
  }
