...
public interface DocumentHeader {
  ...
  /** The unique identifier for the document within the {@link IContentRepository}. */
  String getId();
  ...
  /*
   * The character set encoding that MUST be used to interpret the byte[] returned by {@link
   * Document#getContent()}.
   */
  ...
  /*
   * Return <code>true</code> iff a version of the file existed at the time that this view was
   * constructed.
   */
  boolean exists();
  ...
  /*
   * The time at which the earliest version of this file still on record was created (historical
   * file metadata can be eradicated through compacting merges).
   */
