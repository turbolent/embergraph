...
public interface IContentRepository {
   ...
   *
   * @param document an object containing the content and metadata to persist
   ...
   *
   * @param document an object containing the content and metadata to update
   * @return The new version.
   */
   ...
   * delete all documents within that namespace.
   *
   * @param fromId The identifier of the first document to be deleted or <code>null</code> if there
   *     is no lower bound.
   * @param toId The identifier of the first document that will NOT be deleted or <code>null</code>
   ...
   * efficiently visit all documents within that namespace.
   *
   * @param fromId The identifier of the first document to be visited or <code>null</code> if there
   *     is no lower bound.
   * @param toId The identifier of the first document that will NOT be visited or <code>null</code>
   *     if there is no upper bound.
   ...
   *
   * @param query A query.
   * @return An iterator visiting the identifiers of the documents in order of decreasing relevance
   *     to the query.
   * @todo return more metadata about the search results.
   * @todo allow fromId, toId to restrict to a given namespace?
   * @todo register analyzers against MIME types and index those that are selected on index or
   *     update.
   * @todo refactor out of this API since more than one free text index could be used over the repo.
   */
