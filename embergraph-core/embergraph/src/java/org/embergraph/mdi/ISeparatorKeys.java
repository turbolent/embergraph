...
public interface ISeparatorKeys {
  ...
  /*
   * The separator key that defines the left edge of that index partition (always defined) - this is
   * the first key that can enter the index partition. The left-most separator key for a scale-out
