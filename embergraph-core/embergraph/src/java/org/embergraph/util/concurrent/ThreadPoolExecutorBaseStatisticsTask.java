...
public class ThreadPoolExecutorBaseStatisticsTask implements Runnable {
   ...
   *
   * @param service The service to be monitored.
   * @param w The weight to be used by the {@link MovingAverageTask}s.
   */
  public ThreadPoolExecutorBaseStatisticsTask(final ThreadPoolExecutor service, final double w) {
  ...
  public CounterSet getCounters() {
    ...
    counterSet.addCounter(
        IThreadPoolExecutorCounters.AverageQueueSize,
