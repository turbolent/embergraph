 ...
 * value specified to the constructor and the potential parallelism of the delegate service.
 *
 * <p>Note: The pattern for running tasks on this service is generally to {@link #execute(Runnable)}
 * a {@link Runnable} and to make that {@link Runnable} a {@link FutureTask} if you want to await
 * the {@link Future} of a {@link Runnable} or {@link Callable} or otherwise manage its execution.
 *
 * <p>Note: This class can NOT be trivially wrapped as an {@link ExecutorService} since the
 * resulting delegation pattern for submit() winds up invoking execute() on the delegate {@link
 * ExecutorService} rather than on this class.
 *
...
public class LatchedExecutor implements Executor {
  ...
  /*
   * This is used to limit the concurrency with which tasks submitted to this class may execute on
   ...
   *
   * <p>Pre-condition: The caller has a permit.
   */
