 ...
 * value, {@link #VALUE}.
 *
 * <p>Applications may simply declare their own property names or they may declare their own {@link
 * Schema}. Applications are responsible for ensuring that the primaryKey values are globally
 * distinct, e.g., by use of a namespace convention.
 *
