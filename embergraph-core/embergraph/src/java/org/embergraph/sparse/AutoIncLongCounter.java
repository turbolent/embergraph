...
/**
 * A singleton object that causes the associated property value to be assigned the next higher
 * 64-bit integer value when it is written on the {@link SparseRowStore}.
 *
