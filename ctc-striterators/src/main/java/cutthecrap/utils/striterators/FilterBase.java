...
public abstract class FilterBase implements IFilter, Cloneable {
   ...
   * @return This filter.
   */
  public final FilterBase addFilter(final IFilter filter) {
   ...
   * @throws IllegalStateException unless the named property is bound.
   */
  protected final Object getRequiredProperty(final String name) {
