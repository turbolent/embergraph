...
public interface ICloseableIterator<E> extends Iterator<E>, ICloseable {
   ...
   * closed (and its resources release) as soon as it is exhausted.
   *
   * <p>Note: Implementations that support {@link Iterator#remove()} MUST NOT eagerly close the
   * iterator when it is exhausted since that would make it impossible to remove the last visited
