...
public class HuTuckerTransformationStrategy extends PrefixCoderTransformationStrategy {
   ...
   */
  public HuTuckerTransformationStrategy(
      final Iterable<? extends CharSequence> iterable, final boolean prefixFree) {
    this(getCoder(iterable, prefixFree), prefixFree);
  }

  protected HuTuckerTransformationStrategy(
      PrefixCoderTransformationStrategy huTuckerTransformationStrategy) {
  ...
  private static Object[] getCoder(
      final Iterable<? extends CharSequence> iterable, boolean prefixFree) {
    ...
    // Then, we compute the number of actually used characters. We count from the start the stop
    // character.
