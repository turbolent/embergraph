...
public class TransformationStrategies {
  ...
  private static final TransformationStrategy<BitVector> IDENTITY =
      new TransformationStrategy<BitVector>() {
   ...
   * representation.
   *
   * <p><strong>Warning</strong>: bit vectors returned by this strategy are adaptors around the
   * original string. If the string changes while the bit vector is being accessed, the results will
   * be unpredictable.
   */
  @SuppressWarnings("unchecked")
  ...
  private static class Utf16TransformationStrategy
     ...
     * bit sequence.
     *
     * @param prefixFree if true, the resulting set of binary words will be made prefix free by
     *     adding
     */
    ...
    private static class Utf16CharSequenceBitVector extends AbstractBitVector
      ...
      public long getLong(final long from, final long to) {
        ...
        if (startBit == 0 && to % Character.SIZE == 0) {
          ...
          if (to == from + Long.SIZE)
            l =
                ((to > actualEnd ? 0 : (long) s.charAt(pos + 3)) << 48
                    | (long) s.charAt(pos + 2) << 32
                    | (long) s.charAt(pos + 1) << 16
                    | s.charAt(pos));
          else {
            l = 0;
        ...
        return getLong(startPos, startPos + Long.SIZE) >>> startBit
            | getLong(startPos + Long.SIZE, Math.min(length, startPos + 2 * Long.SIZE))
                << Long.SIZE + l - startBit
                >>> l;
      }
    ...
    private static class Utf16MutableStringBitVector extends AbstractBitVector
        implements Serializable {
      private static final long serialVersionUID = 1L;
      ...
      public long getLong(final long from, final long to) {
        ...
        if (startBit == 0 && to % Character.SIZE == 0) {
          ...
          if (to == from + Long.SIZE)
            l =
                ((to > actualEnd ? 0 : (long) a[pos + 3]) << 48
                    | (long) a[pos + 2] << 32
                    | (long) a[pos + 1] << 16
                    | a[pos]);
          else {
    ...
    public BitVector toBitVector(final CharSequence s) {
      return s instanceof MutableString
          ? new Utf16MutableStringBitVector((MutableString) s, prefixFree)
          : new Utf16CharSequenceBitVector(s, prefixFree);
    }
   ...
   *
   * <p>Note that this transformation is sensible only for strings that are known to be contain just
   * characters in the ISO-8859-1 charset.
   *
   * <p><strong>Warning</strong>: bit vectors returned by this strategy are adaptors around the
   * original string. If the string changes while the bit vector is being accessed, the results will
   * be unpredictable.
   ...
   *
   * <p>Note that this transformation is sensible only for strings that are known to be contain just
   * characters in the ISO-8859-1 charset, and that strings provided to this strategy must not
   * contain ASCII NULs.
   *
   * <p><strong>Warning</strong>: bit vectors returned by this strategy are adaptors around the
   * original string. If the string changes while the bit vector is being accessed, the results will
  ...
  private static class ISOTransformationStrategy
    ...
    private static class ISOCharSequenceBitVector extends AbstractBitVector
        implements Serializable {
      private static final long serialVersionUID = 1L;
      private transient CharSequence s;
      private transient long length;
      ...
      public long getLong(final long from, final long to) {
        ...
        if (startBit == 0 && to % Byte.SIZE == 0) {
          ...
          if (to == from + Long.SIZE)
            l =
                (to > actualEnd ? 0 : (s.charAt(pos + 7) & 0xFFL)) << 56
    ...
    private static class ISOMutableStringBitVector extends AbstractBitVector
        implements Serializable {
      private static final long serialVersionUID = 1L;
      private transient char[] a;
      private transient long length;
      ...
      public long getLong(final long from, final long to) {
        ...
        if (startBit == 0 && to % Byte.SIZE == 0) {
          ...
          if (to == from + Long.SIZE)
            l =
                (to > actualEnd ? 0 : (a[pos + 7] & 0xFFL)) << 56
                    | (a[pos + 6] & 0xFFL) << 48
                    | (a[pos + 5] & 0xFFL) << 40
                    | (a[pos + 4] & 0xFFL) << 32
                    | (a[pos + 3] & 0xFFL) << 24
    ...
    public BitVector toBitVector(final CharSequence s) {
      return s instanceof MutableString
          ? new ISOMutableStringBitVector((MutableString) s, prefixFree)
          : new ISOCharSequenceBitVector(s, prefixFree);
    }
  ...
  private static final class IteratorWrapper<T> extends AbstractObjectIterator<BitVector> {
   ...
   * @param transformationStrategy a strategy to transform the object returned by <code>iterator
   *     </code>.
   * @return an iterator that emits the content of <code>iterator</code> passed through <code>
   *     transformationStrategy</code>.
   */
  @SuppressWarnings("unchecked")
  public static <T> Iterator<BitVector> wrap(
      final Iterator<T> iterator, final TransformationStrategy<? super T> transformationStrategy) {
   ...
   * @param transformationStrategy a strategy to transform the object contained in <code>iterable
   *     </code>.
   * @return an iterable that has the content of <code>iterable</code> passed through <code>
   *     transformationStrategy</code>.
   */
  @SuppressWarnings("unchecked")
  public static <T> Iterable<BitVector> wrap(
      final Iterable<T> iterable, final TransformationStrategy<? super T> transformationStrategy) {
  ...
  private static final class ListWrapper<T> extends AbstractObjectList<BitVector> {
    ...
    public ListWrapper(
        final List<T> list, final TransformationStrategy<? super T> transformationStrategy) {
      this.list = list;
      this.transformationStrategy = transformationStrategy;
    }
   ...
   *     .
   * @return a list that has the content of <code>list</code> passed through <code>
   *     transformationStrategy</code>.
   */
  @SuppressWarnings("unchecked")
  public static <T> List<BitVector> wrap(
      final List<T> list, final TransformationStrategy<? super T> transformationStrategy) {
  ...
  private static class PrefixFreeTransformationStrategy
      implements TransformationStrategy<BitVector>, Serializable {
    private static final long serialVersionUID = 1L;
  ...
  private static final TransformationStrategy<? extends BitVector> PREFIX_FREE =
      new PrefixFreeTransformationStrategy();
}
