 ...
 *
 * <p>This class is a singleton, and its only instance is accessible using the public field {@link
 * #INSTANCE}.
 *
 * <p>The relationship between this class and {@link Element}/{@link Attribute} is a bit twisted due
 * to the need to accomodate two features:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>To this purpose, this class exports packagewise some static factory methods that create {@link
 * Element}s and {@link Attribute}s and register them locally. The static initialisation code in
 * {@link Element} and {@link Attribute} creates elements such as {@link Element#A} using the
...
public class HTMLFactory implements ParsingFactory {
  ...
  static Element newElement(
      final CharSequence name, final boolean breaksFlow, final boolean isSimple) {
