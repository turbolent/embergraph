 ...
 *
 * <p>This class has a protected constructor. If you need an instance of this class, use {@link
 * #getInstance()}.
 */
public class DefaultCallback implements Callback {
  ...
  public boolean startElement(
      final Element elementUnused, final Map<Attribute, MutableString> attrMapUnused) {
    return true;
  }
  ...
  public boolean characters(
      final char[] textUnused,
      final int offsetUnused,
      final int lengthUnused,
      final boolean flowBrokenUnused) {
    return true;
  }

  public boolean cdata(
      final Element elementUnused,
      final char[] textUnused,
      final int offsetUnused,
      final int lengthUnused) {
    return true;
