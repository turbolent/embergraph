...
public class FlyweightPrototypes {
   ...
   *
   * @param <T> the type of {@link FlyweightPrototype} you want to copy, that is, the type of the
   *     elements of <code>prototype</code>.
   * @param prototype an array of prototypes.
   * @return a flyweight copy of <code>prototype</code>, obtained by invoking {@link
   *     FlyweightPrototype#copy()} on each element.
   */
  @SuppressWarnings("unchecked")
  public static <T extends FlyweightPrototype<T>> T[] copy(final T[] prototype) {
    final T[] result =
        (T[]) Array.newInstance(prototype.getClass().getComponentType(), prototype.length);
   ...
   * is <code>null</code>.
   *
   * @param <T> the type of {@link FlyweightPrototype} you want to copy, that is, the type of <code>
   *     prototype</code>.
   * @param prototype a prototype to be copied, or <code>null</code>.
   * @return <code>null</code>, if <code>prototype</code> is <code>null</code>; otherwise,a
   *     flyweight copy of <code>prototype</code>.
   */
  public static <T extends FlyweightPrototype<T>> T copy(final T prototype) {
