 ...
 * it.unimi.dsi.compression.Codec#coder()} an implementation of this interface.
 *
 * <p>Note that the {@linkplain PrefixCodec#coder() coder} returned by a {@link PrefixCodec} is an
...
public interface PrefixCoder extends Coder {
   ...
   *
   * <p><strong>Warning</strong>: bit 0 of each bit vector returned by {@link #codeWords()} is the
   * <em>first (leftmost) bit</em> of the corresponding codeword: in other words, codewords are
   * stored in right-to-left fashion.
   *
