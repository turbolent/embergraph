 ...
 * <var>j</var>-th symbol will get a code lexicographically smaller than the one assigned to the
 * <var>k</var>-th symbol. This result can be obtained with a small loss in code length (for more
 * details, see the third volume of <i>The Art of Computer Programming</i>).
 *
 * <p>A Hu&ndash;Tucker coder is built given an array of frequencies corresponding to each symbol.
 * Frequency 0 symbols are allowed, but they will degrade the resulting code.
 *
 * <p>The implementation of this class is rather inefficient, and the time required to build a
 * Hu&ndash;Tucker code is quadratic in the number of symbols. An <i>O</i>(<var>n</var> log
 * <var>n</var>) implementation is possible, but it requires very sophisticated data structures.
 */
