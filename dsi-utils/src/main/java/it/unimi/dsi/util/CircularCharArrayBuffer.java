 ...
 * buffer size). The characters present in the buffer are provided through the {@link
 * #toCharArray(char[], int, int)} method and alike.
 */
public class CircularCharArrayBuffer {
  ...
  public void add(char[] b, int offset, int length) {
    ...
    // toEnd is the number of bytes that are free from the first free position to the end of the
    // buffer
