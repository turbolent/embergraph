 ...
 * Instances of this class wrap an instance of {@link it.unimi.dsi.util.FrontCodedStringList}
 * together with a permutation &pi;: inquiries with index <var>i</var> will actually return the
 * string with index &pi;<sub><var>i</var></sub>.
 */
public class PermutedFrontCodedStringList extends AbstractObjectList<CharSequence>
   ...
   */
  public PermutedFrontCodedStringList(
      final FrontCodedStringList frontCodedStringList, final int[] permutation) {
  ...
  public ObjectListIterator<CharSequence> listIterator(final int k) {
    return new AbstractObjectListIterator<CharSequence>() {
      ...
      public CharSequence next() {
        return frontCodedStringList.get(permutation[i.nextInt()]);
      }

      public CharSequence previous() {
        return frontCodedStringList.get(permutation[i.previousInt()]);
      }
  ...
  public static void main(final String[] arg)
      throws IOException, ClassNotFoundException, JSAPException {

    SimpleJSAP jsap =
        new SimpleJSAP(
            PermutedFrontCodedStringList.class.getName(),
            "Builds a permuted front-coded list of strings using a given front-coded string list and permutation",
            new Parameter[] {
              new Switch(
                  "invert", 'i', "invert", "Invert permutation before creating the permuted list."),
              new UnflaggedOption(
                  "list", JSAP.STRING_PARSER, JSAP.REQUIRED, "A front-coded string list."),
              new UnflaggedOption(
                  "permutation",
                  JSAP.STRING_PARSER,
                  JSAP.REQUIRED,
                  "A permutation for the indices of the list."),
              new UnflaggedOption(
                  "permutedList",
                  JSAP.STRING_PARSER,
                  JSAP.REQUIRED,
                  "A the filename for the resulting permuted list."),
            });
    ...
    BinIO.storeObject(
        new PermutedFrontCodedStringList(
            (FrontCodedStringList) BinIO.loadObject(jsapResult.getString("list")), permutation),
