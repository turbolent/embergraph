 ...
 */
public abstract class AbstractPrefixMap extends AbstractObject2LongFunction<CharSequence>
  ...
  public Object2ObjectFunction<CharSequence, Interval> rangeMap() {
    if (rangeMap == null)
      rangeMap =
          new AbstractObject2ObjectFunction<CharSequence, Interval>() {
            private static final long serialVersionUID = 1L;
  ...
  public Object2ObjectFunction<Interval, MutableString> prefixMap() {
    if (prefixMap == null)
      prefixMap =
          new AbstractObject2ObjectFunction<Interval, MutableString>() {
            private static final long serialVersionUID = 1L;
            ...
            public boolean containsKey(final Object o) {
              ...
              return interval != Intervals.EMPTY_INTERVAL
                  && interval.left >= 0
                  && interval.right < AbstractPrefixMap.this.size();
            }
  ...
  public ObjectList<MutableString> list() {
    if (list == null)
      list =
          new AbstractObjectList<MutableString>() {
            public int size() {
