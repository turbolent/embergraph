 ...
 *
 * <p>This class provides constant-pattern text search facilities by implementing Sunday's
 * QuickSearch (a simplified but very effective variant of the Boyer&mdash;Moore search algorithm)
 * using <a href="http://vigna.dsi.unimi.it/papers.php#BoVMSJ"><em>compact approximators</em></A>, a
 * randomised data structure that can accomodate in a small space (but in an approximated way) the
 * bad-character shift table of a large alphabet such as Unicode.
 *
 * <p>Since a large subset of US-ASCII is used in all languages (e.g., whitespace, punctuation,
 * etc.), this class caches separately the shifts for the first 128 Unicode characters, resulting in
 * very good performance even on text in pure US-ASCII.
 *
 * <p>Note that the {@link MutableString#indexOf(MutableString) indexOf} methods of {@link
 * MutableString} use a even more simplified variant of QuickSearch which is less efficient, but has
 * a smaller setup time and does not generate any object. The search facilities provided by this
 * class are targeted at searches on very large texts, repeated searches with the same pattern, and
...
public class TextPattern implements java.io.Serializable, CharSequence {
   ...
   * CASE_INSENSITIVE flag, is done in a manner consistent with the Unicode Standard. By default,
   * case-insensitive matching assumes that only characters in the ASCII charset are being matched.
   *
   * <p>Unicode-aware case folding is very expensive (two method calls per examined non-ASCII
   * character).
   */
   ...
   *
   * @param c a character.
   * @return the character <code>c</code>, downcased if it lies between <samp>A</samp> and
   *     <samp>Z</samp>.
   */
  ...
  private void compile() {
    ...
    // We make two passes on the pattern, so to approximate first the number of non-US-ASCII
    // characters.
   ...
   * @return the index of the first occurrence of this pattern or <code>-1</code>, if this pattern
   *     never appears with index greater than or equal to <code>from</code>.
   */
   ...
   * @param from the index from which the search must start.
   * @return the index of the first occurrence of this pattern or <code>-1</code>, if the this
   *     pattern never appears with index greater than or equal to <code>from</code>.
   */
   ...
   *
   * @param array the character array to look in.
   * @return the index of the first occurrence of this pattern contained in the given array, or
   ...
   * @param array the character array to look in.
   * @param from the index from which the search must start.
   * @return the index of the first occurrence of this pattern contained in the subarray starting
   *     from <code>from</code> (inclusive), or <code>-1</code>, if the pattern cannot be found.
   */
   ...
   * @param to the index at which the search must end.
   * @return the index of the first occurrence of this pattern contained in the subarray starting
   *     from <code>from</code> (inclusive) up to <code>to</code> (exclusive) characters, or <code>
   *     -1</code>, if the pattern cannot be found.
   */
   ...
   *
   * @param s the character sequence to look in.
   * @return the index of the first occurrence of this pattern contained in the given character
   *     sequence, or <code>-1</code>, if the pattern cannot be found.
   */
   ...
   * @param from the index from which the search must start.
   * @return the index of the first occurrence of this pattern contained in the subsequence starting
   *     from <code>from</code> (inclusive), or <code>-1</code>, if the pattern cannot be found.
   */
   ...
   * @return the index of the first occurrence of this pattern contained in the given byte array, or
   *     <code>-1</code>, if the pattern cannot be found.
   */
   ...
   * @param a the byte array to look in.
   * @param from the index from which the search must start.
   * @return the index of the first occurrence of this pattern contained in the array fragment
   *     starting from <code>from</code> (inclusive), or <code>-1</code>, if the pattern cannot be
   *     found.
   */
   ...
   * @param to the index at which the search must end.
   * @return the index of the first occurrence of this pattern contained in the array fragment
   *     starting from <code>from</code> (inclusive) up to <code>to</code> (exclusive) characters,
   *     or <code>-1</code>, if the pattern cannot be found. TODO: this must be tested
   */
   ...
   * @return the index of the first occurrence of this pattern contained in the given list, or
   *     <code>-1</code>, if the pattern cannot be found.
   */
   ...
   * @param list the character list to look in.
   * @param from the index from which the search must start.
   * @return the index of the first occurrence of this pattern contained in the sublist starting
   *     from <code>from</code> (inclusive), or <code>-1</code>, if the pattern cannot be found.
   */
   ...
   *
   * @param o an object.
   * @return true if the argument is a <code>TextPattern</code>s that contains the same constant
   *     pattern of this text pattern and has the same flags set.
   */
  public final boolean equals(final Object o) {
    if (o instanceof TextPattern) {
      TextPattern p = (TextPattern) o;
      return caseSensitive == p.caseSensitive
          && asciiCase == p.asciiCase
          && java.util.Arrays.equals(p.pattern, pattern);
    }
    return false;
  }
   ...
   * content (suitably lower cased, if the pattern is case insensitive).
   *
