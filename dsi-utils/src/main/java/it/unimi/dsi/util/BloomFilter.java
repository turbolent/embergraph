 ...
 * shift-add-xor hashing (for the latter, see &ldquo;Performance in practice of string hashing
 * functions&rdquo;, by M.V. Ramakrishna and Justin Zobel, <i>Proc. of the Fifth International
...
public class BloomFilter implements Serializable {
  ...
  public BloomFilter(final int n, final int d) {
    ...
    for (int i = 0; i < d; i++) {
      ...
      for (int j = 0; j < NUMBER_OF_WEIGHTS; j++) weight[i][j] = mersenneTwister.nextInt();
    }
  }
