 ...
 * with a hash of the string, we get a dictionary-like functionality with a rate error that can be
 * balanced with space occupancy (signatures can go from 1 to {@link Long#SIZE} bits).
 *
 * <p>For the kind of hash we use, see &ldquo;Performance in practice of string hashing
 ...
 * @since 1.1.2
 */
public class ShiftAddXorSignedStringMap extends AbstractObject2LongFunction<CharSequence>
   ...
   * @param map a minimal perfect hash for the strings enumerated by <code>iterator</code>; it must
   *     support {@link Function#size() size()} and have default return value -1.
   */
  public ShiftAddXorSignedStringMap(
      final Iterator<? extends CharSequence> iterator,
      final Object2LongFunction<? extends CharSequence> map) {
  ...
  public static void main(final String[] arg)
      throws NoSuchMethodException, IOException, JSAPException, ClassNotFoundException {

    final SimpleJSAP jsap =
        new SimpleJSAP(
            ShiftAddXorSignedStringMap.class.getName(),
            ...
            new Parameter[] {
              new FlaggedOption(
                  ...
                  'b',
                  "buffer-size",
                  "The size of the I/O buffer used to read strings."),
              new FlaggedOption(
                  "encoding",
              ...
              new UnflaggedOption(
                  ...
                  JSAP.REQUIRED,
                  JSAP.NOT_GREEDY,
                  "The filename of the resulting serialised signed string map."),
              new UnflaggedOption(
                  "stringFile",
                  JSAP.STRING_PARSER,
                  JSAP.NO_DEFAULT,
                  JSAP.NOT_REQUIRED,
                  JSAP.NOT_GREEDY,
                  "Read strings from this file instead of standard input."),
            });
    ...
    final InputStream inputStream =
        stringFile != null ? new FileInputStream(stringFile) : System.in;
    final Iterator<MutableString> iterator =
        new LineIterator(
            new FastBufferedReader(
                new InputStreamReader(
                    zipped ? new GZIPInputStream(inputStream) : inputStream, encoding),
                bufferSize));
    final Object2LongFunction<CharSequence> function =
        (Object2LongFunction<CharSequence>) BinIO.loadObject(functionName);
    LOGGER.info("Signing...");
