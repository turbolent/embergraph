 ...
 * {@linkplain it.unimi.dsi.bits.BitVector#asLongBigList(int) list view over a bit vector} requires
 * a more powerful interface. The naming follows the <A
 * HREF="http://fastutil.dsi.unimi.it/"><samp>fastutil</samp></A> conventions (actually, this class
