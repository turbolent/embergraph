 ...
 * &le; {@link #right}.
 *
 * <p>This class has no constructor: use the static factory methods {@link #valueOf(int, int)} and
 * {@link #valueOf(int)}, instead.
 *
 * <p>Instances of this class are immutable, and moreover implement the {@link
 * it.unimi.dsi.fastutil.ints.IntSortedSet} interface. The {@linkplain #equals(Object) equality
 * method} allows to check equality with both sorted and non-sorted sets of integers.
 *
 * <p>To reduce garbage collection, intervals made of one non-negative small points are precomputed
...
public final class Interval extends AbstractIntSortedSet implements IntSortedSet, Serializable {
  ...
  private static final Interval[] POINT_INTERVAL = new Interval[MAX_SINGLE_POINT];
   ...
   * Intervals#EMPTY_INTERVAL} instead.
   *
   * @param left the left extreme.
   * @param right the right extreme (which must be greater than or equal to the left extreme).
   */
  ...
  public static Interval valueOf(final int left, final int right) {
    if (left > right)
      throw new IllegalArgumentException(
          "The left extreme (" + left + ") is greater than the right extreme (" + right + ")");
   ...
   *
   * @param x an integer.
   * @return whether this interval contains <code>x</code>, that is, whether {@link #left} &le;
   *     <code>x</code> &le; {@link #right}.
   */
   ...
   *     e.g., whether {@link #left}&minus;<code>radius</code> &le; <code>x</code> &le; {@link
   *     #right}+<code>radius</code>.
   */
   ...
   * @return whether this interval enlarged to the left by <code>leftRadius</code> and to the right
   *     by <code>rightRadius</code> would contain <code>x</code>, e.g., whether {@link
   *     #left}&minus;<code>leftRadius</code> &le; <code>x</code> &le; {@link #right}+<code>
   *     rightRadius</code>.
   */
   ...
   *
   * @param x an integer.
   * @return a negative integer, zero, or a positive integer as <code>x</code> is positioned at the
   *     left, belongs, or is positioned to the right of this interval, e.g., as <code>x</code> &lt;
   *     {@link #left}, {@link #left} &le; <code>x</code> &le; {@link #right} or {@link #right} &lt;
   *     <code>x</code>.
   */
   ...
   * @param radius the radius.
   * @return a negative integer, zero, or a positive integer as <code>x</code> is positioned at the
   *     left, belongs, or is positioned to the right of this interval enlarged by <code>radius
   *     </code>, that is, as <code>x</code> &lt; {@link #left}&minus;<code>radius</code>, {@link
   *     #left}&minus;<code>radius</code> &le; <code>x</code> &le; {@link #right}+<code>radius
   *     </code> or {@link #right}+<code>radius</code> &lt; <code>x</code>.
   */
   ...
   * @param rightRadius the right radius.
   * @return a negative integer, zero, or a positive integer as <code>x</code> is positioned at the
   *     left, belongs, or is positioned to the right of this interval enlarged by <code>leftRadius
   *     </code> on the left and <code>rightRadius</code> in the right, that is, as <code>x</code>
   *     &lt; {@link #left}&minus;<code>leftRadius</code>, {@link #left}&minus;<code>leftRadius
   *     </code> &le; <code>x</code> &le; {@link #right}+<code>rightRadius</code> or {@link #right}+
   *     <code>rightRadius</code> &lt; <code>x</code>.
   */
   ...
   *
   * @param o an object.
   * @return true if <code>o</code> is an ordered set of integer containing the same element of this
   *     interval in the same order, or if <code>o</code> is a set of integers containing the same
   *     elements of this interval.
   */
  public boolean equals(final Object o) {
    if (o instanceof Interval) return ((Interval) o).left == left && ((Interval) o).right == right;
