 ...
 *   <dd>write <var>x</var> with coding <var>M</var>; the latter can be U (unary), g (&gamma;), z
 *       (&zeta;), d (&delta;), G (Golomb), GS (skewed Golomb); when appropriate, <var>x</var> is
 *       followed by an extra integer (modulus, etc.).
 * </dl>
 *
 * @author Paolo Boldi
