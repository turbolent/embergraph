 ...
 * <em>delimiters</em> defined at construction time. There is a {@link
 * DelimitedWordReader#DelimitedWordReader(String) constructor accepting the delimiter set as a
 * string}. Note that LF and CR are <em>always</em> considered to be delimiters.
 */
public class DelimitedWordReader extends FastBufferedReader {
   ...
   * The wrapped reader will have to be set later using {@link #setReader(Reader)}.
   *
   * @param delimiters a set of characters that will be considered word delimiters, specified as a
   *     string.
   */
