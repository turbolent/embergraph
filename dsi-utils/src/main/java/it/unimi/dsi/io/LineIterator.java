 ...
 *
 * <p>This class reuses the same mutable strings. As a result, the comments for {@link
 * FileLinesCollection} apply here. If you want just get all the lines, use {@link #allLines()}.
 */
