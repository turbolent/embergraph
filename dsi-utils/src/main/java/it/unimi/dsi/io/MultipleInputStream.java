...
public class MultipleInputStream extends InputStream {
   ...
   * @param length the number of input streams to be encapsulated; it <strong>must</strong> be
   *     positive.
   */
  ...
  public static InputStream getStream(
      final InputStream[] inputStream, final int offset, final int length) {
   ...
   *
   * @param inputStream an array of input streams, that will be encapsulated.
   * @return an input stream encapsulating the argument streams (the only argument, if the length is
   *     1).
   */
