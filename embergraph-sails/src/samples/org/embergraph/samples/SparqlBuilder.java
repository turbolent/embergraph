...
public class SparqlBuilder {
  ...
  public SparqlBuilder addTriplePattern(String s, String p, String o, boolean construct) {
  ...
  public SparqlBuilder addTriplePattern(String s, String p, Literal o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(String s, String p, URI o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(String s, String p, Value o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(String s, URI p, String o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(String s, URI p, Literal o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(String s, URI p, URI o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(String s, URI p, Value o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(URI s, String p, String o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(URI s, String p, Literal o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(URI s, String p, URI o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(URI s, String p, Value o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public SparqlBuilder addTriplePattern(URI s, URI p, String o, boolean construct) {
    where.addTriplePattern(s, p, o);
    if (construct) {
      this.construct.addTriplePattern(s, p, o);
    }
  ...
  public static class Graph extends LinkedList<Pattern> implements Collection<Pattern>, Pattern {
    ...
    public Graph addTriplePattern(String s, String p, Value o) {
      Triple triple = new Triple(s, p, o instanceof URI ? uri((URI) o) : literal((Literal) o));
      add(triple);
      return this;
    }
    ...
    public Graph addTriplePattern(String s, URI p, Value o) {
      Triple triple = new Triple(s, uri(p), o instanceof URI ? uri((URI) o) : literal((Literal) o));
      add(triple);
      return this;
    }
    ...
    public Graph addTriplePattern(URI s, String p, Value o) {
      Triple triple = new Triple(uri(s), p, o instanceof URI ? uri((URI) o) : literal((Literal) o));
      add(triple);
      return this;
    }
  ...
  public static class Triple implements Pattern {
    ...
    public static Collection<Character> valid = Arrays.asList(new Character[] {'?', '<', '\"'});
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder();
      sb.append(s).append(' ').append(p).append(' ').append(o).append(' ').append('.');
      return sb.toString();
    }
  }
}
