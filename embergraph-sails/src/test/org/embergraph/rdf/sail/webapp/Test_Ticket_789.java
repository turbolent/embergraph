 ...
 *
 * @author igorkim
 * @see <a href="http://jira.blazegraph.com/browse/BLZG-789" >
 *     EmbergraphSailRemoteRepositoryConnection should implement interface methods </a>
 * @see <a href="http://jira.blazegraph.com/browse/BLZG-753">Result of
 *     EmbergraphSailRemoteRepositoryConnection.getStatements() and export() do not preserve
 *     statement context.
 * @see <a href="http://jira.blazegraph.com/browse/BLZG-1325">
 *     EmbergraphSailRemoteRepositoryConnection must support setBinding(), getBindings(),
 *     clearBindings(), and removeBinding()
 * @see <a href="http://jira.blazegraph.com/browse/BLZG-1326">
 *     EmbergraphSailRemoteRepositoryConnection must support setDataset(), getDataset()
 */
public class Test_Ticket_789<S extends IIndexManager> extends AbstractTestNanoSparqlClient<S> {
  ...
  public static Test suite() {
    ...
    return ProxySuiteHelper.suiteWhenStandalone(Test_Ticket_789.class, "test.*", TestMode.quads);
  }
