...
//                                dep.projectURL(),
            ...
            if (!Boolean.getBoolean(Options.LOG4J_MBEANS_DISABLE)) {
                ...
                try {
                    ...
                    final Class<?> cls = Class
                            .forName("org.embergraph.jmx.JMXLog4jMBeanUtil");
    ...
    /**
     * If logging is not configured for [org.embergraph] then we set a default log
    ...
    private static void setDefaultLogLevel(final boolean quiet) {
        ...
        final Logger defaultLog = 
                LogUtil.getLog4jLogger("org.embergraph");
//                Logger.getLogger("org.embergraph");
     ...
     * references to the <code>org.embergraph.BuildInfo</code> class. This method
     * uses reflection to avoid a compile time dependency.
     * <p>
     * Note: This method works fine. However, people running from an IDE will
     * observe <em>stale</em> data from old <code>org.embergraph.BuildInfo</code>
    ...
    * <code>org.embergraph.BuildInfo</code> class. This class is generated by
