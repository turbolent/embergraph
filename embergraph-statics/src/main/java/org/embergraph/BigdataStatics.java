...
public class BigdataStatics {
     ...
     * used by the {@link org.embergraph.counters.AbstractStatisticsCollector},
     ...
     * log level for the {@link org.embergraph.jini.start.process.ProcessHelper}
     * class to INFO.
     * <p>
     * Note: This needs to be more than the length of the
     * {@link Banner} output in order for anything related to the
    ...
    public static final boolean threadLocalBuffers = Boolean
            .getBoolean("org.embergraph.threadLocalBuffers");
    ...
    public static final boolean runKnownBadTests = Boolean
            .getBoolean("org.embergraph.runKnownBadTests");
