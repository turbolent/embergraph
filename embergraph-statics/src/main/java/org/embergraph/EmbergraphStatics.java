...
public class EmbergraphStatics {
   ...
   * reporting the canonical hostname for the {@link Banner} and other purposes.
   *
   ...
   * the log level for the {@link org.embergraph.jini.start.process.ProcessHelper} class to INFO.
   *
   * <p>Note: This needs to be more than the length of the {@link Banner} output in order for
   * anything related to the process behavior to be echoed on {@link System#out}.
   *
   * @see org.embergraph.jini.start.process.ProcessHelper
   */
  ...
  public static void threadDump(final Appendable w) {
    ...
    try {
      ...
      for (Map.Entry<Thread, StackTraceElement[]> threadEntry : dump.entrySet()) {
