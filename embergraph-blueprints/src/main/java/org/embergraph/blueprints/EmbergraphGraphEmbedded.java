 ...
 * It wraps an embedded {@link EmbergraphSailRepository} and holds open an
 ...
 *
 */
public class EmbergraphGraphEmbedded extends EmbergraphGraph implements TransactionalGraph, IChangeLog {
	
    private final transient static Logger log = Logger.getLogger(EmbergraphGraphEmbedded.class);
    
    public static interface Options {
        
        String AUTO_COMMIT_ON_SHUTDOWN = EmbergraphGraphEmbedded.class.getName()+".autoCommitOnShutdown";
...
//	transient EmbergraphSailRepositoryConnection cxn;
    ...
    /**
     * Create a Blueprints wrapper around a {@link EmbergraphSail} instance with
    ...
    /**
     * Create a Blueprints wrapper around a {@link EmbergraphSailRepository}
     * instance.
     */
...
//    private final ReentrantReadWriteLock lock = new ReentrantReadWriteLock();
    ...
    public EmbergraphReadOnlyGraph getReadOnlyView() throws Exception {
        ...
        return new EmbergraphReadOnlyGraph(
...
//    }
     ...
     */
	protected UUID setupQuery(final EmbergraphSailRepositoryConnection cxn,
    ...
    public class EmbergraphReadOnlyGraph extends EmbergraphGraph {
        ...
        private EmbergraphReadOnlyGraph(final EmbergraphSailRepositoryConnection cxn,
        ...
        protected UUID setupQuery(final EmbergraphSailRepositoryConnection cxn,
            ...
            return EmbergraphGraphEmbedded.this.setupQuery(
