 ...
 * 
 */
public class EmbergraphGraphBulkLoad extends EmbergraphGraph implements
...
//	}
	...
	public Edge addEdge(final Object key, final Vertex from, final Vertex to,
		...
		try {
			...
			return new EmbergraphEdge(new StatementImpl(fromURI, edgeURI, toURI),
					this);
	...
	protected UUID setupQuery(EmbergraphSailRepositoryConnection cxn,
		...
		throw new RuntimeException(
				"Method is not implemented for EmbergraphGraphBulkLoad.");
	}
