...
public abstract class EmbergraphGraph implements Graph {
    ...
    private static final transient Logger sparqlLog = Logger.getLogger(
            EmbergraphGraph.class.getName() + ".SparqlLogger");
...
//            }
     ...
     * low-performance scan and filter paradigm. See {@link EmbergraphGraphQuery}.
     */
    @Override
...
//        return new DefaultGraphQuery(this);
     ...
     */
    public ICloseableIterator<EmbergraphGraphAtom> project(final String queryStr)
            throws Exception {
	...
	public ICloseableIterator<EmbergraphGraphAtom> project(final String queryStr,
        ...
        try {
            ...
            if (query instanceof EmbergraphSailGraphQuery
				...
				queryId = setupQuery((EmbergraphSailRepositoryConnection) cxn,
	 ...
	 */
	@SuppressWarnings("unchecked")
	public ICloseableIterator<EmbergraphBindingSet> select(final String queryStr)
			throws Exception {
...
//            finalizeQuery(queryId);
     ...
     * @see {@link RDRHistory}
     */
    public ICloseableIterator<EmbergraphGraphEdit> history(final List<URI> ids)
            throws Exception {
    	final String randomUUID = UUID.randomUUID().toString();
