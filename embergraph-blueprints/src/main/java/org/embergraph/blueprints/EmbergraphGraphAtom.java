...
public abstract class EmbergraphGraphAtom {
    ...
    protected EmbergraphGraphAtom(final String id) {
        this.id = id;
    }
    ...
    public static class ExistenceAtom extends EmbergraphGraphAtom {
    ...
    public static class EdgeAtom extends EmbergraphGraphAtom {
    ...
    public static class EdgeLabelAtom extends EmbergraphGraphAtom {
    ...
    public static class PropertyAtom extends EmbergraphGraphAtom {
