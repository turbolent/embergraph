...
public class EmbergraphGraphQuery implements GraphQuery {
    ...
    protected final static transient Logger log = Logger.getLogger(EmbergraphGraphQuery.class);
    
    /**
     * These are the only Predicate implementations we handle currently.
     */
    protected static List<Class> knownPredicates = Arrays.<Class>asList(
    ...
    public <T extends Comparable<?>> GraphQuery interval(final String key, 
        ...
        return has(key, EmbergraphPredicate.GTE, startValue)
                .has(key, EmbergraphPredicate.LT, endValue);
    }
    ...
    protected String toQueryStr(final URI type) {
        ...
        for (Has has : criteria) {
            ...
            if (has instanceof HasNot) {
                ...
                if (has.val != null && 
                        (has.pred == null || has.pred == EmbergraphPredicate.EQ)) {
...
//        sb.setLength(sb.length()-1);
     ...
     */
    private String toFilterStr(final EmbergraphPredicate pred, final String var,
            final Object val) {
        ...
        } else if (pred == EmbergraphPredicate.GT || pred == EmbergraphPredicate.GTE ||
                   pred == EmbergraphPredicate.LT || pred == EmbergraphPredicate.LTE ||
    ...
    private class Has {
        ...
        public Has(final String key, final Object val, 
                final EmbergraphPredicate pred) {
