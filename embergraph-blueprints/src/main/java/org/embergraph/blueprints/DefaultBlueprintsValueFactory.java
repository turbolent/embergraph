...
public class DefaultBlueprintsValueFactory implements BlueprintsValueFactory {
  ...
  public DefaultBlueprintsValueFactory(
      final String graphNamespace,
      final String vertexNamespace,
      final String edgeNamespace,
      final URI type,
      final URI vertex,
      final URI edge,
      final URI label) {
   ...
   * {@inheritDoc}
   *
   * <p>Supports: Float, Double, Integer, Long, Boolean, Short, Byte, and String.
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>Return a graph property from a datatyped literal using its XSD datatype.
   *
   * <p>Supports: Float, Double, Integer, Long, Boolean, Short, Byte, and String.
   */
  @Override
