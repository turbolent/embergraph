 ...
 * RemoteRepository that will POST a graphml file to the blueprints layer of the embergraph server.
 *
...
public class EmbergraphGraphClient extends EmbergraphGraph {
   ...
   */
  public EmbergraphGraphClient(
      final String sparqlEndpointURL, final BlueprintsValueFactory factory) {
  ...
  public EmbergraphGraphClient(final RemoteRepository repo, final BlueprintsValueFactory factory) {
   ...
   */
  public EmbergraphGraphClient(
      final EmbergraphSailRemoteRepository repo, final BlueprintsValueFactory factory) {
   ...
   * EmbergraphSailRemoteRepositoryConnection (if namespace uses ISOLATABLE_INDICES).
   */
  @Override
