...
/**
 * Class to test EmbergraphGraphEmbedded creation using a SailRepository for client
 * test suite coverage.
 * 
 * @author beebs
 *
 */
public class TestEmbergraphGraphEmbeddedRepository extends
    AbstractTestEmbergraphGraphFactory {
	...
	public EmbergraphSail getOrCreateRepository(String journalFile) {
		...
		if (journalFile == null || !new File(journalFile).exists()) {
			 ...
			 */
			repo = EmbergraphSailFactory.createRepository(props, journalFile,
