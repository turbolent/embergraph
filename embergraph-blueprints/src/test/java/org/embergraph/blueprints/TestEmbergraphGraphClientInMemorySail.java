...
public class TestEmbergraphGraphClientInMemorySail extends AbstractTestEmbergraphGraph {
    ...
    private static final transient Logger log = Logger.getLogger(
				TestEmbergraphGraphClientInMemorySail.class);
...
//    }
    ...
    private class EmbergraphGraphTest extends GraphTest {
		...
		private Map<String, EmbergraphSailNSSWrapper> testSails = new LinkedHashMap<String, EmbergraphSailNSSWrapper>();
		...
		public Graph generateGraph(final String key) {
			...
			try {
				...
				final EmbergraphGraph graph = new EmbergraphGraphClient(nss.m_repo.getRepositoryForDefaultNamespace());
