 ...
 * connection and persistence methods, i.e. EmbergraphGraphClient,
...
public abstract class AbstractTestEmbergraphGraphFactory extends TestCase {
	...
	private static final transient Logger log = Logger
			.getLogger(AbstractTestEmbergraphGraphFactory.class);
	...
	protected void loadTestGraph(EmbergraphGraph graph, String resource)
			throws IOException {
