 ...
 *
 * <p>Note: It is generally a good idea for comparators to implement <tt>java.io.Serializable</tt>,
 * as they may be used as ordering methods in serializable data structures. In order for the data
 * structure to serialize successfully, the comparator (if provided) must implement
 * <tt>Serializable</tt>.
 *
 * <p>
 *
...
public interface CharComparator {
   ...
   * the same ordering as this comparator. Thus, <code>comp1.equals(comp2)</code> implies that
   * <tt>sgn(comp1.compare(o1, o2))==sgn(comp2.compare(o1, o2))</tt> for every element <tt>o1</tt>
   * and <tt>o2</tt>.
   *
   * <p>Note that it is <i>always</i> safe <i>not</i> to override <tt>Object.equals(Object)</tt>.
