...
/*
 * Fixed sized (non resizable) streaming buffer connected to a target <tt>IntBufferConsumer</tt> to
 * which data is automatically flushed upon buffer overflow.
 *
...
public class IntBuffer extends cern.colt.PersistentObject implements IntBufferConsumer {
   ...
   * @param capacity the number of points the buffer shall be capable of holding before overflowing
   *     and flushing to the target.
   */
