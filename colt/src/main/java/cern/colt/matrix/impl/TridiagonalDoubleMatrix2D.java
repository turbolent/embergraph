  ...
  public void setQuick(int row, int column, double value) {
    ...
    if (!isZero)
      throw new IllegalArgumentException(
          "Can't store non-zero value to non-tridiagonal coordinate: row="
              + row
              + ", column="
              + column
              + ", value="
    ...
    // if (!isZero) throw new IllegalArgumentException("Can't store non-zero value to
    // non-tridiagonal coordinate: row="+row+", column="+column+", value="+value);
