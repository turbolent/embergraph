 ...
 *
 * <p>Internally holds one single contigous one-dimensional array, addressed in row major. Note that
 * this implementation is not synchronized.
 *
 * <p><b>Memory requirements:</b>
 *
 * <p><tt>memory [bytes] = 8*rows()*columns()</tt>. Thus, a 1000*1000 matrix uses 8 MB.
 *
 ...
 *
 * <p>Cells are internally addressed in row-major. Applications demanding utmost speed can exploit
 * this fact. Setting/getting values in a loop row-by-row is quicker than column-by-column. Thus
 *
 * <pre>
...
public class DenseDoubleMatrix2D extends DoubleMatrix2D {
  ...
  public void zAssign8Neighbors(DoubleMatrix2D B, cern.colt.function.Double9Function function) {
    ...
    // 2. if the "function" would be hardwired into the innermost loop, a speedup of 1.5-2.0 would
    // be seen
