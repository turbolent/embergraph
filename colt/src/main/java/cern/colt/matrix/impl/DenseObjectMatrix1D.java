 ...
 *
 * <p>Internally holds one single contigous one-dimensional array. Note that this implementation is
 * not synchronized.
 *
 * <p><b>Memory requirements:</b>
 *
 * <p><tt>memory [bytes] = 8*size()</tt>. Thus, a 1000000 matrix uses 8 MB.
 *
