...
class SelectedDenseObjectMatrix3D extends ObjectMatrix3D {
   ...
   */
  protected SelectedDenseObjectMatrix3D(
      Object[] elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets, int offset) {
  ...
  public ObjectMatrix2D viewColumn(int column) {
    ...
    return new SelectedDenseObjectMatrix2D(
        viewRows,
        viewColumns,
        this.elements,
        viewRowZero,
