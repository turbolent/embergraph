...
public abstract class DoubleMatrix1D extends AbstractMatrix1D {
   ...
   * if the receiver is an instance of type <tt>SparseDoubleMatrix1D</tt> the new matrix must also
   * be of type <tt>SparseDoubleMatrix1D</tt>, etc. In general, the new matrix should have internal
   ...
   * the receiver is an instance of type <tt>SparseDoubleMatrix1D</tt> the new matrix must be of
