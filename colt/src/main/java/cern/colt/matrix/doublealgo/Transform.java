 ...
 *
 * <p>If your favourite transformation is not provided by this class, consider using method
 * <tt>assign</tt> in combination with prefabricated function objects of {@link
 * cern.jet.math.Functions}, using idioms like
 *
 * <table>
 * <td class="PRE">
 * <pre>
 ...
 *
 * <p>Implementation: Performance optimized for medium to very large matrices. In fact, there is now
 * nomore a performance advantage in using this class; The assign (transform) methods directly
 * defined on matrices are now just as fast. Thus, this class will soon be removed altogether.
 *
 * @deprecated
...
public class Transform extends cern.colt.PersistentObject {
   ...
   * "DoubleTransform" to a name that better suits you, for example "Trans".
   *
   * <pre>
