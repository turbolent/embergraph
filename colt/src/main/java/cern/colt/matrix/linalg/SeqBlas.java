...
public class SeqBlas implements Blas {
  /*
   * Little trick to allow for "aliasing", that is, renaming this class. Time and again writing code
   * like
   *
   * <p><tt>SeqBlas.blas.dgemm(...);</tt>
   *
   * <p>is a bit awkward. Using the aliasing you can instead write
   *
   * <p><tt>Blas B = SeqBlas.blas; <br>
   * B.dgemm(...);</tt>
   */
  ...
  public void assign(
      DoubleMatrix2D A, DoubleMatrix2D B, cern.colt.function.DoubleDoubleFunction function) {
    A.assign(B, function);
  }
  ...
  public void dsymv(
    ...
    if (size != x.size() || size != y.size()) {
      throw new IllegalArgumentException(
          A.toStringShort() + ", " + x.toStringShort() + ", " + y.toStringShort());
    }
