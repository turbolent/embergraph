...
class Smp {
  ...
  protected void run(
      final DoubleMatrix2D[] blocksA,
      final DoubleMatrix2D[] blocksB,
    ...
    */
    ...
    int noOfTasks =
        (int)
            Math.min(
                flops / threshold,
                this.maxThreads); // each thread should process at least 30000 flops
  ...
  protected DoubleMatrix2D[][] splitBlockedNN(
      DoubleMatrix2D A, DoubleMatrix2D B, int threshold, long flops) {
