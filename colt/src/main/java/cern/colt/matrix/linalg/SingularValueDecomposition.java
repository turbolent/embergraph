 ...
 *
 * <p>The singular values, <tt>sigma[k] = S[k][k]</tt>, are ordered so that <tt>sigma[0] >= sigma[1]
 * >= ... >= sigma[n-1]</tt>.
 *
 * <p>The singular value decomposition always exists, so the constructor will never fail. The matrix
