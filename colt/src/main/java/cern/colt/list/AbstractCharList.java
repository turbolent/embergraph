...
/*
 * Abstract base class for resizable lists holding <code>char</code> elements; abstract. First see
...
public abstract class AbstractCharList extends AbstractList {
  ...
  public void replaceFromToWithFromTo(
      int from, int to, AbstractCharList other, int otherFrom, int otherTo) {
  ...
  public void replaceFromWith(int from, java.util.Collection other) {
    ...
    for (int i = 0; i < limit; i++) set(index++, ((Character) e.next()).charValue()); // delta
  }
  /*
   ...
   * of this class. For example: public DatabaseList extends AbstractCharList { ... public void
