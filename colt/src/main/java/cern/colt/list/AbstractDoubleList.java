...
public abstract class AbstractDoubleList extends AbstractList
   ...
   * of this class. For example: public DatabaseList extends AbstractDoubleList { ... public void
  ...
  public void shuffleFromTo(int from, int to) {
    ...
    cern.jet.random.Uniform gen =
        new cern.jet.random.Uniform(cern.jet.random.Uniform.makeDefaultGenerator());
    for (int i = from; i < to; i++) {
