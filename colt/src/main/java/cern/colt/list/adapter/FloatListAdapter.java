...
/*
 * Adapter that permits an {@link cern.colt.list.AbstractFloatList} to be viewed and treated as a
 ...
 * a <tt>java.lang.ClassCastException</tt>. <tt>java.lang.Number.floatValue()</tt> is used to
 * convert objects into primitive values which are then stored in the backing templated list. Getter
