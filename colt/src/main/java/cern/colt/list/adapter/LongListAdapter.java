...
/*
 * Adapter that permits an {@link cern.colt.list.AbstractLongList} to be viewed and treated as a JDK
 * 1.2 {@link java.util.AbstractList}. Makes the contained list compatible with the JDK 1.2
 * Collections Framework.
 *
 * <p>Any attempt to pass elements other than <tt>java.lang.Number</tt> to setter methods will throw
 * a <tt>java.lang.ClassCastException</tt>. <tt>java.lang.Number.longValue()</tt> is used to convert
 * objects into primitive values which are then stored in the backing templated list. Getter methods
 * return <tt>java.lang.Long</tt> objects.
 */
public class LongListAdapter extends java.util.AbstractList implements java.util.List {
   ...
   * @throws IndexOutOfBoundsException if the specified index is out of range (<tt>index &lt; 0 ||
   *     index &gt;= size()</tt>).
   */
