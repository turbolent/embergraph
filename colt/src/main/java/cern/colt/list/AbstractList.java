...
public abstract class AbstractList extends AbstractCollection {
   ...
   * @throws IndexOutOfBoundsException if <tt>(from&lt;0 || from&gt;to || to&gt;=size()) &&
   *     to!=from-1</tt>.
   */
   ...
   * superfluos internal memory. Use method <tt>trimToSize</tt> to release superfluos internal
   * memory.
   *
   ...
   * set.
   *
   * <p>This implementation simply calls <tt>sortFromTo(...)</tt>. Override <tt>sortFromTo(...)</tt>
   ...
   *
   * <p>The sorting algorithm is dynamically chosen according to the characteristics of the data
   * set. This default implementation simply calls quickSort. Override this method if you can
   * determine which sort is most appropriate for the given data set.
   *
   * @param from the index of the first element (inclusive) to be sorted.
   * @param to the index of the last element (inclusive) to be sorted.
   * @throws IndexOutOfBoundsException if <tt>(from&lt;0 || from&gt;to || to&gt;=size()) &&
   ...
   *
   * <p>This default implementation does nothing. Override this method in space efficient
   * implementations.
   */
