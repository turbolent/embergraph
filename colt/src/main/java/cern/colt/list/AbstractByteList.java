...
/*
* Abstract base class for resizable lists holding <code>byte</code> elements; abstract. First see
...
public abstract class AbstractByteList extends AbstractList {
  ...
  public void replaceFromToWithFromTo(
      int from, int to, AbstractByteList other, int otherFrom, int otherTo) {
  ...
  public void replaceFromWith(int from, java.util.Collection other) {
    ...
    for (int i = 0; i < limit; i++) set(index++, ((Number) e.next()).byteValue()); // delta
  }
  /*
   ...
   * of this class. For example: public DatabaseList extends AbstractByteList { ... public void
