...
public abstract class AbstractBooleanList extends AbstractList {
  ...
  public void replaceFromToWithFromTo(
      int from, int to, AbstractBooleanList other, int otherFrom, int otherTo) {
  ...
  public void replaceFromWith(int from, java.util.Collection other) {
    ...
    for (int i = 0; i < limit; i++) set(index++, ((Boolean) e.next()).booleanValue()); // delta
  }
  /*
   ...
   * of this class. For example: public DatabaseList extends AbstractBooleanList { ... public void
  ...
  public java.util.ArrayList toList() {
    ...
    for (int i = 0; i < mySize; i++) list.add(Boolean.valueOf(get(i)));
    return list;
  }
  /*
