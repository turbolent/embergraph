...
public abstract class AbstractIntList extends AbstractList
    implements cern.colt.buffer.IntBufferConsumer {
  /*
  ...
  public void replaceFromToWithFromTo(
      int from, int to, AbstractIntList other, int otherFrom, int otherTo) {
  ...
  public void replaceFromWith(int from, java.util.Collection other) {
    ...
    for (int i = 0; i < limit; i++) set(index++, ((Number) e.next()).intValue()); // delta
  }
  /*
   ...
   * of this class. For example: public DatabaseList extends AbstractIntList { ... public void
