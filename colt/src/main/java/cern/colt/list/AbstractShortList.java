...
/*
* Abstract base class for resizable lists holding <code>short</code> elements; abstract. First see
...
public abstract class AbstractShortList extends AbstractList {
  ...
  public void replaceFromToWithFromTo(
      int from, int to, AbstractShortList other, int otherFrom, int otherTo) {
  ...
  public void replaceFromWith(int from, java.util.Collection other) {
    ...
    for (int i = 0; i < limit; i++) set(index++, ((Number) e.next()).shortValue()); // delta
  }
  /*
   ...
   * of this class. For example: public DatabaseList extends AbstractShortList { ... public void
