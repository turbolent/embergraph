...
/**
 * Abstract base class for resizable lists holding <code>long</code> elements; abstract. First see
...
public abstract class AbstractLongList extends AbstractList {
  ...
  public void replaceFromToWithFromTo(
      int from, int to, AbstractLongList other, int otherFrom, int otherTo) {
  ...
  public void replaceFromWith(int from, java.util.Collection other) {
    ...
    for (int i = 0; i < limit; i++) set(index++, ((Number) e.next()).longValue()); // delta
  }
  /**
   ...
   * of this class. For example: public DatabaseList extends AbstractLongList { ... public void
