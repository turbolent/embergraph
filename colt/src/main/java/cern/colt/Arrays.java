...
public class Arrays extends Object {
   ...
   *
   * <p>Returns the identical array if <tt>array.length &lt;= maxCapacity</tt>. Otherwise, returns a
   * new array with a length of <tt>maxCapacity</tt> containing the first <tt>maxCapacity</tt>
