 ...
 *
 * <p>Almost all methods are expressed in terms of {@link #forEachKey(DoubleProcedure)}. As such
 * they are fully functional, but inefficient. Override them in subclasses if necessary.
 *
...
public abstract class AbstractDoubleIntMap extends AbstractMap {
   ...
   * @return the first key for which holds <tt>get(key) == value</tt>; returns <tt>Double.NaN</tt>
