 ...
 *
 * <p>Note that implementations are not synchronized.
 *
...
public abstract class AbstractMap extends cern.colt.PersistentObject {
   ...
   * "highWaterMark". In other words, the table capacity (and proportionally the memory used by this
   * class) oscillates within these constraints. The terms are precomputed and cached to avoid
   ...
   * receiver will grow only once instead of potentially many times.
   *
   * <p><b>This default implementation does nothing.</b> Override this method if necessary.
   *
   ...
   *
   * <p>This default implementation does nothing. Override this method if necessary.
   */
