...
public abstract class AbstractIntIntMap extends AbstractMap {
  ...
  public void pairsMatching(
      final IntIntProcedure condition, final IntArrayList keyList, final IntArrayList valueList) {
    keyList.clear();
    valueList.clear();
   ...
   * criterium is "key". This means that if any two values are equal, the smaller key comes first.
   *
   * <p><b>Example:</b> <br>
