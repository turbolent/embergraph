 ...
 * </ul>
 *
 * <tt>a</tt> and <tt>b</tt> are variables, <tt>constant</tt> is fixed, but for performance reasons
 * publicly accessible. Intended to be passed to <tt>matrix.assign(otherMatrix,function)</tt>
 * methods.
 */
