 ...
 * </ul>
 *
 * <tt>a</tt> is variable, <tt>constant</tt> is fixed, but for performance reasons publicly
 * accessible. Intended to be passed to <tt>matrix.assign(function)</tt> methods.
 */
