...
public class Gamma extends cern.jet.math.Constants {
  ...
  /**
   * Returns the Incomplete Beta Function evaluated from zero to <tt>xx</tt>; formerly named
   * <tt>ibeta</tt>.
   *
    ...
    if (x >= 1000.0)
      q +=
          ((7.9365079365079365079365e-4 * p - 2.7777777777777777777778e-3) * p
              ...
              / x;
    else q += Polynomial.polevl(p, A, 4) / x;
    return q;
  }
  /**
   * Power series for incomplete beta integral; formerly named <tt>pseries</tt>. Use when b*x is
   * small and x not too close to 1.
   */
  ...
  /**
   * Returns the Gamma function computed by Stirling's formula; formerly named <tt>stirf</tt>. The
   * polynomial STIR is valid for 33 <= x <= 172.
   */
