...
// FIXME:   Determine if this test should run without hep.aida
  ...
  public static void main(String[] argv) {
    ...
    */
    ...
    for (int i = 1; i < 100; ) {
      ...
      //	    System.out.println(fmt.format(percent) + "  " + quantile + ",  " +
      // dbin.quantile(percent)+ ",  " + (dbin.quantile(percent)-quantile));
      i = i + step;
    }
  }
}
