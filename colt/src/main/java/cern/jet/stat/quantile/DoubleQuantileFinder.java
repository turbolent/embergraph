...
public interface DoubleQuantileFinder extends java.io.Serializable {
  // public interface DoubleQuantileFinder extends com.objy.db.iapp.PersistentEvents,
   ...
   * elements.
   *
   * <p>Writing a wrapper is a good idea if you can think of better ways of doing interpolation.
