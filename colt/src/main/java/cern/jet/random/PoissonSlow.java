 ...
 *
 *     <p><b>Implementation:</b> This is a port of <A
 ...
 *     implementation, in turn, is based upon "W.H.Press et al., Numerical Recipes in C, Second
 *     Edition".
 *
...
public class PoissonSlow extends AbstractDiscreteDistribution {
  ...
  protected int nextIntSlow() {
    ...
    if (product <= 0.0 && bound > 0.0)
      return (int) Math.round(mean); // detected endless loop due to rounding errors
    return count - 1;
  }
  /** Sets the mean. */
