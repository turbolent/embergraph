 ...
 *
 *     <p><tt>p(x) = (1/g(f/2)) * (x/2)^(f/2-1) * exp(-x/2)</tt> with <tt>g(a)</tt> being the gamma
 *     function and <tt>f</tt> being the degrees of freedom.
 *
 *     <p>Valid parameter ranges: <tt>freedom &gt; 0</tt>.
 *
 ...
 *
 *     <p>J.F. Monahan (1987): An algorithm for generating chi random variables, ACM Trans. Math.
 *     Software 13, 168-172.
 *
...
public class ChiSquare extends AbstractContinousDistribution {
  ...
  public double nextDouble(double freedom) {
     ...
     * * REFERENCE : - J.F. Monahan (1987): An algorithm for * generating chi random variables, ACM
     * Trans. * Math. Software 13, 168-172. * SUBPROGRAM : - anEngine ... pointer to a (0,1)-Uniform
