 ...
 *
 *     <p>D.J. Best, N.I. Fisher (1979): Efficient simulation of the von Mises distribution, Appl.
 *     Statist. 28, 152-157.
 *
...
public class VonMises extends AbstractContinousDistribution {
  ...
  public double nextDouble(double k) {
     ...
     * with parameter * k > 0 via rejection from the wrapped Cauchy * distibution. * REFERENCE: -
     * D.J. Best, N.I. Fisher (1979): Efficient * simulation of the von Mises distribution, * Appl.
     * Statist. 28, 152-157. * SUBPROGRAM: - drand(seed) ... (0,1)-Uniform generator with * unsigned
