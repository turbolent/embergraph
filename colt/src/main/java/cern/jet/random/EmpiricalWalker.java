 ...
 * probabilities, absolute probabilities are also accepted.
 *
 * <p>
 *
 ...
 *
 *     <p><b>Implementation:</b> Walker's algorithm. Generating a random number takes <tt>O(1)</tt>,
 *     i.e. constant time, as opposed to commonly used algorithms with logarithmic time complexity.
 *     Preprocessing time (on object construction) is <tt>O(k)</tt> where <tt>k</tt> is the number
 *     of elements of the provided empirical pdf. Space complexity is <tt>O(k)</tt>.
 *
 *     <p>This is a port of <A
 ...
 *     HREF="http://sourceware.cygnus.com/gsl/">GSL 0.4.1</A>. Theiler's implementation in turn is
 *     based upon
 *
 *     <p>Alastair J. Walker, An efficient method for generating discrete random variables with
 *     general distributions, ACM Trans Math Soft 3, 253-256 (1977).
 *
 *     <p>See also: D. E. Knuth, The Art of Computer Programming, Volume 2 (Seminumerical
 *     algorithms), 3rd edition, Addison-Wesley (1997), p120.
 *
