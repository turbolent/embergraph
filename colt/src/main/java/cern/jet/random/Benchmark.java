...
public class Benchmark extends cern.colt.PersistentObject {
  ...
  public static void demo1() {
    ...
    // for tests and debugging use a random engine with CONSTANT seed --> deterministic and
   ...
   * @param print <tt>true</tt> prints each generated number, <tt>false</tt> does not print
   *     generated numbers (use this setting for benchmarking).
