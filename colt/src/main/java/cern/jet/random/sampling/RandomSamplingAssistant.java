 ...
 * never change position relative to each other. Each element from the <tt>N</tt> elements has the
 * same probability to be included in the <tt>n</tt> chosen elements. This class is a convenience
