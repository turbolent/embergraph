...
public class Hyperbolic extends AbstractContinousDistribution {
  ...
  public double nextDouble(double alpha, double beta) {
     ...
     * parameter a * and b valid for a>0 and |b|<a using the * non-universal rejection method for
     * log-concave * densities. * REFERENCE : - L. Devroye (1986): Non-Uniform Random Variate *
     * Generation, Springer Verlag, New York. * SUBPROGRAM : - drand(seed) ... (0,1)-Uniform
