 ...
 *
 * <p><tt>p(k) = (mean^k / k!) * exp(-mean)</tt> for <tt>k &gt;= 0</tt>.
 *
 * <p>Valid parameter ranges: <tt>mean &gt; 0</tt>. Note: if <tt>mean &lt;= 0.0</tt> then always
 * returns zero.
 *
 ...
 *     <p>Also see
 *
 *     <p>Stadlober E., H. Zechner (1999), <A
 *     HREF="http://www.cis.tu-graz.ac.at/stat/stadl/random.html">The patchwork rejection method for
 *     sampling from unimodal distributions</A>, to appear in ACM Transactions on Modelling and
 *     Simulation.
 *
