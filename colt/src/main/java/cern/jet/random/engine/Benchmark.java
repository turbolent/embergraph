 ...
 * engine. followed by a transformation to the desired distribution. Therefore, the performance of
 * the uniform engines is crucial.
 *
 * <p>
 *
 ...
 * </center>
 *
 * <p><b>Note:</b> Methods working on the default uniform random generator are <b>synchronized</b>
 * and therefore in current VM's <b>slow</b> (as of June '99). Methods taking as argument a uniform
 * random generator are <b>not synchronized</b> and therefore much <b>quicker</b>. Thus, if you need
 * a lot of random numbers, you should use the unsynchronized approach:
 *
 * <p><b>Example usage:</b>
 *
 * <pre>
