 ...
 * respectively, as well as <tt>float</tt>'s and <tt>double</tt>'s in the open unit intervals
 * <tt>(0.0f,1.0f)</tt> and <tt>(0.0,1.0)</tt>, respectively.
 *
 * <p>The seed can be any integer satisfying <tt>0 &lt; 4*seed+1 &lt; 2<sup>32</sup></tt>. In other
 * words, there must hold <tt>seed &gt;= 0 && seed &lt; 1073741823</tt>.
 *
 * <p><b>Quality:</b> This generator follows the multiplicative congruential method of the form
 * <dt><tt>z(i+1) = a * z(i) (mod m)</tt> with <tt>a=663608941 (=0X278DDE6DL),
 *     m=2<sup>32</sup></tt>.
 * <dt><tt>z(i)</tt> assumes all different values <tt>0 &lt; 4*seed+1 &lt; m</tt> during a full
 *     period of 2<sup>30</sup>.
 *
 *     <p><b>Performance:</b> TO_DO
 *
 *     <p><b>Implementation:</b> TO_DO
 *
...
public class DRand extends RandomEngine {
   ...
   *
   * @param seed if the above condition does not hold, a modified seed that meets the condition is
