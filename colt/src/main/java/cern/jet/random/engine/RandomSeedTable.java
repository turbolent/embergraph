 ...
 *     HREF="http://wwwinfo.cern.ch/asd/lhc++/clhep">CLHEP 1.4.0</A> (C++). CLHEP's implementation,
 *     in turn, is part of <A HREF="http://wwwinfo.cern.ch/asd/geant/geant4.html">GEANT 4</A>, a C++
 *     simulation toolkit for High Energy Physics. Geant4, in turn, took the table from the original
 *     FORTRAN77 implementation of the HEP CERN Library routine RECUSQ. Each sequence has a period
 *     of 10**9 numbers.
 *
