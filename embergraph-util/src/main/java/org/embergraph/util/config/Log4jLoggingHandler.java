 ...
 *
 * <ul>
 *   <li>org.embergraph.util.config.Log4jLoggingHandler.loggername specifies the name of a Log4j
 *       Logger that will be used to find the Log4j Appenders used for actually logging the message.
 *       This property is optional and defaults to the log4j root logger.
 * </ul>
 */
public class Log4jLoggingHandler extends Handler {
  ...
  public Log4jLoggingHandler() {
    String log4jLoggerName =
        LogManager.getLogManager()
            .getProperty("org.embergraph.util.config.Log4jLoggingHandler.loggername");
  ...
  public void publish(LogRecord record) {
    ...
    log4jLogger.callAppenders(new XLoggingEvent(log4jLogger, record, formattedMessage));
  }
  ...
  static class XLoggingEvent extends org.apache.log4j.spi.LoggingEvent {
    ...
    public XLoggingEvent(
        org.apache.log4j.Logger log4jLogger, LogRecord record, String formattedMessage) {
      super(
    ...
    protected static org.apache.log4j.Level translateLevel(java.util.logging.Level level) {
