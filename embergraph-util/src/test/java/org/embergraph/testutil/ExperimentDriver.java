...
public class ExperimentDriver {
   ...
   * @param showAll When true, any attributes not named in <i>cols</i> are added after the last
   *     column named in <i>cols</i>. Since there are no declared columns for these attributes they
   ...
   * be analyzed with a pivot table.
   *
   * @param conditions
   * @param a
   * @return
  ...
  protected static class Experiment {
    ...
    public Experiment(
        String className, Map<String, String> defaultProperties, Collection<Condition> conditions) {

      if (className == null) throw new IllegalArgumentException();

      if (defaultProperties == null) throw new IllegalArgumentException();

      if (conditions == null) throw new IllegalArgumentException();
     ...
     * @param nruns The #of times to execute all of the {@link Condition}s.
     */
    public void run(boolean randomize, int nruns) throws Exception {

      if (nruns < 1) throw new IllegalArgumentException("nruns must be at least one, not " + nruns);
      ...
      if (exists) {
        ...
        System.err.println("Will append to existing file: " + outFile.getAbsolutePath());
      }
      ...
      try {
        ...
        for (int run = 0; run < nruns; run++) {
          ...
          System.err.println(
              "Running comparison of " + nconditions + " conditions for " + className);
          ...
          while (itr.hasNext()) {
            ...
            System.err.println(
                "Run " + run + " of " + nruns + ", Running condition " + i + " of " + nconditions);
            ...
            try {
              ...
              condition.result = test.doComparisonTest(condition.properties);
            ...
            condition.properties.setProperty(
            ...
            condition.result.put(
                "java.Runtime.totalMemory", "" + Runtime.getRuntime().totalMemory());
        ...
        Map<Object, Object> invariants = new HashMap<Object, Object>();
        {
          ...
          while (itr.hasNext()) {
            ...
            Map<Object, Object> conditionProperties = PropertyUtil.flatten(condition.properties);
            ...
            if (first) {
              ...
              {
                Iterator<Map.Entry<Object, Object>> itr2 =
                    conditionProperties.entrySet().iterator();
              ...
              // disprove invariants from results.
              {
                final Iterator<Map.Entry<String, String>> itr2 =
                    condition.result.entrySet().iterator();
        ...
        // write each condition and its outcome (if any).
        {
          ...
          while (itr.hasNext()) {
            ...
            writer.write(
                ExperimentDriver.toString(
                    PropertyUtil.flatten(condition.properties), conditionCols, false));

            writer.write(ExperimentDriver.toString(condition.result, resultCols, false));
  ...
  static class DTDValidationHelper extends DefaultHandler2 implements EntityResolver2 {
    ...
    public static final String PUBLIC_EXPERIMENT_0_1 =
        "-//systap.com//DTD BIGDATA EXPERIMENT 0.1//EN";
     ...
     */
    public static void validate(InputSource source)
    ...
    public InputSource resolveEntity(String name, String publicId, String baseURI, String systemId)
      ...
      if (publicId.equals(PUBLIC_EXPERIMENT_0_1)) {
        ...
        InputStream is = getClass().getResourceAsStream(SYSTEM_EXPERIMENT_FILENAME_0_1);

        if (is == null) {

          throw new AssertionError("Could not locate resource: " + SYSTEM_EXPERIMENT_FILENAME_0_1);
        }
  ...
  protected static class DTDParserHelper extends DTDValidationHelper {
    ...
    public void endDocument() throws SAXException {
      ...
      if (className == null) throw new SAXException("'class' attribute not recovered.");

      if (defaultProperties == null) throw new SAXException("defaults not recovered.");
   ...
   *
   * @param properties The inherited properties (this object is NOT modified).
   ...
   *
   * @param args The name of the XML file describing the experiment to be run.
   */
   ...
   * @param nruns The #of runs.
   * @param randomize <code>true</code> if the run order should be randomized.
   * @throws Exception
   */
  public static void doMain(File file, int nruns, boolean randomize) throws Exception {

    final Experiment exp = new DTDParserHelper().parse(new InputSource(new FileReader(file)));
      ...
      while (itr.hasNext()) {
        ...
        if (pname.startsWith("java.")
            && !(pname.equals("java.vm.vendor")
                ...
                || pname.equals("java.vm.name"))) continue;
