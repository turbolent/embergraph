 ...
 *     millisecond as a function of counterBits.
...
public class TestHybridTimestampFactory extends TestCase {
   ...
   * generated by {@link HybridTimestampFactory#nextMillis()} and notes the actual granularity of
  ...
  public void test_nextTimestamp2() {
    ...
    System.err.println(
        "Generated "
            ...
            + elapsed
            + " milliseconds: ts/ms: "
            + limit / (double) elapsed);

    System.err.println(
        "The #of times the factory invoked Thread.sleep(): " + timestampFactory.getSleepCounter());
  }
}
