 ...
 * @version $Id$
 *     <p>TODO Write a unit test for the timeout mechanism. Note that it is invoked with a minimum
 *     granularity of 5 seconds by the JVM wide cleaner thread.
 */
public class TestSynchronizedHardReferenceQueueWithTimeout extends TestCase2 {
   ...
   *
   * @param expected The expected references in the expected order.
   * @param innerQueue The innerQueue whose order is to be verified.
   */
  private void assertSameOrder(
      final String[] expected, final HardReferenceQueue<IRef<String>> innerQueue) {
  ...
  public void test_add_evict() {
    ...
    //        assertEquals("order",new String[]{ref0,ref1,ref2,ref3},innerQueue.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref0,ref1,ref2,ref3,ref4},innerQueue.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref1,ref2,ref3,ref4,ref5},innerQueue.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref2,ref3,ref4,ref5},innerQueue.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref2,ref3,ref4,ref5,ref4},innerQueue.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref3,ref4,ref5,ref4,ref2},innerQueue.toArray(new
    // String[0]));
   ...
   *
   * <p>Note: This is more complex than for the simple {@link HardReferenceQueue} due to the
   * indirection through the {@link IRef} object, which breaks reference testing for equality. The
   * scanHead() method in the inner queue was modified in order for this test to pass.
   *
  ...
  public void test_add_scan() {
    ...
    //        assertEquals("order",new String[]{ref0,ref1,ref2,ref0,ref1},cache.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref1,ref2,ref0,ref1,ref2},cache.toArray(new
    // String[0]));
    ...
    //        assertEquals("order",new String[]{ref2,ref0,ref1,ref2,ref0},cache.toArray(new
    // String[0]));
   ...
   * @param <T>
   */
  private class MyListener<G, T extends IRef<G>> implements HardReferenceQueueEvictionListener<T> {
