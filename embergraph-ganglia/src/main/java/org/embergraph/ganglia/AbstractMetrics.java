...
public abstract class AbstractMetrics implements IGangliaAttributes {
  ...
  public static Map<String, String[]> getMap(
      final String group, final String title, final String description) {
  ...
  static class NV {
    ...
    public NV(final String name, final String[] value) {
      if (name == null || value == null || value.length == 0) throw new IllegalArgumentException();
      this.name = name;
      this.value = value;
    }
  }
  ...
  static Map<String, String[]> getMap(final NV[] a) {
    if (a == null || a.length == 0) return emptyMap;
  ...
  public AbstractMetrics(
      final String hostName, final GangliaSlopeEnum slope, final int tmax, final int dmax) {

    if (hostName == null) throw new IllegalArgumentException();

    if (slope == null) throw new IllegalArgumentException();

    if (tmax < 0) throw new IllegalArgumentException();

    if (dmax < 0) throw new IllegalArgumentException();
