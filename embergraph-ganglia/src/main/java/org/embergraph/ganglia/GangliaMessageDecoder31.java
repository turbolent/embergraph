...
public class GangliaMessageDecoder31 implements IGangliaMessageDecoder {
  ...
  public IGangliaMessage decode(final byte[] data, final int off, final int len) {
      ...
      case METADATA:
        {
          ...
          final GangliaSlopeEnum slope = GangliaSlopeEnum.valueOf(xdr.readInt());
          ...
          if (nextra == 0) {
            ...
            for (int i = 0; i < nextra; i++) {
              ...
              if (a == null) {
                ...
                System.arraycopy(
                    a /* src */, 0 /* srcPos */, b /* dest */, 0 /* destPos */, a.length);
                b[a.length] = value;
          ...
          final GangliaMessageTypeEnum metricType = GangliaMessageTypeEnum.fromGType(metricTypeStr);

          final IGangliaMetadataMessage msg =
      ...
      case REQUEST:
        {
          ...
          final IGangliaMessage msg = new GangliaRequestMessage(hostName, metricName, spoof);
      ...
      case UINT16:
        {
          ...
          final IGangliaMetricMessage msg =
              new GangliaMetricMessage(recordType, hostName, metricName, spoof, format, value);
