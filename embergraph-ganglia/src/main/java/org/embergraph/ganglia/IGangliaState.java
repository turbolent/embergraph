...
public interface IGangliaState {
   ...
   *
   * <p>If an {@link IGangliaMetadataMessage} is declared for that name, then either the
   * pre-existing {@link TimestampMetricValue} will be returned -or- a new {@link
   * TimestampMetricValue} will be atomically created and returned.
   *
   * <p>Otherwise, this method will return <code>null</code> since it lacks the necessary
   * information to create an {@link IGangliaMetadataMessage} by itself.
   *
