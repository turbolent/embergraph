...
public class RichMetricMessage extends GangliaMetricMessage {
   ...
   * @param format The printf format to be used.
   * @param value The value.
   * @throws IllegalArgumentException if the hostName is <code>null</code>.
   * @throws NullPointerException if the declaration is <code>null</code>.
   * @throws IllegalArgumentException if the format is <code>null</code>.
   * @throws IllegalArgumentException if the value is <code>null</code>.
   */
  public RichMetricMessage(
    ...
    super(decl.getMetricType(), hostName, decl.getMetricName(), spoof, format, value);
