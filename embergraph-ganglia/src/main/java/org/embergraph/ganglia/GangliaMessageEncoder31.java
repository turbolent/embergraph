...
public class GangliaMessageEncoder31 implements IGangliaMessageEncoder {
  ...
  public void writeRequest(final XDROutputBuffer xdr, final IGangliaRequestMessage msg) {
  ...
  public void writeMetadata(final XDROutputBuffer xdr, final IGangliaMetadataMessage decl) {
  ...
  public void writeMetric(
    ...
    if (false) {
      ...
      switch (metricType) {
        ...
        case UINT16:
          {
            ...
            if (v < 0) {
              throw new RuntimeException(
                  "Negative integer for uint16 value: " + v + ", decl=" + decl + ", msg=" + msg);
            } else if (v > UnsignedUtil.MAX_UINT16) {
              throw new RuntimeException(
                  "Signed integer exceeds uint16 range: " + v + ", decl=" + decl + ", msg=" + msg);
            }
        ...
        case UINT32:
          {
            ...
            if (v < 0) {
              throw new RuntimeException(
                  "Negative long for uint32 value: " + v + ", decl=" + decl + ", msg=" + msg);
            } else if (v > UnsignedUtil.MAX_UINT32) {
              throw new RuntimeException(
                  "Signed long exceeds uint32 range: " + v + ", decl=" + decl + ", msg=" + msg);
            }
            // Convert bits to unsigned representation of the same value.
        ...
        default:
          throw new UnsupportedOperationException("metricType=" + metricType + ", metric=" + msg);
      }
    }
  }
}
