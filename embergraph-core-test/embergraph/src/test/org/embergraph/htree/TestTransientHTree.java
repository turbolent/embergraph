...
public class TestTransientHTree extends AbstractHTreeTestCase {
  ...
  public void test_createTransient() {
    ...
    final HTree btree = HTree.createTransient(new HTreeIndexMetadata(UUID.randomUUID()));
  ...
  /** Verifies that closing a transient {@link HTree} is allowed and that all data is discarded. */
  ...
  //		 */
  //		final LinkedList<WeakReference<AbstractPage>> refs = new
  // LinkedList<WeakReference<AbstractPage>>();
  //		{
  //
