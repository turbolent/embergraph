...
public class TestHistoryInstrument extends TestCase2 {
   ...
   * to be overwritten (even if the sample in danger of being overwritten is a <code>null</code>. If
   * we accept a truly random starting time then it is harder to setup the unit tests to test
   * overflow handling.
   */
  private final long t0 = new Random().nextInt(100) * 1000L * 60 * 60;
