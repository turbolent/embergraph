...
public class TestDirectBufferPool extends TestCase2 {
  ...
  public void test_allocateRelease() throws InterruptedException {
    ...
    final int poolAcquiredBefore = DirectBufferPool.INSTANCE.getAcquiredBufferCount();
    ...
    final int poolAcquiredDuring;
    {
      ...
      try {
        ...
        poolAcquiredDuring = DirectBufferPool.INSTANCE.getAcquiredBufferCount();
    ...
    final int poolAcquiredAfter = DirectBufferPool.INSTANCE.getAcquiredBufferCount();
