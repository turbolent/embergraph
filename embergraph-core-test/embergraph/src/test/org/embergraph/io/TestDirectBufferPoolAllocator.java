...
public class TestDirectBufferPoolAllocator extends TestCase2 {
  ...
  public void test_close() {
    ...
    final DirectBufferPoolAllocator fixture = new DirectBufferPoolAllocator(pool);
  ...
  public void test_allocationContextsAreDistinct() {
    ...
    try {
      ...
      final IAllocationContext context1 = fixture.getAllocationContext(key1);
      assertNotNull(context1);

      final IAllocationContext context2 = fixture.getAllocationContext(key2);
  ...
  public void test_allocateThenClose() throws InterruptedException {
    ...
    try {
      ...
      final IAllocationContext context1 = fixture.getAllocationContext(key);
