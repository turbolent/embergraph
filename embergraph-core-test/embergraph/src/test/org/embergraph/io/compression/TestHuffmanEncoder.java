 ...
 * <ul>
 *   <li>
 *   <li>http://www.google.com/search?hl=en&q=Hu-Tucker - google search
 *   <li>http://www.cs.rit.edu/~std3246/thesis/node10.html - detailed online description
 *   <li>T. C. Hu. Combinatorial Algorithms. Addison-Wesley Publishing Co., 1982.
 *   <li>Donald E. Knuth. The Art of Computer Programming, volume 3. Addison-Wesley Publishing Co.,
 *       1973. Sorting and Searching.
 *   <li>http://portal.acm.org/citation.cfm?doid=355602.361319 - published algorithm
 *   <li>http://www.cs.rit.edu/~std3246/thesis/thesis.html - thesis studying the Hu-Tucker
 *       algorithm, implementation strategies, and their performance.
 *   <li>http://www.cse.ucsd.edu/classes/sp07/cse202/lec9.pdf - from a lecture.
 *   <li>http://www.cs.utexas.edu/users/plaxton/c/337/projects/1/desc.pdf - a class project that
 *       describes phase I of the Hu-Tucker algorithm.
 *   <li>Towards a Dynamic Optimal Binary Alphabetic Tree - ftp://dimacs.rutgers.edu
 *       /pub/dimacs/TechnicalReports/TechReports/1999/99-22.ps.gz
 *   <li>Describes an approach to fast sorting (word RAM) using a linear time algorithm as an
 *       alternative to Hu-Tucker.
 * </ul>
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 * @see http://www.zlib.net/ (BSD style license; the Java classes are JNI wrappers that expose part
 *     of this functionality. The JNI interface could doubtless be extended to gain greater access
 *     to the underlying library. madler@alumni.caltech.edu is the remaining active author.)
 * @see http://www.jcraft.com/jzlib/ (BSD style license; this is a pure Java port of the zlib
 *     library and might provide access to the dictionary).
 * @see http://www.oberhumer.com/opensource/lzo/ (GPL license; there is a java binding and it
 *     provides faster compression and extremely fast decompression. There is a pure Java
 *     decompression package, but the compression package is only available in C. The Java code is
 *     also GPL. The author offers the possibility of alternative licensing on request.)
 * @see http://www.faqs.org/faqs/compression-faq/ (FAQs on the compression news group).
 * @see http://www.compressconsult.com/huffman/ (Practical Huffman coding by a data compression
 *     consultant : michael@compressconsult.com).
...
public class TestHuffmanEncoder extends TestCase2 {
  ...
  public void test_huffman() throws IOException {
...

    {
      ...
      System.err.println("  compressed(" + compressed.length + "): " + Arrays.toString(compressed));
   ...
   * based on frequency counts or the entire input.
   *
   ...
   * <p>Instances of this class are NOT thread-safe.
   *
   * @todo This class is unable to notice the end of the compressed input and always processes all
   *     provided input. This means that a run length must be used in the serialization format
   *     before the compressed data when compression ends before the EOF.
   * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
   * @version $Id$
   */
  public static class HuffmanDecoder {
     ...
     * @param nbytes The #of bytes to be decompressed.
