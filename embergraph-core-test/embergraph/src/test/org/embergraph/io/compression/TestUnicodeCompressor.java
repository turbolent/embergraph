 ...
 *       href="http://userguide.icu-project.org/conversion/compression" SCSU </a>)
 *   <li>Byte Order Compression for Unicode (<a href="http://www.unicode.org/notes/tn6/">BOCU </a>).
 *       Note that BOCU has the advantage of SCSU and also maintains code point order (which is not
 *       really the same collation sort keys, but does have better "natural" order than SCSU).
 * </ul>
 *
 * BOCU appears to be better than SCSU for most points, but is slower. Neither of these compression
 * schemes is supported by the native JDK.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id: TestUnicodeCompressor.java 4582 2011-05-31 19:12:53Z thompsonbry $
 */
