...
public class TestHASendAndReceive extends AbstractHASendAndReceiveTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    if (log.isInfoEnabled()) log.info("Using port=" + port);
   ...
   * OP_READ within the ReadTask that can only be processed AFTER the RMI is received, then we
   * should not sen the socket until we have a returned FutureTask.
   *
