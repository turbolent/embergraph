...
public class TestConfigurableAnalyzerFactory extends AbstractAnalyzerFactoryTest {
  ...
  String[] getExtraProperties() {
    ...
    return new String[] {
      ...
      analyzer + "_." + AnalyzerOptions.LIKE,
      "x-empty",
      analyzer + "x-empty." + AnalyzerOptions.ANALYZER_CLASS,
      EmptyAnalyzer.class.getName(),
      analyzer + "x-terms." + AnalyzerOptions.PATTERN,
      "\\W+",
      analyzer + "x-splits." + AnalyzerOptions.ANALYZER_CLASS,
      TermCompletionAnalyzer.class.getName(),
      analyzer + "x-splits." + AnalyzerOptions.STOPWORDS,
      AnalyzerOptions.STOPWORDS_VALUE_NONE,
      analyzer + "x-splits." + AnalyzerOptions.WORD_BOUNDARY,
      " ",
      analyzer + "x-splits." + AnalyzerOptions.SUB_WORD_BOUNDARY,
      "(?<!\\p{L}|\\p{N})(?=\\p{L}|\\p{N})|(?<!\\p{Lu})(?=\\p{Lu})|(?<=\\p{N})(?=\\p{L})",
      ...
      " ",
      analyzer + "x-hyphen." + AnalyzerOptions.ALWAYS_REMOVE_SOFT_HYPHENS,
      "false",
      ...
      " ",
      analyzer + "x-hyphen2." + AnalyzerOptions.ALWAYS_REMOVE_SOFT_HYPHENS,
      "true",
      analyzer + "x-keywords." + AnalyzerOptions.ANALYZER_CLASS,
      KeywordAnalyzer.class.getName(),
      analyzer + "en-x-de." + AnalyzerOptions.ANALYZER_CLASS,
      StandardAnalyzer.class.getName(),
      analyzer + "en-x-de." + AnalyzerOptions.STOPWORDS,
      GermanAnalyzer.class.getName(),
    };
  }
  ...
  private void badCombo(String errorMessage, String... props) {
    ...
    myProps[i] =
        ConfigurableAnalyzerFactory.Options.ANALYZER + "_." + AnalyzerOptions.ANALYZER_CLASS;
  ...
  public void testLikeAndClass() {
    badCombo(
        "exactly one",
        AnalyzerOptions.LIKE,
        "*",
        AnalyzerOptions.ANALYZER_CLASS,
        EmptyAnalyzer.class.getName());
  }
  ...
  public void testLikeAndStopwords() {
    badCombo(
        ...
        AnalyzerOptions.LIKE,
        "*",
        AnalyzerOptions.STOPWORDS,
        AnalyzerOptions.STOPWORDS_VALUE_DEFAULT);
  }
  ...
  public void testCantFindStopWords() {
    badCombo(
        ...
        GermanAnalyzer.class.getName(),
        AnalyzerOptions.STOPWORDS,
        NoStopWordsAnalyzer.class.getName());
  }
  ...
  public void testStopWordSwitch() throws IOException {
    ...
    comparisonTest(
        "en-x-de", true, "The fast car die arrived slowly.", "the fast car arrived slowly");
    comparisonTest(
        "en-x-de", false, "The fast car die arrived slowly.", "the fast car die arrived slowly");
  }
