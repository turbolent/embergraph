...
public abstract class AbstractDefaultAnalyzerFactoryTest extends AbstractAnalyzerFactoryTest {
  ...
  public void testGermanFilterStopWords() throws IOException {
    comparisonTest(
        "ger", //$NON-NLS-1$
        true,
        NonEnglishExamples.getString("AbstractAnalyzerFactoryTest.10")
            + //$NON-NLS-1$
  ...
  public void testRussianFilterStopWords() throws IOException {
    comparisonTest(
        ...
        NonEnglishExamples.getString("AbstractAnalyzerFactoryTest.14")
            + //$NON-NLS-1$
  ...
  public void testGermanNoStopWords() throws IOException {
    comparisonTest(
        "ger", //$NON-NLS-1$
        false,
        NonEnglishExamples.getString("AbstractAnalyzerFactoryTest.18")
            + //$NON-NLS-1$
  ...
  public void testRussianNoStopWords() throws IOException {
    comparisonTest(
        "rus", //$NON-NLS-1$
        false,
        NonEnglishExamples.getString("AbstractAnalyzerFactoryTest.22")
            + //$NON-NLS-1$
  ...
  public void testJapanese() throws IOException {
    for (boolean filterStopWords : new Boolean[] {true, false}) {
      comparisonTest(
          ...
          NonEnglishExamples.getString("AbstractAnalyzerFactoryTest.27")
              + //$NON-NLS-1$
              NonEnglishExamples.getString("AbstractAnalyzerFactoryTest.28")
              + //$NON-NLS-1$
  ...
  public void testConfiguredLanguages() {
    ...
    checkConfig(
        ...
        "zho",
        "chi",
        "zh"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    checkConfig(
        "CJKAnalyzer",
        "jpn",
        "ja",
        "kor",
        "ko"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    checkConfig(
        "CzechAnalyzer",
        "ces",
        "cze",
        "cs"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    checkConfig(
        "DutchAnalyzer",
        "dut",
        "nld",
        "nl"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    checkConfig(
        "GermanAnalyzer",
        "deu",
        "ger",
    ...
    checkConfig(
        ...
        "gre",
        "ell",
        "el"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
