...
public class TestPrefixSearch extends AbstractSearchTest {
  ...
  public void test_prefixSearch() throws InterruptedException {
    ...
    final String languageCode = "EN";
    {
      ...
      // index a document. ("The" is a stopword).
      getNdx()
          .index(buffer, docId + 1, fieldId, languageCode, new StringReader("The slow brown cow"));
    ...
    /* Search (exact match on one document, partial match on the other) */
    {
      ...
      assertEquals(
          ...
          getNdx()
              .count(
                  new FullTextQuery("The quick brown dog", languageCode, false /* prefixMatch */)));
     ...
     */
    {
      ...
      assertEquals(
          2,
          getNdx().count(new FullTextQuery("The qui bro do", languageCode, true /*prefixMatch*/)));
