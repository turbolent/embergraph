 ...
 * @version $Id$
 */
public class TestEmbergraphMap extends TestCase {

    /**
     * 
     */
    public TestEmbergraphMap() {
    }

    /**
     * @param arg0
     */
    public TestEmbergraphMap(String arg0) {
        super(arg0);
    }
    ...
    protected void setUp() throws Exception {
        ...
        map = new EmbergraphMap<String, String>(BTree.create(
     ...
     * {@link EmbergraphMap} and {@link EmbergraphSet} (under the assumption that the
