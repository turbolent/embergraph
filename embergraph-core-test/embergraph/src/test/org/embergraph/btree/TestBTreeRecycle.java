 ...
 *     PhysicalAddressResolutionException after reopen using RWStore and recycler</a>
...
//     * Helper class overrides {@link #recycle(long)} in order to observe
  ...
  private static class RawStoreDeleteListener extends SimpleMemoryRawStore {
    ...
    public void expectDelete(final long addr) {
      ...
      if (addr == IRawStore.NULL) fail("Not allowed to expect a NULL address");
    ...
    public void assertDeleteSetEmpty() {
      ...
      if (!addrs.isEmpty()) fail("expectedDeleteAddrs is not empty: " + addrs);
    }
  ...
  public void test_writeCheckpoint_btree() {
    ...
    try {
      ...
      final BTree btree;
      {
        final IndexMetadata md = new IndexMetadata(getName(), UUID.randomUUID());
       ...
       */
      {
        ...
        assertNotSame(newCheckpoint.getRootAddr(), lastCheckpoint.getRootAddr());
      ...
      if (true) {
        ...
        assertNotSame(newCheckpoint.getMetadataAddr(), lastCheckpoint.getMetadataAddr());
  ...
  public void test_writeCheckpoint_btree_bloomFilter() {
    ...
    try {
       ...
       */
      {
        ...
        assertEquals(IRawStore.NULL, lastCheckpoint.getBloomFilterAddr());
        ...
        assertNotSame(IRawStore.NULL, lastCheckpoint.getBloomFilterAddr());
      }
       ...
       */
      {
        ...
        assertNotSame(newCheckpoint.getBloomFilterAddr(), lastCheckpoint.getBloomFilterAddr());
