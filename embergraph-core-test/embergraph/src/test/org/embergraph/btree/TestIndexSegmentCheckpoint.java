...
public class TestIndexSegmentCheckpoint extends TestCase {
  ...
  public void test_size() {
    ...
    log.warn("UNUSED VERSION0: " + IndexSegmentCheckpoint.SIZEOF_UNUSED_VERSION0);

    log.warn("UNUSED VERSION1: " + IndexSegmentCheckpoint.SIZEOF_UNUSED_VERSION1);

    log.warn("UNUSED VERSION2: " + IndexSegmentCheckpoint.SIZEOF_UNUSED_VERSION2);
  ...
  public void test_write_read01() throws IOException {
    ...
    final long commitTime = System.currentTimeMillis();
    {
      ...
      addrRoot = am.toAddr((int) extentNodes, IndexSegmentRegion.BASE.encodeOffset(offsetNodes));
      ...
      addrMetadata = am.toAddr(sizeMetadata, IndexSegmentRegion.BASE.encodeOffset(offsetMetadata));
    ...
    final IndexSegmentCheckpoint expected =
        new IndexSegmentCheckpoint(
            offsetBits,
            height,
            nleaves,
    ...
    if (log.isInfoEnabled()) log.info("Expected: " + expected);
