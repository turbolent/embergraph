...
public class TestIndexSegmentPlan extends AbstractBTreeTestCase {
   ...
   * int nentries)}.
   *
   * <p>This routine is responsible for deciding how many index entries will go into each leaf of
   * the generated {@link IndexSegment}. In particular, it compensates when there would be an
   * underflow in the last leaf unless we short some of the earlier leaves so that all leaves have
   * at least their minimum capacity.
   *
   * @see src/architecture/btree.xls, which has the examples from which these tests are derived.
   */
  ...
  public void test_distributeKeys_m4() {
    ...
    assertEquals(new int[] {4, 4, 2}, IndexSegmentPlan.distributeKeys(4, (4 + 1) / 2, 3, 10));
  }

  public void test_distributeKeys_m5() {

    assertEquals(new int[] {5, 5}, IndexSegmentPlan.distributeKeys(5, (5 + 1) / 2, 2, 10));
  }

  public void test_distributeKeys_m6() {

    assertEquals(new int[] {6, 4}, IndexSegmentPlan.distributeKeys(6, (6 + 1) / 2, 2, 10));
  }

  public void test_distributeKeys_m7() {

    assertEquals(new int[] {6, 4}, IndexSegmentPlan.distributeKeys(7, (7 + 1) / 2, 2, 10));
  }

  public void test_distributeKeys_m8() {

    assertEquals(new int[] {6, 4}, IndexSegmentPlan.distributeKeys(8, (8 + 1) / 2, 2, 10));
  }

  public void test_distributeKeys_m9() {

    assertEquals(new int[] {5, 5}, IndexSegmentPlan.distributeKeys(9, (9 + 1) / 2, 2, 10));
  }
  ...
  public void test_distributeKeys_rootUnderCapacity() {
    ...
    assertEquals(new int[] {3}, IndexSegmentPlan.distributeKeys(10, (10 + 1) / 2, 1, 3));
  }
