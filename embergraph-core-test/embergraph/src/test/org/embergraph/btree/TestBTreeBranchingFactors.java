...
public class TestBTreeBranchingFactors extends AbstractBTreeTestCase {
   ...
   *
   * <p>Note: We already have coverage for both classes of different branching factors and
   * addressBits. However, this specific value caused
   *
   * <pre>
   * 1 &lt;&lt; addressBits
   * </pre>
   *
   * to wrap to a negative integer and provided the clue that the <code>initialCapacity</code>
   * calculation in the BTree {@link NodeSerializer} was incorrect.
   *
   * @see <a href="https://sourceforge.net/apps/trac/bigdata/ticket/598">B+Tree branching factor and
   *     HTree addressBits are confused in their NodeSerializer implementations </a>
   */
