...
public class TestCopyOnWrite extends AbstractBTreeTestCase {
   ...
   * that they are written out directly. Whenever we make an immutable node or leaf mutable using
   * copy-on-write, we wind up with a new reference for that node or leaf and update the variables
