...
public class TestIndexCounter extends AbstractBTreeTestCase {
  ...
  /** Unit tests for {@link PartitionedCounter} when the partition identifier is ZERO (0). */
  public void test_partitionedCounter_pid0() {
    ...
    final ICounter counter = new PartitionedCounter(pid, new BTree.Counter(btree));
  ...
  /** Unit tests for {@link PartitionedCounter} when the partition identifier is <code>-1</code>. */
  ...
  private static void assertSameCounter(final int pid, final int ctr, final long v0) {
