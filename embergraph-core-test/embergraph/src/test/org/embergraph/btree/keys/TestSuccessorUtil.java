...
public class TestSuccessorUtil extends TestCase2 {
   ...
   *
   * <p>First we verify the data that we are going to use in the test. Each of these asserts
   * verifies that a bit pattern, expressed as an int, is equilivant to the specified float. This
   * SHOULD be true, but it is down to the metal enough to make it worth checking.
   *
   * <p>These test data were derived from: <a
   ...
   * infinity, and negative infinity, but also positive zero and negative zero, which Java hides
   * from you most of the time since positive zero and negative zero compare as equals (for Java).
   *
   * <p>Note: The data points used in this test are verified by the previous test.
   *
   * <p>
   */
  public void test_keyBuilder_successor_float_nearZero() throws NoSuccessorException {
    ...
    assertEquals(
        ...
        SuccessorUtil.successor(Float.intBitsToFloat(0x80000000)));
