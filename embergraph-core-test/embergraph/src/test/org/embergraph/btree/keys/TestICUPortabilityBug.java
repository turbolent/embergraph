 ...
 * @version $Id: TestICUPortabilityBug.java 4313 2011-03-18 13:16:31Z thompsonbry $
 */
public class TestICUPortabilityBug extends TestCase {
  ...
  public void test_ICU_Unicode_SortKey() {
    ...
    System.arraycopy(
        raw.bytes /* src */, 0 /* srcPos */, actual /* dest */, 0 /* destPos */, actual.length);
    ...
    if (VersionInfo.ICU_VERSION.getMajor() == 3 && VersionInfo.ICU_VERSION.getMinor() == 6) {
      ...
      expected =
          new byte[] {
            7, -124, 7, -124, 53, 63, 69, 43, 41, 63, 75, 69, 85, 77, 79, 69, 75, 49, 1, 20, 1, 126,
            -113, -124, -113, 8
          };
    } else if (VersionInfo.ICU_VERSION.getMajor() == 4 && VersionInfo.ICU_VERSION.getMinor() == 8) {
      /*
       * The next bundled version was 4.8.
       */
      expected =
          new byte[] {
            6, 12, 6, 12, 51, 61, 67, 41, 39, 61, 73, 67, 83, 75, 77, 67, 73, 47, 1, 20, 1, 126,
            -113, -124, -113, 8
          };
    } else {
