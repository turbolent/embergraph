...
public class RandomKeysGenerator implements IRabaGenerator {
   ...
   */
  public RandomKeysGenerator(final Random r, final int maxKeys, final int maxKeyLength) {
  ...
  public byte[][] generateKeys(final int nkeys) {
    ...
    if (nkeys < 0) throw new IllegalArgumentException();

    if (nkeys > maxKeys) throw new IllegalArgumentException();
