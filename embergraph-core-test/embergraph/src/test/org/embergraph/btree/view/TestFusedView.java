...
public class TestFusedView extends AbstractBTreeTestCase {
   ...
   * btree to which the write operations are directed).
   */
  public void test_indexStuff() {
     ...
     */
    final FusedView view = new FusedView(new AbstractBTree[] {btree1, btree2});
    ...
    assertSameIterator(new byte[][] {v3a, v7a}, btree2.rangeIterator(null, null));
    assertSameIterator(new byte[][] {v3a, v7a}, view.rangeIterator(null, null));
    ...
    assertSameIterator(new byte[][] {v5a, v7b}, btree1.rangeIterator(null, null));
    assertSameIterator(new byte[][] {v3a, v7a}, btree2.rangeIterator(null, null));
    ...
    assertSameIterator(new byte[][] {v5a, v7b}, btree1.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {null, v5a, v7b},
        btree1.rangeIterator(
            null,
            null,
            0 /* capacity */,
            ...
            null /*filter*/));
    assertSameIterator(new byte[][] {v3a, v7a}, btree2.rangeIterator(null, null));
    assertSameIterator(new byte[][] {v5a, v7b}, view.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {null, v5a, v7b},
        view.rangeIterator(
            null,
    ...
    assertEquals(2, btree2.rangeCount(null, null));
    assertEquals(5, view.rangeCount(null, null));
    assertSameIterator(new byte[][] {v5b, v7b}, btree1.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {null, v5b, v7b},
        btree1.rangeIterator(
            null,
            null,
            0 /* capacity */,
            ...
            null /*filter*/));
    assertSameIterator(new byte[][] {v3a, v7a}, btree2.rangeIterator(null, null));
    assertSameIterator(new byte[][] {v5b, v7b}, view.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {null, v5b, v7b},
        view.rangeIterator(
            null,
     ...
     */
    assertEquals(
        null, view.insert(k3, v3b)); // Note: return is [null] because k3 was deleted in btree1 !
    assertEquals(3, btree1.rangeCount(null, null));
    assertEquals(2, btree2.rangeCount(null, null));
    assertEquals(5, view.rangeCount(null, null));
    assertSameIterator(new byte[][] {v3b, v5b, v7b}, btree1.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {v3b, v5b, v7b},
        btree1.rangeIterator(
            null,
            null,
            0 /* capacity */,
    ...
    assertSameIterator(new byte[][] {v3b, v5b, v7b, v9a}, btree1.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {v3b, v5b, v7b, v9a},
        btree1.rangeIterator(
            null,
            null,
            0 /* capacity */,
            ...
            null /*filter*/));
    assertSameIterator(new byte[][] {v3a, v7a}, btree2.rangeIterator(null, null));
    assertSameIterator(new byte[][] {v3b, v5b, v7b, v9a}, view.rangeIterator(null, null));
    assertSameIterator(
        new byte[][] {v3b, v5b, v7b, v9a},
        view.rangeIterator(
            null,
   ...
   * @todo test bloom filter is not on the mutable index, but is on the 2nd index in the view.
   * @todo test bloom filter is on both and then the mutable index bloom filter gets disabled.
   * @todo test bloom filter is on both and then the 2nd index bloom filter gets disabled.
   */
  ...
  public void test_removeAll_filter() {
    ...
    final ITupleIterator itr =
        view.rangeIterator(
            null /* fromKey */, null /* toKey */, 0 /* capacity */, IRangeQuery.REMOVEALL, filter);
   ...
   * iterator. This test is designed to verify that the filters are in fact applied to the {@link
   * FusedTupleIterator} rather than to the source iterators.
   */
  public void test_filter() {
    ...
    count.set(0);
    assertSameIterator(
        new byte[][] {v3a, v5a, v7a, v9a},
        view.rangeIterator(null, null, 0 /*capacity*/, IRangeQuery.DEFAULT, filter));
    assertEquals(4, count.get());

    // reverse : counts four distinct tuples.
    count.set(0);
    assertSameIterator(
        new byte[][] {v9a, v7a, v5a, v3a},
        view.rangeIterator(
            null, null, 0 /* capacity */, IRangeQuery.DEFAULT | IRangeQuery.REVERSE, filter));
    assertEquals(4, count.get());
  }
   ...
   * order to support an {@link Advancer} over a {@link FusedView} (scale-out for the RDF DB) and
   * the requirement to efficiently choose splits points for an index partition, especially for the
   * {@link SparseRowStore} (it must not split a logical row).
   */
  ...
  public void test_cursor() {
    ...
    final ITupleCursor cursor =
        (ITupleCursor)
            view.rangeIterator(
                null /* fromKey */, null /* toKey */, 0 /* capacity */, flags, null /* filter */);
     ...
     */
    {
      ...
      assertEquals(new TestTuple(flags, k3, v3a), actual = cursor.next());
      assertEquals(1, actual.getSourceIndex());

      assertTrue(cursor.hasNext());
      assertEquals(new TestTuple(flags, k5, v5a), actual = cursor.next());
      assertEquals(0, actual.getSourceIndex());

      assertTrue(cursor.hasNext());
      assertEquals(new TestTuple(flags, k9, v9a), actual = cursor.next());
      assertEquals(1, actual.getSourceIndex());

      assertTrue(cursor.hasNext());
      assertEquals(new TestTuple(flags, k11, v11a), actual = cursor.next());
      assertEquals(0, actual.getSourceIndex());
...

    {
      ...
      assertEquals(new TestTuple(flags, k9, v9a), actual = cursor.prior());
      assertEquals(1, actual.getSourceIndex());

      assertTrue(cursor.hasPrior());
      assertEquals(new TestTuple(flags, k5, v5a), actual = cursor.prior());
      assertEquals(0, actual.getSourceIndex());

      assertTrue(cursor.hasPrior());
      assertEquals(new TestTuple(flags, k3, v3a), actual = cursor.prior());
      assertEquals(1, actual.getSourceIndex());
    ...
    // pre-condition test.
    assertSameIterator(
        new Object[] {v3a, v5a, null /*v7a*/, v9a, v11a},
        new Striterator(
                view.rangeIterator(
                    null,
                    null,
...

    {
      ...
      // post-condition test.
      assertSameIterator(
          new Object[] {v3a, null /*v5a*/, null /*v7a*/, v9a, v11a},
          new Striterator(
                  view.rangeIterator(
                      null,
                      null,
...

    {
      ...
      // post-condition test.
      assertSameIterator(
          new Object[] {v3a, null /*v5a*/, null /*v7a*/, v9a, null /*v11a*/},
          new Striterator(
                  view.rangeIterator(
                      null,
                      null,
