...
public class TestWORMStrategyOneCacheBuffer extends AbstractJournalTestCase {
  ...
  public static Test suite() {
    ...
    final TestWORMStrategyOneCacheBuffer delegate =
        new TestWORMStrategyOneCacheBuffer(); // !!!! THIS CLASS !!!!
    ...
    final ProxyTestSuite suite =
        new ProxyTestSuite(delegate, "DiskWORM Journal Test Suite One Cache Buffer");
  ...
  public Properties getProperties() {
    ...
    properties.setProperty(Options.WRITE_CACHE_BUFFER_COUNT, "" + writeCacheBufferCount);
