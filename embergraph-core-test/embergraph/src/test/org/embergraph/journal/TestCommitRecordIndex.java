...
public class TestCommitRecordIndex extends AbstractCommitRecordTestCase {
  ...
  public void test_basics() {
    ...
    final long addr1 = store.write(ByteBuffer.wrap(CommitRecordSerializer.INSTANCE.serialize(cr1)));
...

    {
      ...
      ndx = (CommitRecordIndex) BTree.load(store, ndx_addr, true /* readOnly */);
