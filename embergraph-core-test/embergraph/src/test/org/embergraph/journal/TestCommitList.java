...
public class TestCommitList extends ProxyTestCase<Journal> {
   ...
   *
   * <p>Note: {@link #test_commitList_001_restartSafe()} SHOULD be maintained in parallel with this
   * test -- it additionally verifies that the changes are made restart safe by the commit.
   *
