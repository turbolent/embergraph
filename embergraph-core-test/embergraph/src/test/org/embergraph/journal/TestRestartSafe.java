...
//     * Re-open the same backing store.
  ...
  public void test_restartSafe01() throws IOException {
    ...
    try {
...

      {
        ...
        assertSameIterator(new Object[] {v1, v2, v3, v4, v5, v6, v7, v8}, btree.rangeIterator());
      ...
      if (journal.isStable()) {
        ...
        final long addr2;
        {
          ...
          final BTree btree = BTree.load(journal, addr1, false /* readOnly */);
       ...
       * restart, re-opening the same file.
         */
        {
          ...
          final BTree btree = BTree.load(journal, addr2, true /* readOnly */);
  ...
  public void test_restartSafe_offsetBits() throws IOException {
    ...
    Journal journal;
    {
      ...
      assertEquals("offsetBits", offsetBits, journal.getRootBlockView().getOffsetBits());
    }
  ...
  public void test_restartSafeCounter() {
    ...
    try {
      ...
      if (journal.isStable()) {
        ...
        final BTree btree = BTree.load(journal, addr1, true /* readOnly */);
  ...
  public void test_restartSafeSubclass() {
    ...
    try {
      ...
      if (journal.isStable()) {
        ...
        final MyBTree btree = (MyBTree) BTree.load(journal, addr1, true /* readOnly */);
