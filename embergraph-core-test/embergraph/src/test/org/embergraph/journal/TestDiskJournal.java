...
public class TestDiskJournal extends AbstractJournalTestCase {
  ...
  public static Test suite() {
    ...
    final ProxyTestSuite suite = new ProxyTestSuite(delegate, "Disk Journal Test Suite");
  ...
  public void test_create_disk01() throws IOException {
    ...
    try {
      ...
      final DiskOnlyStrategy bufferStrategy = (DiskOnlyStrategy) journal.getBufferStrategy();
