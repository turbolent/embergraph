 ...
 * commit time of each.
 *
 * <p>Then the store is closed and re-opened. Looking up the historical values stored against the
 * previous commit times.
 *
 * <p>New data is then committed, resulting in aged records being released and a correct failure to
...
public class TestSimpleReleaseTimes {
  ...
  public static Properties getProperties(String releaseAge) throws IOException {
    ...
    properties.setProperty(
        "org.embergraph.service.AbstractTransactionService.minReleaseAge", releaseAge);
