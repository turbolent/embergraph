 ...
 * all of the generic variety has been factored out.
 *
...
public class AbstractKeyRangeMasterTestCase extends TestCase2 {
  ...
  static class DS {
     ...
     */
    public final void writeChunk(L locator, KVO<O>[] chunk) throws MockStaleLocatorException {
  ...
  static class L extends PartitionLocator {
    ...
    public L(
      ...
      super(partitionId, logicalDataServiceUUID, leftSeparatorKey, rightSeparatorKey);
    }
  }
  ...
  abstract class M extends MockMaster<H, O, KVO<O>, S, L, HS> {
    ...
    final IndexMetadata managedIndexMetadata = new IndexMetadata("test-ndx", UUID.randomUUID());
    ...
    protected S newSubtask(L locator, BlockingBuffer<KVO<O>[]> out) {
      ...
      return new S(this, locator, out) {
        ...
        protected void writeData(KVO<O>[] chunk) {
          ...
          dataServices.get(locator.getDataServiceUUID()).writeChunk(locator, chunk);
        }
      };
    }
     ...
     */
    protected void keyRangePartition(final KVO<O>[] chunk, final boolean reopen)
      ...
      final LinkedList<Split> splits =
          splitter.splitKeys(
              0L /* timestampIsIgnored */, 0 /* fromIndex */, chunk.length /* toIndex */, chunk);
      ...
      for (Split split : splits) {
        ...
        addToOutputBuffer((L) split.pmd, chunk, split.fromIndex, split.toIndex, reopen);
      }
    }
  ...
  static class S extends MockSubtask<H, O, KVO<O>, L, S, HS, M> {
    ...
    public S(final M master, final L locator, final BlockingBuffer<KVO<O>[]> buffer) {
    ...
    protected boolean handleChunk(final KVO<O>[] chunk) throws Exception {
      ...
      if (log.isInfoEnabled()) log.info("wrote chunk: " + this + ", #elements=" + chunk.length);
   ...
   */
  protected void awaitChunksOut(
      final M master, final int expectedChunksOut, final long timeout, final TimeUnit unit)
      throws InterruptedException {
