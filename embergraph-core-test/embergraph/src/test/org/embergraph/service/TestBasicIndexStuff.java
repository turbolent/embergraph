 ...
 * @version $Id$
 */
public class TestBasicIndexStuff extends AbstractEmbeddedFederationTestCase {
  ...
  public void test_onePartition() {
    ...
    assertEquals("indexUUID", metadata.getIndexUUID(), ndx.getIndexMetadata().getIndexUUID());
    ...
    assertSameIterator(
        new byte[][] {new byte[] {1}}, ndx.rangeIterator(new byte[] {}, new byte[] {2}));
    assertSameIterator(
        new byte[][] {new byte[] {1}}, ndx.rangeIterator(new byte[] {1}, new byte[] {2}));
  ...
  public void test_twoPartitions() throws Exception {
    ...
    assertSameIterator(new byte[][] {}, ndx.rangeIterator(null, new byte[] {1}));
    assertSameIterator(
        new byte[][] {new byte[] {1}, new byte[] {5}}, ndx.rangeIterator(new byte[] {1}, null));
    assertSameIterator(new byte[][] {new byte[] {1}}, ndx.rangeIterator(null, new byte[] {2}));
    assertSameIterator(
        new byte[][] {new byte[] {1}, new byte[] {5}}, ndx.rangeIterator(null, null));
    ...
    assertSameIterator(new byte[][] {}, ndx.rangeIterator(new byte[] {1}, new byte[] {2}));
    assertSameIterator(new byte[][] {}, ndx.rangeIterator(null, new byte[] {1}));
    assertSameIterator(new byte[][] {new byte[] {5}}, ndx.rangeIterator(new byte[] {1}, null));
    assertSameIterator(new byte[][] {}, ndx.rangeIterator(null, new byte[] {2}));
