...
public class TestLoadBalancerRoundRobin extends TestCase2 {
  ...
  public void test_roundRobin_2DataServices() throws InterruptedException, TimeoutException {
    ...
    actual = fixture.getUnderUtilizedDataServices(minCount, maxCount, exclude);
  ...
  public void test_roundRobin_NDataServices() throws InterruptedException, TimeoutException {
    ...
    for (int i = 0; i < N; i++) {
      ...
      final UUID[] actual = fixture.getUnderUtilizedDataServices(minCount, maxCount, exclude);
   ...
   * proper behavior is to return all services except the excluded service on each request.
   *
   * @throws TimeoutException
   * @throws InterruptedException
   */
