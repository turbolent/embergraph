...
public class TestThickChunkMessage extends TestCase2 {
  ...
  public void test_oneChunkWithEmptyBindingSet() {
    ...
    final IChunkMessage<IBindingSet> msg =
        (IChunkMessage<IBindingSet>) SerializerUtil.deserialize(SerializerUtil.serialize(msg1));
   ...
   * IChunkMessage}. There is an issue open to change that. See {@link
  ...
  private static class MockQueryController implements IQueryClient, Serializable {
     ...
     * the {@link IQueryPeer} proxy from the {@link IChunkMessage}.
     */
    @Override
