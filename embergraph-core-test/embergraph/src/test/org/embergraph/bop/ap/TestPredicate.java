...
public class TestPredicate extends TestCase2 {
  ...
  public void test_ctor() {

    {
      ...
      final IPredicate<?> p1 =
          new Predicate(
              new IVariableOrConstant[] {u, c1, c2},
  ...
  public void test_equalsSameImpl() {
    ...
    final IPredicate<?> p2 =
        new Predicate(
            new IVariableOrConstant[] {u, c3, c4},
            new NV(Predicate.Annotations.RELATION_NAME, new String[] {relation}));
  ...
  public void test_asBound_1() {
    ...
    doAsBoundTest(p1, new ListBindingSet(new IVariable[] {u}, new IConstant[] {c3}));
  ...
  private void doAsBoundTest(final IPredicate<?> p1, final IBindingSet bindingSet) {
  ...
  public void test_asBound_2() {
    ...
    // already bound on predicate, but has different value in binding set.
    assertEquals(
        c1.get(), p1.asBound(1, new ListBindingSet(new IVariable[] {u}, new IConstant[] {c3})));

    // not bound on the predicate, found in the binding set.
    assertEquals(
        c3.get(), p1.asBound(0, new ListBindingSet(new IVariable[] {u}, new IConstant[] {c3})));
