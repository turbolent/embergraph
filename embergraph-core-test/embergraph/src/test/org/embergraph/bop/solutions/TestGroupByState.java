...
public class TestGroupByState extends TestCase2 {
  ...
  static void assertSameState(final IGroupByState expected, final IGroupByState actual) {

    assertEquals("groupByClause", expected.getGroupByClause(), actual.getGroupByClause());

    assertEquals("groupByVars", expected.getGroupByVars(), actual.getGroupByVars());

    assertEquals("selectClause", expected.getSelectClause(), actual.getSelectClause());

    assertEquals("selectVars", expected.getSelectVars(), actual.getSelectVars());

    assertEquals("havingClause", expected.getHavingClause(), actual.getHavingClause());

    assertEquals("columnVars", expected.getColumnVars(), actual.getColumnVars());

    //        assertEquals("distinctColumnVars", expected.getDistinctColumnVars(),
    //                actual.getDistinctColumnVars());

    assertEquals("anyDistinct", expected.isAnyDistinct(), actual.isAnyDistinct());

    assertEquals("selectDependency", expected.isSelectDependency(), actual.isSelectDependency());

    assertEquals("nestedAggregates", expected.isNestedAggregates(), actual.isNestedAggregates());
  ...
  public void test_aggregateExpr_01() {
    ...
    final MockGroupByState expected =
        new MockGroupByState(
            ...
            columnVars,
            false /* anyDistinct */,
            false /* selectDependency */,
            false /* nestedAggregates */,
            true /* simpleHaving */);
  ...
  public void test_aggregateExpr_02() {
    ...
    final IValueExpression<?>[] select = new IValueExpression[] {new Bind(newVar, org)};
  ...
  public void test_simpleAggregate() {
    ...
    final IValueExpression<?> totalPriceExpr =
        new /* Conditional */ Bind(
            totalPrice, new SUM(false /* distinct */, (IValueExpression<IV>) lprice));
  ...
  public void test_aggregateExpr_03() {
    ...
    final IValueExpression<?> ucaseExpr = new Bind(org2, new UcaseBOp(org, globals));
  ...
  public void test_aggregateExpr_04() {
    ...
    final IValueExpression<?> mathExpr =
        new Bind(
            index, new MathBOp(o, new Constant(new XSDNumericIV(1)), MathBOp.MathOp.PLUS, globals));

    final IValueExpression<?>[] select = new IValueExpression[] {new Bind(index, index)};
  ...
  public void test_simpleHavingClause() {
    ...
    final IValueExpression<IV> xExpr =
        new /* Conditional */ Bind(x, new SUM(false /* distinct */, (IValueExpression<IV>) y));
  ...
  public void test_nestedAggregates() {
    ...
    final IValueExpression<IV> zExpr =
        new /* Conditional */ Bind(
            z,
            new SUM(
                false /* distinct */,
  ...
  public void test_reverseReference_allowed_aka_select_dependency() {
    ...
    final IValueExpression<IV> zExpr =
        new /* Conditional */ Bind(z, new SUM(false /* distinct */, (IValueExpression<IV>) y));

    final IValueExpression<IV> aExpr =
        new /* Conditional */ Bind(
            a,
            new MathBOp(
                new SUM(false /* distinct */, (IValueExpression<IV>) x), z, MathOp.PLUS, globals));
  ...
  public void test_forwardReference_not_allowed() {
    ...
    try {
      ...
      if (log.isInfoEnabled()) log.info("Ignoring expected exception: " + ex, ex);
    }
  }
  ...
  public void test_isAnyDistinct_select() {
    ...
    final IValueExpression<IV> xExpr =
        new /* Conditional */ Bind(x, new SUM(true /* distinct */, (IValueExpression<IV>) y));
  ...
  public void test_with_constant() {
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    final IValueExpression<IV> xExpr =
        new /* Conditional */ Bind(x, new Constant<IV>(new XSDNumericIV(12)));
  ...
  public void test_correctRejection() {
    ...
    try {
      new GroupByState(new IValueExpression[] {} /* select */, groupBy, having);
      fail("Expecting: " + IllegalArgumentException.class);
    } catch (IllegalArgumentException ex) {
      if (log.isInfoEnabled()) log.info("Ignoring expected exception: " + ex, ex);
    }
