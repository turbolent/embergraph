...
public abstract class AbstractAggregationTestCase extends TestCase2 {
  ...
  /**
   * The {@link IQueryContext} - operators which require access to the {@link IMemoryManager} MUST
   * explicitly setup and tear down this field.
   */
   ...
   * @param groupBy The optional GROUP BY clause.
   * @param having The optional HAVING clause.
   * @return The {@link GroupByOp} to be tested.
   */
  protected abstract GroupByOp newFixture(
      final IValueExpression<?>[] select,
      final IValueExpression<?>[] groupBy,
      final IConstraint[] having);

  /**
   * Return <code>true</code> iff the fixture will be a pipelined aggregation operator as defined by
   * {@link GroupByOp#isPipelinedAggregationOp()}. This is used to conditionally modify the behavior
   * of certain tests to verify correct rejection rather of aggregation requests which can not be
   * handled by a pipelined aggregation operator.
   */
  ...
  public void test_aggregation_groupBy_with_aggregate() {
    ...
    final IBindingSet expected[] =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable<?>[] {org, totalPrice}, new IConstant[] {org1, _price21}),
  ...
  public void test_aggregation_groupBy_with_aggregate_and_projected_constant() {
    ...
    final IBindingSet expected[] =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable<?>[] {org, totalPrice, z}, new IConstant[] {org1, _price21, price12}),
          new ListBindingSet(
              new IVariable<?>[] {org, totalPrice, z}, new IConstant[] {org2, _price7, price12})
        };
  ...
  public void test_aggregation_groupBy_with_aggregate_and_having_with_errors() {
    ...
    final IBindingSet data[] =
        new IBindingSet[] {
          ...
          new ListBindingSet(
              new IVariable<?>[] {org, auth, book, lprice},
              new IConstant[] {org1, auth2, book3, blue}),
          new ListBindingSet(
              new IVariable<?>[] {org, auth, book, lprice},
              new IConstant[] {org2, auth3, book4, price7})
        };
  ...
  public void test_aggregation_count_star_no_groups() {
    ...
    //        final IConstant<XSDNumericIV<EmbergraphLiteral>> _totalCount = new
  ...
  public void test_aggregation_without_groupBy_with_nestedAggregate() {
    ...
    try {
      ...
      final IValueExpression<IV> nestedExpr =
          new SUM(
              false /* distinct */, new MathBOp(lprice, sumLPrice, MathBOp.MathOp.PLUS, globals));
  ...
  public void test_aggregation_with_groupBy_with_nestedAggregate() {
    ...
    try {
      ...
      final IBindingSet expected[] =
          new IBindingSet[] {
            new ListBindingSet(
                new IVariable<?>[] {org, totalPrice}, new IConstant[] {org1, _price84}),
            new ListBindingSet(
                new IVariable<?>[] {org, totalPrice}, new IConstant[] {org2, _price14})
          };
  ...
  public void test_aggregation_withoutGroupBy_withSelectDependency() {
    ...
    try {
      ...
      final IValueExpression<IV> inflatedPriceExpr =
          new Bind(
              inflatedPrice,
              new MathBOp(
      ...
      final IBindingSet expected[] =
          new IBindingSet[] {
            new ListBindingSet(
                new IVariable<?>[] {totalPrice, inflatedPrice},
                new IConstant[] {_price28, _price56})
          };
  ...
  public void test_aggregation_withGroupBy_withSelectDependency() {
    ...
    try {
      ...
      final IBindingSet expected[] =
          new IBindingSet[] {
            new ListBindingSet(
                new IVariable<?>[] {org, totalPrice, inflatedPrice},
                new IConstant[] {org1, _price21, _price42}),
            new ListBindingSet(
                new IVariable<?>[] {org, totalPrice, inflatedPrice},
                new IConstant[] {org2, _price7, _price14})
          };
  ...
  public void test_aggregation_groupBy_by_error_values1() {
    ...
    try {
      ...
      // SAMPLE(?v) AS ?S
      final IValueExpression<IV> sampleVAsS =
          new Bind(S, new SAMPLE(false /* distinct */, (IValueExpression<IV>) v));
