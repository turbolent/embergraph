...
public class TestDistinctTermScanOp extends TestCase2 {
   ...
   * E(lement) type that use IVs to write this test.
   */
  ...
  //
  //        final IAsynchronousIterator<IBindingSet[]> source = new
  // ThickAsynchronousIterator<IBindingSet[]>(
  //                new IBindingSet[][] { new IBindingSet[] { new ListBindingSet()} });
  //
  //        final IBlockingBuffer<IBindingSet[]> sink = new
  // BlockingBufferWithStats<IBindingSet[]>(query, stats);
  //
