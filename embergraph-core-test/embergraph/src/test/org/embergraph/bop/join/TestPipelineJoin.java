...
public class TestPipelineJoin extends TestCase2 {
  ...
  public void test_join_noSharedVariables_emptySourceSolution()
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {Var.var("x")}, new IConstant[] {new Constant<String>("John")}),
          new ListBindingSet(
              new IVariable[] {Var.var("x")}, new IConstant[] {new Constant<String>("Paul")}),
        };
  ...
  public void test_join_constraint() throws InterruptedException, ExecutionException {
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {Var.var("y")}, new IConstant[] {new Constant<String>("John")})
        };
  ...
  public void test_join_selectVariables() throws InterruptedException, ExecutionException {
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {Var.var("y")}, new IConstant[] {new Constant<String>("Mary")}),
          new ListBindingSet(
              new IVariable[] {Var.var("y")}, new IConstant[] {new Constant<String>("Paul")}),
          new ListBindingSet(
              new IVariable[] {Var.var("y")}, new IConstant[] {new Constant<String>("John")}),
          new ListBindingSet(
              new IVariable[] {Var.var("y")}, new IConstant[] {new Constant<String>("Paul")}),
          new ListBindingSet(
              new IVariable[] {Var.var("y")}, new IConstant[] {new Constant<String>("Leon")}),
        };
  ...
  public void test_optionalJoin() throws InterruptedException, ExecutionException {
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          ...
          new ListBindingSet(new IVariable[] {x}, new IConstant[] {new Constant<String>("Luke")}),
        };
    ...
    final PipelineJoin<E> query =
        new PipelineJoin<E>(
            ...
            new NV(
                PipelineJoin.Annotations.CONSTRAINTS,
                new IConstraint[] {
                  Constraint.wrap(new NEConstant(x, new Constant<String>("Paul")))
                }));
