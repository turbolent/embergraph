 ...
 *
 * <p>TODO Verify application of constraints, but only to the non-optional solutions (so this means
 * a test with optionals and also we need a test w/o constraints).
 *
 * <p>TODO See {@link TestHTreeHashJoinOp} and some of the other join test suites for some of these
 * variations.
 *
...
public abstract class AbstractHashJoinUtilityTestCase extends TestCase {
  ...
  protected static void assertSameSolutionsAnyOrder(
    ...
    AbstractQueryEngineTestCase.assertSameSolutionsAnyOrder(expected, actual);
  }
  ...
  protected void doHashJoinTest(
    ...
    final PipelineOp op =
        new MockPipelineOp(
            BOp.NOARGS,
            new NV(HTreeHashJoinAnnotations.RELATION_NAME, new String[] {getName()}),
    ...
    try {
       ...
       */
      {
        ...
        //                final ICloseableIterator<IBindingSet> leftItr = new
        // CloseableIteratorWrapper<IBindingSet>(
        //                        left.iterator());
   ...
   * @param joinType The type of operation to be performed.
   * @return
   */
  protected abstract IHashJoinUtility newHashJoinUtility(
      PipelineOp op, final JoinTypeEnum joinType);
  ...
  public void test_hashJoin03() {
    ...
    // the join constraints.
    final IConstraint[] constraints =
        new IConstraint[] {Constraint.wrap(new EQConstant(a, new Constant<IV>(setup.john)))};
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          ...
          new ListBindingSet(
              new IVariable[] {x, y},
              new IConstant[] {
                new Constant<IV>(setup.brad), new Constant<IV>(setup.fred),
              }),
        };
  ...
  public void test_hashJoin05() {
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.mary)}),
          new ListBindingSet(
              new IVariable[] {a, x, y},
              new IConstant[] {
   ...
   * and the solutions can not conflict as they do not bind the same variables for the non-join
   * variables).
   *
   * <p>The following represents the solutions for each source organized by the join variable <code>
   * ?a</code>.
   *
   * <pre>
   * (?a,     ?x)   (?a,     ?y)
  ...
  public void test_mergeJoin01() {
    ...
    @SuppressWarnings("rawtypes")
    final IBindingSet[] firstSolutions =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.mary)}),
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.leon)}),
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.mary), new Constant<IV>(setup.john)}),
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.fred), new Constant<IV>(setup.brad)}),
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.leon), new Constant<IV>(setup.john)}),
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.leon), new Constant<IV>(setup.mary)}),
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.paul), new Constant<IV>(setup.leon)}),
        };
    assertEquals(7, firstSolutions.length);

    /** Setup the source solutions for [other]. */
    @SuppressWarnings("rawtypes")
    final IBindingSet[] otherSolutions =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.brad)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.fred)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.leon)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.mary), new Constant<IV>(setup.brad)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.brad), new Constant<IV>(setup.fred)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.leon), new Constant<IV>(setup.brad)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.paul), new Constant<IV>(setup.leon)}),
          new ListBindingSet(
              new IVariable[] {a, y},
              new IConstant[] {new Constant<IV>(setup.paul), new Constant<IV>(setup.brad)}),
        };
    ...
    try {
      ...
      first = newHashJoinUtility(firstOp, optional ? JoinTypeEnum.Optional : JoinTypeEnum.Normal);

      other = newHashJoinUtility(otherOp, optional ? JoinTypeEnum.Optional : JoinTypeEnum.Normal);
   ...
   *
   * @param optional
   * @param constrain When <code>true</code>, we constrain <code>?y = brad</code>
   */
  @SuppressWarnings("rawtypes")
  public void mergeJoin03(final boolean optional, final boolean constrain) {
    ...
    final IConstraint[] constraints =
        constrain
            ? new IConstraint[] {
              Constraint.wrap(new EQConstant(y, new Constant<IV>(setup.brad))),
            }
            : null;
    ...
    final IBindingSet[] firstSolutions =
        new IBindingSet[] {
          ...
          new ListBindingSet(
              new IVariable[] {a, x},
              new IConstant[] {new Constant<IV>(setup.fred), new Constant<IV>(setup.leon)})
        };
    ...
    /** Setup the source solutions for [other]. */
    final IBindingSet[] moreSolutions =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {a, z},
              new IConstant[] {new Constant<IV>(setup.john), new Constant<IV>(setup.mary)}),
    ...
    try {
      ...
      more = newHashJoinUtility(moreOp, optional ? JoinTypeEnum.Optional : JoinTypeEnum.Normal);
   ...
   *     [first] and [others] are considered together.
  ...
  public void test_exists_01() {
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {person}, new IConstant[] {new Constant<IV>(setup.alice)}),
        };
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              ...
              new IConstant[] {new Constant<IV>(setup.b), new Constant<IV>(setup.three)}),
        };

    doHashJoinTest(
        JoinTypeEnum.NotExists, joinVars, selectVars, constraints, left, right, expected);
  }
...
//     * Unit tests for NOT EXISTS based on Sesame <code>sparql11-exists-06</code>
  ...
  public void test_service02() {
    ...
    // The expected solutions to the join.
    final IBindingSet[] expected =
        setup.getServiceCall2JoinSolutions().toArray(new IBindingSet[] {});
   ...
   * variables are dropped by the projection. We model the projection here in order to compare
   * directly to the expected solutions for the query.
   */
  public void test_service02b() {
     ...
     * </pre>
     *
     * This is the non-OPTIONAL ServiceCallJoin solution. It combines the first left solution with
     * the first (and only) right solution.
     *
     * <pre>
     *     <result>
    ...
    final IBindingSet[] expected =
        new IBindingSet[] {
          new ListBindingSet(
              new IVariable[] {s, o1},
              new IConstant[] {new Constant<IV>(setup.b), new Constant<IV>(setup.bob)}),
          new ListBindingSet(
              new IVariable[] {s, o1, o2},
              new IConstant[] {
                new Constant<IV>(setup.a),
  ...
  public void test_service04a() {
    ...
    // The expected solutions to the join.
    final IBindingSet[] expected =
        setup.getServiceCallJoinSolutions().toArray(new IBindingSet[] {});
  ...
  public void test_service04b() {
    ...
    // The expected solutions to the join.
    final IBindingSet[] expected = setup.getOptionalGroupSolutions().toArray(new IBindingSet[] {});
