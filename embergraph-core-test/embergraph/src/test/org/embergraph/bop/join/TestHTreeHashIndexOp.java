...
public class TestHTreeHashIndexOp extends HashIndexOpTestCase {
  ...
  @Override
  protected HashIndexOp newHashIndexOp(final String namespace, final BOp[] args, final NV... anns) {
    ...
    final NV[] anns2 =
        concat(
            anns1,
            new NV[] {
              new NV(HTreeHashJoinAnnotations.RELATION_NAME, new String[] {namespace}),
              new NV(
                  HashIndexOp.Annotations.HASH_JOIN_UTILITY_FACTORY, HTreeHashJoinUtility.factory),
            });
  ...
  @Override
  protected SolutionSetHashJoinOp newSolutionSetHashJoinOp(final BOp[] args, final NV... anns) {
   ...
   * must be specified; last pass semantics must be requested, etc).
   */
  public void test_hashIndexOp_ctor() {
    ...
    new HashIndexOp(
        ...
        new NV(HashIndexOp.Annotations.HASH_JOIN_UTILITY_FACTORY, HTreeHashJoinUtility.factory),
