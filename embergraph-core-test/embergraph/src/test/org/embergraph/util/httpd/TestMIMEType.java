...
public class TestMIMEType extends TestCase {
  ...
  private final NVPair[] EMPTY = new NVPair[] {};
  ...
  public abstract static class Criteria {
    ...
    public void test(MIMEType t) throws AssertionFailedError {

      if (!getType().equalsIgnoreCase(t.getType())) {

        throw new AssertionFailedError("MIME type should be " + getType() + ", not " + t.getType());
      }

      if (!getSubtype().equalsIgnoreCase(t.getSubtype())) {

        throw new AssertionFailedError(
            "MIME subtype should be " + getSubtype() + ", not " + t.getSubtype());
      }

      // should always be true.
      assertEquals(t.getParams().length, t.getParamCount());
      ...
      for (int i = 0; i < params.length; i++) {
        ...
        if (foundValue == null) {
          ...
          throw new AssertionFailedError("Should have found MIME parameter named " + attribute);
        }
   ...
   */
  public static void doAcceptanceTest(String data, Criteria criteria) {
    ...
    try {
      ...
      throw new AssertionFailedError2("data = '" + data + "'", ex);
    }
    ...
    try {
      ...
      MIMEType t2 = new MIMEType(roundTripData);
      ...
      throw new AssertionFailedError2(
          "data = '" + data + "'" + ", roundTripData = '" + roundTripData + "'", ex);
    }
  }

  /** Test helper submits data that should produce an exception of the indicated class. */
  public static void doRejectionTest(String data, Class exceptionClass) {

    try {

      MIMEType t = new MIMEType(data);
    ...
    throw new AssertionFailedError(
        "Should have thrown " + exceptionClass + " for data='" + data + "'");
  }

  /** Helper class. */
  public static class AssertionFailedError2 extends AssertionFailedError {

    public AssertionFailedError2(String msg, Throwable t) {
  ...
  public void testAccept5() {
    doAcceptanceTest(
        ...
        new Criteria() {
          ...
          public NVPair[] getParams() {
            return new NVPair[] {new NVPair("a", "b"), new NVPair("charset", "UTF-8")};
          }
        });
  }
  ...
  public void testAcceptMultipart_1() {
    doAcceptanceTest(
        "multipart/mixed" + "; boundary=\"----\\=_Part_67_3945427.1085762166434\"",
        new Criteria() {
          public String getType() {
            return "multipart";
          }
  ...
  public void testAcceptMultipart_2() {
    doAcceptanceTest(
        ...
        new Criteria() {
          ...
          public NVPair[] getParams() {
            return new NVPair[] {
              new NVPair("protocol", "application/pgp-signature"),
              new NVPair("micalg", "pgp-sha1"),
              new NVPair("boundary", "Apple-Mail-3-78839501")
            };
          }
        });
  }
   ...
   * part of the test harness for classes that extend {@link MIMEType}.
   *
   * <p>
   */
  public static void doEqualTest(MIMEType t1, MIMEType t2) {
    ...
    try {
      ...
      throw new AssertionFailedError2(
          "Comparing equal" + ": t1='" + t1 + "'" + ", t2='" + t2 + "'", ex);
    }
  }
  ...
  public static void doNotEqualTest(MIMEType t1, MIMEType t2) {
    ...
    try {
      ...
      throw new AssertionFailedError2(
          "Comparing NOT equal" + ": t1='" + t1 + "'" + ", t2='" + t2 + "'", ex);
    }
  }
   ...
   * <p>
   */
  public static void doSpansTest(MIMEType t1, MIMEType t2, boolean compareParams) {

    try {

      assertTrue(t1.spans(t2, compareParams));
  ...
  public static void doDoesNotSpanTest(MIMEType t1, MIMEType t2, boolean compareParams) {
    ...
    try {
      ...
      assertFalse(t1.spans(t2, compareParams));
  ...
  public void test_spans_when_A_equals_B() {
    ...
    doSpansTest(
        new MIMEType("text/xml"), new MIMEType("text/xml"), true // compare parameters.
        );
  }
  ...
  public void test_spans_when_A_equals_B_same_params() {
    ...
    doSpansTest(
        new MIMEType("text/xml;a=a"), new MIMEType("text/xml;a=a"), true // compare parameters.
        );
  }
  ...
  public void test_spans_will_ingore_parameters_when_asked_to() {
    ...
    doSpansTest(
        new MIMEType("text/xml;a=a"), new MIMEType("text/xml;b=a"), false // compare parameters.
        );
  }
  ...
  public void test_spans_subtype_1() {
    ...
    doSpansTest // no params.
        (new MIMEType("text/*"), new MIMEType("text/xml"), true);
  }

  public void test_spans_subtype_2() {

    doSpansTest // same params.
        (new MIMEType("text/*;a=a"), new MIMEType("text/xml;a=a"), true);
  }
  ...
  public void test_no_intersection_3() {
    ...
    doIntersectionTest(
        new MIMEType("text/xml;lang=en-us"), new MIMEType("text/text;charset=US-ASCII"), null);
  }

  public static void doIntersectionTest(MIMEType a, MIMEType b, MIMEType expectedResult) {

    MIMEType actualResult = a.getIntersection(b, new String[] {});
    ...
    if (expectedResult == null) {
      ...
      fail("Expecting null intersection, but found" + ": \"" + actualResult + "\"");
    }
    ...
    assertTrue("The intersection is correct", expectedResult.isExactMatch(actualResult));
  }
}
