...
public class TestRuleState extends TestCase2 {
  ...
  public void test_requiredVars() {
    ...
    final IVariable[] requiredVars = new IVariable[] {Var.var("a")};

    final Rule rule = new Rule("", null, tails, QueryOptions.NONE, null, null, null, requiredVars);

    final int[] order = new int[] {1, 2, 3, 0};
