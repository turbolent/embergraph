...
public class TestThickCloseableIterator extends TestCase2 {
  ...
  protected void doRoundTripTest(final String[] expected, final ICloseableIterator<String> itr) {

    @SuppressWarnings("unchecked")
    final ICloseableIterator<String> itr2 =
        (ICloseableIterator<String>) SerializerUtil.deserialize(SerializerUtil.serialize(itr));
  ...
  protected void assertSameIterator(
      final String[] expected, final ICloseableIterator<String> actual) {
