...
public class InnerCause {
  ...
  public static Throwable getInnerCause(Throwable t, final Class<? extends Throwable> cls) {
  ...
  public static boolean isInnerCause(final Throwable t, final Class<? extends Throwable> cls) {
