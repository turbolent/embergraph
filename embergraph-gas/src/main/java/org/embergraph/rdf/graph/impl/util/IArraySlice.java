...
public interface IArraySlice<T> extends Iterable<T> {
  ...
  /*
   * Absolute bulk <i>put</i> copies all values in the caller's array into this buffer starting at
   * the specified position within the slice defined by this buffer.
   *
   * @param pos The starting position within the slice defined by this buffer.
   * @param src The source data.
   */
  void put(int pos, T[] src);

  /*
   * Absolute bulk <i>put</i> copies the specified slice of values from the caller's array into this
   * buffer starting at the specified position within the slice defined by this buffer.
   *
   * @param dstoff The offset into the slice to which the data will be copied.
   * @param src The source data.
   * @param srcoff The offset of the 1st value in the source data to be copied.
   * @param srclen The #of values to be copied.
   */
  void put(int dstoff, T[] src, int srcoff, int srclen);

  /*
   * Absolute bulk <i>get</i> copies <code>dst.length</code> values from the specified offset into
   * the slice defined by this buffer into the caller's array.
   *
   * @param srcoff The offset into the slice of the first value to be copied.
   * @param dst The array into which the data will be copied.
   */
  void get(final int srcoff, final T[] dst);

  /*
   * Absolute bulk <i>get</i> copies the specified slice of values from this buffer into the
   * specified slice of the caller's array.
   *
   * @param srcoff The offset into the slice defined by this buffer of the first value to be copied.
   * @param dst The array into which the data will be copied.
   * @param dstoff The offset of the first value in that array onto which the data will be copied.
   * @param dstlen The #of values to be copied.
   */
