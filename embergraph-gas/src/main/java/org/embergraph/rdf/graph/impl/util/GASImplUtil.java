...
public class GASImplUtil {
   ...
   * Compact a collection of vertices into an ordered frontier.
   *
   * @param vertices The collection of vertices for the new frontier.
   * @param buffer The backing buffer for the new frontier - it will be resized if necessary.
   * @return A slice onto just the new frontier.
   */
  public static IArraySlice<Value> compactAndSort(
      final Set<Value> vertices, final IManagedArray<Value> buffer) {
