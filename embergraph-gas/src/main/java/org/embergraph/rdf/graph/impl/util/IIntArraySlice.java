...
public interface IIntArraySlice {
   ...
   * @param src The source data.
   * @param srcoff The offset of the 1st <code>int</code> in the source data to be copied.
   * @param srclen The #of <code>int</code>s to be copied.
   */
   ...
   *
   * @param srcoff The offset into the slice of the first <code>int</code> to be copied.
   ...
   *
   * @param srcoff The offset into the slice defined by this buffer of the first <code>int</code> to
   *     be copied.
   * @param dst The array into which the data will be copied.
   * @param dstoff The offset of the first <code>int</code> in that array onto which the data will
   *     be copied.
   * @param dstlen The #of <code>int</code>s to be copied.
   */
  void get(final int srcoff, final int[] dst, final int dstoff, final int dstlen);
}
