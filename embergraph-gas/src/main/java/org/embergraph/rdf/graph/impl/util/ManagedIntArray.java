 ...
 *     <p>TODO Refactor to create a test suite for this.
 */
public class ManagedIntArray implements IManagedIntArray {
  ...
  @Override
  public final void put(final int pos, final int[] b) {

    put(pos, b, 0, b.length);
  }

  @Override
  public final void put(final int pos, final int[] b, final int off, final int len) {
  ...
  @Override
  public final void get(final int srcoff, final int[] dst) {

    get(srcoff, dst, 0 /* dstoff */, dst.length);
  }

  @Override
  public final void get(final int srcoff, final int[] dst, final int dstoff, final int dstlen) {

    System.arraycopy(buf, srcoff, dst, dstoff, dstlen);
  }

  @Override
  public final void putInt(final int pos, final int v) {
  ...
  @Override
  public final int getInt(final int pos) {
  ...
  private class SliceImpl implements IIntArraySlice {
    ...
    @Override
    public final void put(final int dstoff, final int[] src, final int srcoff, final int srclen) {
