...
public class BFS extends BaseGASProgram<BFS.VS, BFS.ES, Void>
  ...
  private static final Factory<Value, BFS.VS> vertexStateFactory =
      new Factory<Value, BFS.VS>() {
  ...
  public void initVertex(
      final IGASContext<BFS.VS, BFS.ES, Void> ctx,
      final IGASState<BFS.VS, BFS.ES, Void> state,
      final Value u) {
  ...
  /** Not used. */
  @Override
  public Void sum(final IGASState<BFS.VS, BFS.ES, Void> state, final Void left, final Void right) {
  ...
  /** NOP */
  @Override
  public BFS.VS apply(final IGASState<BFS.VS, BFS.ES, Void> state, final Value u, final Void sum) {
   ...
   *   <dt>{@value Bindings#PREDECESSOR}
   *   <dd>The predecessor is the first vertex that discovers a given vertex during traversal.
   * </dl>
   */
  @Override
  public List<IBinder<BFS.VS, BFS.ES, Void>> getBinderList() {
    ...
    tmp.add(
        new BinderBase<BFS.VS, BFS.ES, Void>() {
          ...
          @Override
          public Value bind(
              final ValueFactory vf, final IGASState<BFS.VS, BFS.ES, Void> state, final Value u) {
  ...
  //
  //        private final ConcurrentHashMap<Integer, AtomicLong> values = new
