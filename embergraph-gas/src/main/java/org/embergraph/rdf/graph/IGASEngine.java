...
public interface IGASEngine {
   ...
   * @param program The program to execute against that graph.
   ...
   *     {@link IGASProgram}.
   * @param <ST> The generic type for the SUM. This is often directly related to the generic type
   *     for the per-edge state, but that is not always true. The SUM type is scoped to the GATHER +
   *     SUM operation (NOT the computation).
   */
