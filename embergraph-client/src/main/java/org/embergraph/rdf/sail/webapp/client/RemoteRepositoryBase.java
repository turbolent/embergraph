...
public class RemoteRepositoryBase extends RemoteRepositoryDecls {
   ...
   *     <p>FIXME Configure ContextPath, but NOT with EmbergraphStatics since that will drag in code
   *     outside of this package. Instead, make this a System property or constructor property or
   *     parse it out of the request URL.
   *     <p>FIXME Actually, the situation is a bit worse. The ContextPath might not appear in the
   ...
   * @throws IOException
   */
  public static JettyResponseListener checkResponseCode(
      final JettyResponseListener responseListener) throws IOException {
   ...
   * @throws Exception
   */
  public static Graph asGraph(final GraphQueryResult result) throws Exception {
  ...
  protected static byte[] serialize(
      final Iterable<? extends Statement> stmts, final RDFFormat format) throws Exception {
  ...
  protected static MutationResult mutationResults(final JettyResponseListener response)
      throws Exception {
  ...
  protected static BooleanResult booleanResults(final JettyResponseListener response)
      throws Exception {
  ...
  protected static RangeCountResult rangeCountResults(final JettyResponseListener response)
      throws Exception {
  ...
  protected static ContextsResult contextsResults(final JettyResponseListener response)
      throws Exception {
      ...
      parser.parse(
          ...
          new DefaultHandler2() {
            ...
            public void startElement(
              ...
              if ("context".equals(qName)) contexts.add(new URIImpl(attributes.getValue("uri")));
            }
          });
  ...
  protected static String[] toStrings(final Resource[] resources) {
