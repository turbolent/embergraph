 ...
 *      EmbergraphSailRemoteRepositoryConnection should implement interface methods
 *      </a>
 * 
...
public class EmbergraphSailRemoteRepositoryConnection implements RepositoryConnection {
   ...
   private static final transient Logger log = Logger
         .getLogger(EmbergraphSailRemoteRepositoryConnection.class);

    private final EmbergraphSailRemoteRepository repo;

    public EmbergraphSailRemoteRepositoryConnection(
