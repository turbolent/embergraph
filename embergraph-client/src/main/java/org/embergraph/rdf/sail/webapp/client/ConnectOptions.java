...
public class ConnectOptions extends AbstractConnectOptions {
   ...
   * encapsulate this within the scope of the logic that manages its value and pass it through
   * function calls rather than by side effect on this object.
   */
   ...
   * @param useLBS When <code>true</code> the load balancer aware paths will be used.
