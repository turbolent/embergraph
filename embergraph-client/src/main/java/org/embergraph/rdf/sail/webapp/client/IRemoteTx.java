...
public interface IRemoteTx extends IRemoteTxState0 {
   ...
   * time.
   *
   * <p>Note: transactions always validate during {@link #commit()}. Invoking this method explicitly
   * is discouraged since it just adds overhead unless you are actually going to gain something from
   * the information.
   *
   * @throws RemoteTransactionValidationException if the transaction was not found on the server.
   */
   ...
   * in order to release the resources on the server!
   *
   * @throws RemoteTransactionValidationException if the transaction was not found on the server.
   */
