...
public class EmbergraphRemoteTupleQuery extends AbstractEmbergraphRemoteQuery implements TupleQuery {

	private IPreparedTupleQuery q;

	public EmbergraphRemoteTupleQuery(RemoteRepository remote, String query, String baseURI) throws Exception {
		super(baseURI);
