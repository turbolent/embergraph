...
public class BackgroundGraphResult implements GraphQueryResult, Runnable, RDFHandler {
  ...
  public BackgroundGraphResult(
      final QueueCursor<Statement> queue,
   ...
   * Thread} after the flow of control leaves {@link #run()} (at which point it might even be
  ...
  public void handleStatement(final Statement st) throws RDFHandlerException {
    ...
    if (closed) throw new RDFHandlerException("Result closed");
    try {
      queue.put(st);
    } catch (InterruptedException e) {
