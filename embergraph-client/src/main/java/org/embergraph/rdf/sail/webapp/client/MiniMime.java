 ...
 * correctly, but largely assumes that such whitespace is omitted.
 *
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 *     <p>TODO Lift out patterns.
 */
public class MiniMime {
  ...
  public MiniMime(final String s) {
    ...
    if (log.isDebugEnabled()) log.debug("Considering: " + s + " :: q=" + q);
    this.q = q;
  }
   ...
   * @return The value for that parameter and the caller's default value otherwise.
   */
   ...
   * </ul>
   *
   * @return The value of the <code>charset</code> parameter and <code>null</code> if that parameter
   *     was not given.
   */
