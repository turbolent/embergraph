 ...
 *   <li>Sets up redirect handling.
 *   <li>Sets a default SSL context factory. By default the {@link SslContextFactory} will trusts
 *       all certificates. This allows encrypted communications with any SSL endpoint, but it does
 *       not verify the identity associated with that certificate. You can change the default
 *       behavior by specify the {@link Options#SSL_KEYSTORE_PATH} system property.
 * </ul>
 *
 * @see Options
 */
public final class DefaultHttpClientFactory implements IHttpClientFactory {
  ...
  public interface Options {
     ...
     * the Jetty response buffer (default @value {@value #DEFAULT_RESPONSE_BUFFER_SIZE})
     *
     * @see <a href="http://trac.blazegraph.com/ticket/1092">Set query timeout and response buffer
    ...
    /**
     * The name of the system property that may be used to specify the maximum size (in bytes) for
     * the Jetty request buffer (default @value {@value #DEFAULT_REQUEST_BUFFER_SIZE})
     *
     * @see <a href="http://trac.blazegraph.com/ticket/1096">Set jetty request buffer size</a>
     */
  ...
  public HttpClient newInstance() {
    ...
    final AutoCloseHttpClient cm;
    {
      final String sslKeystorePath =
          System.getProperty(Options.SSL_KEYSTORE_PATH, Options.DEFAULT_SSL_KEYSTORE_PATH);
    ...
    try {
      ...
      final boolean followRedirects =
          Boolean.valueOf(
              System.getProperty(Options.FOLLOW_REDIRECTS, Options.DEFAULT_FOLLOW_REDIRECTS));
