...
public class EmbergraphRemoteGraphQuery extends AbstractEmbergraphRemoteQuery implements GraphQuery {

	private IPreparedGraphQuery q;

	public EmbergraphRemoteGraphQuery(RemoteRepository remote, String query, String baseURI) throws Exception {
		super(baseURI);
