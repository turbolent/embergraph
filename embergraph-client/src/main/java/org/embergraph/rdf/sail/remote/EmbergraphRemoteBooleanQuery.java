...
public class EmbergraphRemoteBooleanQuery extends AbstractEmbergraphRemoteQuery implements BooleanQuery {

	private IPreparedBooleanQuery q;

	public EmbergraphRemoteBooleanQuery(RemoteRepository remote, String query, String baseURI) throws Exception {
		super(baseURI);
