 ...
 * 
 * @see <a href="http://trac.bigdata.com/ticket/1152" > EmbergraphSailFactory must be
...
//        Persistent
    ...
    */
   public static EmbergraphSailRemoteRepository connect(final String host,
         final int port) {
	 ...
	 */
   public static EmbergraphSailRemoteRepository connect(
    ...
    *      EmbergraphSailFactory.connect() </a>
    */
