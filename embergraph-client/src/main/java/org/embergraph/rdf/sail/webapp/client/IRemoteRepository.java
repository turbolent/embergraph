 ...
 * metadata about the database (e.g. what mode it's in).
 */
public interface IRemoteRepository {
   ...
   *
   * <ul>
   *   <li><code>AddOp(InputStream in, String baseURI, RDFFormat format)</code>
   *   <li><code>AddOp(Iterable<Statement> stmts)</code>
   ...
   *
   * <ul>
   *   <li><code>RemoveOp(InputStream in, String baseURI, RDFFormat format)</code>
   *   <li><code>RemoveOp(Iterable<Statement> stmts)</code>
   *   <li><code>RemoveOp(URI s, URI p, Value o, URI c)</code>
