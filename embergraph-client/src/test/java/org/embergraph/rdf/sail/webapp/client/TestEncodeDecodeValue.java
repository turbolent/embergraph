...
public class TestEncodeDecodeValue extends TestCase2 {
  ...
  public void test_encodeDecode_URI() {
    ...
    doTest("<http://www.embergraph.org>", new URIImpl("http://www.embergraph.org"));
  ...
  public void test_encodeDecode_Literal_datatype() {
    ...
    doTest(
        "\"abc\"^^<http://www.embergraph.org/dt1>",
        new LiteralImpl("abc", new URIImpl("http://www.embergraph.org/dt1")));

    doTest(
        "\"\"^^<http://www.embergraph.org/dt1>",
        new LiteralImpl("", new URIImpl("http://www.embergraph.org/dt1")));

    doTest(
        "\"'ab'c'\"^^<http://www.embergraph.org/dt1>",
        new LiteralImpl("'ab\'c'", new URIImpl("http://www.embergraph.org/dt1")));
  }
   ...
   * @param expectedValue The given RDF {@link Value}.
   */
  private void doTest(final String expectedString, final Value expectedValue) {

    final String actualString = EncodeDecodeValue.encodeValue(expectedValue);

    assertEquals(expectedString, actualString);

    final Value decodedValue = EncodeDecodeValue.decodeValue(expectedString);
  ...
  public void test_encodeDecodeContexts_quads_context_not_specified() {
    ...
    final String[] encoded = EncodeDecodeValue.encodeContexts(new Resource[0]);
  ...
  public void test_encodeDecodeContexts_quads_context_nullGraph() {
    ...
    final String[] encoded = EncodeDecodeValue.encodeContexts(new Resource[] {null});
  ...
  public void test_encodeDecodeContexts_quads_context_x_y_z() {
    ...
    final String[] encoded = EncodeDecodeValue.encodeContexts(new Resource[] {x, y, z});
  ...
  public void test_encodeDecodeContexts_quads_context_x_null_z() {
    ...
    final String[] encoded = EncodeDecodeValue.encodeContexts(new Resource[] {x, null, z});
