...
public class StandaloneNanoSparqlServer extends NanoSparqlServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String propertyFile =
        System.getProperty(SystemProperties.EMBERGRAPH_PROPERTY_FILE, "RWStore.properties");

    String portStr =
        System.getProperty(SystemProperties.JETTY_PORT, Integer.toString(Config.HTTP_PORT));
    ...
    // Create the service.
    final Server server =
        StandaloneNanoSparqlServer.newInstance(port, jettyXml, null /* indexManager */, initParams);
    ...
    System.out.println(
        "Go to http://" + getHost() + ":" + port + "/" + Config.PATH + "/ to get started.");
