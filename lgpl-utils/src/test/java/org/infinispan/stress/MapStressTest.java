 ...
 * @since 4.0
 */
// @Test(testName = "stress.MapsStressTest", groups = "stress", enabled = true, description =
// "Disabled by default, designed to be run manually.")
public class MapStressTest extends TestCase {
  ...
  //        doTest(new BufferedConcurrentHashMap<Integer, Integer>(MAP_CAPACITY, MAP_LOAD_FACTOR,
  // CONCURRENCY, EvictionStrategy.LRU,null));
  //    }
  ...
  private String opsPerMS(long nanos, int ops) {
    ...
    if (totalMillis > 0) return "" + ops / totalMillis;
